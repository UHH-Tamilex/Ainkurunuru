...
`),g="".concat(this.fontWeight," ").concat(this.fontSize,"px ").concat(this.fontFace);s.font=g;var v=Math.max.apply(Math,ia(m.map(function(R){return s.measureText(R).width}))),p=this.fontSize*m.length;if(a.width=v+c[0]*2+f[0]*2,a.height=p+c[1]*2+f[1]*2,this.borderWidth){if(s.strokeStyle=this.borderColor,c[0]){var h=c[0]/2;s.lineWidth=c[0],s.beginPath(),s.moveTo(h,l[0]),s.lineTo(h,a.height-l[3]),s.moveTo(a.width-h,l[1]),s.lineTo(a.width-h,a.height-l[2]),s.stroke()}if(c[1]){var A=c[1]/2;s.lineWidth=c[1],s.beginPath(),s.moveTo(Math.max(c[0],l[0]),A),s.lineTo(a.width-Math.max(c[0],l[1]),A),s.moveTo(Math.max(c[0],l[3]),a.height-A),s.lineTo(a.width-Math.max(c[0],l[2]),a.height-A),s.stroke()}if(this.borderRadius){var y=Math.max.apply(Math,ia(c)),_=y/2;s.lineWidth=y,s.beginPath(),[!!l[0]&&[l[0],_,_,l[0]],!!l[1]&&[a.width-l[1],a.width-_,_,l[1]],!!l[2]&&[a.width-l[2],a.width-_,a.height-_,a.height-l[2]],!!l[3]&&[l[3],_,a.height-_,a.height-l[3]]].filter(function(R){return R}).forEach(function(R){var x=_l(R,4),E=x[0],N=x[1],U=x[2],ee=x[3];s.moveTo(E,U),s.quadraticCurveTo(N,U,N,ee)}),s.stroke()}}this.backgroundColor&&(s.fillStyle=this.backgroundColor,this.borderRadius?(s.beginPath(),s.moveTo(c[0],l[0]),[[c[0],l[0],a.width-l[1],c[1],c[1],c[1]],[a.width-c[0],a.width-c[0],a.width-c[0],c[1],l[1],a.height-l[2]],[a.width-c[0],a.width-l[2],l[3],a.height-c[1],a.height-c[1],a.height-c[1]],[c[0],c[0],c[0],a.height-c[1],a.height-l[3],l[0]]].forEach(function(R){var x=_l(R,6),E=x[0],N=x[1],U=x[2],ee=x[3],T=x[4],C=x[5];s.quadraticCurveTo(E,ee,N,T),s.lineTo(U,C)}),s.closePath(),s.fill()):s.fillRect(c[0],c[1],a.width-c[0]*2,a.height-c[1]*2)),s.translate.apply(s,ia(c)),s.translate.apply(s,ia(f)),s.font=g,s.fillStyle=this.color,s.textBaseline="bottom";var b=this.strokeWidth>0;b&&(s.lineWidth=this.strokeWidth*this.fontSize/10,s.strokeStyle=this.strokeColor),m.forEach(function(R,x){var E=(v-s.measureText(R).width)/2,N=(x+1)*r.fontSize;b&&s.strokeText(R,E,N),s.fillText(R,E,N)}),this.material.map&&this.material.map.dispose();var k=this.material.map=new Tn.Texture(a);k.minFilter=Tn.LinearFilter,k.colorSpace=Tn.SRGBColorSpace,k.needsUpdate=!0;var S=this.textHeight*m.length+o[1]*2+d[1]*2;this.scale.set(S*a.width/a.height,S,0)}},{key:"clone",value:function(){return new this.constructor(this.text,this.textHeight,this.color).copy(this)}},{key:"copy",value:function(r){return Tn.Sprite.prototype.copy.call(this,r),this.color=r.color,this.backgroundColor=r.backgroundColor,this.padding=r.padding,this.borderWidth=r.borderWidth,this.borderColor=r.borderColor,this.fontFace=r.fontFace,this.fontSize=r.fontSize,this.fontWeight=r.fontWeight,this.strokeWidth=r.strokeWidth,this.strokeColor=r.strokeColor,this}}]),t}(Tn.Sprite);const Ob=[{id:"nīl",size:6,type:"noun"},{id:"mēṉi",size:6,type:"noun"},{id:"vāl",size:6,type:"noun"},{id:"iḻai",size:11,type:"noun"},{id:"pākattu",size:1},{id:"oru",size:6,type:"noun"},{id:"iru",size:7,type:"noun"},{id:"tāḷ",size:3,type:"noun"},{id:"niḻal",size:7,type:"noun"},{id:"kīḻ",size:1},{id:"mu",size:1,type:"noun"},{id:"vaku",size:1,type:"verb"},{id:"ulakam",size:1,type:"noun"},{id:"vāḻ",size:82,type:"verb"},{id:"yātaṉ",size:10},{id:"yaviṉi",size:10},{id:"nel",size:9,type:"noun"},{id:"pal",size:31,type:"noun"},{id:"poli",size:3,type:"noun"},{id:"poṉ",size:9,type:"noun"},{id:"peru(m)",size:39,type:"adjective"},{id:"ciṟa",size:9,type:"verb"},{id:"veṉa",size:9},{id:"vēṭṭōḷ",size:10},{id:"yāy",size:13,type:"noun"},{id:"yām",size:20,type:"pronoun"},{id:"naṉai",size:3,type:"noun"},{id:"kāñcic",size:1},{id:"ciṉai",size:11,type:"verb"},{id:"ciṟu(m)",size:16,type:"adjective"},{id:"miṉ",size:5,type:"noun"},{id:"yāṇar",size:9,type:"noun"},{id:"ūr",size:49,type:"noun"},{id:"pāṇ",size:21,type:"noun"},{id:"māri",size:3,type:"noun"},{id:"vāy",size:5,type:"noun"},{id:"vaḷam",size:5,type:"noun"},{id:"naṉi",size:12},{id:"pū(m)",size:27,type:"noun"},{id:"māattup",size:2},{id:"pulavu",size:2,type:"noun"},{id:"taṭpam",size:39,type:"noun"},{id:"tuṟai",size:31,type:"noun"},{id:"yūraṉ",size:20},{id:"tāṉ",size:31,type:"pronoun"},{id:"koḷ",size:24,type:"verb"},{id:"cel",size:34,type:"noun"},{id:"puṉal",size:17,type:"noun"},{id:"aṭu",size:8,type:"verb"},{id:"maka",size:45,type:"noun"},{id:"iṭu",size:1,type:"verb"},{id:"voḷ",size:4},{id:"ḷiḻai",size:1},{id:"maṇal",size:7,type:"noun"},{id:"cimaiyattu",size:1},{id:"erumai",size:6,type:"noun"},{id:"kiḷai",size:2,type:"noun"},{id:"i-",size:34,type:"pronoun"},{id:"narampu",size:1,type:"noun"},{id:"aṉṉai",size:41,type:"noun"},{id:"vēṇṭu",size:24,type:"verb"},{id:"yutuk",size:1},{id:"kaṇ",size:58,type:"noun"},{id:"ēr",size:5,type:"noun"},{id:"koṭip",size:3},{id:"pācu",size:2},{id:"aṭumpu",size:1,type:"noun"},{id:"pari",size:5,type:"noun"},{id:"vūrpu",size:1},{id:"iḻi",size:2,type:"verb"},{id:"neytal",size:5,type:"noun"},{id:"mayakkam",size:3},{id:"varavu",size:55,type:"noun"},{id:"nī",size:77,type:"pronoun"},{id:"pūp",size:4},{id:"pōl",size:8,type:"verb"},{id:"uṇ",size:19},{id:"maruvu",size:1,type:"verb"},{id:"no/nō",size:9,type:"verb"},{id:"maruntu",size:4,type:"noun"},{id:"ākkam",size:49,type:"noun"},{id:"namm",size:4},{id:"niṟap",size:1},{id:"kaṭal",size:8,type:"noun"},{id:"puḷ",size:3,type:"noun"},{id:"°āṉ",size:2,type:"verb"},{id:"tuṉpam",size:1,type:"noun"},{id:"uṟu",size:14,type:"verb"},{id:"tuyara",size:1},{id:"nīkku",size:2,type:"verb"},{id:"viṉpu",size:1},{id:"vicaikkum",size:1},{id:"a-",size:67,type:"pronoun"},{id:"tēr",size:9,type:"noun"},{id:"puṉṉai",size:3,type:"noun"},{id:"ñāḻal",size:6,type:"noun"},{id:"taṇṇ",size:3},{id:"am",size:13,type:"adjective"},{id:"amaintaṉaṉ",size:1},{id:"amai",size:7,type:"noun"},{id:"mā",size:13,type:"adjective"},{id:"ūrp",size:3},{id:"maṭi",size:1,type:"noun"},{id:"poḻutu",size:6,type:"noun"},{id:"nal",size:52,type:"adjective"},{id:"mikac",size:2},{id:"cā",size:6,type:"verb"},{id:"naḷḷeṉ",size:2,type:"verb"},{id:"viyal",size:3,type:"noun"},{id:"tērc",size:1},{id:"celvak",size:1},{id:"koṇkaṉ",size:13,type:"noun"},{id:"muḻakkam",size:4},{id:"tirai",size:4,type:"verb"},{id:"taru",size:1},{id:"muttam",size:2,type:"noun"},{id:"veḷ",size:19,type:"adjective"},{id:"imai",size:1,type:"noun"},{id:"eṉap",size:5},{id:"civantaṉṟu",size:1},{id:"yavar",size:3},{id:"nāṭṭut",size:1},{id:"tutik",size:1},{id:"kāl",size:21,type:"noun"},{id:"aṉṉam",size:1,type:"noun"},{id:"tuṇai",size:12,type:"noun"},{id:"miti",size:1,type:"noun"},{id:"vaḷaiyiṉum",size:1},{id:"ilaṅku",size:3,type:"verb"},{id:"kaliḻ",size:7,type:"verb"},{id:"ākam",size:1,type:"noun"},{id:"yeṉ",size:6},{id:"tōḻaṉ",size:46},{id:"cuṭar",size:7,type:"noun"},{id:"nutal",size:13,type:"noun"},{id:"pacappac",size:2},{id:"cāayp",size:1},{id:"paṭar",size:6,type:"noun"},{id:"mel",size:13,type:"adjective"},{id:"paṭu",size:14,type:"verb"},{id:"kēḷ",size:19,type:"verb"},{id:"tuñcu",size:5,type:"verb"},{id:"kaḻi",size:12},{id:"muṇṭakam",size:1,type:"noun"},{id:"malar",size:26,type:"noun"},{id:"cērppu",size:2,type:"noun"},{id:"em",size:12,type:"pronoun"},{id:"tōḷ",size:15,type:"noun"},{id:"tuṟa",size:4,type:"verb"},{id:"e-",size:26,type:"pronoun"},{id:"kol",size:7,type:"verb"},{id:"nīrp",size:4},{id:"tūmpu",size:4,type:"noun"},{id:"pūk",size:6},{id:"keḻu",size:10},{id:"yevaṉ",size:2},{id:"nāḷ",size:9,type:"noun"},{id:"maṉai",size:12,type:"noun"},{id:"naṭu",size:3,type:"verb"},{id:"vayalai",size:1,type:"noun"},{id:"vēḻam",size:8,type:"noun"},{id:"cuṟṟam",size:1,type:"noun"},{id:"koṭu(m)",size:6,type:"adjective"},{id:"nāṇ",size:3,type:"noun"},{id:"nallaṉ",size:1},{id:"yallaṉ",size:1},{id:"taṭa(m)",size:7,type:"adjective"},{id:"amma",size:36},{id:"cūḻ",size:2,type:"verb"},{id:"maruṅku",size:3,type:"noun"},{id:"iraik",size:1},{id:"koḷīic",size:1},{id:"ciṉaik",size:2},{id:"kayal",size:3,type:"noun"},{id:"māy",size:1,type:"verb"},{id:"pirintum",size:1},{id:"nām",size:22,type:"pronoun"},{id:"yarum",size:8},{id:"tavam",size:1,type:"noun"},{id:"ilaic",size:1},{id:"cerunti",size:1,type:"noun"},{id:"tāvu",size:2,type:"verb"},{id:"virum",size:4},{id:"kaḻic",size:1},{id:"varak",size:2},{id:"maṟantōm",size:1},{id:"neṉṉal",size:1},{id:"ōkku",size:3,type:"verb"},{id:"uṭai",size:7,type:"noun"},{id:"ūrār",size:1},{id:"peṇ",size:10,type:"noun"},{id:"eṉ",size:35,type:"pronoun"},{id:"moḻi",size:5,type:"noun"},{id:"veṉṉai",size:1},{id:"yatu",size:1},{id:"pai",size:4},{id:"vem",size:20},{id:"mai",size:4,type:"noun"},{id:"nērēm",size:1},{id:"celkuvam",size:1},{id:"nārai",size:3,type:"noun"},{id:"yiraṟṟum",size:1},{id:"maṭalam",size:1},{id:"peṇṇai",size:1,type:"noun"},{id:"nuṇ",size:4,type:"adjective"},{id:"aṭai",size:2,type:"noun"},{id:"karai",size:4,type:"noun"},{id:"nammōṭu",size:1},{id:"āṭu",size:7,type:"noun"},{id:"ṇam",size:1},{id:"maṟaii",size:1},{id:"yaṉṉai",size:1},{id:"kaṭi",size:4,type:"noun"},{id:"aḻu",size:1,type:"verb"},{id:"nīla",size:1},{id:"kūmpum",size:1},{id:"mālai",size:4,type:"noun"},{id:"yaṉṉa",size:9},{id:"yaṇi",size:2},{id:"toṟum",size:9},{id:"vari",size:8,type:"noun"},{id:"maṇi",size:8,type:"noun"},{id:"nīrc",size:1},{id:"yāṉ",size:7,type:"pronoun"},{id:"aṟam",size:7,type:"noun"},{id:"il",size:23,type:"noun"},{id:"āḷ",size:3,type:"noun"},{id:"ciṉavuveṉ",size:1},{id:"takaikkuveṉ",size:1},{id:"ceṉṟaṉeṉ",size:1},{id:"piṉ",size:3},{id:"niṉai",size:7,type:"verb"},{id:"iraṅkip",size:1},{id:"eyyāmaiyiṉ",size:1},{id:"ētil",size:1,type:"adjective"},{id:"paṟṟu",size:3,type:"noun"},{id:"yaṉpu",size:1},{id:"pulak",size:2},{id:"cēr",size:2,type:"verb"},{id:"karuppu",size:6,type:"adjective"},{id:"āṟṟuka",size:1},{id:"tōṟka",size:1},{id:"vel",size:16,type:"verb"},{id:"miku",size:4,type:"verb"},{id:"vāyiṉa",size:5},{id:"vaḷiya",size:1},{id:"mal",size:3,type:"noun"},{id:"iru(m)",size:7,type:"adjective"},{id:"nīr",size:10,type:"pronoun"},{id:"aṟal",size:3,type:"noun"},{id:"viri",size:7,type:"verb"},{id:"lam",size:1},{id:"pulampu",size:5,type:"noun"},{id:"al",size:23,type:"verb"},{id:"muṇṭakak",size:1},{id:"kōtai",size:2,type:"noun"},{id:"naṉaiyat",size:1},{id:"teḷ",size:4,type:"adjective"},{id:"tiraip",size:1},{id:"pauvam",size:1,type:"noun"},{id:"yoḷḷ",size:1},{id:"yuyar",size:1},{id:"vīḻ",size:2,type:"noun"},{id:"veḷḷām ",size:1},{id:"yoḷ",size:6},{id:"āy",size:2,type:"verb"},{id:"ārppat",size:1},{id:"vaṇṭal",size:2,type:"noun"},{id:"pāvai",size:9,type:"noun"},{id:"vauvu",size:3,type:"verb"},{id:"poṭi",size:1},{id:"yaḷaiik",size:1},{id:"vauva",size:1},{id:"vuṇ",size:3},{id:"civa",size:5,type:"verb"},{id:"yuṇ",size:3},{id:"vaṇṭu",size:9,type:"noun"},{id:"iṉam",size:2,type:"noun"},{id:"moyppat",size:1},{id:"tumpai",size:1},{id:"yiḷa",size:3},{id:"mulai",size:8,type:"noun"},{id:"pūṭṭu",size:3,type:"noun"},{id:"yuṟāa",size:1},{id:"vaṟu(m)",size:2,type:"adjective"},{id:"maṭāa",size:1},{id:"vuṇṇāp",size:1},{id:"yuṭai",size:2},{id:"poṅku",size:1,type:"verb"},{id:"uḷai",size:1,type:"noun"},{id:"vaṭai",size:1},{id:"pakar",size:1,type:"verb"},{id:"yāmam",size:1,type:"noun"},{id:"koṇkaṉatu",size:1},{id:"naṭpu",size:1,type:"noun"},{id:"tillai",size:1,type:"noun"},{id:"vēli",size:1,type:"noun"},{id:"yiv",size:1},{id:"vūrk",size:1},{id:"kal",size:8,type:"noun"},{id:"leṉ",size:1},{id:"kauvai",size:1,type:"noun"},{id:"yarumpu",size:1},{id:"mali",size:4,type:"verb"},{id:"kāṉal",size:2,type:"noun"},{id:"iv",size:4},{id:"vūr",size:4},{id:"cey",size:20,type:"noun"},{id:"vāṉātu",size:1},{id:"mell",size:4},{id:"piri",size:16,type:"verb"},{id:"pull",size:2},{id:"eṉṟaṉa",size:1},{id:"puri",size:4,type:"noun"},{id:"kāṇmati",size:1},{id:"kaḻip",size:1},{id:"pāy",size:6,type:"verb"},{id:"neṭu(m)",size:23,type:"adjective"},{id:"tērk",size:2},{id:"koṇkaṉōṭu",size:1},{id:"paṇait",size:3},{id:"ai",size:4,type:"noun"},{id:"akal",size:5,type:"noun"},{id:"valkul",size:1},{id:"kaṇṇi",size:1,type:"noun"},{id:"nēr",size:3,type:"noun"},{id:"kōḷ",size:5,type:"noun"},{id:"vaḷai",size:6,type:"noun"},{id:"nekiḻ",size:5,type:"verb"},{id:"tuṟaivaṟkuc",size:1},{id:"niṉṉ",size:3},{id:"viṉavu",size:1,type:"verb"},{id:"numm",size:2},{id:"ūrt",size:1},{id:"tiṇ",size:6,type:"adjective"},{id:"koṇkaṉai",size:1},{id:"naya",size:10,type:"verb"},{id:"paṇṭait",size:1},{id:"tām",size:8,type:"pronoun"},{id:"paṇpu",size:4,type:"noun"},{id:"viv",size:1},{id:"aṉpu",size:3,type:"noun"},{id:"kaḻaṟu",size:1,type:"verb"},{id:"vayiṉ",size:7,type:"noun"},{id:"māṇ",size:7,type:"noun"},{id:"maruṭṭum",size:1},{id:"tīṇṭu",size:1,type:"verb"},{id:"yayala",size:1},{id:"vaṭuk",size:1},{id:"mā(m)",size:5,type:"noun"},{id:"val",size:15,type:"noun"},{id:"taḷir",size:3,type:"noun"},{id:"nuṭaṅku",size:4,type:"verb"},{id:"aṇit",size:1},{id:"mārpu",size:11,type:"noun"},{id:"paṉit",size:1},{id:"tuyil",size:1,type:"noun"},{id:"mati",size:1,type:"noun"},{id:"yuraittaṟku",size:1},{id:"uri-",size:3},{id:"viṟai",size:1},{id:"el",size:5,type:"noun"},{id:"ekkar",size:6,type:"noun"},{id:"ceruntiyoṭu",size:2},{id:"kamaḻat",size:1},{id:"tuvalait",size:1},{id:"tuḷi",size:1,type:"noun"},{id:"vīcip",size:1},{id:"paca",size:11,type:"verb"},{id:"paṉi",size:7,type:"noun"},{id:"iṟakku",size:1,type:"verb"},{id:"iṇarp",size:1},{id:"ḷiṟai",size:1},{id:"kūr",size:3,type:"noun"},{id:"yuḷḷēṉ",size:1},{id:"paṭi",size:1,type:"noun"},{id:"puḷḷ",size:4},{id:"imiḻ",size:1,type:"noun"},{id:"yiṉiya",size:4},{id:"nil",size:12,type:"verb"},{id:"muṉi",size:3,type:"noun"},{id:"vivaḷ",size:7},{id:"iṇar",size:6,type:"noun"},{id:"potumpart",size:1},{id:"taṉik",size:1},{id:"kuruku",size:5,type:"noun"},{id:"uṟaṅku",size:1,type:"verb"},{id:"tuṟaivarku",size:1},{id:"iṉip",size:2},{id:"ciṟi",size:3},{id:"yilaip",size:1},{id:"yōtam",size:1},{id:"vāṅku",size:1,type:"verb"},{id:"malir",size:3,type:"verb"},{id:"niṟai",size:5,type:"noun"},{id:"virumpiya",size:2},{id:"taḻaip",size:1},{id:"makaḷirkkup",size:1},{id:"puṇar",size:14,type:"verb"},{id:"yutavum",size:1},{id:"mūtu",size:2},{id:"vēḻattut",size:2},{id:"uṭait",size:1},{id:"tiraḷ",size:1,type:"noun"},{id:"toḻumakaḷir",size:1},{id:"añcaṉam",size:1},{id:"pey",size:4,type:"verb"},{id:"kañal",size:4,type:"verb"},{id:"yuḷḷip",size:1},{id:"putal",size:1,type:"noun"},{id:"micai",size:1,type:"noun"},{id:"vicumpu",size:3,type:"noun"},{id:"tōṟṟam",size:7,type:"noun"},{id:"putu",size:3,type:"adjective"},{id:"mēvu",size:1,type:"noun"},{id:"maṭa(m)",size:13,type:"noun"},{id:"cāy",size:2,type:"noun"},{id:"alamvaru",size:2,type:"verb"},{id:"kaḻaṉi",size:9,type:"noun"},{id:"poru",size:3,type:"verb"},{id:"ṇaḻap",size:1},{id:"putup",size:5},{id:"meym",size:1},{id:"maṇa",size:6,type:"verb"},{id:"kamaḻ",size:4,type:"verb"},{id:"poḻil",size:4,type:"noun"},{id:"ḷuḷai",size:1},{id:"cī",size:2,type:"verb"},{id:"kalakkam",size:5,type:"noun"},{id:"viḷaika",size:1},{id:"vayal",size:3,type:"noun"},{id:"viravalar",size:1},{id:"litaḻ",size:1},{id:"nikar",size:1,type:"noun"},{id:"vaḻi",size:2,type:"noun"},{id:"vaḻic",size:1},{id:"aṟu",size:9,type:"noun"},{id:"cil",size:5,type:"noun"},{id:"vam",size:4},{id:"ciṟait",size:1},{id:"tumpi",size:1,type:"noun"},{id:"nūṟṟu",size:1},{id:"itaḻt",size:1},{id:"tāmaraip",size:1},{id:"pūc",size:1},{id:"kāmpu",size:1,type:"noun"},{id:"naṇṇu",size:2,type:"verb"},{id:"yūraṉai",size:2},{id:"yuḷḷi",size:3},{id:"ṉiṟai",size:1},{id:"yēr",size:2},{id:"yeṉṉai",size:2},{id:"tāṉum",size:1},{id:"malaintāṉ",size:1},{id:"emakkum",size:1},{id:"taḻāi",size:1},{id:"yāyiṉa",size:1},{id:"vī",size:4,type:"noun"},{id:"yarumpiṉavē",size:1},{id:"yeṉṉa",size:1},{id:"maram",size:2,type:"noun"},{id:"cāral",size:2,type:"noun"},{id:"avvē",size:1},{id:"notumal",size:2,type:"noun"},{id:"varaiviṉkaṇ",size:1},{id:"cevili",size:1,type:"noun"},{id:"āṟṟāl",size:1},{id:"talaimakaḷ",size:4},{id:"aṟattoṭu",size:2},{id:"pārppaṉak",size:1},{id:"kuṟu(m)",size:7,type:"adjective"},{id:"makap",size:1},{id:"pōlat",size:1},{id:"kuṭumit",size:1},{id:"talai",size:5},{id:"malai",size:8,type:"noun"},{id:"nāṭu",size:9,type:"noun"},{id:"talaimakaṉ",size:3},{id:"varaital",size:1},{id:"vēṇṭit",size:1},{id:"varukiṉṟamaik",size:1},{id:"yuvanta",size:1},{id:"vuḷḷattaḷ",size:1},{id:"āyt",size:1},{id:"talaimakaṭkuk",size:1},{id:"paṭappait",size:1},{id:"tēm",size:3,type:"noun"},{id:"pāl",size:3,type:"noun"},{id:"iṉum",size:1},{id:"iṉ",size:15,type:"adjective"},{id:"vavar",size:3},{id:"nāṭṭu",size:4,type:"verb"},{id:"uvalaik",size:1},{id:"kūval",size:1,type:"noun"},{id:"kīḻa",size:1},{id:"eñcu",size:1,type:"verb"},{id:"kaliḻi",size:1},{id:"-uṭaṉ",size:2},{id:"pōy",size:1},{id:"mīḷ",size:1,type:"verb"},{id:"eṅṅaṉam",size:1},{id:"nukarntāy",size:1},{id:"eṉak",size:5},{id:"aḵtu",size:2},{id:"varaiyara",size:1},{id:"nirai",size:3,type:"noun"},{id:"kuḻuvu",size:1,type:"verb"},{id:"peyar",size:7,type:"noun"},{id:"uḻi",size:2,type:"noun"},{id:"tavir",size:1,type:"verb"},{id:"nōkkam",size:5,type:"noun"},{id:"tīyēṉ",size:1},{id:"-uṭai",size:3},{id:"accam",size:3,type:"noun"},{id:"oli",size:2,type:"verb"},{id:"veḷḷ",size:1},{id:"aruvi",size:1,type:"noun"},{id:"yōṅku",size:1},{id:"pāyal",size:3,type:"noun"},{id:"veppa(m)",size:5,type:"noun"},{id:"varai",size:10,type:"noun"},{id:"viṭu",size:3,type:"verb"},{id:"uḻit",size:1},{id:"talaimakaṭku",size:1},{id:"uḷ",size:2},{id:"varuttam",size:4,type:"noun"},{id:"vāṟu",size:3},{id:"ātaṟkkuk",size:1},{id:"kāraṇam",size:1},{id:"yeṉṟu",size:2},{id:"viṉāviya",size:1},{id:"cevilikkut",size:1},{id:"yuvak",size:2},{id:"mārik",size:1},{id:"kuṉṟattuk",size:1},{id:"kā",size:3,type:"noun"},{id:"tūvu",size:1,type:"verb"},{id:"toṭalai",size:2,type:"noun"},{id:"vāḷ",size:3,type:"noun"},{id:"pāci",size:1,type:"noun"},{id:"kaḻal",size:5,type:"noun"},{id:"vaiku",size:1,type:"verb"},{id:"varik",size:1},{id:"kaccu",size:1,type:"noun"},{id:"iravuk",size:1},{id:"kuṟik",size:1},{id:"kuṟi",size:3,type:"noun"},{id:"yiṭattu",size:1},{id:"niṉṟamai",size:1},{id:"yaṟinta",size:1},{id:"naṉṟum",size:2},{id:"uṇaṅkala",size:1},{id:"tiṉai",size:2,type:"noun"},{id:"niṇa",size:3,type:"verb"},{id:"poti",size:1,type:"noun"},{id:"vaḻukkiṉ",size:1},{id:"maḻai",size:4,type:"noun"},{id:"vai",size:5,type:"noun"},{id:"kuṉṟam",size:8,type:"noun"},{id:"yiṉmaiyāl",size:1},{id:"yuṇaṅkum",size:1},{id:"viḷaiya",size:1},{id:"māṭṭā",size:1},{id:"puṉam",size:1,type:"noun"},{id:"kāppac",size:1},{id:"avarai",size:1,type:"noun"},{id:"yetirppaṭalām",size:1},{id:"eṇṇu",size:1,type:"verb"},{id:"yirunta",size:1},{id:"vitu",size:1},{id:"kūṭṭam",size:3,type:"noun"},{id:"veṟuttu",size:1},{id:"talaimakaṭkut",size:1},{id:"kāṉ",size:7,type:"noun"},{id:"kiḻaṅku",size:1,type:"noun"},{id:"akaḻ",size:1,type:"verb"},{id:"kuḻi",size:1,type:"noun"},{id:"vēṅkaip",size:2},{id:"vīt",size:1},{id:"tāam",size:1},{id:"niṟam",size:4,type:"noun"},{id:"māl",size:2,type:"adjective"},{id:"maṟai",size:3,type:"noun"},{id:"toṟu",size:1},{id:"aṟai",size:1,type:"noun"},{id:"ār",size:1,type:"noun"},{id:"cevilikku",size:1},{id:"yavaḷāl",size:1},{id:"māṭcimaip",size:1},{id:"piṉpu",size:1},{id:"ellavum",size:1},{id:"tīrntatu",size:1},{id:"maṟṟu",size:3},{id:"maṟa",size:5,type:"verb"},{id:"yāyiṉ",size:3},{id:"koṇṭal",size:1,type:"noun"},{id:"avaraip",size:1},{id:"cūṭit",size:1},{id:"iṭai",size:12,type:"noun"},{id:"vaittup",size:1},{id:"kaṇṇ",size:1},{id:"avaṉai",size:1},{id:"viṭātu",size:1},{id:"āṟṟu",size:4,type:"verb"},{id:"tōḻikkut",size:1},{id:"muḷḷi",size:3,type:"noun"},{id:"nīṭṭu",size:6,type:"verb"},{id:"mutu",size:2,type:"adjective"},{id:"karaip",size:1},{id:"puḷḷik",size:3},{id:"kaḷvaṉ",size:9,type:"noun"},{id:"āmpal",size:6,type:"noun"},{id:"pacappatu",size:2},{id:"aḷḷal",size:1,type:"noun"},{id:"vēr",size:2,type:"noun"},{id:"aḷaic",size:1},{id:"col",size:6,type:"noun"},{id:"nīyēṉ",size:1},{id:"kātal",size:9,type:"noun"},{id:"veṉṉ",size:2},{id:"kaviṉ",size:4,type:"noun"},{id:"tolai",size:3,type:"verb"},{id:"vaḻit",size:1},{id:"taṇantu",size:1},{id:"varaitaṟku",size:1},{id:"vēṇṭuvaṉa",size:1},{id:"muṭi",size:2,type:"noun"},{id:"kūṟak",size:1},{id:"ciṟaippuṟattāṉ",size:1},{id:"āyk",size:1},{id:"kēṭpat",size:1},{id:"aḷaik",size:1},{id:"āṭṭip",size:1},{id:"kuṟṟu",size:5,type:"verb"},{id:"eytu",size:1,type:"verb"},{id:"aṇi",size:15,type:"noun"},{id:"tēṟṟam",size:1},{id:"nap",size:1},{id:"iṉit",size:1},{id:"tākku",size:1,type:"verb"},{id:"aṇaṅku",size:4,type:"noun"},{id:"tāy",size:3,type:"noun"},{id:"cāp",size:1},{id:"piṟa",size:6,type:"noun"},{id:"kaḷvaṉoṭu",size:1},{id:"piḷḷai",size:1,type:"noun"},{id:"tiṉṉum",size:2},{id:"mutalaittu",size:1},{id:"eytiṉaṉ",size:1},{id:"makiḻ",size:24,type:"noun"},{id:"polam",size:4,type:"noun"},{id:"toṭi",size:13,type:"noun"},{id:"teḷir",size:1,type:"verb"},{id:"muyaṅkiyavar",size:1},{id:"tuṟappatu",size:1},{id:"ayal",size:2,type:"noun"},{id:"puṟantā",size:1,type:"verb"},{id:"puṉiṟu",size:2,type:"noun"},{id:"pai(m)",size:7,type:"adjective"},{id:"kāy",size:6,type:"noun"},{id:"vayalaic",size:2},{id:"ce(m)",size:14,type:"adjective"},{id:"koṭi",size:3,type:"noun"},{id:"palarkku",size:1},{id:"poy",size:6,type:"noun"},{id:"aṟiyāk",size:2},{id:"kaḻaṅku",size:2,type:"noun"},{id:"mey",size:1,type:"noun"},{id:"varaik",size:1},{id:"kaṭci",size:1,type:"noun"},{id:"mayil",size:2,type:"noun"},{id:"ālu",size:3,type:"verb"},{id:"vaḷḷi",size:1,type:"noun"},{id:"kiḻamai",size:1,type:"noun"},{id:"āṇ",size:1,type:"noun"},{id:"taku",size:3,type:"verb"},{id:"viṟal",size:4,type:"noun"},{id:"vēṭkai",size:1,type:"noun"},{id:"tāṅku",size:1,type:"verb"},{id:"iḷa(m)",size:2,type:"adjective"},{id:"karantai",size:1,type:"noun"},{id:"ceṟu",size:3,type:"verb"},{id:"vaḷḷai",size:1,type:"noun"},{id:"aṟi",size:8,type:"verb"},{id:"iṉṉaṉ",size:1},{id:"katir",size:7,type:"noun"},{id:"ṇakam",size:2},{id:"maṇ",size:3,type:"noun"},{id:"ṇaḷaic",size:1},{id:"nekiḻac",size:2},{id:"allal",size:1,type:"noun"},{id:"uḻa",size:1,type:"verb"},{id:"yaṇaṅku",size:2},{id:"uṟai",size:6,type:"noun"},{id:"cēṟu",size:1,type:"noun"},{id:"oṇmai",size:8,type:"noun"},{id:"koḷak",size:1},{id:"kaṭuka",size:1},{id:"vittu",size:2,type:"noun"},{id:"muḷai",size:2,type:"noun"},{id:"marīit",size:1},{id:"titti",size:2,type:"noun"},{id:"yalkul",size:3},{id:"koḷvatu",size:1},{id:"vūṟuka",size:1},{id:"pakaṭu",size:1},{id:"vuḻavar",size:1},{id:"vēppa(m)",size:3,type:"noun"},{id:"ṇaḷai",size:1},{id:"vuṟaikkum",size:1},{id:"iḻa",size:2,type:"verb"},{id:"lōttirattu",size:1},{id:"maiy",size:1},{id:"aru(m)",size:15,type:"adjective"},{id:"curam",size:34,type:"noun"},{id:"ceṉṉik",size:1},{id:"av",size:1},{id:"varaiy",size:1},{id:"iṟakkuvaiy",size:1},{id:"poruḷ",size:6,type:"noun"},{id:"viṉai",size:3,type:"noun"},{id:"tappal",size:1,type:"noun"},{id:"arivai",size:5,type:"noun"},{id:"takaittaṟku",size:1},{id:"pulampav",size:1},{id:"putuk",size:1},{id:"kalam",size:2,type:"noun"},{id:"kaṉiya",size:1},{id:"vālam",size:1},{id:"pōkil",size:2,type:"noun"},{id:"taṉait",size:1},{id:"taṭukkum",size:1},{id:"vēṉal",size:10,type:"noun"},{id:"viṉiya",size:2},{id:"vāka",size:2},{id:"kallāk",size:1},{id:"kōvalar",size:2,type:"noun"},{id:"kōl",size:2,type:"noun"},{id:"tōṇṭiyav",size:1},{id:"ā",size:2},{id:"pattar",size:1,type:"noun"},{id:"yāṉai",size:10,type:"noun"},{id:"kall",size:2},{id:"atark",size:1},{id:"kavalai",size:3,type:"noun"},{id:"celliṉ",size:1},{id:"iyal",size:2,type:"noun"},{id:"puyal",size:1,type:"noun"},{id:"kūntal",size:7,type:"noun"},{id:"vaya(m)",size:2,type:"noun"},{id:"kaḷiṟu",size:3,type:"noun"},{id:"piṭi",size:1,type:"noun"},{id:"taḻīip",size:1},{id:"pulam",size:3,type:"noun"},{id:"paṭarātu",size:1},{id:"paci",size:3,type:"noun"},{id:"tiṉ",size:2,type:"verb"},{id:"kuṉṟattuc",size:1},{id:"cuṭart",size:1},{id:"toṭik",size:1},{id:"iṉaiyav",size:1},{id:"eṉaip",size:1},{id:"paya",size:5,type:"verb"},{id:"viṭalai",size:3,type:"noun"},{id:"pōrk",size:1},{id:"kuricil",size:1,type:"noun"},{id:"iṟa",size:9,type:"verb"},{id:"kāḻ",size:1,type:"noun"},{id:"alkul",size:3,type:"noun"},{id:"vāṭak",size:1},{id:"kuḻal",size:1,type:"noun"},{id:"iṉaikuvaḷ",size:1},{id:"viḻavu",size:2,type:"noun"},{id:"ñeli",size:1,type:"noun"},{id:"kaḻai",size:3,type:"noun"},{id:"aḻal",size:3,type:"noun"},{id:"vayamā",size:1},{id:"veru",size:3,type:"noun"},{id:"ayar",size:2,type:"verb"},{id:"tuṇaip",size:1},{id:"pall",size:6},{id:"yiṇark",size:2},{id:"eṟuḻ",size:1,type:"noun"},{id:"muruku",size:1,type:"noun"},{id:"amar",size:5,type:"noun"},{id:"tiṅkaḷ",size:1,type:"noun"},{id:"kaṭuñcūl",size:1},{id:"muṟuval",size:3,type:"noun"},{id:"viṟu",size:1},{id:"yiṟantu",size:1},{id:"kaṭam",size:4,type:"noun"},{id:"mūr",size:3},{id:"muṭam",size:1},{id:"mutir",size:3,type:"verb"},{id:"marutattup",size:2},{id:"yuṭaṉ",size:1},{id:"āyamōṭu",size:2},{id:"pacu(m)",size:5,type:"adjective"},{id:"pāṇṭil",size:3,type:"noun"},{id:"kācu",size:1,type:"noun"},{id:"nekiḻap",size:1},{id:"yivaḷ",size:2},{id:"vēṅkai",size:3,type:"noun"},{id:"koyyunar",size:1},{id:"pañcuram",size:1},{id:"viḷippiṉum",size:1},{id:"iṭaic",size:2},{id:"kāṭu",size:5,type:"noun"},{id:"nīṭuvar",size:1},{id:"cāliyar",size:3},{id:"vaṟṟu",size:5,type:"verb"},{id:"uṇṭāyiṉum",size:1},{id:"vaṉappu",size:2,type:"noun"},{id:"varuvik",size:1},{id:"eṉṉ",size:2},{id:"aiyai",size:1,type:"noun"},{id:"teṟu",size:5,type:"verb"},{id:"num",size:5,type:"pronoun"},{id:"viruppam",size:2,type:"noun"},{id:"yuṟu",size:4},{id:"tuyar",size:3,type:"noun"},{id:"avala(m)",size:1,type:"noun"},{id:"uyir",size:2,type:"noun"},{id:"celac",size:2},{id:"ppāḻ",size:1},{id:"neñcam",size:11,type:"noun"},{id:"aṭak",size:1},{id:"vilakku",size:2,type:"verb"},{id:"avir",size:6,type:"verb"},{id:"koṭpak",size:1},{id:"kaḻutu",size:1,type:"noun"},{id:"pukavu",size:1,type:"noun"},{id:"ayarak",size:1},{id:"karu(m)",size:7,type:"adjective"},{id:"kākkaiyoṭu",size:1},{id:"kaḻuku",size:1},{id:"akavac",size:1},{id:"yāḷ",size:1},{id:"vīḻttut",size:1},{id:"tiri",size:2,type:"noun"},{id:"taru/tā",size:11,type:"verb"},{id:"nīḷ",size:6,type:"noun"},{id:"pūcal",size:1,type:"noun"},{id:"cēy",size:1,type:"noun"},{id:"viḻai",size:1,type:"verb"},{id:"uṟīik",size:1},{id:"cōlaik",size:1},{id:"nantat",size:1},{id:"vāṭṭam",size:2,type:"noun"},{id:"viṟantōr",size:1},{id:"maṉ",size:17},{id:"piṟaṅku",size:2,type:"verb"},{id:"malaip",size:1},{id:"arai",size:2,type:"noun"},{id:"yōmai",size:1},{id:"puli",size:2,type:"noun"},{id:"vaḻakku",size:4,type:"noun"},{id:"cūḻkam",size:1},{id:"pāḻ",size:2,type:"noun"},{id:"paṭṭup",size:1},{id:"pālai",size:1,type:"noun"},{id:"kāṭṭu",size:1,type:"noun"},{id:"nali",size:1,type:"verb"},{id:"vēy",size:4,type:"noun"},{id:"maruṭkai",size:4,type:"noun"},{id:"vill",size:2},{id:"nacai",size:2,type:"noun"},{id:"vicai",size:1,type:"noun"},{id:"nimir",size:1,type:"verb"},{id:"ōṭṭu",size:1,type:"verb"},{id:"eri",size:4,type:"noun"},{id:"naṭa",size:4,type:"verb"},{id:"uyar",size:7,type:"verb"},{id:"piṟaṅkal",size:2,type:"noun"},{id:"viḷakkam",size:4,type:"noun"},{id:"purai",size:2,type:"noun"},{id:"muḷi",size:3,type:"verb"},{id:"til",size:2},{id:"mil",size:1},{id:"vantataṟku",size:1},{id:"eḻu",size:3,type:"noun"},{id:"aḻupa",size:1},{id:"veṉpa",size:2},{id:"vavaṉ",size:1},{id:"tī",size:6,type:"noun"},{id:"meḻukiṉ",size:1},{id:"muḷḷ",size:1},{id:"yilavattu",size:1},{id:"oḷḷ",size:2},{id:"vāṉ",size:3,type:"noun"},{id:"acai",size:2,type:"verb"},{id:"vaḷi",size:2,type:"noun"},{id:"yeṭuppa",size:1},{id:"urumup",size:1},{id:"kaṉaliṉ",size:1},{id:"nilam",size:2,type:"noun"},{id:"pōyiṉar",size:1},{id:"tavu",size:1,type:"verb"},{id:"ulaṟu",size:1,type:"verb"},{id:"talaip",size:3},{id:"paruntu",size:1,type:"noun"},{id:"uḷi",size:1,type:"noun"},{id:"vāyp",size:1},{id:"pēṭaiy",size:1},{id:"alaṟu",size:1,type:"verb"},{id:"talaiy",size:1},{id:"ōmaiy",size:1},{id:"kavaṭu",size:1},{id:"ēṟip",size:2},{id:"viḷi",size:2,type:"noun"},{id:"malaiy",size:1},{id:"iṟappiṉum",size:1},{id:"oḻi",size:3,type:"verb"},{id:"muḷiya",size:1},{id:"nīṭik",size:1},{id:"kaṭu(m)",size:2,type:"adjective"},{id:"ñāyiṟu",size:1,type:"noun"},{id:"pakat",size:1},{id:"muṉ",size:9},{id:"yuḷḷu",size:1},{id:"vaḷḷ",size:1},{id:"eyiṟṟuc",size:1},{id:"piṇaviṟkuk",size:1},{id:"kaḷḷi",size:1,type:"noun"},{id:"yam",size:2},{id:"kaṭattiṭaik",size:1},{id:"kēḻal",size:1,type:"noun"},{id:"pār",size:2,type:"noun"},{id:"curak",size:1},{id:"nīttam",size:3,type:"noun"},{id:"kavar",size:3,type:"verb"},{id:"veṉṟūḻ",size:3},{id:"kaṇpaṭuppiṉum",size:1},{id:"kāṇkuveṉ",size:1},{id:"kaṅkul",size:1,type:"noun"},{id:"naḷi",size:1,type:"noun"},{id:"nakar",size:3,type:"noun"},{id:"cuṇaṅku",size:3,type:"noun"},{id:"araiyattu",size:1},{id:"yoli",size:1},{id:"verīip",size:1},{id:"pukarvu",size:1},{id:"alai",size:1,type:"noun"},{id:"naliyātu",size:1},{id:"naṉam",size:1,type:"adjective"},{id:"iṭam",size:1,type:"noun"},{id:"peṟu",size:6,type:"verb"},{id:"piṇa",size:6,type:"noun"},{id:"maṟiyoṭu",size:1},{id:"tiraṅku",size:1,type:"verb"},{id:"nirappu",size:1,type:"verb"},{id:"viyaviṉ",size:1},{id:"poṟi",size:2,type:"noun"},{id:"varit",size:1},{id:"taṭak",size:1},{id:"kai",size:6,type:"noun"},{id:"vētal",size:1},{id:"añcic",size:1},{id:"nilan",size:1},{id:"toṭal",size:1},{id:"veyil",size:4,type:"noun"},{id:"cōlai",size:5,type:"noun"},{id:"vār",size:3,type:"noun"},{id:"iṭaiyāṉ",size:1},{id:"taṇmai",size:1},{id:"vit",size:1},{id:"taḷittu",size:1},{id:"naṟu(m)",size:11,type:"adjective"},{id:"tāayt",size:1},{id:"vāyiṉum",size:2},{id:"yoḻiyak",size:1},{id:"utir",size:1,type:"verb"},{id:"naṉantalai",size:1},{id:"maṟu",size:2,type:"noun"},{id:"ceṟi",size:3,type:"verb"},{id:"uku",size:2,type:"verb"},{id:"nilai",size:1,type:"verb"},{id:"voḻintōḷ",size:1},{id:"urappu",size:1,type:"noun"},{id:"maruta(m)",size:3,type:"noun"},{id:"tuṟaip",size:1},{id:"peṇṭirōṭu",size:1},{id:"tār",size:2,type:"noun"},{id:"talait",size:1},{id:"tukaḷ",size:1,type:"noun"},{id:"iṉic",size:1},{id:"yaḻuta",size:1},{id:"citaiyak",size:1},{id:"niṉaikkum",size:1},{id:"yaviḻ",size:1},{id:"iṇark",size:1},{id:"marām",size:3,type:"noun"},{id:"vaikal",size:1,type:"noun"},{id:"oḻintōr",size:1},{id:"-uḷ",size:2},{id:"veṟpu",size:1,type:"noun"},{id:"yeṉṉatūum",size:1},{id:"micaik",size:2},{id:"kāṉatta",size:1},{id:"māk",size:2},{id:"kaṇam",size:1,type:"noun"},{id:"kātalip",size:1},{id:"yāṅkaṇ",size:10,type:"pronoun"},{id:"yavaṇa",size:1},{id:"nāṭṭup",size:1},{id:"iṉap",size:1},{id:"tōṭu",size:1,type:"noun"},{id:"(i)yāam",size:1},{id:"uṟaitum",size:1},{id:"yāṅkup",size:1},{id:"uṟaiti",size:1},{id:"yilai",size:1},{id:"nelli",size:2,type:"noun"},{id:"iṭaip",size:2},{id:"pētai",size:2,type:"noun"},{id:"vali",size:1,type:"noun"},{id:"itaḻ",size:2,type:"noun"},{id:"neyttōr",size:1,type:"noun"},{id:"cevviya",size:1},{id:"veruvai",size:1},{id:"puṭai",size:1,type:"noun"},{id:"muṭai",size:1,type:"noun"},{id:"yārkkum",size:1},{id:"yivaṇ",size:1},{id:"pōlap",size:5},{id:"piṇi",size:7,type:"noun"},{id:"muṟṟi",size:2,type:"verb"},{id:"meyy",size:1},{id:"muyakkiṉum",size:1},{id:"yirum",size:4},{id:"yila",size:1},{id:"vōṅku",size:1},{id:"yilavam",size:1},{id:"mutal",size:1,type:"noun"},{id:"yilaik",size:1},{id:"paḻa(m)",size:3,type:"adjective"},{id:"vāval",size:2,type:"noun"},{id:"ukakkum",size:2},{id:"mūrp",size:2},{id:"poykaip",size:3},{id:"puḻaik",size:1},{id:"tātu",size:6,type:"noun"},{id:"vaṇṇa(m)",size:2,type:"noun"},{id:"vētilāḷarkkup",size:1},{id:"uḷḷu",size:3,type:"verb"},{id:"viṭṭuc",size:1},{id:"taṭṭait",size:1},{id:"kuyil",size:3,type:"noun"},{id:"peṭai",size:2,type:"noun"},{id:"kural",size:4,type:"noun"},{id:"akavu",size:2,type:"verb"},{id:"vayir",size:1},{id:"kkēḻ",size:1},{id:"nuṇṇ",size:1},{id:"curumpu",size:3,type:"noun"},{id:"kaḷi",size:1,type:"noun"},{id:"kkarum",size:1},{id:"nuṇavam",size:1},{id:"nilaik",size:1},{id:"kōṅkam",size:2,type:"noun"},{id:"koḻu",size:1,type:"verb"},{id:"mukiḻ",size:4,type:"noun"},{id:"kuravam",size:2,type:"noun"},{id:"ceyyāp",size:1},{id:"ppū",size:1},{id:"vatiral",size:1},{id:"tāayk",size:1},{id:"katuppu",size:2,type:"noun"},{id:"ciṉaip",size:1},{id:"pātiri",size:2,type:"noun"},{id:"yalarntu",size:1},{id:"eṉac",size:4},{id:"yeḻil",size:1},{id:"poliyap",size:1},{id:"porip",size:2},{id:"puṉku",size:2,type:"noun"},{id:"muṟi",size:2,type:"noun"},{id:"curi",size:2,type:"noun"},{id:"pori",size:2,type:"noun"},{id:"putai",size:1,type:"noun"},{id:"veri",size:1},{id:"poykai",size:7,type:"noun"},{id:"yāmpal",size:3},{id:"nār",size:1,type:"noun"},{id:"uri",size:1,type:"noun"},{id:"niḻaṟṟutal",size:1},{id:"yiṉip",size:1},{id:"oṇ",size:2},{id:"vuṟaippat",size:1},{id:"kiḷa",size:1,type:"verb"},{id:"attap",size:1},{id:"palavu",size:1,type:"noun"},{id:"aruntiṉar",size:1},{id:"piṉṉ",size:1},{id:"tīr",size:2,type:"verb"},{id:"maṭantai",size:5,type:"noun"},{id:"nall",size:3},{id:"eḻil",size:2,type:"noun"},{id:"viḻut",size:1},{id:"toṭai",size:1,type:"noun"},{id:"maṟam",size:1,type:"noun"},{id:"iṭat",size:1},{id:"eḻuttu",size:1,type:"noun"},{id:"viḻup",size:1},{id:"piṇarp",size:1},{id:"ciṉa(m)",size:4,type:"noun"},{id:"ari",size:3,type:"noun"},{id:"veṉṉār",size:1},{id:"erik",size:1},{id:"koṭik",size:1},{id:"kavai",size:3,type:"noun"},{id:"cev",size:1},{id:"pōlac",size:1},{id:"cuṭarp",size:1},{id:"ēntal",size:1,type:"noun"},{id:"yiṉitu",size:3},{id:"muyakkam",size:2,type:"noun"},{id:"īr(m)",size:1,type:"noun"},{id:"ēṟṟai",size:2,type:"noun"},{id:"maṟi",size:2,type:"noun"},{id:"teri",size:2,type:"verb"},{id:"yiḻai",size:3},{id:"yarivai",size:3},{id:"tiruttu",size:3,type:"verb"},{id:"uḷḷi",size:2,type:"noun"},{id:"tiru",size:1,type:"noun"},{id:"vuṟuka",size:1},{id:"poṟic",size:1},{id:"neṟi",size:4,type:"noun"},{id:"uḷḷutaṟku",size:1},{id:"puṉai",size:3,type:"noun"},{id:"kayiṟu",size:2,type:"noun"},{id:"mēy",size:3,type:"verb"},{id:"yuḷḷam",size:1},{id:"vāṅkat",size:1},{id:"maravam",size:2},{id:"pūppac",size:1},{id:"vaḻuṅkuka",size:1},{id:"kaviṉa",size:2},{id:"yiṟantaṉar",size:1},{id:"nīṭa",size:1},{id:"tuṭait",size:2},{id:"yuṭaittu",size:1},{id:"veḷḷam",size:1,type:"noun"},{id:"vēṭkaiyam",size:1},{id:"atar",size:1,type:"noun"},{id:"kālait",size:1},{id:"tava",size:2},{id:"amaikuva",size:1},{id:"karutiya",size:1},{id:"olku",size:1,type:"verb"},{id:"yariya",size:1},{id:"eḷitu",size:1,type:"adjective"},{id:"yavavu",size:1},{id:"kavavu",size:1,type:"verb"},{id:"virumpik",size:1},{id:"kaṭu",size:2,type:"verb"},{id:"kaṭavu",size:1,type:"verb"},{id:"karaik",size:1},{id:"yāṟu",size:2,type:"noun"},{id:"aka(m)",size:2,type:"noun"},{id:"kuvaiit",size:1},{id:"tai",size:1,type:"noun"},{id:"katam",size:2,type:"noun"},{id:"mulaiyiṉum",size:1},{id:"patukku",size:1,type:"noun"},{id:"āya",size:1},{id:"votukku",size:1},{id:"kavalaic",size:1},{id:"pakai",size:3,type:"noun"},{id:"(i)yāṅku",size:1},{id:"varuḷ",size:1},{id:"uyttara",size:1},{id:"viruḷ",size:1},{id:"cilai",size:1,type:"noun"},{id:"vil",size:4,type:"noun"},{id:"pakaḻic",size:1},{id:"cen",size:1},{id:"tuvar",size:1,type:"noun"},{id:"āṭaik",size:1},{id:"eyiṉar",size:1,type:"noun"},{id:"taṅkai",size:2,type:"noun"},{id:"muḷ",size:2,type:"noun"},{id:"valci",size:2,type:"noun"},{id:"yeyiṉar",size:1},{id:"eyiṟṟikku",size:1},{id:"in",size:1},{id:"yaṟiyac",size:1},{id:"colliṉeṉ",size:1},{id:"irakkum",size:1},{id:"aḷa",size:2,type:"verb"},{id:"vēl",size:9,type:"noun"},{id:"kaṇa",size:1},{id:"tolaiccit",size:1},{id:"taṉṉ",size:2},{id:"vūṉ",size:1},{id:"valcip",size:1},{id:"ōppu",size:1,type:"verb"},{id:"eyiṟṟi",size:1},{id:"nayavaravu",size:1},{id:"nōṟṟaṉai",size:1},{id:"koṉ",size:1},{id:"kaṭavuti",size:1},{id:"yaraik",size:1},{id:"kōṅkamōṭ’",size:2,type:"noun"},{id:"yiṇar",size:1},{id:"vēṅkaiyoṭu",size:1},{id:"vēṟupaṭu",size:1,type:"verb"},{id:"milaicci",size:1},{id:"yāṟṟut",size:1},{id:"kuṟuku",size:1,type:"verb"},{id:"pēroṭu",size:1},{id:"erip",size:1},{id:"vilavattu",size:1},{id:"ūḻ",size:3,type:"verb"},{id:"pukar",size:1,type:"noun"},{id:"pata(m)",size:3,type:"noun"},{id:"iṉpa",size:1},{id:"nukarcci",size:1},{id:"yemmoṭu",size:1},{id:"ōti",size:3,type:"noun"},{id:"yaḻivu",size:1},{id:"vaḷa",size:1},{id:"tatai",size:1,type:"verb"},{id:"nerunal",size:2},{id:"yeṉpa",size:2},{id:"kurava",size:1},{id:"yaṟaiyum",size:1},{id:"paruva",size:1},{id:"tēṟṟāṉ",size:1},{id:"vaḷ",size:5,type:"noun"},{id:"paṭalai",size:1,type:"noun"},{id:"ciṟai",size:3,type:"noun"},{id:"moyppa",size:1},{id:"uṟaiyappaṭṭōḷ",size:1},{id:"yāvaḷ",size:1},{id:"maḷḷar",size:3,type:"noun"},{id:"koṭṭiṉ",size:1},{id:"maññai",size:1,type:"noun"},{id:"yālum",size:1},{id:"paṭumaḻai",size:1},{id:"talaiic",size:1},{id:"vākuka",size:2},{id:"yitu",size:2},{id:"veṉat",size:1},{id:"teḷintav",size:1},{id:"piṟai",size:1,type:"noun"},{id:"taṉṉai",size:1},{id:"uṇat",size:1},{id:"tēṟṟu",size:1,type:"verb"},{id:"vañcu",size:1},{id:"iṉak",size:1},{id:"kāḷai",size:8,type:"noun"},{id:"aḻuṅkal",size:1,type:"noun"},{id:"eḻac",size:1},{id:"ceḻu(m)",size:1,type:"adjective"},{id:"niṉait",size:2},{id:"iṭumpai",size:2,type:"noun"},{id:"yeytuka",size:1},{id:"pulik",size:1},{id:"piḻai",size:1,type:"verb"},{id:"kavaik",size:1},{id:"kōṭṭam",size:5,type:"noun"},{id:"yaṇai",size:1},{id:"vāṇ",size:1},{id:"uy",size:2,type:"verb"},{id:"vampu",size:1,type:"noun"},{id:"niṉaippiṉum",size:1},{id:"eṉṟūḻa",size:1},{id:"mīḷi",size:1,type:"noun"},{id:"yakam",size:1},{id:"pukāak",size:1},{id:"kaṭuvaṉ",size:1,type:"noun"},{id:"ṉalamaru",size:1},{id:"varu",size:1},{id:"kiḷḷai",size:2,type:"noun"},{id:"yeṭutta",size:1},{id:"nīṅkiṉaḷ",size:1},{id:"kaṉaliyar",size:1},{id:"kalleṉak",size:1},{id:"kalaṅkap",size:1},{id:"pōkku",size:3,type:"verb"},{id:"ūkku",size:1,type:"verb"},{id:"vuyaval",size:1},{id:"yiyam",size:1},{id:"attam",size:3,type:"noun"},{id:"pantu",size:1,type:"noun"},{id:"muyalip",size:1},{id:"ciṟakar",size:1,type:"noun"},{id:"pulampap",size:2},{id:"tē",size:1},{id:"moḻit",size:1},{id:"yilaḷ",size:1},{id:"iṇai",size:1,type:"noun"},{id:"āyam",size:1,type:"noun"},{id:"nukar",size:1,type:"verb"},{id:"yiṉak",size:1},{id:"vayakku",size:1,type:"noun"},{id:"uṇarntōr",size:2},{id:"yavaṉoṭu",size:1},{id:"naku",size:3,type:"verb"},{id:"vall",size:1},{id:"eṭuttēṉ",size:1},{id:"koṭuttōr",size:1},{id:"palavuṭaṉ",size:1},{id:"micaintu",size:1},{id:"iruntōr",size:1},{id:"aḷi",size:2,type:"noun"},{id:"ciṟaik",size:1},{id:"makaṉṟil",size:1,type:"noun"},{id:"vuṭaṉ",size:1},{id:"olikku",size:1},{id:"kaḻivōḷ",size:1},{id:"ell",size:1},{id:"yacainta",size:1},{id:"kalleṉ",size:1,type:"verb"},{id:"cīṟu",size:1},{id:"makaḷirp",size:1},{id:"araṟṟu",size:1,type:"verb"},{id:"amal",size:1,type:"verb"},{id:"marāattuk",size:1},{id:"koytaṟku",size:1},{id:"maḷḷaṉ",size:1},{id:"kūrntaṉṟu",size:1},{id:"pañcāyp",size:1},{id:"pāvaikku",size:1},{id:"cēṇ",size:2,type:"noun"},{id:"muṉṉu",size:1,type:"verb"},{id:"vacai",size:1,type:"noun"},{id:"yantaṇir",size:1},{id:"irantaṉeṉ",size:1},{id:"emm",size:1},{id:"eṭu",size:1,type:"verb"},{id:"yiṟantaṉaḷ",size:1},{id:"eṉmiṉ",size:1},{id:"iṟai",size:2,type:"noun"},{id:"kaṭuṅkaṇ",size:1},{id:"ēṟik",size:1},{id:"piṟak",size:1},{id:"koḻiya",size:1},{id:"vēṟu",size:1,type:"noun"},{id:"kūṟumiṉ",size:1},{id:"makkaḷ",size:1,type:"noun"},{id:"pārāṭṭu",size:1,type:"verb"},{id:"keṭu",size:2,type:"verb"},{id:"puṉkaṇ",size:1,type:"noun"},{id:"cuvar",size:1,type:"noun"},{id:"viṭumpai",size:1},{id:"yuṟuvi",size:1},{id:"yaru",size:2},{id:"navil",size:1,type:"verb"},{id:"nā",size:1,type:"noun"},{id:"tiṟam",size:1,type:"noun"},{id:"yantaṇīr",size:1},{id:"toḻuval",size:1},{id:"viṉavum",size:1},{id:"kaṇṭaṉem",size:3},{id:"yavaḷai",size:1},{id:"yiṉ",size:1},{id:"pārāṭṭak",size:1},{id:"neruppu",size:1,type:"noun"},{id:"kaṉal",size:1,type:"verb"},{id:"yuruppuc",size:1},{id:"taṇiyak",size:1},{id:"(y)ākkai",size:1,type:"noun"},{id:"irīic",size:1},{id:"yiṟappiṉ",size:1},{id:"kāṇkuvai",size:1},{id:"toṭip",size:1},{id:"poṉṉ",size:2},{id:"viṉaip",size:1},{id:"nōṉ",size:1,type:"verb"},{id:"yaṇal",size:1},{id:"viyalip",size:1},{id:"oṉṟiṉa",size:1},{id:"vavaḷ",size:1},{id:"yaṭaiya",size:1},{id:"ñekiḻap",size:1},{id:"para",size:1,type:"verb"},{id:"maruki",size:1},{id:"viṉavuvōy",size:1},{id:"tūvic",size:1},{id:"kākkaiy",size:1},{id:"marapu",size:1},{id:"kiḷaiyōṭu",size:2},{id:"ārap",size:1},{id:"paccūṉ",size:1},{id:"kalattil",size:1},{id:"nōkkip",size:1},{id:"pariyiṉ",size:1},{id:"yil",size:2},{id:"tuṟantataṉ",size:1},{id:"aṭac",size:1},{id:"pula",size:3,type:"verb"},{id:"paḻikkum",size:1},{id:"aḷai",size:1,type:"noun"},{id:"āṭṭi",size:1,type:"noun"},{id:"yevva",size:1},{id:"ēm",size:1,type:"noun"},{id:"tiṟal",size:1,type:"noun"},{id:"vaṉpu",size:1},{id:"aruḷiṟṟu",size:1},{id:"ōtip",size:1},{id:"yalaitta",size:1},{id:"vayirp",size:1},{id:"eric",size:1},{id:"viṭar",size:1,type:"noun"},{id:"tīrntaṉam",size:1},{id:"vēkumati",size:1},{id:"kala",size:1,type:"verb"},{id:"kaṟakku",size:1,type:"verb"},{id:"icai",size:1,type:"noun"},{id:"yaruvi",size:1},{id:"pulip",size:1},{id:"koy",size:1,type:"verb"},{id:"paipayac",size:1},{id:"yayarcciyai",size:1},{id:"yāṟuka",size:1},{id:"viruntu",size:1,type:"noun"},{id:"ākip",size:1},{id:"kaviḻ",size:1,type:"verb"},{id:"mayir",size:1,type:"noun"},{id:"eruttam",size:1,type:"noun"},{id:"kuruḷaip",size:1},{id:"paṉṟi",size:1,type:"noun"},{id:"muṉṉ",size:1},{id:"virai",size:1,type:"verb"},{id:"urai",size:3,type:"verb"},{id:"aṟiyāp",size:1},{id:"paḻuṉi",size:1},{id:"aṟiyāt",size:1},{id:"nilaiic",size:1},{id:"mikap",size:1},{id:"maṉaic",size:1},{id:"cilampu",size:1,type:"noun"},{id:"ayariṉ",size:1},{id:"vatuvai",size:2,type:"noun"},{id:"maṟṟē",size:1},{id:"yaṟa",size:1},{id:"aṭip",size:1},{id:"pul",size:2,type:"noun"},{id:"lārka",size:1},{id:"ōtuka",size:1},{id:"kāytta",size:1},{id:"paḻaṉa(m)",size:5,type:"noun"},{id:"ākaṟka",size:2},{id:"aḻap",size:1},{id:"keṇṭai",size:1,type:"noun"},{id:"vaviḻnta",size:1},{id:"taḻuvu",size:4,type:"verb"},{id:"nuṭakkum",size:1},{id:"kāḷaiyōṭu",size:1},{id:"puku",size:1,type:"verb"},{id:"yiṭaip",size:1},{id:"putalvaṉ",size:4,type:"noun"},{id:"naṭuvaṇaṉ",size:1},{id:"iṉitumaṉṟa",size:1},{id:"kiṭa",size:1,type:"verb"},{id:"niṟa",size:1,type:"verb"},{id:"vīṉum",size:1},{id:"umparum",size:1},{id:"kātaliyiṉ",size:1},{id:"vuḷḷam",size:1},{id:"yakaṉ",size:1},{id:"tantai",size:2,type:"noun"},{id:"muṟuvaliṉ",size:1},{id:"payiṟṟic",size:1},{id:"uruṭṭu",size:1,type:"verb"},{id:"taḷar",size:2,type:"verb"},{id:"yūṭṭat",size:1},{id:"puṟam",size:1,type:"noun"},{id:"puṟavam",size:3},{id:"poṟu",size:1,type:"verb"},{id:"maṉaikku",size:1},{id:"kaṉai",size:1,type:"verb"},{id:"mātar",size:1,type:"noun"},{id:"viḷaiyāṭak",size:1},{id:"kātalit",size:1},{id:"iruntaṉaṉ",size:1},{id:"piracam",size:1,type:"noun"},{id:"ūtu",size:2,type:"verb"},{id:"pārpput",size:2},{id:"mutalai",size:1,type:"noun"},{id:"poykaittu",size:1},{id:"mayaṅkiṉaḷ",size:1},{id:"kāviri",size:1,type:"noun"},{id:"ampaṇattu",size:1},{id:"yāmai",size:3,type:"noun"},{id:"yēṟic",size:1},{id:"cempiṉ",size:1},{id:"pārppup",size:1},{id:"tīm",size:2,type:"adjective"},{id:"yiḷam",size:1},{id:"mukam",size:1,type:"noun"},{id:"vaḷarnticiṉāaṅku",size:1},{id:"yaiya",size:1},{id:"yaṟintaṉai",size:1},{id:"yoḻukumati",size:1},{id:"kūtir",size:1,type:"noun"},{id:"aṇintaṉa",size:1},{id:"yaṉṟu",size:1},{id:"kuṟippiṉai",size:1},{id:"yāki",size:2},{id:"yīṇṭu",size:1},{id:"yaruḷātu",size:1},{id:"ḷeyiṟṟup",size:1},{id:"keṭiṟu",size:1,type:"noun"},{id:"cori",size:3,type:"verb"},{id:"vakaṉ",size:1},{id:"vaṭṭi",size:2,type:"noun"},{id:"payaṟu",size:1,type:"noun"},{id:"niṟaikkum",size:2},{id:"yāyam",size:1},{id:"valai",size:1,type:"noun"},{id:"eyiṟu",size:1,type:"noun"},{id:"varāal",size:1,type:"noun"},{id:"yuḷ",size:1},{id:"vēṇṭēm",size:1},{id:"parattaṉ",size:1,type:"noun"},{id:"yāṇṭuc",size:1},{id:"kuṟiyōṭu",size:1},{id:"yacai",size:1},{id:"naṭaip",size:2},{id:"citaiyap",size:1},{id:"lākuka",size:3},{id:"mutalaip",size:1},{id:"pōttu",size:2,type:"noun"},{id:"muḻu",size:1,type:"noun"},{id:"kaṭai",size:1,type:"noun"},{id:"niṟka",size:1},{id:"celvam",size:1,type:"noun"},{id:"vañci",size:1,type:"noun"},{id:"yōṅkiya",size:1},{id:"tañcam",size:1,type:"noun"},{id:"aruḷ",size:1,type:"noun"},{id:"kōḻi",size:1,type:"noun"},{id:"nīlac",size:1},{id:"cēval",size:1,type:"noun"},{id:"ukirp",size:1},{id:"pēṭai",size:3,type:"noun"},{id:"vayāam",size:1},{id:"puḷim",size:1},{id:"vēṭkaittu",size:1},{id:"taiic",size:1},{id:"viral",size:1,type:"noun"},{id:"yari",size:1},{id:"maḻaik",size:1},{id:"vāyk",size:1},{id:"vev",size:1},{id:"yaḻi",size:2},{id:"kalaṅkik",size:1},{id:"kaḻaṉit",size:2},{id:"tāmarai",size:3,type:"noun"},{id:"vūra",size:1},{id:"tērt",size:1},{id:"teṉ",size:1,type:"noun"},{id:"oḻukku",size:1,type:"verb"},{id:"tēṉūr",size:3},{id:"vūriṉ",size:1},{id:"pañcāyk",size:1},{id:"entiram",size:1},{id:"etir",size:1,type:"noun"},{id:"piḷiṟṟum",size:1},{id:"kō",size:1,type:"noun"},{id:"laṇi",size:1},{id:"tuṟattaliṉ",size:1},{id:"aṟiyap",size:1},{id:"pakal",size:3,type:"noun"},{id:"viḷakkōṭu",size:1},{id:"ira(m)",size:1,type:"noun"},{id:"pōrc",size:1},{id:"cōḻaṉ",size:1,type:"noun"},{id:"āmūr",size:1,type:"noun"},{id:"tēmpa",size:1},{id:"vevaṉ",size:1},{id:"katirt",size:1},{id:"vaṉai",size:1,type:"verb"},{id:"viṇṭu",size:1,type:"noun"},{id:"vaṉṉa",size:1},{id:"pōr",size:2,type:"verb"},{id:"virāaṉ",size:1,type:"noun"},{id:"iruppai",size:1,type:"noun"},{id:"maṉaiyai",size:1},{id:"vāṟṟu",size:1},{id:"maintu",size:1,type:"noun"},{id:"evvam",size:1,type:"noun"},{id:"yivaṭku",size:1},{id:"vēttu",size:1,type:"adjective"},{id:"taṇika",size:1},{id:"nantuka",size:1},{id:"tāmarait",size:1},{id:"varaika",size:1},{id:"entai",size:1,type:"noun"},{id:"koṭukka",size:1},{id:"paḻaṉak",size:1},{id:"kampuḷ",size:2,type:"noun"},{id:"payirp",size:1},{id:"yakavum",size:1},{id:"yūra",size:2},{id:"vaṭi",size:1,type:"noun"},{id:"viḷai",size:1,type:"noun"},{id:"poykait",size:2},{id:"tuṭumeṉ",size:1},{id:"viḻūum",size:1},{id:"matti",size:1,type:"noun"},{id:"kaḻāar",size:1,type:"noun"},{id:"yayara",size:1},{id:"intira",size:1},{id:"maṅkaiyart",size:1},{id:"toku",size:1,type:"verb"},{id:"yev",size:1},{id:"paḷḷip",size:1},{id:"nīrnāy",size:1,type:"noun"},{id:"vāḷai",size:1,type:"noun"},{id:"irai",size:1,type:"noun"},{id:"tolaivatu",size:1},{id:"tuṉṉu",size:1,type:"verb"},{id:"piṟart",size:1},{id:"āṭak",size:1},{id:"oruvar",size:1},{id:"ē",size:1,type:"noun"},{id:"pāttiyiṉ",size:1},{id:"kali",size:1,type:"noun"},{id:"vāmpal",size:1},{id:"kaḷai",size:1,type:"verb"},{id:"yīṉṟa",size:1},{id:"muyaṅkaṉmō",size:1},{id:"uṭaliṉēṉ",size:1},{id:"yiṉik",size:1},{id:"nikarā",size:1},{id:"veṉṉoṭu",size:1},{id:"nikarip",size:1},{id:"tarukkum",size:1},{id:"malart",size:1},{id:"yōti",size:1},{id:"kaṉṉi",size:1,type:"noun"},{id:"viṭiyal",size:1,type:"noun"},{id:"kaṇaik",size:1},{id:"pēṇāḷ",size:1},{id:"vaḻutu",size:1},{id:"yaṟam",size:1},{id:"vallatu",size:1},{id:"yuḷaip",size:1},{id:"marutattuk",size:1},{id:"kiḷaik",size:1},{id:"ṉūrk",size:1},{id:"paḻaṉap",size:2},{id:"ceṉṉic",size:1},{id:"cē",size:2,type:"noun"},{id:"tūyar",size:1},{id:"naṟiyar",size:1},{id:"pēy",size:1,type:"noun"},{id:"(i)yām",size:1},{id:"cūtu",size:1},{id:"toṭic",size:1},{id:"cūr",size:1,type:"noun"},{id:"nuṭakkattu",size:1},{id:"yāṭiṉai",size:1},{id:"ol(lu)",size:3,type:"verb"},{id:"putaittal",size:1},{id:"kayil",size:1},{id:"taḻait",size:1},{id:"tuyal",size:1,type:"verb"},{id:"kuvaḷai",size:2,type:"noun"},{id:"liyal",size:1},{id:"taḻai",size:1,type:"noun"},{id:"paṇṇai",size:2,type:"noun"},{id:"kaḷ",size:1,type:"verb"},{id:"nāṟit",size:1},{id:"tōkaic",size:1},{id:"cīr",size:1,type:"noun"},{id:"niḻaṟṟak",size:1},{id:"pāyvōḷ",size:1},{id:"ovvāy",size:1},{id:"vataṉāl",size:1},{id:"toṭakku",size:1,type:"verb"},{id:"tol",size:1,type:"adjective"},{id:"niṉṉōṭu",size:2},{id:"āṭiṉaḷ",size:1},{id:"paiñcāyk",size:1},{id:"malarc",size:1},{id:"āṭit",size:2},{id:"mēmpaṭṭaṉaḷ",size:1},{id:"antaram",size:1},{id:"makaḷirkkut",size:2},{id:"pēr",size:1,type:"noun"},{id:"alaik",size:1},{id:"kiḷḷi",size:1,type:"noun"},{id:"matil",size:1,type:"noun"},{id:"kataḻpu",size:1},{id:"āṭi",size:1,type:"noun"},{id:"yamartta",size:1},{id:"makaṉai",size:1},{id:"yaracu",size:1},{id:"muṟai",size:1,type:"noun"},{id:"ceyka",size:1},{id:"kaḷavu",size:1,type:"noun"},{id:"yalaṅku",size:1},{id:"cūḷ",size:1,type:"noun"},{id:"vāyppatu",size:1},{id:"pulakkuvēm",size:1},{id:"nalat",size:1},{id:"yākit",size:1},{id:"ḷakaṭṭu",size:1},{id:"yarip",size:1},{id:"paṟai",size:2,type:"noun"},{id:"nayantaṉeṉ",size:1},{id:"kēṭkiṉ",size:1},{id:"vekuṇṭaṉaḷ",size:1},{id:"aviḻ",size:2,type:"noun"},{id:"tārt",size:1},{id:"paṟa",size:1,type:"verb"},{id:"yaruḷāy",size:1},{id:"paipayat",size:1},{id:"taṇa",size:1,type:"verb"},{id:"yuymmō",size:1},{id:"cevi",size:1,type:"noun"},{id:"liṟantu",size:1},{id:"vekuḷvōḷ",size:1},{id:"yaim",size:1},{id:"taiit",size:1},{id:"kayam",size:1,type:"noun"},{id:"paṭintu",size:1},{id:"arik",size:1},{id:"paḻaṉattuk",size:1},{id:"ciṟuvariṉ",size:1},{id:"nakār",size:1},{id:"talaik",size:1},{id:"viḷik",size:1},{id:"yimiḻum",size:1},{id:"mivaṇ",size:1},{id:"alku",size:1,type:"verb"},{id:"pakaṉṟaik",size:1},{id:"kaṇṇip",size:1},{id:"lāṉ",size:1},{id:"kuṇil",size:1,type:"noun"},{id:"kaṉi",size:1,type:"noun"},{id:"yutirkkum",size:1},{id:"malarp",size:2},{id:"yevvai",size:1},{id:"yem",size:1},{id:"vevvaikku",size:1},{id:"virumpiṉṟu",size:1},{id:"yampal",size:1},{id:"kuṇam",size:2,type:"noun"},{id:"maruppu",size:1,type:"noun"},{id:"veṟi",size:1,type:"noun"},{id:"mayakkum",size:2},{id:"vetir",size:1,type:"noun"},{id:"erumaic",size:1},{id:"āk",size:1},{id:"kuḻavikku",size:1},{id:"ūṟṟu",size:1,type:"noun"},{id:"maṭukkum",size:1},{id:"nuntai",size:2,type:"noun"},{id:"niṉṉai",size:1},{id:"lēṟṟu",size:1},{id:"aruttu",size:1,type:"verb"},{id:"mōrōṭamōṭu",size:1},{id:"viṉaiya",size:1},{id:"veṟukkaiya",size:1},{id:"vāki",size:1},{id:"mucci",size:1,type:"noun"},{id:"vati",size:1,type:"noun"},{id:"ilañcip",size:1},{id:"paḻaṉattatu",size:1},{id:"yerumai",size:2},{id:"yāṭiya",size:1},{id:"āmpaloṭu",size:1},{id:"kalikkum",size:1},{id:"vūraṉ",size:1},{id:"pakaṉṟai",size:1,type:"noun"},{id:"miṭai",size:1,type:"noun"},{id:"kōṭṭaik",size:1},{id:"erumaik",size:1},{id:"kaṉṟu",size:1,type:"noun"},{id:"yampiyiṉ",size:1},{id:"pākal",size:1,type:"noun"},{id:"muyiṟu",size:1,type:"noun"},{id:"mūcu",size:1,type:"verb"},{id:"kuṭampai",size:1,type:"noun"}],Ib=[{id:"nī nī",source:"nī",target:"nī",strength:.08179584191146737,citations:["Aink309","Aink50"],curvature:.5},{id:"a- nī",source:"a-",target:"nī",strength:.09929048879730529,citations:["Aink44","Aink51"]},{id:"kaṇ nī",source:"kaṇ",target:"nī",strength:.1174311338384539,citations:["Aink351","Aink361"]},{id:"nal nī",source:"nal",target:"nī",strength:.1311638961672341,citations:["Aink139","Aink309"],curvature:.25},{id:"kaṇ kaṇ",source:"kaṇ",target:"kaṇ",strength:.15306642576544044,citations:["Aink375","Aink84"],curvature:.5},{id:"a- ūr",source:"a-",target:"ūr",strength:.1561315558849711,citations:["Aink24","Aink41"]},{id:"maka a-",source:"maka",target:"a-",strength:.1668408921941494,citations:["Aink400","Aink94"]},{id:"kaṇ ākkam",source:"kaṇ",target:"ākkam",strength:.17427220092611972,citations:["Aink330","Aink84"]},{id:"nī eṉ",source:"nī",target:"eṉ",strength:.1809512241618501,citations:["Aink208","Aink363"],curvature:.25},{id:"varavu nī",source:"varavu",target:"nī",strength:.18450919268050733,citations:["Aink101","Aink323","Aink393"]},{id:"kaṇ maka",source:"kaṇ",target:"maka",strength:.18498153723529803,citations:["Aink406","Aink79"]},{id:"nal ākkam",source:"nal",target:"ākkam",strength:.18800496325489993,citations:["Aink117","Aink63"],curvature:.25},{id:"varavu tōḻaṉ",source:"varavu",target:"tōḻaṉ",strength:.1888965214668915,citations:["Aink352","Aink357"]},{id:"varavu maka",source:"varavu",target:"maka",strength:.1916605604710284,citations:["Aink101","Aink393"]},{id:"nī pal",source:"nī",target:"pal",strength:.19621340924809577,citations:["Aink55","Aink69"]},{id:"aṉṉai kaṇ",source:"aṉṉai",target:"kaṇ",strength:.19668846895662254,citations:["Aink101","Aink206"]},{id:"eṉ a-",source:"eṉ",target:"a-",strength:.19844587104768804,citations:["Aink41","Aink89"]},{id:"ākkam nī",source:"ākkam",target:"nī",strength:.19981647469962685,citations:["Aink359","Aink393","Aink79"]},{id:"ūr maka",source:"ūr",target:"maka",strength:.20618731239597735,citations:["Aink100","Aink99"]},{id:"tāṉ a-",source:"tāṉ",target:"a-",strength:.21370805613393368,citations:["Aink103","Aink404"],curvature:.25},{id:"ūr peru(m)",source:"ūr",target:"peru(m)",strength:.22418349020448655,citations:["Aink30","Aink48"]},{id:"ākkam peru(m)",source:"ākkam",target:"peru(m)",strength:.22418349020448655,citations:["Aink403","Aink63"]},{id:"varavu curam",source:"varavu",target:"curam",strength:.22691097463109583,citations:["Aink331","Aink395"],curvature:.25},{id:"curam varavu",source:"curam",target:"varavu",strength:.22691097463109583,citations:["Aink354","Aink397"],curvature:.25},{id:"makiḻ nī",source:"makiḻ",target:"nī",strength:.22839926078416364,citations:["Aink69","Aink77"]},{id:"vāḻ nal",source:"vāḻ",target:"nal",strength:.23051506762777685,citations:["Aink117","Aink119","Aink120","Aink9"]},{id:"tāṉ kaṇ",source:"tāṉ",target:"kaṇ",strength:.23184870117508233,citations:["Aink112","Aink202"]},{id:"il nī",source:"il",target:"nī",strength:.23375150308446374,citations:["Aink136","Aink307"]},{id:"malar a-",source:"malar",target:"a-",strength:.23582783983336117,citations:["Aink18","Aink72"]},{id:"ūr eṉ",source:"ūr",target:"eṉ",strength:.23779229124951595,citations:["Aink41","Aink89"]},{id:"tuṟai varavu",source:"tuṟai",target:"varavu",strength:.23852772441081269,citations:["Aink105","Aink69"]},{id:"nī nal",source:"nī",target:"nal",strength:.23918256931698786,citations:["Aink139","Aink309","Aink355","Aink357"],curvature:.25},{id:"i- ākkam",source:"i-",target:"ākkam",strength:.24143772655604473,citations:["Aink117","Aink8"]},{id:"cel ūr",source:"cel",target:"ūr",strength:.24143772655604473,citations:["Aink22","Aink27"]},{id:"vāḻ yūraṉ",source:"vāḻ",target:"yūraṉ",strength:.24341582330759612,citations:["Aink36","Aink39"]},{id:"makiḻ a-",source:"makiḻ",target:"a-",strength:.24589390767000155,citations:["Aink31","Aink90"]},{id:"tōḻaṉ i-",source:"tōḻaṉ",target:"i-",strength:.24938302386108613,citations:["Aink117","Aink118"]},{id:"kēḷ vāḻ",source:"kēḷ",target:"vāḻ",strength:.24986640195338267,citations:["Aink111","Aink59"]},{id:"a- neṭu(m)",source:"a-",target:"neṭu(m)",strength:.25124614997030165,citations:["Aink207","Aink209"]},{id:"nī vem",source:"nī",target:"vem",strength:.25132778496971664,citations:["Aink393","Aink71"]},{id:"ūr nal",source:"ūr",target:"nal",strength:.25183710072342197,citations:["Aink12","Aink22","Aink63"]},{id:"tuṟai ūr",source:"tuṟai",target:"ūr",strength:.2530544763357616,citations:["Aink11","Aink12"]},{id:"kaṇ e-",source:"kaṇ",target:"e-",strength:.2539684848745098,citations:["Aink84"]},{id:"varavu pū(m)",source:"varavu",target:"pū(m)",strength:.25590133306576457,citations:["Aink344","Aink362"]},{id:"nī maka",source:"nī",target:"maka",strength:.2591012125845128,citations:["Aink101","Aink29","Aink393","Aink49"]},{id:"ūr ūr",source:"ūr",target:"ūr",strength:.25971164250271106,citations:["Aink15"],curvature:.5},{id:"tōḻaṉ nal",source:"tōḻaṉ",target:"nal",strength:.2602093030713633,citations:["Aink117","Aink119","Aink120"]},{id:"varavu e-",source:"varavu",target:"e-",strength:.2606475081102402,citations:["Aink134","Aink221"]},{id:"eṉ peru(m)",source:"eṉ",target:"peru(m)",strength:.26649780536720347,citations:["Aink398","Aink73"]},{id:"ākkam e-",source:"ākkam",target:"e-",strength:.2751742600351891,citations:["Aink108","Aink17"],curvature:.25},{id:"e- ākkam",source:"e-",target:"ākkam",strength:.2751742600351891,citations:["Aink366","Aink84"],curvature:.25},{id:"e- maka",source:"e-",target:"maka",strength:.2858835963443674,citations:["Aink204","Aink373"]},{id:"varavu kāl",source:"varavu",target:"kāl",strength:.28750631191930315,citations:["Aink116","Aink349"]},{id:"iṉ nī",source:"iṉ",target:"nī",strength:.2875063119193032,citations:["Aink203","Aink46"]},{id:"varavu eṉ",source:"varavu",target:"eṉ",strength:.2889922462675563,citations:["Aink2","Aink397","Aink88"]},{id:"ākkam taṭpam",source:"ākkam",target:"taṭpam",strength:.28995951913565654,citations:["Aink28","Aink45","Aink54"]},{id:"ūr al",source:"ūr",target:"al",strength:.2905925701721296,citations:["Aink372","Aink77"]},{id:"aṉṉai tōḻaṉ",source:"aṉṉai",target:"tōḻaṉ",strength:.2917045508647592,citations:["Aink107","Aink205","Aink366"]},{id:"nal nal",source:"nal",target:"nal",strength:.29326494634663547,citations:["Aink120","Aink204","Aink365","Aink61"],curvature:.5},{id:"eṉ nī",source:"eṉ",target:"nī",strength:.293724257955426,citations:["Aink357","Aink363","Aink81","Aink82"],curvature:.25},{id:"eṉ tāṉ",source:"eṉ",target:"tāṉ",strength:.29536879149847856,citations:["Aink33","Aink41"]},{id:"nal eṉ",source:"nal",target:"eṉ",strength:.29642498650738675,citations:["Aink204","Aink67"]},{id:"pū(m) a-",source:"pū(m)",target:"a-",strength:.29722833630318657,citations:["Aink209","Aink41","Aink62"]},{id:"vāḻ koṇkaṉ",source:"vāḻ",target:"koṇkaṉ",strength:.2975905280656919,citations:["Aink114","Aink139"]},{id:"a- nal",source:"a-",target:"nal",strength:.29825892098585827,citations:["Aink55","Aink56","Aink57","Aink61"]},{id:"tuṟai i-",source:"tuṟai",target:"i-",strength:.29901422680500733,citations:["Aink103","Aink28"]},{id:"pū(m) peru(m)",source:"pū(m)",target:"peru(m)",strength:.299133599108401,citations:["Aink19","Aink33"]},{id:"ākkam nal",source:"ākkam",target:"nal",strength:.3014515824945438,citations:["Aink302","Aink308","Aink318","Aink330"],curvature:.25},{id:"e- peru(m)",source:"e-",target:"peru(m)",strength:.3038797741528766,citations:["Aink123","Aink89"]},{id:"ūr vem",source:"ūr",target:"vem",strength:.3081688520573825,citations:["Aink63","Aink86"]},{id:"ūr ākkam",source:"ūr",target:"ākkam",strength:.30963821864245217,citations:["Aink15","Aink19","Aink24"]},{id:"tuṟai tāṉ",source:"tuṟai",target:"tāṉ",strength:.31063097658472416,citations:["Aink10","Aink7"]},{id:"pāṇ nī",source:"pāṇ",target:"nī",strength:.31209682389964916,citations:["Aink136","Aink140","Aink82"],curvature:.25},{id:"koḷ peru(m)",source:"koḷ",target:"peru(m)",strength:.31394584198951697,citations:["Aink368","Aink400"]},{id:"varavu puṉal",source:"varavu",target:"puṉal",strength:.314080271411385,citations:["Aink69","Aink72"]},{id:"tōḻaṉ yūraṉ",source:"tōḻaṉ",target:"yūraṉ",strength:.3161141493624239,citations:["Aink36","Aink39"]},{id:"malar kaṇ",source:"malar",target:"kaṇ",strength:.32134487738418466,citations:["Aink19","Aink208","Aink315"]},{id:"nī paca",source:"nī",target:"paca",strength:.32651099627991215,citations:["Aink29","Aink45"]},{id:"nī neñcam",source:"nī",target:"neñcam",strength:.32651099627991215,citations:["Aink50"]},{id:"vēṇṭu eṉ",source:"vēṇṭu",target:"eṉ",strength:.3275546430345464,citations:["Aink209","Aink88"]},{id:"puṉal ūr",source:"puṉal",target:"ūr",strength:.3286070233363339,citations:["Aink65","Aink95"]},{id:"piri nal",source:"piri",target:"nal",strength:.3287580848706329,citations:["Aink308","Aink57"]},{id:"koḷ cel",source:"koḷ",target:"cel",strength:.3312000783410752,citations:["Aink10","Aink7"]},{id:"ce(m) kaṇ",source:"ce(m)",target:"kaṇ",strength:.33181805851427537,citations:["Aink346","Aink92"]},{id:"em a-",source:"em",target:"a-",strength:.3330632044502907,citations:["Aink82","Aink90"]},{id:"neṭu(m) kaṇ",source:"neṭu(m)",target:"kaṇ",strength:.3375916215114151,citations:["Aink208","Aink30","Aink315"]},{id:"nī yāṅkaṇ",source:"nī",target:"yāṅkaṇ",strength:.33849708175000576,citations:["Aink79","Aink87"]},{id:"amma pāṇ",source:"amma",target:"pāṇ",strength:.34080464579858,citations:["Aink132","Aink89"]},{id:"curam nām",source:"curam",target:"nām",strength:.34214251705653453,citations:["Aink314","Aink329"]},{id:"tāṉ koḷ",source:"tāṉ",target:"koḷ",strength:.34281682812079206,citations:["Aink10","Aink7"]},{id:"makiḻ tāṉ",source:"makiḻ",target:"tāṉ",strength:.34281682812079206,citations:["Aink38","Aink66"]},{id:"vāḻ kātal",source:"vāḻ",target:"kātal",strength:.34383512285191886,citations:["Aink221","Aink340"]},{id:"peru(m) tuṟai",source:"peru(m)",target:"tuṟai",strength:.3506296353142856,citations:["Aink31","Aink69","Aink75"]},{id:"ūr nī",source:"ūr",target:"nī",strength:.35157138136843086,citations:["Aink42","Aink43","Aink49","Aink54","Aink68","Aink85","Aink87"]},{id:"yaṉṉa nī",source:"yaṉṉa",target:"nī",strength:.35174708451403935,citations:["Aink307","Aink42"]},{id:"cel nal",source:"cel",target:"nal",strength:.35180018526079365,citations:["Aink22","Aink302","Aink307","Aink385"]},{id:"cel eṉ",source:"cel",target:"eṉ",strength:.3527287205517992,citations:["Aink221","Aink357","Aink389"]},{id:"nal mā",source:"nal",target:"mā",strength:.3548705439835792,citations:["Aink221","Aink357"]},{id:"vāḻ pāṇ",source:"vāḻ",target:"pāṇ",strength:.35543209790201663,citations:["Aink1","Aink111","Aink132","Aink89"]},{id:"vāḻ vāḻ",source:"vāḻ",target:"vāḻ",strength:.35686631507165206,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.5},{id:"kēḷ eṉ",source:"kēḷ",target:"eṉ",strength:.3569337458658859,citations:["Aink113","Aink315"]},{id:"ūr i-",source:"ūr",target:"i-",strength:.359986821408702,citations:["Aink100","Aink30","Aink8","Aink99"]},{id:"kaṇ paca",source:"kaṇ",target:"paca",strength:.3621462882068987,citations:["Aink36","Aink37"]},{id:"ūr toṭi",source:"ūr",target:"toṭi",strength:.36234355681547825,citations:["Aink28","Aink98"]},{id:"ākkam toṭi",source:"ākkam",target:"toṭi",strength:.36234355681547825,citations:["Aink330","Aink389"]},{id:"nī pāṇ",source:"nī",target:"pāṇ",strength:.3640995995912276,citations:["Aink139","Aink43","Aink47","Aink49"],curvature:.25},{id:"yūraṉ tāṉ",source:"yūraṉ",target:"tāṉ",strength:.36574535230634503,citations:["Aink10","Aink7"]},{id:"nī mulai",source:"nī",target:"mulai",strength:.36655932739515534,citations:["Aink361","Aink363"]},{id:"aṟi nī",source:"aṟi",target:"nī",strength:.36655932739515534,citations:["Aink47","Aink79"]},{id:"nāḷ a-",source:"nāḷ",target:"a-",strength:.3692417313998773,citations:["Aink109","Aink95"]},{id:"malar neṭu(m)",source:"malar",target:"neṭu(m)",strength:.37028885412051965,citations:["Aink208","Aink315"]},{id:"ūr pāṇ",source:"ūr",target:"pāṇ",strength:.37199199170273345,citations:["Aink1","Aink43","Aink49"]},{id:"ūr maṉai",source:"ūr",target:"maṉai",strength:.37240962465211863,citations:["Aink3","Aink87"]},{id:"malar taṭpam",source:"malar",target:"taṭpam",strength:.3739379267367847,citations:["Aink108","Aink328","Aink69"]},{id:"nī maṉai",source:"nī",target:"maṉai",strength:.386254754687437,citations:["Aink66","Aink81","Aink87"]},{id:"kaṇ toṟum",source:"kaṇ",target:"toṟum",strength:.3873823764410259,citations:["Aink375"]},{id:"pū(m) veḷ",source:"pū(m)",target:"veḷ",strength:.38956953960708346,citations:["Aink19","Aink209"],curvature:.25},{id:"yūraṉ maka",source:"yūraṉ",target:"maka",strength:.38974221370985085,citations:["Aink91","Aink96","Aink97"]},{id:"aru(m) cel",source:"aru(m)",target:"cel",strength:.39030712947621476,citations:["Aink301","Aink351"]},{id:"iṉ curam",source:"iṉ",target:"curam",strength:.39030712947621476,citations:["Aink326","Aink395"]},{id:"curam aṇi",source:"curam",target:"aṇi",strength:.39030712947621476,citations:["Aink357","Aink397"]},{id:"peṇ ūr",source:"peṇ",target:"ūr",strength:.39533814883767165,citations:["Aink13","Aink40"]},{id:"vēṉal ākkam",source:"vēṉal",target:"ākkam",strength:.39533814883767165,citations:["Aink45","Aink54"]},{id:"il pāṇ",source:"il",target:"pāṇ",strength:.3971476579295827,citations:["Aink136","Aink138"]},{id:"pōl kaṇ",source:"pōl",target:"kaṇ",strength:.4021946193221419,citations:["Aink101","Aink16"]},{id:"yāṅkaṇ maka",source:"yāṅkaṇ",target:"maka",strength:.4060474851468499,citations:["Aink79"]},{id:"am i-",source:"am",target:"i-",strength:.40830330728472397,citations:["Aink103","Aink302"]},{id:"yaṉṉa ākkam",source:"yaṉṉa",target:"ākkam",strength:.40858815160170525,citations:["Aink221","Aink389"]},{id:"nī naya",source:"nī",target:"naya",strength:.4104152406517965,citations:["Aink309","Aink370","Aink46"]},{id:"nī peṇ",source:"nī",target:"peṇ",strength:.4104152406517965,citations:["Aink68","Aink69","Aink70"]},{id:"peru(m) ciṉai",source:"peru(m)",target:"ciṉai",strength:.41205757748526556,citations:["Aink145","Aink19"]},{id:"tōḻaṉ kātal",source:"tōḻaṉ",target:"kātal",strength:.4165334489067466,citations:["Aink221","Aink340"]},{id:"kaḻi curam",source:"kaḻi",target:"curam",strength:.41836937512136435,citations:["Aink354","Aink397"]},{id:"curam naṉi",source:"curam",target:"naṉi",strength:.41836937512136435,citations:["Aink371","Aink398"]},{id:"kaṇ paṉi",source:"kaṇ",target:"paṉi",strength:.41898735529456455,citations:["Aink208","Aink37"]},{id:"kaḻaṉi maka",source:"kaḻaṉi",target:"maka",strength:.4192974879108835,citations:["Aink91","Aink96"]},{id:"poḻutu a-",source:"poḻutu",target:"a-",strength:.42023250123057987,citations:["Aink406","Aink82"]},{id:"aṟi ākkam",source:"aṟi",target:"ākkam",strength:.42340039448282124,citations:["Aink26","Aink366"],curvature:.25},{id:"ākkam aṟi",source:"ākkam",target:"aṟi",strength:.42340039448282124,citations:["Aink79","Aink90"],curvature:.25},{id:"malar aṇi",source:"malar",target:"aṇi",strength:.42404366295535917,citations:["Aink367","Aink81"]},{id:"nī moḻi",source:"nī",target:"moḻi",strength:.42566637853029493,citations:["Aink60","Aink77"]},{id:"yūraṉ i-",source:"yūraṉ",target:"i-",strength:.42688665133958703,citations:["Aink91","Aink96","Aink97"]},{id:"yūraṉ kēḷ",source:"yūraṉ",target:"kēḷ",strength:.4273103066737524,citations:["Aink2","Aink9"]},{id:"a- varavu",source:"a-",target:"varavu",strength:.4313014106273374,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"]},{id:"nal cuṭar",source:"nal",target:"cuṭar",strength:.4327201176233448,citations:["Aink375","Aink56"]},{id:"yāy pū(m)",source:"yāy",target:"pū(m)",strength:.43729366571939277,citations:["Aink10","Aink4"]},{id:"kaḷvaṉ taṭpam",source:"kaḷvaṉ",target:"taṭpam",strength:.43729366571939277,citations:["Aink27","Aink30"]},{id:"peṇ eṉ",source:"peṇ",target:"eṉ",strength:.4376524640003886,citations:["Aink113","Aink89"]},{id:"pāṇ maka",source:"pāṇ",target:"maka",strength:.4381006198884002,citations:["Aink47","Aink48","Aink49"]},{id:"tōṟṟam ūr",source:"tōṟṟam",target:"ūr",strength:.4401931304552439,citations:["Aink17","Aink98"]},{id:"ūr māṇ",source:"ūr",target:"māṇ",strength:.4401931304552439,citations:["Aink42","Aink47"]},{id:"tuṟai kēḷ",source:"tuṟai",target:"kēḷ",strength:.44592474691456924,citations:["Aink111","Aink2","Aink9"]},{id:"nutal maka",source:"nutal",target:"maka",strength:.4468277541196436,citations:["Aink371","Aink394","Aink404"]},{id:"maṉ curam",source:"maṉ",target:"curam",strength:.44842297641337514,citations:["Aink326","Aink390","Aink394"]},{id:"toṟum eṉ",source:"toṟum",target:"eṉ",strength:.45090246676442214,citations:["Aink376","Aink398"]},{id:"kaḻi malar",source:"kaḻi",target:"malar",strength:.45210590860050864,citations:["Aink108","Aink368"]},{id:"makiḻ toṭi",source:"makiḻ",target:"toṭi",strength:.45210590860050864,citations:["Aink24","Aink40"]},{id:"malar nil",source:"malar",target:"nil",strength:.45210590860050864,citations:["Aink338","Aink75"]},{id:"peru(m) kaṭal",source:"peru(m)",target:"kaṭal",strength:.4521059086005087,citations:["Aink102","Aink123"]},{id:"yaviṉi pal",source:"yaviṉi",target:"pal",strength:.4529146490866342,citations:["Aink1","Aink3"]},{id:"tuṟai peṇ",source:"tuṟai",target:"peṇ",strength:.4529146490866342,citations:["Aink113","Aink13"]},{id:"nī mārpu",source:"nī",target:"mārpu",strength:.4531840259109162,citations:["Aink42","Aink44","Aink46","Aink51"]},{id:"i- no/nō",source:"i-",target:"no/nō",strength:.4545479020709509,citations:["Aink28","Aink99"]},{id:"iṟa cel",source:"iṟa",target:"cel",strength:.4545479020709509,citations:["Aink309","Aink317"]},{id:"yām pū(m)",source:"yām",target:"pū(m)",strength:.45743467712590846,citations:["Aink10","Aink4","Aink7"]},{id:"naṟu(m) pū(m)",source:"naṟu(m)",target:"pū(m)",strength:.4583021722714925,citations:["Aink344","Aink404"]},{id:"a- maṇi",source:"a-",target:"maṇi",strength:.4584199292077344,citations:["Aink207","Aink208","Aink209"]},{id:"ūr koṭu(m)",source:"ūr",target:"koṭu(m)",strength:.4595789214324078,citations:["Aink11","Aink12"]},{id:"peṟu ūr",source:"peṟu",target:"ūr",strength:.4595789214324078,citations:["Aink49","Aink63"]},{id:"kaṇ ēr",source:"kaṇ",target:"ēr",strength:.4613016704572815,citations:["Aink101","Aink72"]},{id:"kaṇ civa",source:"kaṇ",target:"civa",strength:.4613016704572815,citations:["Aink125","Aink69"]},{id:"vāḻ nām",source:"vāḻ",target:"nām",strength:.46171723283604266,citations:["Aink111","Aink116","Aink335","Aink336","Aink337","Aink34","Aink35"]},{id:"koḷ kaḻi",source:"koḷ",target:"kaḻi",strength:.4621719764371491,citations:["Aink354","Aink397"]},{id:"varavu varavu",source:"varavu",target:"varavu",strength:.4624193825321259,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"],curvature:.5},{id:"nal naya",source:"nal",target:"naya",strength:.4624358666755916,citations:["Aink309","Aink385","Aink55"]},{id:"paca e-",source:"paca",target:"e-",strength:.4630483473159681,citations:["Aink144","Aink35"]},{id:"malar mārpu",source:"malar",target:"mārpu",strength:.4630483473159681,citations:["Aink205","Aink51"]},{id:"veḷ pū(m)",source:"veḷ",target:"pū(m)",strength:.4642318487873851,citations:["Aink17","Aink19","Aink41"],curvature:.25},{id:"pal veṉa",source:"pal",target:"veṉa",strength:.4661646518506678,citations:["Aink3","Aink6"]},{id:"maṉai neṭu(m)",source:"maṉai",target:"neṭu(m)",strength:.46752421873744915,citations:["Aink324","Aink60"]},{id:"varavu eṉap",source:"varavu",target:"eṉap",strength:.4679806936930119,citations:["Aink105","Aink72"]},{id:"āṭu taṭpam",source:"āṭu",target:"taṭpam",strength:.46889864457293134,citations:["Aink115","Aink84"],curvature:.25},{id:"mel kāl",source:"mel",target:"kāl",strength:.46889864457293134,citations:["Aink26","Aink35"]},{id:"taṭpam āṭu",source:"taṭpam",target:"āṭu",strength:.46889864457293134,citations:["Aink77","Aink98"],curvature:.25},{id:"keḻu ūr",source:"keḻu",target:"ūr",strength:.47031040845488076,citations:["Aink11","Aink12","Aink85"]},{id:"toṭi yām",source:"toṭi",target:"yām",strength:.47503443278606167,citations:["Aink38","Aink40"]},{id:"nal nāṭu",source:"nal",target:"nāṭu",strength:.47639779912346664,citations:["Aink392","Aink61"]},{id:"vāḻ makiḻ",source:"vāḻ",target:"makiḻ",strength:.47819346962729764,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40","Aink59","Aink77"]},{id:"yāṇar nī",source:"yāṇar",target:"nī",strength:.48082999371755897,citations:["Aink42","Aink43","Aink49","Aink87"]},{id:"vāḻ ciṟi",source:"vāḻ",target:"ciṟi",strength:.48199518946291053,citations:["Aink334","Aink339"]},{id:"tuñcu ūr",source:"tuñcu",target:"ūr",strength:.4825074456179608,citations:["Aink13","Aink43"]},{id:"ūr el",source:"ūr",target:"el",strength:.4825074456179608,citations:["Aink27","Aink396"]},{id:"kaliḻ eṉ",source:"kaliḻ",target:"eṉ",strength:.4825074456179608,citations:["Aink376","Aink398"]},{id:"moḻi ūr",source:"moḻi",target:"ūr",strength:.4825074456179608,citations:["Aink384","Aink77"]},{id:"no/nō ākkam",source:"no/nō",target:"ākkam",strength:.4842723409027557,citations:["Aink101","Aink28","Aink99"]},{id:"piri val",source:"piri",target:"val",strength:.48510050062270205,citations:["Aink310","Aink338"]},{id:"em vem",source:"em",target:"vem",strength:.48510050062270205,citations:["Aink325","Aink78"]},{id:"piri aru(m)",source:"piri",target:"aru(m)",strength:.48510050062270205,citations:["Aink338"]},{id:"yāṉ i-",source:"yāṉ",target:"i-",strength:.48615288092448955,citations:["Aink118","Aink59"]},{id:"ciṟu(m) kaṇ",source:"ciṟu(m)",target:"kaṇ",strength:.48629317793128135,citations:["Aink309","Aink314","Aink327","Aink355","Aink362"]},{id:"maṇa taṭpam",source:"maṇa",target:"taṭpam",strength:.48828443555009526,citations:["Aink19","Aink348"]},{id:"eṉac kaṇ",source:"eṉac",target:"kaṇ",strength:.4893639161024311,citations:["Aink346","Aink366"]},{id:"yarivai nī",source:"yarivai",target:"nī",strength:.48990715112503114,citations:["Aink354","Aink355"]},{id:"maka paḻaṉa(m)",source:"maka",target:"paḻaṉa(m)",strength:.4932167819271391,citations:["Aink91","Aink96"]},{id:"curam cel",source:"curam",target:"cel",strength:.4937779361915439,citations:["Aink301","Aink307","Aink309","Aink317","Aink331","Aink351"]},{id:"em cel",source:"em",target:"cel",strength:.4945791147556446,citations:["Aink303","Aink77"]},{id:"curam iṭai",source:"curam",target:"iṭai",strength:.4945791147556446,citations:["Aink356","Aink387","Aink396"]},{id:"tāṉ amai",source:"tāṉ",target:"amai",strength:.4977696307042064,citations:["Aink103"]},{id:"uṭai tuṟai",source:"uṭai",target:"tuṟai",strength:.4977696307042064,citations:["Aink113","Aink20"]},{id:"maṇal tuṟai",source:"maṇal",target:"tuṟai",strength:.4977696307042064,citations:["Aink113","Aink361"]},{id:"peyar pal",source:"peyar",target:"pal",strength:.4977696307042064,citations:["Aink321","Aink355"]},{id:"tōḻaṉ makiḻ",source:"tōḻaṉ",target:"makiḻ",strength:.5004939723455194,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40"]},{id:"nal miku",source:"nal",target:"miku",strength:.5030966784312113,citations:["Aink120","Aink64"],curvature:.25},{id:"il veṉa",source:"il",target:"veṉa",strength:.5037027456870358,citations:["Aink8","Aink9"]},{id:"kaṇ yāṉai",source:"kaṇ",target:"yāṉai",strength:.5053529299904037,citations:["Aink314","Aink327","Aink355","Aink362"]},{id:"puṉal em",source:"puṉal",target:"em",strength:.5055386719016535,citations:["Aink77","Aink78"]},{id:"maḷḷar a-",source:"maḷḷar",target:"a-",strength:.507401798010869,citations:["Aink400","Aink94"]},{id:"vivaḷ nal",source:"vivaḷ",target:"nal",strength:.5097009302720441,citations:["Aink55","Aink56","Aink57"]},{id:"namm ūr",source:"namm",target:"ūr",strength:.5105696912631104,citations:["Aink102","Aink396"]},{id:"miṉ taṭpam",source:"miṉ",target:"taṭpam",strength:.5112129597356483,citations:["Aink10","Aink5"]},{id:"peru(m) ciṟa",source:"peru(m)",target:"ciṟa",strength:.5145202175357012,citations:["Aink1","Aink403","Aink9"]},{id:"maka i-",source:"maka",target:"i-",strength:.5165381996779722,citations:["Aink100","Aink52","Aink79","Aink91","Aink96","Aink97","Aink98","Aink99"]},{id:"tāṉ col",source:"tāṉ",target:"col",strength:.5171554216813703,citations:["Aink38","Aink41"]},{id:"maṇi neṭu(m)",source:"maṇi",target:"neṭu(m)",strength:.5185149885681518,citations:["Aink207","Aink209"]},{id:"e- kol",source:"e-",target:"kol",strength:.5198894144036339,citations:["Aink108","Aink372"]},{id:"e- taṭa(m)",source:"e-",target:"taṭa(m)",strength:.5198894144036339,citations:["Aink11"]},{id:"viri malar",source:"viri",target:"malar",strength:.5198894144036339,citations:["Aink361","Aink367"]},{id:"em tōḷ",source:"em",target:"tōḷ",strength:.5212790275722887,citations:["Aink108","Aink109"]},{id:"aṟu yūraṉ",source:"aṟu",target:"yūraṉ",strength:.5212790275722887,citations:["Aink25","Aink29"]},{id:"vem iṟa",source:"vem",target:"iṟa",strength:.5212790275722887,citations:["Aink309","Aink394"]},{id:"poṉ cey",source:"poṉ",target:"cey",strength:.5212790275722887,citations:["Aink316","Aink41"]},{id:"vem kātal",source:"vem",target:"kātal",strength:.5212790275722887,citations:["Aink325","Aink71"]},{id:"muṉ yām",source:"muṉ",target:"yām",strength:.5212790275722887,citations:["Aink38","Aink40"]},{id:"al nī",source:"al",target:"nī",strength:.5215548816382893,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128","Aink69"]},{id:"nī kēḷ",source:"nī",target:"kēḷ",strength:.5233585508611097,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"tōḻaṉ vayiṉ",source:"tōḻaṉ",target:"vayiṉ",strength:.5259476743992745,citations:["Aink335","Aink336","Aink337"]},{id:"veḷ nel",source:"veḷ",target:"nel",strength:.5277296062180752,citations:["Aink48","Aink58"]},{id:"nekiḻ cel",source:"nekiḻ",target:"cel",strength:.5284671960872065,citations:["Aink25","Aink315"]},{id:"vāyiṉa curam",source:"vāyiṉa",target:"curam",strength:.5284671960872065,citations:["Aink322","Aink359"]},{id:"vāyiṉa i-",source:"vāyiṉa",target:"i-",strength:.5284671960872065,citations:["Aink322","Aink359"]},{id:"i- paḻaṉa(m)",source:"i-",target:"paḻaṉa(m)",strength:.5284671960872065,citations:["Aink91","Aink96"]},{id:"toṭi maṭa(m)",source:"toṭi",target:"maṭa(m)",strength:.5292091375441575,citations:["Aink76","Aink98"]},{id:"puṇar tuṇai",source:"puṇar",target:"tuṇai",strength:.5299554822402742,citations:["Aink15","Aink72"]},{id:"kāl vari",source:"kāl",target:"vari",strength:.5299554822402742,citations:["Aink381","Aink388"]},{id:"nal maṇa",source:"nal",target:"maṇa",strength:.5301283300916492,citations:["Aink22","Aink379","Aink399"]},{id:"taṭpam kaṭal",source:"taṭpam",target:"kaṭal",strength:.5301283300916494,citations:["Aink106","Aink107","Aink108"]},{id:"vem curam",source:"vem",target:"curam",strength:.5304892380982207,citations:["Aink309","Aink330","Aink352","Aink373","Aink394"]},{id:"tuṟai keḻu",source:"tuṟai",target:"keḻu",strength:.5309805246335099,citations:["Aink11","Aink12","Aink140"]},{id:"tōḷ iḻai",source:"tōḷ",target:"iḻai",strength:.532221466287748,citations:["Aink310","Aink318"]},{id:"nīttam varavu",source:"nīttam",target:"varavu",strength:.532221466287748,citations:["Aink323","Aink330"]},{id:"ari varavu",source:"ari",target:"varavu",strength:.532221466287748,citations:["Aink352","Aink354"]},{id:"taṭpam puṉal",source:"taṭpam",target:"puṉal",strength:.5340878461861733,citations:["Aink54","Aink69","Aink76","Aink77","Aink98"]},{id:"a- vivaḷ",source:"a-",target:"vivaḷ",strength:.5346183090822741,citations:["Aink54","Aink55","Aink56","Aink57"]},{id:"aṟam il",source:"aṟam",target:"il",strength:.5353077245405744,citations:["Aink118","Aink332"]},{id:"kaṇ al",source:"kaṇ",target:"al",strength:.5374181051837554,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"kamaḻ taṭpam",source:"kamaḻ",target:"taṭpam",strength:.5392752053807979,citations:["Aink19","Aink348"]},{id:"taṭpam poḻil",source:"taṭpam",target:"poḻil",strength:.5392752053807979,citations:["Aink19","Aink348"]},{id:"pōlap pal",source:"pōlap",target:"pal",strength:.5400839458669234,citations:["Aink365","Aink84"]},{id:"uṟu neñcam",source:"uṟu",target:"neñcam",strength:.5408979209557336,citations:["Aink360","Aink59"]},{id:"katam nī",source:"katam",target:"nī",strength:.5408979209557336,citations:["Aink361"]},{id:"yūra nī",source:"yūra",target:"nī",strength:.5408979209557336,citations:["Aink60","Aink81"]},{id:"pōl uṇ",source:"pōl",target:"uṇ",strength:.5425418490991912,citations:["Aink101","Aink16"]},{id:"nīr iṉ",source:"nīr",target:"iṉ",strength:.5442075517578416,citations:["Aink203","Aink397"]},{id:"yeṉ tōḻaṉ",source:"yeṉ",target:"tōḻaṉ",strength:.5463750742188797,citations:["Aink107","Aink205","Aink366"]},{id:"karu(m) kāl",source:"karu(m)",target:"kāl",strength:.5467482182126969,citations:["Aink331","Aink388"]},{id:"tōḻaṉ nām",source:"tōḻaṉ",target:"nām",strength:.5480107441323385,citations:["Aink116","Aink335","Aink336","Aink337","Aink34","Aink35","Aink36"]},{id:"vel pāvai",source:"vel",target:"pāvai",strength:.5493412732174383,citations:["Aink375"]},{id:"varavu tāṉ",source:"varavu",target:"tāṉ",strength:.5528197436635355,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"],curvature:.25},{id:"nōkkam nal",source:"nōkkam",target:"nal",strength:.5542888160560089,citations:["Aink204","Aink375"]},{id:"tōḻaṉ ciṟi",source:"tōḻaṉ",target:"ciṟi",strength:.5546935155177384,citations:["Aink334","Aink339"]},{id:"al poy",source:"al",target:"poy",strength:.5546935155177384,citations:["Aink66","Aink80"]},{id:"i- iv",source:"i-",target:"iv",strength:.5565294417323561,citations:["Aink205","Aink208"]},{id:"cel ai",source:"cel",target:"ai",strength:.5565294417323561,citations:["Aink332","Aink389"]},{id:"i- maruntu",source:"i-",target:"maruntu",strength:.5565294417323561,citations:["Aink59","Aink99"]},{id:"iṉ maṉ",source:"iṉ",target:"maṉ",strength:.5568620191322388,citations:["Aink326","Aink337","Aink356"]},{id:"aru(m) iṟa",source:"aru(m)",target:"iṟa",strength:.5574575545218753,citations:["Aink317","Aink385"]},{id:"veḷ maṇal",source:"veḷ",target:"maṇal",strength:.5593345850716138,citations:["Aink105","Aink113"]},{id:"aṉṉai yeṉ",source:"aṉṉai",target:"yeṉ",strength:.5616235778850451,citations:["Aink107","Aink205","Aink366"]},{id:"eṉ niṉai",source:"eṉ",target:"niṉai",strength:.5621633578352979,citations:["Aink311","Aink363"]},{id:"kāl āmpal",source:"kāl",target:"āmpal",strength:.5661340091898609,citations:["Aink34","Aink68"]},{id:"kātal puṇar",source:"kātal",target:"puṇar",strength:.5661340091898609,citations:["Aink386","Aink400"]},{id:"uṇ kaṇ",source:"uṇ",target:"kaṇ",strength:.5665182427748447,citations:["Aink101","Aink16","Aink21","Aink334","Aink351","Aink37","Aink378","Aink406"]},{id:"a- tāṉ",source:"a-",target:"tāṉ",strength:.5667407524921709,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350","Aink41","Aink66"],curvature:.25},{id:"aṉṉai ūrp",source:"aṉṉai",target:"ūrp",strength:.5691644862431997,citations:["Aink104","Aink202"]},{id:"maṟa vēṇṭu",source:"maṟa",target:"vēṇṭu",strength:.5722697974029913,citations:["Aink209"]},{id:"cey poruḷ",source:"cey",target:"poruḷ",strength:.5722697974029913,citations:["Aink355","Aink357"]},{id:"val kāḷai",source:"val",target:"kāḷai",strength:.5722697974029913,citations:["Aink390","Aink399"]},{id:"maṉai yāṅkaṇ",source:"maṉai",target:"yāṅkaṇ",strength:.5722697974029913,citations:["Aink48","Aink87"]},{id:"maṉ yāṉ",source:"maṉ",target:"yāṉ",strength:.5733221777047787,citations:["Aink326","Aink380"]},{id:"aṟam maṉ",source:"aṟam",target:"maṉ",strength:.5733221777047787,citations:["Aink332","Aink394"]},{id:"taṇṇ peru(m)",source:"taṇṇ",target:"peru(m)",strength:.5754537323303844,citations:["Aink123","Aink73"]},{id:"taṭpam maṇ",source:"taṭpam",target:"maṇ",strength:.5754537323303844,citations:["Aink27","Aink30"]},{id:"tāṉ varavu",source:"tāṉ",target:"varavu",strength:.5765110883620944,citations:["Aink134","Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"],curvature:.25},{id:"yuvak kaṇ",source:"yuvak",target:"kaṇ",strength:.5765332128827203,citations:["Aink206","Aink207"]},{id:"itaḻ kaṇ",source:"itaḻ",target:"kaṇ",strength:.5765332128827203,citations:["Aink334","Aink351"]},{id:"pari neṭu(m)",source:"pari",target:"neṭu(m)",strength:.5776220397032914,citations:["Aink134","Aink95"]},{id:"uṇ nīḷ",source:"uṇ",target:"nīḷ",strength:.5787203760487778,citations:["Aink324","Aink360"]},{id:"pall uṇ",source:"pall",target:"uṇ",strength:.5787203760487778,citations:["Aink334","Aink351"]},{id:"vēḻam pū(m)",source:"vēḻam",target:"pū(m)",strength:.5788576715101487,citations:["Aink12","Aink17","Aink19"]},{id:"aṭu puṇar",source:"aṭu",target:"puṇar",strength:.5809462520709768,citations:["Aink15","Aink72"]},{id:"vayiṉ piri",source:"vayiṉ",target:"piri",strength:.5809462520709768,citations:["Aink308","Aink336"]},{id:"miku nal",source:"miku",target:"nal",strength:.5838588610598319,citations:["Aink120","Aink365"],curvature:.25},{id:"naṉi ciṟa",source:"naṉi",target:"ciṟa",strength:.5855198001670249,citations:["Aink10","Aink7"]},{id:"tēṉūr a-",source:"tēṉūr",target:"a-",strength:.5883952970003862,citations:["Aink54","Aink55","Aink57"]},{id:"aṇi kāṉ",source:"aṇi",target:"kāṉ",strength:.5890625333754138,citations:["Aink357","Aink367"]},{id:"am vari",source:"am",target:"vari",strength:.5902659752115004,citations:["Aink306","Aink316"]},{id:"ayar nal",source:"ayar",target:"nal",strength:.5902659752115004,citations:["Aink307","Aink309"]},{id:"maruntu ākkam",source:"maruntu",target:"ākkam",strength:.591733402839121,citations:["Aink101","Aink59","Aink99"]},{id:"mel tōḷ",source:"mel",target:"tōḷ",strength:.5924112344682434,citations:["Aink120","Aink28","Aink310"]},{id:"i- vāṟu",source:"i-",target:"vāṟu",strength:.5927079686819426,citations:["Aink205","Aink208"]},{id:"oḻi cel",source:"oḻi",target:"cel",strength:.5927079686819426,citations:["Aink321","Aink330"]},{id:"kaṇṭaṉem curam",source:"kaṇṭaṉem",target:"curam",strength:.5927079686819426,citations:["Aink387","Aink390"]},{id:"maṭa(m) maka",source:"maṭa(m)",target:"maka",strength:.5931646236504827,citations:["Aink326","Aink361","Aink394","Aink398","Aink48","Aink98"]},{id:"paya cey",source:"paya",target:"cey",strength:.5951983215885442,citations:["Aink305","Aink56"]},{id:"uḷ ākkam",source:"uḷ",target:"ākkam",strength:.5977389880433995,citations:["Aink205","Aink54"]},{id:"veṉṉ ākkam",source:"veṉṉ",target:"ākkam",strength:.5977389880433995,citations:["Aink221","Aink389"]},{id:"niṟaikkum ūr",source:"niṟaikkum",target:"ūr",strength:.5977389880433995,citations:["Aink47","Aink48"]},{id:"pūk ūr",source:"pūk",target:"ūr",strength:.5989590581081705,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"neṭu(m) kuṉṟam",source:"neṭu(m)",target:"kuṉṟam",strength:.6001056051870624,citations:["Aink207","Aink209","Aink371"]},{id:"paṇpu il",source:"paṇpu",target:"il",strength:.6056842853484409,citations:["Aink138","Aink332"]},{id:"tōḻaṉ mūrp",source:"tōḻaṉ",target:"mūrp",strength:.6056842853484409,citations:["Aink34","Aink35"]},{id:"vuṇ kaṇ",source:"vuṇ",target:"kaṇ",strength:.6075106485317011,citations:["Aink125","Aink36","Aink69"]},{id:"yuṇ kaṇ",source:"yuṇ",target:"kaṇ",strength:.6075106485317011,citations:["Aink126","Aink376","Aink72"]},{id:"yuṭai maka",source:"yuṭai",target:"maka",strength:.6084483243525779,citations:["Aink13","Aink354"]},{id:"aru(m) poruḷ",source:"aru(m)",target:"poruḷ",strength:.6084483243525779,citations:["Aink302","Aink359"]},{id:"kaṭu maka",source:"kaṭu",target:"maka",strength:.6084483243525779,citations:["Aink360","Aink78"]},{id:"val poy",source:"val",target:"poy",strength:.6084483243525779,citations:["Aink37"]},{id:"aṉṉai vāḻ",source:"aṉṉai",target:"vāḻ",strength:.6085544349475227,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink366"],curvature:.25},{id:"vāḻ aṉṉai",source:"vāḻ",target:"aṉṉai",strength:.6085544349475227,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink366"],curvature:.25},{id:"veḷ vēl",source:"veḷ",target:"vēl",strength:.6098153291359849,citations:["Aink379","Aink382","Aink393"]},{id:"koṇkaṉ nī",source:"koṇkaṉ",target:"nī",strength:.6100435794973077,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128","Aink307"]},{id:"aru(m) curam",source:"aru(m)",target:"curam",strength:.6131848567391371,citations:["Aink301","Aink303","Aink317","Aink351","Aink382","Aink385"]},{id:"aṉṉai namm",source:"aṉṉai",target:"namm",strength:.6153541088532278,citations:["Aink102","Aink104","Aink202"]},{id:"āṭu em",source:"āṭu",target:"em",strength:.6171247790205634,citations:["Aink77","Aink78"]},{id:"ōkku pū(m)",source:"ōkku",target:"pū(m)",strength:.6216983271166114,citations:["Aink16","Aink33"]},{id:"aṟu kaḻaṉi",source:"aṟu",target:"kaḻaṉi",strength:.6216983271166114,citations:["Aink25","Aink29"]},{id:"kaḷvaṉ kaḻaṉi",source:"kaḷvaṉ",target:"kaḻaṉi",strength:.6216983271166114,citations:["Aink25","Aink29"]},{id:"iṟa kātal",source:"iṟa",target:"kātal",strength:.6216983271166114,citations:["Aink311","Aink319"]},{id:"vāṉ pū(m)",source:"vāṉ",target:"pū(m)",strength:.6216983271166114,citations:["Aink320","Aink331"]},{id:"poykaip pū(m)",source:"poykaip",target:"pū(m)",strength:.6216983271166114,citations:["Aink34","Aink97"]},{id:"toṟum toṟum",source:"toṟum",target:"toṟum",strength:.6216983271166114,citations:["Aink358","Aink375"],curvature:.5},{id:"ciṟu(m) miṉ",source:"ciṟu(m)",target:"miṉ",strength:.6232605672336937,citations:["Aink1","Aink10"]},{id:"vem ciṉa(m)",source:"vem",target:"ciṉa(m)",strength:.6232605672336937,citations:["Aink391","Aink400"]},{id:"vem viṟal",source:"vem",target:"viṟal",strength:.6232605672336937,citations:["Aink391","Aink400"]},{id:"kaṇ koṇkaṉ",source:"kaṇ",target:"koṇkaṉ",strength:.6243193289587256,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"vēḻam veḷ",source:"vēḻam",target:"veḷ",strength:.6254234416919329,citations:["Aink13","Aink17","Aink19"]},{id:"taṭpam ṇakam",source:"taṭpam",target:"ṇakam",strength:.626444502161087,citations:["Aink27","Aink30"]},{id:"marutattup peru(m)",source:"marutattup",target:"peru(m)",strength:.626444502161087,citations:["Aink31","Aink75"]},{id:"peṟu nutal",source:"peṟu",target:"nutal",strength:.626444502161087,citations:["Aink56","Aink94"]},{id:"paca paṉi",source:"paca",target:"paṉi",strength:.6280672177360228,citations:["Aink141","Aink37"]},{id:"kuṟu(m) ciṉai",source:"kuṟu(m)",target:"ciṉai",strength:.6280672177360228,citations:["Aink339","Aink383"]},{id:"māṇ iḻai",source:"māṇ",target:"iḻai",strength:.6280672177360228,citations:["Aink42","Aink47"]},{id:"aruḷ nī",source:"aruḷ",target:"nī",strength:.6280672177360228,citations:["Aink50"]},{id:"pūp uṇ",source:"pūp",target:"uṇ",strength:.6297111458794804,citations:["Aink101","Aink16"]},{id:"kēḷ talaimakaḷ",source:"kēḷ",target:"talaimakaḷ",strength:.6297111458794804,citations:["Aink201","Aink221"]},{id:"eri uṇ",source:"eri",target:"uṇ",strength:.6297111458794804,citations:["Aink324","Aink360"]},{id:"kōḷ val",source:"kōḷ",target:"val",strength:.6313768485381308,citations:["Aink312","Aink385"]},{id:"vel vēl",source:"vel",target:"vēl",strength:.6325882024783313,citations:["Aink364","Aink388","Aink399"]},{id:"vēṇṭu yeṉ",source:"vēṇṭu",target:"yeṉ",strength:.6325882024783314,citations:["Aink107","Aink205","Aink366"]},{id:"kuṟṟu maka",source:"kuṟṟu",target:"maka",strength:.6358091118761745,citations:["Aink371","Aink394","Aink395","Aink52"]},{id:"koḷ tuyar",source:"koḷ",target:"tuyar",strength:.6365105699977274,citations:["Aink393","Aink394"]},{id:"oṇmai muṉ",source:"oṇmai",target:"muṉ",strength:.6365105699977274,citations:["Aink40","Aink83"]},{id:"yūraṉ mārpu",source:"yūraṉ",target:"mārpu",strength:.6389051486341999,citations:["Aink14","Aink25","Aink29","Aink4"]},{id:"puṉal aṭu",source:"puṉal",target:"aṭu",strength:.6401625951042444,citations:["Aink100","Aink15","Aink72"]},{id:"maṉ tām",source:"maṉ",target:"tām",strength:.6401625951042444,citations:["Aink316","Aink332","Aink337"]},{id:"curam yiṉiya",source:"curam",target:"yiṉiya",strength:.6401625951042444,citations:["Aink326","Aink371","Aink398"]},{id:"aṉpu il",source:"aṉpu",target:"il",strength:.6418628122980274,citations:["Aink138","Aink41"]},{id:"al urai",source:"al",target:"urai",strength:.6418628122980274,citations:["Aink66","Aink80"]},{id:"il lākuka",source:"il",target:"lākuka",strength:.6418628122980274,citations:["Aink8","Aink9"]},{id:"cel ayar",source:"cel",target:"ayar",strength:.6436987385126453,citations:["Aink307","Aink309"]},{id:"curam iṟa",source:"curam",target:"iṟa",strength:.643987067597709,citations:["Aink306","Aink309","Aink317","Aink385","Aink394"]},{id:"vāl iḻai",source:"vāl",target:"iḻai",strength:.6474530087131868,citations:["Aink0","Aink73"]},{id:"taṭpam yūraṉ",source:"taṭpam",target:"yūraṉ",strength:.6487337303381695,citations:["Aink10","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"nutal kuṟṟu",source:"nutal",target:"kuṟṟu",strength:.64937302634664,citations:["Aink371","Aink394"]},{id:"toṭi maṭantai",source:"toṭi",target:"maṭantai",strength:.64937302634664,citations:["Aink389","Aink92"]},{id:"am cil",source:"am",target:"cil",strength:.64937302634664,citations:["Aink391","Aink49"]},{id:"maṇi kuṉṟam",source:"maṇi",target:"kuṉṟam",strength:.6513228128788433,citations:["Aink207","Aink209"]},{id:"pai(m) aṟu",source:"pai(m)",target:"aṟu",strength:.6533033059701501,citations:["Aink305","Aink317"]},{id:"kāl marām",source:"kāl",target:"marām",strength:.6533033059701501,citations:["Aink331","Aink381"]},{id:"taṭpam tuṟai",source:"taṭpam",target:"tuṟai",strength:.6545870333547409,citations:["Aink10","Aink105","Aink115","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"kañal ūr",source:"kañal",target:"ūr",strength:.6548191093212261,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"tuṟai yūraṉai",source:"tuṟai",target:"yūraṉai",strength:.6553154882923621,citations:["Aink20","Aink88"]},{id:"marutattup tuṟai",source:"marutattup",target:"tuṟai",strength:.6553154882923621,citations:["Aink31","Aink75"]},{id:"tāṉ uṇarntōr",source:"tāṉ",target:"uṇarntōr",strength:.6553154882923621,citations:["Aink38","Aink41"]},{id:"puṉal āṭu",source:"puṉal",target:"āṭu",strength:.6578576136968738,citations:["Aink77","Aink78","Aink98"]},{id:"tōḷ tuṟa",source:"tōḷ",target:"tuṟa",strength:.6594390941832803,citations:["Aink108","Aink109"]},{id:"keḻu koṭu(m)",source:"keḻu",target:"koṭu(m)",strength:.6594390941832803,citations:["Aink11","Aink12"]},{id:"val vil",source:"val",target:"vil",strength:.6594390941832803,citations:["Aink373","Aink390"]},{id:"toṭi muṉ",source:"toṭi",target:"muṉ",strength:.6601036978843011,citations:["Aink38","Aink40","Aink83"]},{id:"yarum curam",source:"yarum",target:"curam",strength:.660728445247768,citations:["Aink307","Aink314","Aink320","Aink325","Aink329"]},{id:"maka piṇa",source:"maka",target:"piṇa",strength:.6617774347111395,citations:["Aink326","Aink354","Aink373","Aink394","Aink401"]},{id:"tātu uṇ",source:"tātu",target:"uṇ",strength:.6635458601041676,citations:["Aink67","Aink82","Aink93"]},{id:"vekuḷvōḷ kaṇ",source:"vekuḷvōḷ",target:"kaṇ",strength:.6637025096630094,citations:["Aink84"]},{id:"kavar uṇ",source:"kavar",target:"uṇ",strength:.665889672829067,citations:["Aink324","Aink360"]},{id:"uṇ veṉṟūḻ",source:"uṇ",target:"veṉṟūḻ",strength:.665889672829067,citations:["Aink324","Aink360"]},{id:"maṇal aṭu",source:"maṇal",target:"aṭu",strength:.668115548851266,citations:["Aink100","Aink15"]},{id:"aṇaṅku uṟu",source:"aṇaṅku",target:"uṟu",strength:.668115548851266,citations:["Aink53","Aink58"]},{id:"vāḻ yātaṉ",source:"vāḻ",target:"yātaṉ",strength:.6682378636944032,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"yātaṉ vāḻ",source:"yātaṉ",target:"vāḻ",strength:.6682378636944032,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"vāḻ yaviṉi",source:"vāḻ",target:"yaviṉi",strength:.6682378636944032,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"nām maṟa",source:"nām",target:"maṟa",strength:.6682790702004187,citations:["Aink319","Aink36"]},{id:"iḻai nekiḻ",source:"iḻai",target:"nekiḻ",strength:.6703815328987398,citations:["Aink25","Aink318"]},{id:"porip pū(m)",source:"porip",target:"pū(m)",strength:.6726890969473139,citations:["Aink347","Aink368"]},{id:"pū(m) puṉku",source:"pū(m)",target:"puṉku",strength:.6726890969473139,citations:["Aink347","Aink368"]},{id:"mell am",source:"mell",target:"am",strength:.6774352719917895,citations:["Aink133","Aink302"]},{id:"nal nayavaravu",source:"nal",target:"nayavaravu",strength:.6774352719917895,citations:["Aink365"]},{id:"kaḻaṉit malar",source:"kaḻaṉit",target:"malar",strength:.6774352719917895,citations:["Aink53","Aink94"]},{id:"kaḻaṉi mārpu",source:"kaḻaṉi",target:"mārpu",strength:.6822410026482937,citations:["Aink25","Aink29","Aink4"]},{id:"ciṟu(m) yāṉai",source:"ciṟu(m)",target:"yāṉai",strength:.6827778305827648,citations:["Aink314","Aink327","Aink355","Aink362"]},{id:"mūtu ūr",source:"mūtu",target:"ūr",strength:.6835863522195381,citations:["Aink15","Aink372"]},{id:"vēṇṭu namm",source:"vēṇṭu",target:"namm",strength:.6863187334465138,citations:["Aink102","Aink104","Aink202"]},{id:"em tuṟa",source:"em",target:"tuṟa",strength:.6875013398284299,citations:["Aink108","Aink109"]},{id:"vēḻam karuppu",source:"vēḻam",target:"karuppu",strength:.6875013398284299,citations:["Aink12","Aink18"]},{id:"naṉi yiṉiya",source:"naṉi",target:"yiṉiya",strength:.6875013398284299,citations:["Aink371","Aink398"]},{id:"kuṇam koḷ",source:"kuṇam",target:"koḷ",strength:.6875013398284299,citations:["Aink90"]},{id:"nām vayiṉ",source:"nām",target:"vayiṉ",strength:.6880434844278591,citations:["Aink335","Aink336","Aink337","Aink39"]},{id:"yeṉpa al",source:"yeṉpa",target:"al",strength:.69285358212873,citations:["Aink369","Aink71"]},{id:"ciṟa vēṭṭōḷ",source:"ciṟa",target:"vēṭṭōḷ",strength:.6948711068549254,citations:["Aink1","Aink10","Aink3"]},{id:"varai nāṭu",source:"varai",target:"nāṭu",strength:.6948711068549254,citations:["Aink301","Aink309","Aink392"]},{id:"iṉ vavar",source:"iṉ",target:"vavar",strength:.695617621132867,citations:["Aink203","Aink331"]},{id:"kāṭu iṟa",source:"kāṭu",target:"iṟa",strength:.695617621132867,citations:["Aink311","Aink313"]},{id:"toṟum kalakkam",source:"toṟum",target:"kalakkam",strength:.695617621132867,citations:["Aink358","Aink375"]},{id:"mal val",source:"mal",target:"val",strength:.695617621132867,citations:["Aink37"]},{id:"iṉ naku",source:"iṉ",target:"naku",strength:.695617621132867,citations:["Aink397","Aink403"]},{id:"puṟavam aṇi",source:"puṟavam",target:"aṇi",strength:.695617621132867,citations:["Aink404","Aink405"]},{id:"nām mūrp",source:"nām",target:"mūrp",strength:.6984437785438893,citations:["Aink34","Aink35"]},{id:"vāḻ vēṇṭu",source:"vāḻ",target:"vēṇṭu",strength:.7024976920751133,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink366"]},{id:"pai(m) kāy",source:"pai(m)",target:"kāy",strength:.7042940758008526,citations:["Aink25","Aink381"]},{id:"koṭu(m) uyar",source:"koṭu(m)",target:"uyar",strength:.7042940758008526,citations:["Aink318","Aink358"]},{id:"poruḷ piṇi",source:"poruḷ",target:"piṇi",strength:.7042940758008526,citations:["Aink336","Aink355"]},{id:"peṟu cuṭar",source:"peṟu",target:"cuṭar",strength:.7042940758008526,citations:["Aink56","Aink94"]},{id:"taṭa(m) erumai",source:"taṭa(m)",target:"erumai",strength:.7042940758008526,citations:["Aink94","Aink98"]},{id:"yāṇar ūr",source:"yāṇar",target:"ūr",strength:.706011859844696,citations:["Aink1","Aink100","Aink42","Aink43","Aink49","Aink50","Aink70","Aink87"]},{id:"ciṟa veṉa",source:"ciṟa",target:"veṉa",strength:.7088330393028005,citations:["Aink1","Aink10","Aink3"]},{id:"kaḷvaṉ aṟu",source:"kaḷvaṉ",target:"aṟu",strength:.7088330393028005,citations:["Aink21","Aink25","Aink29"]},{id:"pāvai yaṉṉa",source:"pāvai",target:"yaṉṉa",strength:.7088330393028005,citations:["Aink221","Aink307","Aink389"]},{id:"yāṉai neṟi",source:"yāṉai",target:"neṟi",strength:.7104298640139829,citations:["Aink355","Aink78"]},{id:"tuṟai yūraṉ",source:"tuṟai",target:"yūraṉ",strength:.7123204479632309,citations:["Aink10","Aink13","Aink14","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"alkul am",source:"alkul",target:"am",strength:.7136137989413761,citations:["Aink306","Aink316"]},{id:"yoḷ nutal",source:"yoḷ",target:"nutal",strength:.7138342288524836,citations:["Aink123","Aink322","Aink73"]},{id:"tāmarai malar",source:"tāmarai",target:"malar",strength:.7138342288524836,citations:["Aink53","Aink68","Aink94"]},{id:"muttam veḷ",source:"muttam",target:"veḷ",strength:.7168804426597695,citations:["Aink105","Aink380"]},{id:"itaḻ uṇ",source:"itaḻ",target:"uṇ",strength:.7168804426597695,citations:["Aink334","Aink351"]},{id:"no/nō maruntu",source:"no/nō",target:"maruntu",strength:.7236798667780164,citations:["Aink101","Aink99"]},{id:"viṟal vēl",source:"viṟal",target:"vēl",strength:.7236798667780164,citations:["Aink391","Aink400"]},{id:"ciṉa(m) vēl",source:"ciṉa(m)",target:"vēl",strength:.7236798667780164,citations:["Aink391","Aink400"]},{id:"vāl iṇar",source:"vāl",target:"iṇar",strength:.7236798667780165,citations:["Aink301","Aink383"]},{id:"maṉai nakar",source:"maṉai",target:"nakar",strength:.7236798667780165,citations:["Aink324","Aink60"]},{id:"malai nāṭu",source:"malai",target:"nāṭu",strength:.7244411518587485,citations:["Aink202","Aink205","Aink221"]},{id:"nīḷ iṭai",source:"nīḷ",target:"iṭai",strength:.7244411518587486,citations:["Aink314","Aink360","Aink380"]},{id:"katir teṟu",source:"katir",target:"teṟu",strength:.7272225999864056,citations:["Aink319","Aink330"]},{id:"maṟa amai",source:"maṟa",target:"amai",strength:.7272225999864056,citations:["Aink36"]},{id:"karu(m) kōṭṭam",source:"karu(m)",target:"kōṭṭam",strength:.7272225999864056,citations:["Aink92","Aink95"]},{id:"taṭa(m) kōṭṭam",source:"taṭa(m)",target:"kōṭṭam",strength:.7272225999864056,citations:["Aink94","Aink98"]},{id:"neṭu(m) nakar",source:"neṭu(m)",target:"nakar",strength:.7300809729797141,citations:["Aink324","Aink376","Aink60"]},{id:"yaḻi puṉal",source:"yaḻi",target:"puṉal",strength:.7308680352929344,citations:["Aink53","Aink78"]},{id:"puṉal āṭit",source:"puṉal",target:"āṭit",strength:.7308680352929344,citations:["Aink76","Aink80"]},{id:"tiruttu iḻai",source:"tiruttu",target:"iḻai",strength:.7346223054934758,citations:["Aink355","Aink39"]},{id:"iḻai yarivai",source:"iḻai",target:"yarivai",strength:.7346223054934758,citations:["Aink355","Aink42"]},{id:"pūp pōl",source:"pūp",target:"pōl",strength:.7384921096591325,citations:["Aink101","Aink16"]},{id:"kaṭal tirai",source:"kaṭal",target:"tirai",strength:.7384921096591325,citations:["Aink105","Aink107"]},{id:"karai vēḻam",source:"karai",target:"vēḻam",strength:.7384921096591325,citations:["Aink12","Aink13"]},{id:"toṟum kaliḻ",source:"toṟum",target:"kaliḻ",strength:.7421361704513778,citations:["Aink373","Aink376","Aink398"]},{id:"amaintaṉaṉ tāṉ",source:"amaintaṉaṉ",target:"tāṉ",strength:.7424847850726513,citations:["Aink103"]},{id:"vaḷai nekiḻ",source:"vaḷai",target:"nekiḻ",strength:.7466083909635695,citations:["Aink136","Aink54"]},{id:"yoḷ arivai",source:"yoḷ",target:"arivai",strength:.7466083909635695,citations:["Aink322","Aink73"]},{id:"katuppu aṇi",source:"katuppu",target:"aṇi",strength:.7466083909635695,citations:["Aink345","Aink396"]},{id:"val curi",source:"val",target:"curi",strength:.7466083909635695,citations:["Aink348","Aink383"]},{id:"pata(m) vēṉal",source:"pata(m)",target:"vēṉal",strength:.7466083909635695,citations:["Aink368","Aink400"]},{id:"yaviṉi pakai",source:"yaviṉi",target:"pakai",strength:.7466083909635695,citations:["Aink4","Aink6"]},{id:"pāy eṉak",source:"pāy",target:"eṉak",strength:.7466083909635695,citations:["Aink53","Aink73"]},{id:"kai vaḷ",source:"kai",target:"vaḷ",strength:.7466083909635695,citations:["Aink58","Aink61"]},{id:"lākuka vēṭṭōḷ",source:"lākuka",target:"vēṭṭōḷ",strength:.7466083909635695,citations:["Aink8","Aink9"]},{id:"vāḻ tōḻaṉ",source:"vāḻ",target:"tōḻaṉ",strength:.748242533697135,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink221","Aink31","Aink32","Aink33","Aink331","Aink332","Aink333","Aink334","Aink335","Aink336","Aink337","Aink338","Aink339","Aink34","Aink340","Aink35","Aink36","Aink37","Aink38","Aink39","Aink392","Aink40"]},{id:"vayalaic ce(m)",source:"vayalaic",target:"ce(m)",strength:.7552848456315552,citations:["Aink25","Aink52"]},{id:"ce(m) ēṟṟai",source:"ce(m)",target:"ēṟṟai",strength:.7552848456315552,citations:["Aink354","Aink397"]},{id:"vari niḻal",source:"vari",target:"niḻal",strength:.7577442830073259,citations:["Aink381","Aink388","Aink62"]},{id:"puḷḷik kaḷvaṉ",source:"puḷḷik",target:"kaḷvaṉ",strength:.7598583937276031,citations:["Aink21","Aink22"]},{id:"lākuka veṉa",source:"lākuka",target:"veṉa",strength:.7598583937276031,citations:["Aink8","Aink9"]},{id:"cuṭar nutal",source:"cuṭar",target:"nutal",strength:.7605221926864978,citations:["Aink107","Aink375","Aink56","Aink94"]},{id:"yallaṉ e-",source:"yallaṉ",target:"e-",strength:.7646045687720787,citations:["Aink11"]},{id:"mel pulak",source:"mel",target:"pulak",strength:.7646045687720787,citations:["Aink119","Aink138"]},{id:"kaḻaṉi yūraṉ",source:"kaḻaṉi",target:"yūraṉ",strength:.765152632914295,citations:["Aink18","Aink25","Aink29","Aink4","Aink91","Aink96"]},{id:"al koṇkaṉ",source:"al",target:"koṇkaṉ",strength:.765200770599106,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"putup puṉal",source:"putup",target:"puṉal",strength:.7699190958069968,citations:["Aink53","Aink64","Aink78","Aink79"]},{id:"yiḷa mulai",source:"yiḷa",target:"mulai",strength:.774670636608719,citations:["Aink127","Aink347"]},{id:"maṇa kamaḻ",source:"maṇa",target:"kamaḻ",strength:.774670636608719,citations:["Aink19","Aink348"]},{id:"aṟattoṭu nil",source:"aṟattoṭu",target:"nil",strength:.774670636608719,citations:["Aink201","Aink208"]},{id:"alkul vari",source:"alkul",target:"vari",strength:.774670636608719,citations:["Aink306","Aink316"]},{id:"eṉac col",source:"eṉac",target:"col",strength:.774670636608719,citations:["Aink355","Aink399"]},{id:"tava naṉi",source:"tava",target:"naṉi",strength:.774670636608719,citations:["Aink359","Aink80"]},{id:"naṉi vākuka",source:"naṉi",target:"vākuka",strength:.774670636608719,citations:["Aink371","Aink398"]},{id:"vaṭṭi maṉai",source:"vaṭṭi",target:"maṉai",strength:.774670636608719,citations:["Aink47","Aink48"]},{id:"mūr oṇmai",source:"mūr",target:"oṇmai",strength:.774670636608719,citations:["Aink83","Aink92"]},{id:"paṇait tōḷ",source:"paṇait",target:"tōḷ",strength:.7867240562353426,citations:["Aink135","Aink318","Aink39"]},{id:"aṟam cāliyar",source:"aṟam",target:"cāliyar",strength:.7914633725811417,citations:["Aink312"]},{id:"poykai yāmpal",source:"poykai",target:"yāmpal",strength:.7914633725811417,citations:["Aink35","Aink91"]},{id:"koṇkaṉ kēḷ",source:"koṇkaṉ",target:"kēḷ",strength:.7943009081901953,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"am ōti",source:"am",target:"ōti",strength:.8056871782329008,citations:["Aink368","Aink391","Aink49"]},{id:"nutal arivai",source:"nutal",target:"arivai",strength:.8068772451770276,citations:["Aink322","Aink404","Aink46","Aink73"]},{id:"yaṉṉa veṉṉ",source:"yaṉṉa",target:"veṉṉ",strength:.8108491635583056,citations:["Aink221","Aink389"]},{id:"pāvai veṉṉ",source:"pāvai",target:"veṉṉ",strength:.8108491635583056,citations:["Aink221","Aink389"]},{id:"kaḷvaṉ ṇakam",source:"kaḷvaṉ",target:"ṇakam",strength:.8108491635583056,citations:["Aink27","Aink30"]},{id:"tuṭait toṟum",source:"tuṭait",target:"toṟum",strength:.8108491635583056,citations:["Aink358"]},{id:"niṉait toṟum",source:"niṉait",target:"toṟum",strength:.8108491635583056,citations:["Aink373","Aink398"]},{id:"pāvai yitu",source:"pāvai",target:"yitu",strength:.8108491635583056,citations:["Aink375"]},{id:"tēr taḷar",source:"tēr",target:"taḷar",strength:.8108491635583056,citations:["Aink403","Aink66"]},{id:"ilaṅku vaḷai",source:"ilaṅku",target:"vaḷai",strength:.8108491635583057,citations:["Aink136","Aink310"]},{id:"piṟa pulam",source:"piṟa",target:"pulam",strength:.8108491635583057,citations:["Aink305","Aink325"]},{id:"veṉṟūḻ nīḷ",source:"veṉṟūḻ",target:"nīḷ",strength:.8108491635583057,citations:["Aink324","Aink360"]},{id:"pall ūḻ",source:"pall",target:"ūḻ",strength:.8108491635583057,citations:["Aink374","Aink390"]},{id:"poy urai",source:"poy",target:"urai",strength:.8108491635583057,citations:["Aink66","Aink80"]},{id:"amma vāḻ",source:"amma",target:"vāḻ",strength:.8168383116512294,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink132","Aink139","Aink221","Aink31","Aink32","Aink33","Aink331","Aink332","Aink333","Aink334","Aink335","Aink336","Aink337","Aink338","Aink339","Aink34","Aink340","Aink36","Aink37","Aink38","Aink39","Aink40","Aink77","Aink89"]},{id:"vēṇṭu aṉṉai",source:"vēṇṭu",target:"aṉṉai",strength:.8240929980606883,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink366"],curvature:.25},{id:"aṉṉai vēṇṭu",source:"aṉṉai",target:"vēṇṭu",strength:.8240929980606883,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink366"],curvature:.25},{id:"iv vūr",source:"iv",target:"vūr",strength:.8256614064394217,citations:["Aink132","Aink62"]},{id:"kamaḻ poḻil",source:"kamaḻ",target:"poḻil",strength:.8256614064394217,citations:["Aink19","Aink348"]},{id:"ciṉa(m) viṟal",source:"ciṉa(m)",target:"viṟal",strength:.8256614064394217,citations:["Aink391","Aink400"]},{id:"maṇi niṟam",source:"maṇi",target:"niṟam",strength:.8319022137951136,citations:["Aink208","Aink45","Aink96"]},{id:"vuṇ civa",source:"vuṇ",target:"civa",strength:.8337776877438586,citations:["Aink125","Aink69"]},{id:"cāliyar vaṟṟu",source:"cāliyar",target:"vaṟṟu",strength:.8337776877438586,citations:["Aink312"]},{id:"cil ōti",source:"cil",target:"ōti",strength:.8337776877438586,citations:["Aink391","Aink49"]},{id:"ciṟai putup",source:"ciṟai",target:"putup",strength:.8337776877438586,citations:["Aink53","Aink78"]},{id:"num mūr",source:"num",target:"mūr",strength:.8337776877438586,citations:["Aink83","Aink92"]},{id:"el vaḷai",source:"el",target:"vaḷai",strength:.8404545872035252,citations:["Aink140","Aink20","Aink27"]},{id:"kōṭṭam erumai",source:"kōṭṭam",target:"erumai",strength:.8404545872035252,citations:["Aink94","Aink95","Aink98"]},{id:"peyar uḻi",source:"peyar",target:"uḻi",strength:.8424541424118444,citations:["Aink204"]},{id:"uyar piṟaṅkal",source:"uyar",target:"piṟaṅkal",strength:.8424541424118444,citations:["Aink318","Aink387"]},{id:"niṉait kaliḻ",source:"niṉait",target:"kaliḻ",strength:.8424541424118444,citations:["Aink373","Aink398"]},{id:"pai(m) kiḷḷai",source:"pai(m)",target:"kiḷḷai",strength:.8424541424118444,citations:["Aink375"]},{id:"māṇ kuṇam",source:"māṇ",target:"kuṇam",strength:.8424541424118444,citations:["Aink90"]},{id:"oṇmai toṭi",source:"oṇmai",target:"toṭi",strength:.8451987586118301,citations:["Aink28","Aink387","Aink40","Aink76","Aink83","Aink92"]},{id:"yāy yām",source:"yāy",target:"yām",strength:.8493430099865954,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"namm ūrp",source:"namm",target:"ūrp",strength:.8618399333890082,citations:["Aink104","Aink202"]},{id:"iv vāṟu",source:"iv",target:"vāṟu",strength:.8618399333890082,citations:["Aink205","Aink208"]},{id:"kaviṉ tolai",source:"kaviṉ",target:"tolai",strength:.8618399333890082,citations:["Aink221","Aink392"]},{id:"nekiḻac cā",source:"nekiḻac",target:"cā",strength:.8618399333890082,citations:["Aink27","Aink28"]},{id:"muḻakkam aḻal",source:"muḻakkam",target:"aḻal",strength:.8618399333890082,citations:["Aink307","Aink320"]},{id:"eri kavar",source:"eri",target:"kavar",strength:.8618399333890082,citations:["Aink324","Aink360"]},{id:"pall itaḻ",source:"pall",target:"itaḻ",strength:.8618399333890082,citations:["Aink334","Aink351"]},{id:"col uṇarntōr",source:"col",target:"uṇarntōr",strength:.8618399333890082,citations:["Aink38","Aink41"]},{id:"amma tōḻaṉ",source:"amma",target:"tōḻaṉ",strength:.8837143055411883,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink221","Aink31","Aink32","Aink33","Aink331","Aink332","Aink333","Aink334","Aink335","Aink336","Aink337","Aink338","Aink339","Aink34","Aink340","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"yaḻi putup",source:"yaḻi",target:"putup",strength:.8847684575745612,citations:["Aink53","Aink78"]},{id:"tēṉūr vivaḷ",source:"tēṉūr",target:"vivaḷ",strength:.8877196507999777,citations:["Aink54","Aink55","Aink57"]},{id:"vēṭṭōḷ yām",source:"vēṭṭōḷ",target:"yām",strength:.8907103955657583,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"kavar veṉṟūḻ",source:"kavar",target:"veṉṟūḻ",strength:.8980184603385948,citations:["Aink324","Aink360"]},{id:"karai cēr",source:"karai",target:"cēr",strength:.9128307032197108,citations:["Aink12","Aink74"]},{id:"mell iyal",source:"mell",target:"iyal",strength:.9128307032197108,citations:["Aink304","Aink308"]},{id:"puli vaḻakku",source:"puli",target:"vaḻakku",strength:.9128307032197108,citations:["Aink316","Aink386"]},{id:"ukakkum mālai",source:"ukakkum",target:"mālai",strength:.9128307032197108,citations:["Aink339","Aink378"]},{id:"vāval mālai",source:"vāval",target:"mālai",strength:.9128307032197108,citations:["Aink339","Aink378"]},{id:"yiṉiya vākuka",source:"yiṉiya",target:"vākuka",strength:.9128307032197108,citations:["Aink371","Aink398"]},{id:"malir niṟai",source:"malir",target:"niṟai",strength:.9323075365839424,citations:["Aink15","Aink42","Aink72"]},{id:"veṉa yāy",source:"veṉa",target:"yāy",strength:.9429676974897666,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"pūk kañal",source:"pūk",target:"kañal",strength:.9441399487869444,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"ekkar ñāḻal",source:"ekkar",target:"ñāḻal",strength:.9481705660068228,citations:["Aink141","Aink142","Aink143","Aink144","Aink145"]},{id:"muḷḷi vēr",source:"muḷḷi",target:"vēr",strength:.9490092301692974,citations:["Aink22","Aink23"]},{id:"ṇakam maṇ",source:"ṇakam",target:"maṇ",strength:.9490092301692974,citations:["Aink27","Aink30"]},{id:"titti yalkul",source:"titti",target:"yalkul",strength:.9490092301692974,citations:["Aink29","Aink72"]},{id:"ciṟai yaḻi",source:"ciṟai",target:"yaḻi",strength:.9490092301692974,citations:["Aink53","Aink78"]},{id:"kaḻaṉit tāmarai",source:"kaḻaṉit",target:"tāmarai",strength:.9490092301692974,citations:["Aink53","Aink94"]},{id:"vēṭṭōḷ yāy",source:"vēṭṭōḷ",target:"yāy",strength:.9586326144208371,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"veṉa vēṭṭōḷ",source:"veṉa",target:"vēṭṭōḷ",strength:.98365910287693,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"yātaṉ yaviṉi",source:"yātaṉ",target:"yaviṉi",strength:1,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"vāval ukakkum",source:"vāval",target:"ukakkum",strength:1,citations:["Aink339","Aink378"]},{id:"porip puṉku",source:"porip",target:"puṉku",strength:1,citations:["Aink347","Aink368"]}],ka={nodes:Ob,links:Ib},Nb=i=>{const t=1+200/Math.hypot(i.x,i.y,i.z),n=i.x||i.y||i.z?{x:i.x*t,y:i.y*t,z:i.z*t}:{x:0,y:0,z:200};Ma.cameraPosition(n,i,1e3)},Ma=yb(),Ub=()=>{const i=new Map([["adjective","#66c2a5"],["noun","#fc8d62"],["pronoun","#8da0cb"],["verb","#e78ac3"],["other","#a6d854"]]),e=document.getElementById("panellegend");e.innerHTML=[...i].map(n=>`<div><input type="checkbox" name="${n[0]}" checked autocomplete="off"/><label><span style="color:${n[1]}; font-size: 150%">●</span> ${n[0]}</div>`).join("")+'<div id="solonodes"><input type="checkbox" name="solonodes" checked autocomplete="off"/><label>Show unconnected nodes</label></div>';const t=structuredClone(ka.links).filter(n=>n.strength>=.45);Ma(document.getElementById("colgraph")).graphData({nodes:ka.nodes,links:t}).nodeLabel(n=>`${n.size} occurences`).nodeThreeObject(n=>{const r=new Db(n.id);return r.material.depthWrite=!1,r.color=i.get(n.type)||i.get("other"),r.textHeight=n.size/2<8?8:n.size/2,r}).linkWidth(n=>n.strength*5).linkOpacity(.3).linkDirectionalArrowLength(5).linkCurvature(n=>n.curvature||0).linkLabel(n=>`${n.citations.join(", ")} (NPMI: ${n.strength.toPrecision(4)})`).onNodeClick(Nb),Ma.d3Force("link").distance(n=>40/n.strength)},Fb=i=>{const e=document.getElementById("panel");e.style.display!=="flex"?(e.animate([{marginTop:"-25px"},{marginTop:"0px"}],{duration:200,iterations:1}),e.style.display="flex",i.target.textContent="⇧"):(e.animate([{marginTop:"0px"},{marginTop:"-25px"}],{duration:200,iterations:1}),setTimeout(()=>e.style.display="none",200),i.target.textContent="⇩")},Bb=i=>{const e=new Set;for(const t of i)e.add(t.source),e.add(t.target);return e},Hb=()=>{const i={};i.nodes=ka.nodes,i.links=structuredClone(ka.links);const e=document.getElementById("npmi").value;i.links=i.links.filter(r=>r.strength>=e);const t=document.getElementById("panellegend").querySelectorAll('input:not([name="solonodes"])'),n=new Set([...t].filter(r=>r.checked).map(r=>r.getAttribute("name")));if(n.size!==t.length){i.nodes=i.nodes.filter(a=>n.has(a.type));const r=new Set(i.nodes.map(a=>a.id));i.links=i.links.filter(a=>r.has(a.target)&&r.has(a.source))}if(!document.querySelector('input[name="solonodes"]').checked){const r=Bb(i.links);i.nodes=i.nodes.filter(a=>r.has(a.id))}Ma.graphData(i)};document.getElementById("paneltoggle").addEventListener("click",Fb);document.getElementById("graphupdate").addEventListener("click",Hb);Ub();
