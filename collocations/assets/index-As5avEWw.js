...
Object.defineProperty(this, '{var}', {
  ...
  Vector.prototype.reset = function () {
    ${t("this.{var} = ",{join:""})}0;
  };`}var Ay=xr.exports,Gn={exports:{}};const zo=Vi,On=vd;Gn.exports=My;Gn.exports.generateQuadTreeFunctionBody=Ad;Gn.exports.getInsertStackCode=Td;Gn.exports.getQuadNodeCode=wd;Gn.exports.isSamePosition=Md;Gn.exports.getChildBodyCode=Ed;Gn.exports.setChildBodyCode=Sd;function My(n){let e=Ad(n);return new Function(e)()}function Ad(n){let e=zo(n),t=Math.pow(2,n);return`
${Td()}
${wd(n)}
${Md(n)}
${Ed(n)}
...
`)}}function Md(n){let e=zo(n);return`
...
`)}}function wd(n){let e=zo(n),t=Math.pow(2,n);var i=`
function QuadNode() {
...
`}var Sy=Gn.exports,Lo={exports:{}};Lo.exports=wy;Lo.exports.generateFunctionBody=kd;const Ey=Vi;function wy(n){let e=kd(n);return new Function("bodies","settings","random",e)}function kd(n){let e=Ey(n);return`
  var boundingBox = {
...
`}var Ty=Lo.exports,Do={exports:{}};const ky=Vi;Do.exports=Cy;Do.exports.generateCreateDragForceFunctionBody=Cd;function Cy(n){let e=Cd(n);return new Function("options",e)}function Cd(n){return`
...
`}var Ry=Do.exports,Oo={exports:{}};const Py=Vi;Oo.exports=zy;Oo.exports.generateCreateSpringForceFunctionBody=Rd;function zy(n){let e=Rd(n);return new Function("options","random",e)}function Rd(n){let e=Py(n);return`
...
`}var Ly=Oo.exports,Io={exports:{}};const Dy=Vi;Io.exports=Oy;Io.exports.generateIntegratorFunctionBody=Pd;function Oy(n){let e=Pd(n);return new Function("bodies","timeStep","adaptiveTimeStepWeight",e)}function Pd(n){let e=Dy(n);return`
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function zA(n,e){if(typeof n!="object"||n===null)return n;var t=n[Symbol.toPrimitive];if(t!==void 0){var i=t.call(n,e||"default");if(typeof i!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function LA(n){var e=zA(n,"string");return typeof e=="symbol"?e:String(e)}var ki=typeof window<"u"&&window.THREE?window.THREE:{LinearFilter:Ft,Sprite:w0,SpriteMaterial:Zu,SRGBColorSpace:ut,Texture:Pt},DA=function(n){AA(t,n);var e=wA(t);function t(){var i,r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"",a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:10,s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"rgba(255, 255, 255, 1)";return xA(this,t),i=e.call(this,new ki.SpriteMaterial),i._text="".concat(r),i._textHeight=a,i._color=s,i._backgroundColor=!1,i._padding=0,i._borderWidth=0,i._borderRadius=0,i._borderColor="white",i._strokeWidth=0,i._strokeColor="white",i._fontFace="system-ui",i._fontSize=90,i._fontWeight="normal",i._canvas=document.createElement("canvas"),i._genCanvas(),i}return bA(t,[{key:"text",get:function(){return this._text},set:function(r){this._text=r,this._genCanvas()}},{key:"textHeight",get:function(){return this._textHeight},set:function(r){this._textHeight=r,this._genCanvas()}},{key:"color",get:function(){return this._color},set:function(r){this._color=r,this._genCanvas()}},{key:"backgroundColor",get:function(){return this._backgroundColor},set:function(r){this._backgroundColor=r,this._genCanvas()}},{key:"padding",get:function(){return this._padding},set:function(r){this._padding=r,this._genCanvas()}},{key:"borderWidth",get:function(){return this._borderWidth},set:function(r){this._borderWidth=r,this._genCanvas()}},{key:"borderRadius",get:function(){return this._borderRadius},set:function(r){this._borderRadius=r,this._genCanvas()}},{key:"borderColor",get:function(){return this._borderColor},set:function(r){this._borderColor=r,this._genCanvas()}},{key:"fontFace",get:function(){return this._fontFace},set:function(r){this._fontFace=r,this._genCanvas()}},{key:"fontSize",get:function(){return this._fontSize},set:function(r){this._fontSize=r,this._genCanvas()}},{key:"fontWeight",get:function(){return this._fontWeight},set:function(r){this._fontWeight=r,this._genCanvas()}},{key:"strokeWidth",get:function(){return this._strokeWidth},set:function(r){this._strokeWidth=r,this._genCanvas()}},{key:"strokeColor",get:function(){return this._strokeColor},set:function(r){this._strokeColor=r,this._genCanvas()}},{key:"_genCanvas",value:function(){var r=this,a=this._canvas,s=a.getContext("2d"),o=Array.isArray(this.borderWidth)?this.borderWidth:[this.borderWidth,this.borderWidth],c=o.map(function(P){return P*r.fontSize*.1}),l=Array.isArray(this.borderRadius)?this.borderRadius:[this.borderRadius,this.borderRadius,this.borderRadius,this.borderRadius],u=l.map(function(P){return P*r.fontSize*.1}),d=Array.isArray(this.padding)?this.padding:[this.padding,this.padding],f=d.map(function(P){return P*r.fontSize*.1}),m=this.text.split(`
`),g="".concat(this.fontWeight," ").concat(this.fontSize,"px ").concat(this.fontFace);s.font=g;var v=Math.max.apply(Math,na(m.map(function(P){return s.measureText(P).width}))),p=this.fontSize*m.length;if(a.width=v+c[0]*2+f[0]*2,a.height=p+c[1]*2+f[1]*2,this.borderWidth){if(s.strokeStyle=this.borderColor,c[0]){var h=c[0]/2;s.lineWidth=c[0],s.beginPath(),s.moveTo(h,u[0]),s.lineTo(h,a.height-u[3]),s.moveTo(a.width-h,u[1]),s.lineTo(a.width-h,a.height-u[2]),s.stroke()}if(c[1]){var x=c[1]/2;s.lineWidth=c[1],s.beginPath(),s.moveTo(Math.max(c[0],u[0]),x),s.lineTo(a.width-Math.max(c[0],u[1]),x),s.moveTo(Math.max(c[0],u[3]),a.height-x),s.lineTo(a.width-Math.max(c[0],u[2]),a.height-x),s.stroke()}if(this.borderRadius){var _=Math.max.apply(Math,na(c)),y=_/2;s.lineWidth=_,s.beginPath(),[!!u[0]&&[u[0],y,y,u[0]],!!u[1]&&[a.width-u[1],a.width-y,y,u[1]],!!u[2]&&[a.width-u[2],a.width-y,a.height-y,a.height-u[2]],!!u[3]&&[u[3],y,a.height-y,a.height-u[3]]].filter(function(P){return P}).forEach(function(P){var b=yu(P,4),w=b[0],N=b[1],U=b[2],ee=b[3];s.moveTo(w,U),s.quadraticCurveTo(N,U,N,ee)}),s.stroke()}}this.backgroundColor&&(s.fillStyle=this.backgroundColor,this.borderRadius?(s.beginPath(),s.moveTo(c[0],u[0]),[[c[0],u[0],a.width-u[1],c[1],c[1],c[1]],[a.width-c[0],a.width-c[0],a.width-c[0],c[1],u[1],a.height-u[2]],[a.width-c[0],a.width-u[2],u[3],a.height-c[1],a.height-c[1],a.height-c[1]],[c[0],c[0],c[0],a.height-c[1],a.height-u[3],u[0]]].forEach(function(P){var b=yu(P,6),w=b[0],N=b[1],U=b[2],ee=b[3],k=b[4],R=b[5];s.quadraticCurveTo(w,ee,N,k),s.lineTo(U,R)}),s.closePath(),s.fill()):s.fillRect(c[0],c[1],a.width-c[0]*2,a.height-c[1]*2)),s.translate.apply(s,na(c)),s.translate.apply(s,na(f)),s.font=g,s.fillStyle=this.color,s.textBaseline="bottom";var A=this.strokeWidth>0;A&&(s.lineWidth=this.strokeWidth*this.fontSize/10,s.strokeStyle=this.strokeColor),m.forEach(function(P,b){var w=(v-s.measureText(P).width)/2,N=(b+1)*r.fontSize;A&&s.strokeText(P,w,N),s.fillText(P,w,N)}),this.material.map&&this.material.map.dispose();var M=this.material.map=new ki.Texture(a);M.minFilter=ki.LinearFilter,M.colorSpace=ki.SRGBColorSpace,M.needsUpdate=!0;var E=this.textHeight*m.length+o[1]*2+d[1]*2;this.scale.set(E*a.width/a.height,E,0)}},{key:"clone",value:function(){return new this.constructor(this.text,this.textHeight,this.color).copy(this)}},{key:"copy",value:function(r){return ki.Sprite.prototype.copy.call(this,r),this.color=r.color,this.backgroundColor=r.backgroundColor,this.padding=r.padding,this.borderWidth=r.borderWidth,this.borderColor=r.borderColor,this.fontFace=r.fontFace,this.fontSize=r.fontSize,this.fontWeight=r.fontWeight,this.strokeWidth=r.strokeWidth,this.strokeColor=r.strokeColor,this}}]),t}(ki.Sprite);const OA=[{id:"nīl",size:6,type:"noun"},{id:"mēṉi",size:5,type:"noun"},{id:"vāl",size:5,type:"noun"},{id:"iḻai",size:8,type:"noun"},{id:"pākattu",size:1},{id:"oru",size:4,type:"noun"},{id:"iru",size:4,type:"noun"},{id:"tāḷ",size:2,type:"noun"},{id:"niḻal",size:3,type:"noun"},{id:"kīḻ",size:1},{id:"mu",size:1,type:"noun"},{id:"vaku",size:1,type:"verb"},{id:"ulakam",size:1,type:"noun"},{id:"vāḻ",size:63,type:"verb"},{id:"yātaṉ",size:10},{id:"yaviṉi",size:10},{id:"nel",size:9,type:"noun"},{id:"pal",size:22,type:"noun"},{id:"poli",size:2,type:"noun"},{id:"poṉ",size:6,type:"noun"},{id:"peru(m)",size:26,type:"adjective"},{id:"ciṟa",size:8,type:"verb"},{id:"veṉa",size:9},{id:"vēṭṭōḷ",size:10},{id:"yāy",size:11,type:"noun"},{id:"yām",size:18,type:"pronoun"},{id:"naṉai",size:2,type:"noun"},{id:"kāñcic",size:1},{id:"ciṉai",size:5,type:"verb"},{id:"ciṟu(m)",size:6,type:"adjective"},{id:"miṉ",size:5,type:"noun"},{id:"yāṇar",size:9,type:"noun"},{id:"ūr",size:46,type:"noun"},{id:"pāṇ",size:21,type:"noun"},{id:"māri",size:3,type:"noun"},{id:"vāy",size:3,type:"noun"},{id:"vaḷam",size:4,type:"noun"},{id:"naṉi",size:4},{id:"pū(m)",size:18,type:"noun"},{id:"māattup",size:2},{id:"pulavu",size:2,type:"noun"},{id:"taṭpam",size:33,type:"noun"},{id:"tuṟai",size:30,type:"noun"},{id:"yūraṉ",size:20},{id:"tāṉ",size:19,type:"pronoun"},{id:"koḷ",size:13,type:"verb"},{id:"cel",size:14,type:"noun"},{id:"puṉal",size:17,type:"noun"},{id:"aṭu",size:8,type:"verb"},{id:"maka",size:27,type:"noun"},{id:"iṭu",size:1,type:"verb"},{id:"voḷ",size:4},{id:"ḷiḻai",size:1},{id:"maṇal",size:6,type:"noun"},{id:"cimaiyattu",size:1},{id:"erumai",size:6,type:"noun"},{id:"kiḷai",size:1,type:"noun"},{id:"i-",size:26,type:"pronoun"},{id:"narampu",size:1,type:"noun"},{id:"aṉṉai",size:28,type:"noun"},{id:"vēṇṭu",size:15,type:"verb"},{id:"yutuk",size:1},{id:"kaṇ",size:33,type:"noun"},{id:"ēr",size:3,type:"noun"},{id:"koṭip",size:3},{id:"pācu",size:2},{id:"aṭumpu",size:1,type:"noun"},{id:"pari",size:4,type:"noun"},{id:"vūrpu",size:1},{id:"iḻi",size:2,type:"verb"},{id:"neytal",size:5,type:"noun"},{id:"mayakkam",size:2},{id:"varavu",size:20,type:"noun"},{id:"nī",size:52,type:"pronoun"},{id:"pūp",size:3},{id:"pōl",size:8,type:"verb"},{id:"uṇ",size:13},{id:"maruvu",size:1,type:"verb"},{id:"no/nō",size:6,type:"verb"},{id:"maruntu",size:4,type:"noun"},{id:"ākkam",size:32,type:"noun"},{id:"namm",size:3},{id:"niṟap",size:1},{id:"kaṭal",size:8,type:"noun"},{id:"puḷ",size:2,type:"noun"},{id:"°āṉ",size:1,type:"verb"},{id:"tuṉpam",size:1,type:"noun"},{id:"uṟu",size:7,type:"verb"},{id:"tuyara",size:1},{id:"nīkku",size:2,type:"verb"},{id:"viṉpu",size:1},{id:"vicaikkum",size:1},{id:"a-",size:40,type:"pronoun"},{id:"tēr",size:6,type:"noun"},{id:"puṉṉai",size:3,type:"noun"},{id:"ñāḻal",size:6,type:"noun"},{id:"taṇṇ",size:3},{id:"am",size:6,type:"adjective"},{id:"amaintaṉaṉ",size:1},{id:"amai",size:6,type:"noun"},{id:"mā",size:6,type:"adjective"},{id:"ūrp",size:2},{id:"maṭi",size:1,type:"noun"},{id:"poḻutu",size:5,type:"noun"},{id:"nal",size:34,type:"adjective"},{id:"mikac",size:2},{id:"cā",size:4,type:"verb"},{id:"naḷḷeṉ",size:2,type:"verb"},{id:"viyal",size:2,type:"noun"},{id:"tērc",size:1},{id:"celvak",size:1},{id:"koṇkaṉ",size:13,type:"noun"},{id:"muḻakkam",size:2},{id:"tirai",size:4,type:"verb"},{id:"taru",size:1},{id:"muttam",size:1,type:"noun"},{id:"veḷ",size:14,type:"adjective"},{id:"imai",size:1,type:"noun"},{id:"eṉap",size:5},{id:"civantaṉṟu",size:1},{id:"yavar",size:1},{id:"nāṭṭut",size:1},{id:"tutik",size:1},{id:"kāl",size:11,type:"noun"},{id:"aṉṉam",size:1,type:"noun"},{id:"tuṇai",size:8,type:"noun"},{id:"miti",size:1,type:"noun"},{id:"vaḷaiyiṉum",size:1},{id:"ilaṅku",size:2,type:"verb"},{id:"kaliḻ",size:2,type:"verb"},{id:"ākam",size:1,type:"noun"},{id:"yeṉ",size:2},{id:"tōḻaṉ",size:26},{id:"cuṭar",size:5,type:"noun"},{id:"nutal",size:9,type:"noun"},{id:"pacappac",size:2},{id:"cāayp",size:1},{id:"paṭar",size:3,type:"noun"},{id:"mel",size:10,type:"adjective"},{id:"paṭu",size:5,type:"verb"},{id:"kēḷ",size:18,type:"verb"},{id:"tuñcu",size:4,type:"verb"},{id:"kaḻi",size:5},{id:"muṇṭakam",size:1,type:"noun"},{id:"malar",size:16,type:"noun"},{id:"cērppu",size:2,type:"noun"},{id:"em",size:9,type:"pronoun"},{id:"tōḷ",size:9,type:"noun"},{id:"tuṟa",size:3,type:"verb"},{id:"e-",size:17,type:"pronoun"},{id:"kol",size:3,type:"verb"},{id:"nīrp",size:3},{id:"tūmpu",size:3,type:"noun"},{id:"pūk",size:6},{id:"keḻu",size:7},{id:"yevaṉ",size:2},{id:"nāḷ",size:7,type:"noun"},{id:"maṉai",size:10,type:"noun"},{id:"naṭu",size:2,type:"verb"},{id:"vayalai",size:1,type:"noun"},{id:"vēḻam",size:8,type:"noun"},{id:"cuṟṟam",size:1,type:"noun"},{id:"koṭu(m)",size:3,type:"adjective"},{id:"nāṇ",size:2,type:"noun"},{id:"nallaṉ",size:1},{id:"yallaṉ",size:1},{id:"taṭa(m)",size:5,type:"adjective"},{id:"amma",size:24},{id:"cūḻ",size:1,type:"verb"},{id:"maruṅku",size:1,type:"noun"},{id:"iraik",size:1},{id:"koḷīic",size:1},{id:"ciṉaik",size:1},{id:"kayal",size:3,type:"noun"},{id:"māy",size:1,type:"verb"},{id:"pirintum",size:1},{id:"nām",size:12,type:"pronoun"},{id:"yarum",size:3},{id:"tavam",size:1,type:"noun"},{id:"ilaic",size:1},{id:"cerunti",size:1,type:"noun"},{id:"tāvu",size:1,type:"verb"},{id:"virum",size:4},{id:"kaḻic",size:1},{id:"varak",size:1},{id:"maṟantōm",size:1},{id:"neṉṉal",size:1},{id:"ōkku",size:3,type:"verb"},{id:"uṭai",size:3,type:"noun"},{id:"ūrār",size:1},{id:"peṇ",size:8,type:"noun"},{id:"eṉ",size:19,type:"pronoun"},{id:"moḻi",size:3,type:"noun"},{id:"veṉṉai",size:1},{id:"yatu",size:1},{id:"pai",size:3},{id:"vem",size:8},{id:"mai",size:2,type:"noun"},{id:"nērēm",size:1},{id:"celkuvam",size:1},{id:"nārai",size:3,type:"noun"},{id:"yiraṟṟum",size:1},{id:"maṭalam",size:1},{id:"peṇṇai",size:1,type:"noun"},{id:"nuṇ",size:3,type:"adjective"},{id:"aṭai",size:2,type:"noun"},{id:"karai",size:4,type:"noun"},{id:"nammōṭu",size:1},{id:"āṭu",size:7,type:"noun"},{id:"ṇam",size:1},{id:"maṟaii",size:1},{id:"yaṉṉai",size:1},{id:"kaṭi",size:3,type:"noun"},{id:"aḻu",size:1,type:"verb"},{id:"nīla",size:1},{id:"kūmpum",size:1},{id:"mālai",size:2,type:"noun"},{id:"yaṉṉa",size:7},{id:"yaṇi",size:1},{id:"toṟum",size:2},{id:"vari",size:4,type:"noun"},{id:"maṇi",size:5,type:"noun"},{id:"nīrc",size:1},{id:"yāṉ",size:3,type:"pronoun"},{id:"aṟam",size:1,type:"noun"},{id:"il",size:13,type:"noun"},{id:"āḷ",size:1,type:"noun"},{id:"ciṉavuveṉ",size:1},{id:"takaikkuveṉ",size:1},{id:"ceṉṟaṉeṉ",size:1},{id:"piṉ",size:2},{id:"niṉai",size:1,type:"verb"},{id:"iraṅkip",size:1},{id:"eyyāmaiyiṉ",size:1},{id:"ētil",size:1,type:"adjective"},{id:"paṟṟu",size:2,type:"noun"},{id:"yaṉpu",size:1},{id:"pulak",size:2},{id:"cēr",size:2,type:"verb"},{id:"karuppu",size:6,type:"adjective"},{id:"āṟṟuka",size:1},{id:"tōṟka",size:1},{id:"vel",size:6,type:"verb"},{id:"miku",size:3,type:"verb"},{id:"vāyiṉa",size:3},{id:"vaḷiya",size:1},{id:"mal",size:2,type:"noun"},{id:"iru(m)",size:3,type:"adjective"},{id:"nīr",size:6,type:"pronoun"},{id:"aṟal",size:1,type:"noun"},{id:"viri",size:3,type:"verb"},{id:"lam",size:1},{id:"pulampu",size:2,type:"noun"},{id:"al",size:21,type:"verb"},{id:"muṇṭakak",size:1},{id:"kōtai",size:2,type:"noun"},{id:"naṉaiyat",size:1},{id:"teḷ",size:4,type:"adjective"},{id:"tiraip",size:1},{id:"pauvam",size:1,type:"noun"},{id:"yoḷḷ",size:1},{id:"yuyar",size:1},{id:"vīḻ",size:1,type:"noun"},{id:"veḷḷām ",size:1},{id:"yoḷ",size:5},{id:"āy",size:2,type:"verb"},{id:"ārppat",size:1},{id:"vaṇṭal",size:2,type:"noun"},{id:"pāvai",size:4,type:"noun"},{id:"vauvu",size:2,type:"verb"},{id:"poṭi",size:1},{id:"yaḷaiik",size:1},{id:"vauva",size:1},{id:"vuṇ",size:3},{id:"civa",size:4,type:"verb"},{id:"yuṇ",size:2},{id:"vaṇṭu",size:7,type:"noun"},{id:"iṉam",size:2,type:"noun"},{id:"moyppat",size:1},{id:"tumpai",size:1},{id:"yiḷa",size:1},{id:"mulai",size:5,type:"noun"},{id:"pūṭṭu",size:2,type:"noun"},{id:"yuṟāa",size:1},{id:"vaṟu(m)",size:2,type:"adjective"},{id:"maṭāa",size:1},{id:"vuṇṇāp",size:1},{id:"yuṭai",size:1},{id:"poṅku",size:1,type:"verb"},{id:"uḷai",size:1,type:"noun"},{id:"vaṭai",size:1},{id:"pakar",size:1,type:"verb"},{id:"yāmam",size:1,type:"noun"},{id:"koṇkaṉatu",size:1},{id:"naṭpu",size:1,type:"noun"},{id:"tillai",size:1,type:"noun"},{id:"vēli",size:1,type:"noun"},{id:"yiv",size:1},{id:"vūrk",size:1},{id:"kal",size:2,type:"noun"},{id:"leṉ",size:1},{id:"kauvai",size:1,type:"noun"},{id:"yarumpu",size:1},{id:"mali",size:3,type:"verb"},{id:"kāṉal",size:2,type:"noun"},{id:"iv",size:2},{id:"vūr",size:4},{id:"cey",size:13,type:"noun"},{id:"vāṉātu",size:1},{id:"mell",size:2},{id:"piri",size:6,type:"verb"},{id:"pull",size:2},{id:"eṉṟaṉa",size:1},{id:"puri",size:1,type:"noun"},{id:"kāṇmati",size:1},{id:"kaḻip",size:1},{id:"pāy",size:5,type:"verb"},{id:"neṭu(m)",size:9,type:"adjective"},{id:"tērk",size:2},{id:"koṇkaṉōṭu",size:1},{id:"paṇait",size:2},{id:"ai",size:1,type:"noun"},{id:"akal",size:4,type:"noun"},{id:"valkul",size:1},{id:"kaṇṇi",size:1,type:"noun"},{id:"nēr",size:2,type:"noun"},{id:"kōḷ",size:1,type:"noun"},{id:"vaḷai",size:5,type:"noun"},{id:"nekiḻ",size:3,type:"verb"},{id:"tuṟaivaṟkuc",size:1},{id:"niṉṉ",size:1},{id:"viṉavu",size:1,type:"verb"},{id:"numm",size:1},{id:"ūrt",size:1},{id:"tiṇ",size:4,type:"adjective"},{id:"koṇkaṉai",size:1},{id:"naya",size:5,type:"verb"},{id:"paṇṭait",size:1},{id:"tām",size:4,type:"pronoun"},{id:"paṇpu",size:1,type:"noun"},{id:"viv",size:1},{id:"aṉpu",size:2,type:"noun"},{id:"kaḻaṟu",size:1,type:"verb"},{id:"vayiṉ",size:3,type:"noun"},{id:"māṇ",size:5,type:"noun"},{id:"maruṭṭum",size:1},{id:"tīṇṭu",size:1,type:"verb"},{id:"yayala",size:1},{id:"vaṭuk",size:1},{id:"mā(m)",size:4,type:"noun"},{id:"val",size:5,type:"noun"},{id:"taḷir",size:2,type:"noun"},{id:"nuṭaṅku",size:4,type:"verb"},{id:"aṇit",size:1},{id:"mārpu",size:9,type:"noun"},{id:"paṉit",size:1},{id:"tuyil",size:1,type:"noun"},{id:"mati",size:1,type:"noun"},{id:"yuraittaṟku",size:1},{id:"uri-",size:3},{id:"viṟai",size:1},{id:"el",size:3,type:"noun"},{id:"ekkar",size:6,type:"noun"},{id:"ceruntiyoṭu",size:2},{id:"kamaḻat",size:1},{id:"tuvalait",size:1},{id:"tuḷi",size:1,type:"noun"},{id:"vīcip",size:1},{id:"paca",size:9,type:"verb"},{id:"paṉi",size:2,type:"noun"},{id:"iṟakku",size:1,type:"verb"},{id:"iṇarp",size:1},{id:"ḷiṟai",size:1},{id:"kūr",size:2,type:"noun"},{id:"yuḷḷēṉ",size:1},{id:"paṭi",size:1,type:"noun"},{id:"puḷḷ",size:1},{id:"imiḻ",size:1,type:"noun"},{id:"yiṉiya",size:1},{id:"nil",size:4,type:"verb"},{id:"muṉi",size:2,type:"noun"},{id:"vivaḷ",size:7},{id:"iṇar",size:3,type:"noun"},{id:"potumpart",size:1},{id:"taṉik",size:1},{id:"kuruku",size:5,type:"noun"},{id:"uṟaṅku",size:1,type:"verb"},{id:"tuṟaivarku",size:1},{id:"iṉip",size:1},{id:"ciṟi",size:1},{id:"yilaip",size:1},{id:"yōtam",size:1},{id:"vāṅku",size:1,type:"verb"},{id:"malir",size:3,type:"verb"},{id:"niṟai",size:5,type:"noun"},{id:"virumpiya",size:1},{id:"taḻaip",size:1},{id:"makaḷirkkup",size:1},{id:"puṇar",size:5,type:"verb"},{id:"yutavum",size:1},{id:"mūtu",size:2},{id:"vēḻattut",size:2},{id:"uṭait",size:1},{id:"tiraḷ",size:1,type:"noun"},{id:"toḻumakaḷir",size:1},{id:"añcaṉam",size:1},{id:"pey",size:3,type:"verb"},{id:"kañal",size:4,type:"verb"},{id:"yuḷḷip",size:1},{id:"putal",size:1,type:"noun"},{id:"micai",size:1,type:"noun"},{id:"vicumpu",size:2,type:"noun"},{id:"tōṟṟam",size:3,type:"noun"},{id:"putu",size:1,type:"adjective"},{id:"mēvu",size:1,type:"noun"},{id:"maṭa(m)",size:6,type:"noun"},{id:"cāy",size:1,type:"noun"},{id:"alamvaru",size:2,type:"verb"},{id:"kaḻaṉi",size:9,type:"noun"},{id:"poru",size:1,type:"verb"},{id:"ṇaḻap",size:1},{id:"putup",size:5},{id:"meym",size:1},{id:"maṇa",size:3,type:"verb"},{id:"kamaḻ",size:1,type:"verb"},{id:"poḻil",size:2,type:"noun"},{id:"ḷuḷai",size:1},{id:"cī",size:2,type:"verb"},{id:"kalakkam",size:2,type:"noun"},{id:"viḷaika",size:1},{id:"vayal",size:3,type:"noun"},{id:"viravalar",size:1},{id:"litaḻ",size:1},{id:"nikar",size:1,type:"noun"},{id:"vaḻi",size:1,type:"noun"},{id:"vaḻic",size:1},{id:"aṟu",size:6,type:"noun"},{id:"cil",size:3,type:"noun"},{id:"vam",size:3},{id:"ciṟait",size:1},{id:"tumpi",size:1,type:"noun"},{id:"nūṟṟu",size:1},{id:"itaḻt",size:1},{id:"tāmaraip",size:1},{id:"pūc",size:1},{id:"kāmpu",size:1,type:"noun"},{id:"naṇṇu",size:2,type:"verb"},{id:"yūraṉai",size:2},{id:"yuḷḷi",size:2},{id:"ṉiṟai",size:1},{id:"yēr",size:1},{id:"yeṉṉai",size:2},{id:"tāṉum",size:1},{id:"malaintāṉ",size:1},{id:"emakkum",size:1},{id:"taḻāi",size:1},{id:"yāyiṉa",size:1},{id:"vī",size:2,type:"noun"},{id:"yarumpiṉavē",size:1},{id:"yeṉṉa",size:1},{id:"maram",size:1,type:"noun"},{id:"cāral",size:1,type:"noun"},{id:"avvē",size:1},{id:"notumal",size:1,type:"noun"},{id:"varaiviṉkaṇ",size:1},{id:"cevili",size:1,type:"noun"},{id:"āṟṟāl",size:1},{id:"talaimakaḷ",size:4},{id:"aṟattoṭu",size:1},{id:"pārppaṉak",size:1},{id:"kuṟu(m)",size:3,type:"adjective"},{id:"makap",size:1},{id:"pōlat",size:1},{id:"kuṭumit",size:1},{id:"talai",size:2},{id:"malai",size:2,type:"noun"},{id:"nāṭu",size:5,type:"noun"},{id:"talaimakaṉ",size:2},{id:"varaital",size:1},{id:"vēṇṭit",size:1},{id:"varukiṉṟamaik",size:1},{id:"yuvanta",size:1},{id:"vuḷḷattaḷ",size:1},{id:"āyt",size:1},{id:"talaimakaṭkuk",size:1},{id:"paṭappait",size:1},{id:"tēm",size:2,type:"noun"},{id:"pāl",size:3,type:"noun"},{id:"iṉum",size:1},{id:"iṉ",size:5,type:"adjective"},{id:"vavar",size:2},{id:"nāṭṭu",size:3,type:"verb"},{id:"uvalaik",size:1},{id:"kūval",size:1,type:"noun"},{id:"kīḻa",size:1},{id:"eñcu",size:1,type:"verb"},{id:"kaliḻi",size:1},{id:"-uṭaṉ",size:2},{id:"pōy",size:1},{id:"mīḷ",size:1,type:"verb"},{id:"eṅṅaṉam",size:1},{id:"nukarntāy",size:1},{id:"eṉak",size:4},{id:"aḵtu",size:2},{id:"varaiyara",size:1},{id:"nirai",size:1,type:"noun"},{id:"kuḻuvu",size:1,type:"verb"},{id:"peyar",size:4,type:"noun"},{id:"uḻi",size:2,type:"noun"},{id:"tavir",size:1,type:"verb"},{id:"nōkkam",size:2,type:"noun"},{id:"tīyēṉ",size:1},{id:"muḷḷi",size:3,type:"noun"},{id:"nīṭṭu",size:2,type:"verb"},{id:"mutu",size:1,type:"adjective"},{id:"karaip",size:1},{id:"puḷḷik",size:3},{id:"kaḷvaṉ",size:9,type:"noun"},{id:"āmpal",size:6,type:"noun"},{id:"pacappatu",size:2},{id:"aḷḷal",size:1,type:"noun"},{id:"vēr",size:2,type:"noun"},{id:"aḷaic",size:1},{id:"col",size:4,type:"noun"},{id:"nīyēṉ",size:1},{id:"kātal",size:3,type:"noun"},{id:"veṉṉ",size:1},{id:"kaviṉ",size:3,type:"noun"},{id:"tolai",size:1,type:"verb"},{id:"vaḻit",size:1},{id:"taṇantu",size:1},{id:"varaitaṟku",size:1},{id:"vēṇṭuvaṉa",size:1},{id:"muṭi",size:1,type:"noun"},{id:"kūṟak",size:1},{id:"ciṟaippuṟattāṉ",size:1},{id:"āyk",size:1},{id:"kēṭpat",size:1},{id:"aḷaik",size:1},{id:"āṭṭip",size:1},{id:"kuṟṟu",size:2,type:"verb"},{id:"eytu",size:1,type:"verb"},{id:"aṇi",size:8,type:"noun"},{id:"tēṟṟam",size:1},{id:"nap",size:1},{id:"iṉit",size:1},{id:"tākku",size:1,type:"verb"},{id:"aṇaṅku",size:3,type:"noun"},{id:"tāy",size:2,type:"noun"},{id:"cāp",size:1},{id:"piṟa",size:3,type:"noun"},{id:"kaḷvaṉoṭu",size:1},{id:"piḷḷai",size:1,type:"noun"},{id:"tiṉṉum",size:2},{id:"mutalaittu",size:1},{id:"eytiṉaṉ",size:1},{id:"makiḻ",size:23,type:"noun"},{id:"polam",size:2,type:"noun"},{id:"toṭi",size:8,type:"noun"},{id:"teḷir",size:1,type:"verb"},{id:"muyaṅkiyavar",size:1},{id:"tuṟappatu",size:1},{id:"ayal",size:1,type:"noun"},{id:"puṟantā",size:1,type:"verb"},{id:"puṉiṟu",size:2,type:"noun"},{id:"pai(m)",size:2,type:"adjective"},{id:"kāy",size:2,type:"noun"},{id:"vayalaic",size:2},{id:"ce(m)",size:9,type:"adjective"},{id:"koṭi",size:1,type:"noun"},{id:"palarkku",size:1},{id:"poy",size:5,type:"noun"},{id:"aṟiyāk",size:1},{id:"kaḻaṅku",size:1,type:"noun"},{id:"mey",size:1,type:"noun"},{id:"varaik",size:1},{id:"kaṭci",size:1,type:"noun"},{id:"mayil",size:2,type:"noun"},{id:"ālu",size:2,type:"verb"},{id:"vaḷḷi",size:1,type:"noun"},{id:"kāṉ",size:1,type:"noun"},{id:"kiḻamai",size:1,type:"noun"},{id:"āṇ",size:1,type:"noun"},{id:"taku",size:2,type:"verb"},{id:"viṟal",size:1,type:"noun"},{id:"vēṭkai",size:1,type:"noun"},{id:"tāṅku",size:1,type:"verb"},{id:"iḷa(m)",size:1,type:"adjective"},{id:"karantai",size:1,type:"noun"},{id:"ceṟu",size:3,type:"verb"},{id:"vaḷḷai",size:1,type:"noun"},{id:"aṟi",size:7,type:"verb"},{id:"iṉṉaṉ",size:1},{id:"katir",size:5,type:"noun"},{id:"ṇakam",size:2},{id:"maṇ",size:2,type:"noun"},{id:"ṇaḷaic",size:1},{id:"nekiḻac",size:2},{id:"allal",size:1,type:"noun"},{id:"uḻa",size:1,type:"verb"},{id:"yaṇaṅku",size:1},{id:"uṟai",size:3,type:"noun"},{id:"cēṟu",size:1,type:"noun"},{id:"oṇmai",size:5,type:"noun"},{id:"koḷak",size:1},{id:"kā",size:1,type:"noun"},{id:"kaṭuka",size:1},{id:"vittu",size:2,type:"noun"},{id:"muḷai",size:1,type:"noun"},{id:"marīit",size:1},{id:"titti",size:2,type:"noun"},{id:"yalkul",size:2},{id:"koḷvatu",size:1},{id:"vūṟuka",size:1},{id:"pakaṭu",size:1},{id:"vuḻavar",size:1},{id:"vēppa(m)",size:1,type:"noun"},{id:"ṇaḷai",size:1},{id:"vuṟaikkum",size:1},{id:"iḻa",size:1,type:"verb"},{id:"māl",size:1,type:"adjective"},{id:"lōttirattu",size:1},{id:"maiy",size:1},{id:"aru(m)",size:4,type:"adjective"},{id:"curam",size:4,type:"noun"},{id:"ceṉṉik",size:1},{id:"kūṭṭam",size:2,type:"noun"},{id:"av",size:1},{id:"varaiy",size:1},{id:"iṟakkuvaiy",size:1},{id:"varai",size:1,type:"noun"},{id:"poruḷ",size:2,type:"noun"},{id:"viṉai",size:2,type:"noun"},{id:"tappal",size:1,type:"noun"},{id:"arivai",size:5,type:"noun"},{id:"takaittaṟku",size:1},{id:"pulampav",size:1},{id:"ñeli",size:1,type:"noun"},{id:"kaḻai",size:2,type:"noun"},{id:"aḻal",size:1,type:"noun"},{id:"vayamā",size:1},{id:"veru",size:2,type:"noun"},{id:"kuṉṟam",size:1,type:"noun"},{id:"ayar",size:1,type:"verb"},{id:"tuṇaip",size:1},{id:"kaṭam",size:1,type:"noun"},{id:"mūr",size:3},{id:"muṭam",size:1},{id:"mutir",size:2,type:"verb"},{id:"marutattup",size:2},{id:"yuṭaṉ",size:1},{id:"āyamōṭu",size:2},{id:"pāṇṭil",size:2,type:"noun"},{id:"kalam",size:1,type:"noun"},{id:"nantat",size:1},{id:"alkul",size:1,type:"noun"},{id:"vāṭṭam",size:1,type:"noun"},{id:"viṟantōr",size:1},{id:"maṉ",size:3},{id:"piṟaṅku",size:1,type:"verb"},{id:"malaip",size:1},{id:"arai",size:1,type:"noun"},{id:"yōmai",size:1},{id:"puli",size:1,type:"noun"},{id:"vaḻakku",size:1,type:"noun"},{id:"cūḻkam",size:1},{id:"pāḻ",size:1,type:"noun"},{id:"paṭṭup",size:1},{id:"veppa(m)",size:2,type:"noun"},{id:"pālai",size:1,type:"noun"},{id:"kāṭṭu",size:1,type:"noun"},{id:"iṟa",size:1,type:"verb"},{id:"neñcam",size:3,type:"noun"},{id:"mil",size:1},{id:"vantataṟku",size:1},{id:"eḻu",size:2,type:"noun"},{id:"aḻupa",size:1},{id:"veṉpa",size:1},{id:"vavaṉ",size:1},{id:"tī",size:3,type:"noun"},{id:"yuṟu",size:1},{id:"meḻukiṉ",size:1},{id:"muḷiya",size:1},{id:"vēṉal",size:3,type:"noun"},{id:"nīṭik",size:1},{id:"kaṭu(m)",size:1,type:"adjective"},{id:"ñāyiṟu",size:1,type:"noun"},{id:"pakat",size:1},{id:"teṟu",size:1,type:"verb"},{id:"muṉ",size:6},{id:"yuḷḷu",size:1},{id:"eri",size:1,type:"noun"},{id:"kavar",size:1,type:"verb"},{id:"veṉṟūḻ",size:1},{id:"nīḷ",size:2,type:"noun"},{id:"iṭaic",size:1},{id:"kaṇpaṭuppiṉum",size:1},{id:"kāṇkuveṉ",size:1},{id:"kaṅkul",size:1,type:"noun"},{id:"naḷi",size:1,type:"noun"},{id:"nakar",size:2,type:"noun"},{id:"vēṅkai",size:1,type:"noun"},{id:"cuṇaṅku",size:2,type:"noun"},{id:"maruta(m)",size:3,type:"noun"},{id:"uyar",size:1,type:"verb"},{id:"tuṟaip",size:1},{id:"peṇṭirōṭu",size:1},{id:"tār",size:1,type:"noun"},{id:"talait",size:1},{id:"mūrp",size:2},{id:"poykaip",size:3},{id:"puḻaik",size:1},{id:"tātu",size:6,type:"noun"},{id:"vaṇṇa(m)",size:2,type:"noun"},{id:"vētilāḷarkkup",size:1},{id:"nilaik",size:1},{id:"kōṅkam",size:1,type:"noun"},{id:"paya",size:2,type:"verb"},{id:"vaṇi",size:1},{id:"koḻu",size:1,type:"verb"},{id:"mukiḻ",size:2,type:"noun"},{id:"poykai",size:7,type:"noun"},{id:"yāmpal",size:3},{id:"nār",size:1,type:"noun"},{id:"uri",size:1,type:"noun"},{id:"niṟam",size:3,type:"noun"},{id:"niḻaṟṟutal",size:1},{id:"yiṉip",size:1},{id:"maṟa",size:2,type:"verb"},{id:"uḷḷu",size:1,type:"verb"},{id:"amaikuva",size:1},{id:"karutiya",size:1},{id:"olku",size:1,type:"verb"},{id:"tēṟṟāṉ",size:1},{id:"aḻuṅkal",size:1,type:"noun"},{id:"uṇarntōr",size:2},{id:"yaṭaiya",size:1},{id:"muyakkam",size:1,type:"noun"},{id:"tiruttu",size:1,type:"verb"},{id:"ñekiḻap",size:1},{id:"pakai",size:2,type:"noun"},{id:"pul",size:2,type:"noun"},{id:"lārka",size:1},{id:"pār",size:1,type:"noun"},{id:"ōtuka",size:1},{id:"kāytta",size:1},{id:"paḻaṉa(m)",size:5,type:"noun"},{id:"ākaṟka",size:2},{id:"aḻap",size:1},{id:"iṟai",size:1,type:"noun"},{id:"keṇṭai",size:1,type:"noun"},{id:"taru/tā",size:3,type:"verb"},{id:"vaviḻnta",size:1},{id:"piṇi",size:4,type:"noun"},{id:"maṟi",size:1,type:"noun"},{id:"yiṭaip",size:1},{id:"piṇa",size:1,type:"noun"},{id:"pōlap",size:3},{id:"putalvaṉ",size:4,type:"noun"},{id:"naṭuvaṇaṉ",size:1},{id:"naṉṟum",size:1},{id:"iṉitumaṉṟa",size:1},{id:"kiṭa",size:1,type:"verb"},{id:"niṟa",size:1,type:"verb"},{id:"aka(m)",size:1,type:"noun"},{id:"kavai",size:2,type:"noun"},{id:"vīṉum",size:1},{id:"umparum",size:1},{id:"kātaliyiṉ",size:1},{id:"amar",size:2,type:"noun"},{id:"vuḷḷam",size:1},{id:"yakaṉ",size:1},{id:"tantai",size:2,type:"noun"},{id:"muṟuvaliṉ",size:1},{id:"naku",size:1,type:"verb"},{id:"payiṟṟic",size:1},{id:"uruṭṭu",size:1,type:"verb"},{id:"taḷar",size:2,type:"verb"},{id:"vāḷ",size:1,type:"noun"},{id:"yūṭṭat",size:1},{id:"puṟam",size:1,type:"noun"},{id:"naṟu(m)",size:7,type:"adjective"},{id:"puṟavam",size:3},{id:"poṟu",size:1,type:"verb"},{id:"oṇ",size:1},{id:"maṉaikku",size:1},{id:"viḷakkam",size:1,type:"noun"},{id:"kaṉai",size:1,type:"verb"},{id:"vai",size:1,type:"noun"},{id:"mātar",size:1,type:"noun"},{id:"viḷaiyāṭak",size:1},{id:"kātalit",size:1},{id:"taḻuvu",size:3,type:"verb"},{id:"yiṉitu",size:1},{id:"iruntaṉaṉ",size:1},{id:"piracam",size:1,type:"noun"},{id:"ūtu",size:2,type:"verb"},{id:"pārpput",size:2},{id:"mutalai",size:1,type:"noun"},{id:"poykaittu",size:1},{id:"mayaṅkiṉaḷ",size:1},{id:"yarivai",size:1},{id:"kāviri",size:1,type:"noun"},{id:"ampaṇattu",size:1},{id:"yāmai",size:3,type:"noun"},{id:"yēṟic",size:1},{id:"cempiṉ",size:1},{id:"pārppup",size:1},{id:"tīm",size:2,type:"adjective"},{id:"yiḷam",size:1},{id:"mukam",size:1,type:"noun"},{id:"vaḷarnticiṉāaṅku",size:1},{id:"yaiya",size:1},{id:"yaṟintaṉai",size:1},{id:"yoḻukumati",size:1},{id:"kūtir",size:1,type:"noun"},{id:"yāṟu",size:1,type:"noun"},{id:"aṇintaṉa",size:1},{id:"yaṉṟu",size:1},{id:"kuṟippiṉai",size:1},{id:"yāki",size:2},{id:"yīṇṭu",size:1},{id:"yaruḷātu",size:1},{id:"muḷ",size:1,type:"noun"},{id:"ḷeyiṟṟup",size:1},{id:"keṭiṟu",size:1,type:"noun"},{id:"cori",size:3,type:"verb"},{id:"vakaṉ",size:1},{id:"vaṭṭi",size:2,type:"noun"},{id:"ari",size:1,type:"noun"},{id:"payaṟu",size:1,type:"noun"},{id:"niṟaikkum",size:2},{id:"yāyam",size:1},{id:"valai",size:1,type:"noun"},{id:"eyiṟu",size:1,type:"noun"},{id:"varāal",size:1,type:"noun"},{id:"yuḷ",size:1},{id:"yāṅkaṇ",size:8,type:"pronoun"},{id:"vēṇṭēm",size:1},{id:"parattaṉ",size:1,type:"noun"},{id:"yāṇṭuc",size:1},{id:"kuṟiyōṭu",size:1},{id:"ōti",size:1,type:"noun"},{id:"yacai",size:1},{id:"naṭaip",size:2},{id:"peṟu",size:5,type:"verb"},{id:"citaiyap",size:1},{id:"paci",size:2,type:"noun"},{id:"yil",size:1},{id:"lākuka",size:3},{id:"cēṇ",size:1,type:"noun"},{id:"mutalaip",size:1},{id:"pōttu",size:2,type:"noun"},{id:"muḻu",size:1,type:"noun"},{id:"kaṭai",size:1,type:"noun"},{id:"niṟka",size:1},{id:"celvam",size:1,type:"noun"},{id:"varuttam",size:1,type:"noun"},{id:"vañci",size:1,type:"noun"},{id:"yōṅkiya",size:1},{id:"tañcam",size:1,type:"noun"},{id:"aruḷ",size:1,type:"noun"},{id:"kōḻi",size:1,type:"noun"},{id:"nīlac",size:1},{id:"cēval",size:1,type:"noun"},{id:"ukirp",size:1},{id:"pēṭai",size:3,type:"noun"},{id:"vayāam",size:1},{id:"puḷim",size:1},{id:"vēṭkaittu",size:1},{id:"taiic",size:1},{id:"viral",size:1,type:"noun"},{id:"yari",size:1},{id:"maḻaik",size:1},{id:"vāyk",size:1},{id:"vev",size:1},{id:"ciṟai",size:2,type:"noun"},{id:"yaḻi",size:2},{id:"kalaṅkik",size:1},{id:"kaḻaṉit",size:2},{id:"tāmarai",size:3,type:"noun"},{id:"vūra",size:1},{id:"tērt",size:1},{id:"teṉ",size:1,type:"noun"},{id:"uḷ",size:1},{id:"oḻukku",size:1,type:"verb"},{id:"tēṉūr",size:3},{id:"teri",size:1,type:"verb"},{id:"vūriṉ",size:1},{id:"pañcāyk",size:1},{id:"accam",size:2,type:"noun"},{id:"entiram",size:1},{id:"kaḷiṟu",size:1,type:"noun"},{id:"etir",size:1,type:"noun"},{id:"piḷiṟṟum",size:1},{id:"vaḷ",size:4,type:"noun"},{id:"kō",size:1,type:"noun"},{id:"laṇi",size:1},{id:"tuṟattaliṉ",size:1},{id:"aṟiyap",size:1},{id:"pakal",size:3,type:"noun"},{id:"viḷakkōṭu",size:1},{id:"ira(m)",size:1,type:"noun"},{id:"pōrc",size:1},{id:"cōḻaṉ",size:1,type:"noun"},{id:"āmūr",size:1,type:"noun"},{id:"tēmpa",size:1},{id:"vevaṉ",size:1},{id:"katirt",size:1},{id:"pulampap",size:1},{id:"vaṉai",size:1,type:"verb"},{id:"-uṭai",size:2},{id:"viṇṭu",size:1,type:"noun"},{id:"vaṉṉa",size:1},{id:"pōr",size:2,type:"verb"},{id:"kai",size:2,type:"noun"},{id:"virāaṉ",size:1,type:"noun"},{id:"iruppai",size:1,type:"noun"},{id:"maṉaiyai",size:1},{id:"vāṟṟu",size:1},{id:"maintu",size:1,type:"noun"},{id:"evvam",size:1,type:"noun"},{id:"tīr",size:1,type:"verb"},{id:"yivaṭku",size:1},{id:"vēttu",size:1,type:"adjective"},{id:"taṇika",size:1},{id:"nantuka",size:1},{id:"tāmarait",size:1},{id:"varaika",size:1},{id:"entai",size:1,type:"noun"},{id:"koṭukka",size:1},{id:"paḻaṉak",size:1},{id:"kampuḷ",size:2,type:"noun"},{id:"payirp",size:1},{id:"peṭai",size:1,type:"noun"},{id:"yakavum",size:1},{id:"yūra",size:2},{id:"vaṭi",size:1,type:"noun"},{id:"viḷai",size:1,type:"noun"},{id:"uku",size:1,type:"verb"},{id:"paḻa(m)",size:1,type:"adjective"},{id:"poykait",size:2},{id:"tuṭumeṉ",size:1},{id:"viḻūum",size:1},{id:"matti",size:1,type:"noun"},{id:"kaḻāar",size:1,type:"noun"},{id:"vatuvai",size:1,type:"noun"},{id:"yayara",size:1},{id:"intira",size:1},{id:"viḻavu",size:1,type:"noun"},{id:"talaip",size:2},{id:"akavu",size:1,type:"verb"},{id:"maṅkaiyart",size:1},{id:"toku",size:1,type:"verb"},{id:"yev",size:1},{id:"paḷḷip",size:1},{id:"nīrnāy",size:1,type:"noun"},{id:"vāḷai",size:1,type:"noun"},{id:"irai",size:1,type:"noun"},{id:"tolaivatu",size:1},{id:"tuṉṉu",size:1,type:"verb"},{id:"piṟart",size:1},{id:"āṭak",size:1},{id:"oruvar",size:1},{id:"ē",size:1,type:"noun"},{id:"pāttiyiṉ",size:1},{id:"kali",size:1,type:"noun"},{id:"vāmpal",size:1},{id:"curumpu",size:1,type:"noun"},{id:"kaḷai",size:1,type:"verb"},{id:"yīṉṟa",size:1},{id:"muyaṅkaṉmō",size:1},{id:"uṭaliṉēṉ",size:1},{id:"urai",size:2,type:"verb"},{id:"yiṉik",size:1},{id:"nikarā",size:1},{id:"veṉṉoṭu",size:1},{id:"nikarip",size:1},{id:"tarukkum",size:1},{id:"malart",size:1},{id:"yōti",size:1},{id:"kaṉṉi",size:1,type:"noun"},{id:"viṭiyal",size:1,type:"noun"},{id:"kaṇaik",size:1},{id:"pēṇāḷ",size:1},{id:"naṭa",size:2,type:"verb"},{id:"kaṇṭaṉem",size:1},{id:"uy",size:1,type:"verb"},{id:"vaḻutu",size:1},{id:"yaṟam",size:1},{id:"vallatu",size:1},{id:"keṭu",size:1,type:"verb"},{id:"yuḷaip",size:1},{id:"marutattuk",size:1},{id:"kiḷaik",size:1},{id:"ṉūrk",size:1},{id:"paḻaṉap",size:2},{id:"ceṉṉic",size:1},{id:"cē",size:2,type:"noun"},{id:"tūyar",size:1},{id:"naṟiyar",size:1},{id:"pēy",size:1,type:"noun"},{id:"(i)yām",size:1},{id:"cūtu",size:1},{id:"toṭic",size:1},{id:"cūr",size:1,type:"noun"},{id:"nuṭakkattu",size:1},{id:"nerunal",size:1},{id:"yāṭiṉai",size:1},{id:"yeṉpa",size:1},{id:"maṟai",size:1,type:"noun"},{id:"ol(lu)",size:3,type:"verb"},{id:"putaittal",size:1},{id:"kayil",size:1},{id:"taḻait",size:1},{id:"tuyal",size:1,type:"verb"},{id:"kūntal",size:3,type:"noun"},{id:"kuvaḷai",size:2,type:"noun"},{id:"liyal",size:1},{id:"taḻai",size:1,type:"noun"},{id:"paṇṇai",size:2,type:"noun"},{id:"kaḷ",size:1,type:"verb"},{id:"nāṟit",size:1},{id:"tōkaic",size:1},{id:"cīr",size:1,type:"noun"},{id:"pacu(m)",size:3,type:"adjective"},{id:"avir",size:1,type:"verb"},{id:"niḻaṟṟak",size:1},{id:"ēṟip",size:1},{id:"pāyvōḷ",size:1},{id:"ovvāy",size:1},{id:"vataṉāl",size:1},{id:"toṭakku",size:1,type:"verb"},{id:"tol",size:1,type:"adjective"},{id:"niṉṉōṭu",size:2},{id:"āṭiṉaḷ",size:1},{id:"paiñcāyk",size:1},{id:"malarc",size:1},{id:"āṭit",size:2},{id:"mēmpaṭṭaṉaḷ",size:1},{id:"antaram",size:1},{id:"makaḷirkkut",size:2},{id:"pēr",size:1,type:"noun"},{id:"alaik",size:1},{id:"vēl",size:1,type:"noun"},{id:"kaṭu",size:1,type:"verb"},{id:"kiḷḷi",size:1,type:"noun"},{id:"matil",size:1,type:"noun"},{id:"yāṉai",size:1,type:"noun"},{id:"kataḻpu",size:1},{id:"neṟi",size:2,type:"noun"},{id:"āṭi",size:1,type:"noun"},{id:"yamartta",size:1},{id:"makaṉai",size:1},{id:"yaracu",size:1},{id:"muṟai",size:1,type:"noun"},{id:"ceyka",size:1},{id:"kaḷavu",size:1,type:"noun"},{id:"yalaṅku",size:1},{id:"cūḷ",size:1,type:"noun"},{id:"vāyppatu",size:1},{id:"pulakkuvēm",size:1},{id:"nalat",size:1},{id:"yākit",size:1},{id:"tava",size:1},{id:"ḷakaṭṭu",size:1},{id:"yarip",size:1},{id:"paṟai",size:2,type:"noun"},{id:"micaik",size:1},{id:"nayantaṉeṉ",size:1},{id:"kēṭkiṉ",size:1},{id:"vekuṇṭaṉaḷ",size:1},{id:"aviḻ",size:2,type:"noun"},{id:"tārt",size:1},{id:"paṟa",size:1,type:"verb"},{id:"yaruḷāy",size:1},{id:"paipayat",size:1},{id:"taṇa",size:1,type:"verb"},{id:"yuymmō",size:1},{id:"num",size:3,type:"pronoun"},{id:"cevi",size:1,type:"noun"},{id:"liṟantu",size:1},{id:"vekuḷvōḷ",size:1},{id:"yaim",size:1},{id:"taiit",size:1},{id:"kayam",size:1,type:"noun"},{id:"paṭintu",size:1},{id:"arik",size:1},{id:"kural",size:2,type:"noun"},{id:"paḻaṉattuk",size:1},{id:"kiḷaiyōṭu",size:1},{id:"ciṟuvariṉ",size:1},{id:"nakār",size:1},{id:"talaik",size:1},{id:"viḷik",size:1},{id:"yimiḻum",size:1},{id:"mivaṇ",size:1},{id:"alku",size:1,type:"verb"},{id:"pakaṉṟaik",size:1},{id:"kaṇṇip",size:1},{id:"lāṉ",size:1},{id:"kōvalar",size:1,type:"noun"},{id:"kuṇil",size:1,type:"noun"},{id:"ā",size:1},{id:"kaṉi",size:1,type:"noun"},{id:"yutirkkum",size:1},{id:"pula",size:2,type:"verb"},{id:"malarp",size:2},{id:"yevvai",size:1},{id:"yem",size:1},{id:"vevvaikku",size:1},{id:"aḷi",size:1,type:"noun"},{id:"virumpiṉṟu",size:1},{id:"yampal",size:1},{id:"kuṇam",size:2,type:"noun"},{id:"maruppu",size:1,type:"noun"},{id:"veṟi",size:1,type:"noun"},{id:"mayakkum",size:2},{id:"vetir",size:1,type:"noun"},{id:"karu(m)",size:3,type:"adjective"},{id:"kōṭṭam",size:4,type:"noun"},{id:"erumaic",size:1},{id:"āk",size:1},{id:"kuḻavikku",size:1},{id:"ūṟṟu",size:1,type:"noun"},{id:"maṭukkum",size:1},{id:"nuntai",size:2,type:"noun"},{id:"maṭantai",size:1,type:"noun"},{id:"niṉṉai",size:1},{id:"lēṟṟu",size:1},{id:"mēy",size:2,type:"verb"},{id:"aruttu",size:1,type:"verb"},{id:"mōrōṭamōṭu",size:1},{id:"viṉaiya",size:1},{id:"veṟukkaiya",size:1},{id:"vāki",size:1},{id:"yivaḷ",size:1},{id:"mucci",size:1,type:"noun"},{id:"maḷḷar",size:1,type:"noun"},{id:"vati",size:1,type:"noun"},{id:"ilañcip",size:1},{id:"paḻaṉattatu",size:1},{id:"kayiṟu",size:1,type:"noun"},{id:"acai",size:1,type:"verb"},{id:"muṟṟi",size:1,type:"verb"},{id:"yaru",size:1},{id:"yerumai",size:2},{id:"yāṭiya",size:1},{id:"āmpaloṭu",size:1},{id:"kalikkum",size:1},{id:"vūraṉ",size:1},{id:"pāyal",size:1,type:"noun"},{id:"pakaṉṟai",size:1,type:"noun"},{id:"miṭai",size:1,type:"noun"},{id:"kōṭṭaik",size:1},{id:"erumaik",size:1},{id:"kaṉṟu",size:1,type:"noun"},{id:"yampiyiṉ",size:1},{id:"pākal",size:1,type:"noun"},{id:"muyiṟu",size:1,type:"noun"},{id:"mūcu",size:1,type:"verb"},{id:"kuṭampai",size:1,type:"noun"}],IA=[{id:"a- nī",source:"a-",target:"nī",strength:.15658327071371678,citations:["Aink44","Aink51"]},{id:"a- ūr",source:"a-",target:"ūr",strength:.1731179173466118,citations:["Aink24","Aink41"]},{id:"tuṟai ūr",source:"tuṟai",target:"ūr",strength:.21191588894642213,citations:["Aink11","Aink12"]},{id:"ūr ūr",source:"ūr",target:"ūr",strength:.22103871124379562,citations:["Aink15"],curvature:.5},{id:"vāḻ yūraṉ",source:"vāḻ",target:"yūraṉ",strength:.2241847120855547,citations:["Aink36","Aink39"]},{id:"ūr maka",source:"ūr",target:"maka",strength:.22612523560259537,citations:["Aink100","Aink99"]},{id:"ūr peru(m)",source:"ūr",target:"peru(m)",strength:.23121504937085327,citations:["Aink30","Aink48"]},{id:"makiḻ nī",source:"makiḻ",target:"nī",strength:.23121504937085327,citations:["Aink69","Aink77"]},{id:"nī pal",source:"nī",target:"pal",strength:.23720999444020163,citations:["Aink55","Aink69"]},{id:"kēḷ vāḻ",source:"kēḷ",target:"vāḻ",strength:.23839405874172798,citations:["Aink111","Aink59"]},{id:"nal ākkam",source:"nal",target:"ākkam",strength:.24397878703837317,citations:["Aink117","Aink63"]},{id:"eṉ nī",source:"eṉ",target:"nī",strength:.2569815338331656,citations:["Aink81","Aink82"]},{id:"ūr nal",source:"ūr",target:"nal",strength:.26416372717236747,citations:["Aink12","Aink22","Aink63"]},{id:"makiḻ a-",source:"makiḻ",target:"a-",strength:.26659855865546805,citations:["Aink31","Aink90"]},{id:"kaṇ maka",source:"kaṇ",target:"maka",strength:.2709181522717541,citations:["Aink406","Aink79"]},{id:"vāḻ nal",source:"vāḻ",target:"nal",strength:.2714808812417605,citations:["Aink117","Aink119","Aink120","Aink9"]},{id:"ūr eṉ",source:"ūr",target:"eṉ",strength:.2735161804660606,citations:["Aink41","Aink89"]},{id:"nī maka",source:"nī",target:"maka",strength:.2795603658270045,citations:["Aink101","Aink29","Aink49"]},{id:"i- ākkam",source:"i-",target:"ākkam",strength:.28015795678798205,citations:["Aink117","Aink8"]},{id:"ākkam peru(m)",source:"ākkam",target:"peru(m)",strength:.28015795678798205,citations:["Aink403","Aink63"]},{id:"vāḻ koṇkaṉ",source:"vāḻ",target:"koṇkaṉ",strength:.2822818441097962,citations:["Aink114","Aink139"]},{id:"puṉal ūr",source:"puṉal",target:"ūr",strength:.28851652093010066,citations:["Aink65","Aink95"]},{id:"tuṟai i-",source:"tuṟai",target:"i-",strength:.2888618836223834,citations:["Aink103","Aink28"]},{id:"tāṉ a-",source:"tāṉ",target:"a-",strength:.29236504311778044,citations:["Aink103","Aink404"],curvature:.25},{id:"eṉ a-",source:"eṉ",target:"a-",strength:.29236504311778044,citations:["Aink41","Aink89"]},{id:"pū(m) a-",source:"pū(m)",target:"a-",strength:.29965676796336127,citations:["Aink41","Aink62"]},{id:"nal nal",source:"nal",target:"nal",strength:.3072887431009393,citations:["Aink120","Aink204","Aink61"],curvature:.5},{id:"tōḻaṉ i-",source:"tōḻaṉ",target:"i-",strength:.3081610440468145,citations:["Aink117","Aink118"]},{id:"il nī",source:"il",target:"nī",strength:.3081610440468145,citations:["Aink136","Aink307"]},{id:"cel ūr",source:"cel",target:"ūr",strength:.3147011888519268,citations:["Aink22","Aink27"]},{id:"pāṇ nī",source:"pāṇ",target:"nī",strength:.3154142346329997,citations:["Aink136","Aink140","Aink82"],curvature:.25},{id:"malar a-",source:"malar",target:"a-",strength:.31554146607259687,citations:["Aink18","Aink72"]},{id:"tāṉ kaṇ",source:"tāṉ",target:"kaṇ",strength:.31830909713521927,citations:["Aink112","Aink202"]},{id:"ākkam taṭpam",source:"ākkam",target:"taṭpam",strength:.32019676228411353,citations:["Aink28","Aink45","Aink54"]},{id:"tuṟai varavu",source:"tuṟai",target:"varavu",strength:.3242453929069983,citations:["Aink105","Aink69"]},{id:"ūr ākkam",source:"ūr",target:"ākkam",strength:.32728766415893157,citations:["Aink15","Aink19","Aink24"]},{id:"tuṟai tāṉ",source:"tuṟai",target:"tāṉ",strength:.3311630147175908,citations:["Aink10","Aink7"]},{id:"ūr pāṇ",source:"ūr",target:"pāṇ",strength:.3329053416962817,citations:["Aink1","Aink43","Aink49"]},{id:"kaṇ e-",source:"kaṇ",target:"e-",strength:.33330943759925935,citations:["Aink84"]},{id:"ākkam e-",source:"ākkam",target:"e-",strength:.3374594283472295,citations:["Aink108","Aink17"]},{id:"malar taṭpam",source:"malar",target:"taṭpam",strength:.3414855200900357,citations:["Aink108","Aink69"]},{id:"vāḻ pāṇ",source:"vāḻ",target:"pāṇ",strength:.34316455671832186,citations:["Aink1","Aink111","Aink132","Aink89"]},{id:"tōḻaṉ yūraṉ",source:"tōḻaṉ",target:"yūraṉ",strength:.34354455333142936,citations:["Aink36","Aink39"]},{id:"tōḻaṉ nal",source:"tōḻaṉ",target:"nal",strength:.34556072711129643,citations:["Aink117","Aink119","Aink120"]},{id:"amma pāṇ",source:"amma",target:"pāṇ",strength:.34775939815982,citations:["Aink132","Aink89"]},{id:"pū(m) peru(m)",source:"pū(m)",target:"peru(m)",strength:.35775389998760265,citations:["Aink19","Aink33"]},{id:"nī paca",source:"nī",target:"paca",strength:.35775389998760265,citations:["Aink29","Aink45"]},{id:"ūr i-",source:"ūr",target:"i-",strength:.35817844105228336,citations:["Aink100","Aink30","Aink8","Aink99"]},{id:"ūr maṉai",source:"ūr",target:"maṉai",strength:.36007919996432436,citations:["Aink3","Aink87"]},{id:"peru(m) tuṟai",source:"peru(m)",target:"tuṟai",strength:.3634171746599543,citations:["Aink31","Aink69","Aink75"]},{id:"e- peru(m)",source:"e-",target:"peru(m)",strength:.3654625156060619,citations:["Aink123","Aink89"]},{id:"makiḻ tāṉ",source:"makiḻ",target:"tāṉ",strength:.3669968217749169,citations:["Aink38","Aink66"]},{id:"a- tāṉ",source:"a-",target:"tāṉ",strength:.36712297733927135,citations:["Aink343","Aink41","Aink66"],curvature:.25},{id:"ūr nī",source:"ūr",target:"nī",strength:.36903688178811794,citations:["Aink42","Aink43","Aink49","Aink54","Aink68","Aink85","Aink87"]},{id:"nī pāṇ",source:"nī",target:"pāṇ",strength:.37171243017397915,citations:["Aink139","Aink43","Aink47","Aink49"],curvature:.25},{id:"nī yāṅkaṇ",source:"nī",target:"yāṅkaṇ",strength:.37363859809683836,citations:["Aink79","Aink87"]},{id:"a- nal",source:"a-",target:"nal",strength:.3850407136640791,citations:["Aink55","Aink56","Aink57","Aink61"]},{id:"yūraṉ tāṉ",source:"yūraṉ",target:"tāṉ",strength:.38584568442663675,citations:["Aink10","Aink7"]},{id:"tāṉ varavu",source:"tāṉ",target:"varavu",strength:.38584568442663675,citations:["Aink134","Aink343"]},{id:"varavu eṉ",source:"varavu",target:"eṉ",strength:.38584568442663675,citations:["Aink2","Aink88"]},{id:"vāḻ vāḻ",source:"vāḻ",target:"vāḻ",strength:.38872120534305676,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.5},{id:"peṇ ūr",source:"peṇ",target:"ūr",strength:.39017324472973336,citations:["Aink13","Aink40"]},{id:"ūr toṭi",source:"ūr",target:"toṭi",strength:.39017324472973336,citations:["Aink28","Aink98"]},{id:"ūr vem",source:"ūr",target:"vem",strength:.39017324472973336,citations:["Aink63","Aink86"]},{id:"nal eṉ",source:"nal",target:"eṉ",strength:.3903088024292299,citations:["Aink204","Aink67"]},{id:"yaṉṉa nī",source:"yaṉṉa",target:"nī",strength:.3916471835278881,citations:["Aink307","Aink42"]},{id:"aṟi nī",source:"aṟi",target:"nī",strength:.3916471835278881,citations:["Aink47","Aink79"]},{id:"eṉ tāṉ",source:"eṉ",target:"tāṉ",strength:.3927633062372292,citations:["Aink33","Aink41"]},{id:"yūraṉ kēḷ",source:"yūraṉ",target:"kēḷ",strength:.3931374092722175,citations:["Aink2","Aink9"]},{id:"em a-",source:"em",target:"a-",strength:.3931374092722175,citations:["Aink82","Aink90"]},{id:"varavu e-",source:"varavu",target:"e-",strength:.40084602489067683,citations:["Aink134","Aink221"]},{id:"varavu puṉal",source:"varavu",target:"puṉal",strength:.40084602489067683,citations:["Aink69","Aink72"]},{id:"yūraṉ maka",source:"yūraṉ",target:"maka",strength:.41587877073111085,citations:["Aink91","Aink96","Aink97"]},{id:"tuṟai kēḷ",source:"tuṟai",target:"kēḷ",strength:.4158787707311109,citations:["Aink111","Aink2","Aink9"]},{id:"kaḷvaṉ taṭpam",source:"kaḷvaṉ",target:"taṭpam",strength:.41908146328965634,citations:["Aink27","Aink30"]},{id:"kaṇ paca",source:"kaṇ",target:"paca",strength:.41908146328965634,citations:["Aink36","Aink37"]},{id:"nī maṉai",source:"nī",target:"maṉai",strength:.42126300902354896,citations:["Aink66","Aink81","Aink87"]},{id:"yūraṉ i-",source:"yūraṉ",target:"i-",strength:.42126300902354896,citations:["Aink91","Aink96","Aink97"]},{id:"vāḻ nām",source:"vāḻ",target:"nām",strength:.42641932138961924,citations:["Aink111","Aink116","Aink34","Aink35"]},{id:"nāḷ a-",source:"nāḷ",target:"a-",strength:.427030692812503,citations:["Aink109","Aink95"]},{id:"il pāṇ",source:"il",target:"pāṇ",strength:.43044515512769843,citations:["Aink136","Aink138"]},{id:"cel nal",source:"cel",target:"nal",strength:.4338761919884482,citations:["Aink22","Aink302","Aink307"]},{id:"pōl kaṇ",source:"pōl",target:"kaṇ",strength:.434966161398892,citations:["Aink101","Aink16"]},{id:"iṉ nī",source:"iṉ",target:"nī",strength:.4370251946402857,citations:["Aink203","Aink46"]},{id:"tāṉ koḷ",source:"tāṉ",target:"koḷ",strength:.44394281645087813,citations:["Aink10","Aink7"]},{id:"kaḻaṉi maka",source:"kaḻaṉi",target:"maka",strength:.44614472752820106,citations:["Aink91","Aink96"]},{id:"tuṟai peṇ",source:"tuṟai",target:"peṇ",strength:.44782007898126347,citations:["Aink113","Aink13"]},{id:"āṭu taṭpam",source:"āṭu",target:"taṭpam",strength:.4529747468299418,citations:["Aink115","Aink84"],curvature:.25},{id:"taṭpam āṭu",source:"taṭpam",target:"āṭu",strength:.4529747468299418,citations:["Aink77","Aink98"],curvature:.25},{id:"nī peṇ",source:"nī",target:"peṇ",strength:.45309786891778836,citations:["Aink68","Aink69","Aink70"]},{id:"ūr māṇ",source:"ūr",target:"māṇ",strength:.45355984127318066,citations:["Aink42","Aink47"]},{id:"peṟu ūr",source:"peṟu",target:"ūr",strength:.45355984127318066,citations:["Aink49","Aink63"]},{id:"ākkam aṟi",source:"ākkam",target:"aṟi",strength:.45712473757791194,citations:["Aink79","Aink90"]},{id:"yaviṉi pal",source:"yaviṉi",target:"pal",strength:.45955478634252905,citations:["Aink1","Aink3"]},{id:"yāṅkaṇ maka",source:"yāṅkaṇ",target:"maka",strength:.46202942563743676,citations:["Aink79"]},{id:"peru(m) kaṭal",source:"peru(m)",target:"kaṭal",strength:.46711923940569466,citations:["Aink102","Aink123"]},{id:"pāṇ maka",source:"pāṇ",target:"maka",strength:.46921815544411505,citations:["Aink47","Aink48","Aink49"]},{id:"poḻutu a-",source:"poḻutu",target:"a-",strength:.47240870392490053,citations:["Aink406","Aink82"]},{id:"yāy pū(m)",source:"yāy",target:"pū(m)",strength:.47376413299870235,citations:["Aink10","Aink4"]},{id:"pal veṉa",source:"pal",target:"veṉa",strength:.47376413299870235,citations:["Aink3","Aink6"]},{id:"vāḻ makiḻ",source:"vāḻ",target:"makiḻ",strength:.482507319349579,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40","Aink59","Aink77"]},{id:"tuñcu ūr",source:"tuñcu",target:"ūr",strength:.48365388603858966,citations:["Aink13","Aink43"]},{id:"makiḻ toṭi",source:"makiḻ",target:"toṭi",strength:.48365388603858966,citations:["Aink24","Aink40"]},{id:"koḷ cel",source:"koḷ",target:"cel",strength:.4851278248367444,citations:["Aink10","Aink7"]},{id:"yām pū(m)",source:"yām",target:"pū(m)",strength:.48875590326396673,citations:["Aink10","Aink4","Aink7"]},{id:"keḻu ūr",source:"keḻu",target:"ūr",strength:.48963928306208737,citations:["Aink11","Aink12","Aink85"]},{id:"nal nāṭu",source:"nal",target:"nāṭu",strength:.4943266661995331,citations:["Aink61"]},{id:"nī mārpu",source:"nī",target:"mārpu",strength:.49776602889977234,citations:["Aink42","Aink44","Aink46","Aink51"]},{id:"yāṇar nī",source:"yāṇar",target:"nī",strength:.49776602889977234,citations:["Aink42","Aink43","Aink49","Aink87"]},{id:"miṉ taṭpam",source:"miṉ",target:"taṭpam",strength:.49835275794233935,citations:["Aink10","Aink5"]},{id:"maṭa(m) maka",source:"maṭa(m)",target:"maka",strength:.5008273972372471,citations:["Aink48","Aink98"]},{id:"am i-",source:"am",target:"i-",strength:.5059172110055049,citations:["Aink103","Aink302"]},{id:"i- no/nō",source:"i-",target:"no/nō",strength:.5059172110055049,citations:["Aink28","Aink99"]},{id:"nī neñcam",source:"nī",target:"neñcam",strength:.5059172110055049,citations:["Aink50"]},{id:"nī moḻi",source:"nī",target:"moḻi",strength:.5059172110055049,citations:["Aink60","Aink77"]},{id:"paca e-",source:"paca",target:"e-",strength:.5085360128557064,citations:["Aink144","Aink35"]},{id:"puṉal em",source:"puṉal",target:"em",strength:.5085360128557064,citations:["Aink77","Aink78"]},{id:"peṇ eṉ",source:"peṇ",target:"eṉ",strength:.509420370500902,citations:["Aink113","Aink89"]},{id:"toṭi yām",source:"toṭi",target:"yām",strength:.5167120953464828,citations:["Aink38","Aink40"]},{id:"taṭpam kaṭal",source:"taṭpam",target:"kaṭal",strength:.5179729762885356,citations:["Aink106","Aink107","Aink108"]},{id:"taṭpam puṉal",source:"taṭpam",target:"puṉal",strength:.5213041161796468,citations:["Aink54","Aink69","Aink76","Aink77","Aink98"]},{id:"ūr koṭu(m)",source:"ūr",target:"koṭu(m)",strength:.5224518576384,citations:["Aink11","Aink12"]},{id:"tōṟṟam ūr",source:"tōṟṟam",target:"ūr",strength:.5224518576384,citations:["Aink17","Aink98"]},{id:"veḷ pū(m)",source:"veḷ",target:"pū(m)",strength:.5246097720699618,citations:["Aink17","Aink19","Aink41"]},{id:"maka paḻaṉa(m)",source:"maka",target:"paḻaṉa(m)",strength:.5254160221808841,citations:["Aink91","Aink96"]},{id:"kaṇ civa",source:"kaṇ",target:"civa",strength:.5284468027077484,citations:["Aink125","Aink69"]},{id:"peru(m) ciṉai",source:"peru(m)",target:"ciṉai",strength:.5305058359491419,citations:["Aink145","Aink19"]},{id:"i- paḻaṉa(m)",source:"i-",target:"paḻaṉa(m)",strength:.5305058359491419,citations:["Aink91","Aink96"]},{id:"vivaḷ nal",source:"vivaḷ",target:"nal",strength:.5327642989906591,citations:["Aink55","Aink56","Aink57"]},{id:"veḷ nel",source:"veḷ",target:"nel",strength:.5347206807775325,citations:["Aink48","Aink58"]},{id:"em cel",source:"em",target:"cel",strength:.5347206807775325,citations:["Aink77"]},{id:"aṟu yūraṉ",source:"aṟu",target:"yūraṉ",strength:.5413007202901198,citations:["Aink25","Aink29"]},{id:"il veṉa",source:"il",target:"veṉa",strength:.5447151826053153,citations:["Aink8","Aink9"]},{id:"tāṉ amai",source:"tāṉ",target:"amai",strength:.5482183421007124,citations:["Aink103"]},{id:"tuṟai keḻu",source:"tuṟai",target:"keḻu",strength:.550620746539317,citations:["Aink11","Aink12","Aink140"]},{id:"peru(m) ciṟa",source:"peru(m)",target:"ciṟa",strength:.5519859759199994,citations:["Aink1","Aink403","Aink9"]},{id:"mel kāl",source:"mel",target:"kāl",strength:.5530354276513854,citations:["Aink26","Aink35"]},{id:"nī kēḷ",source:"nī",target:"kēḷ",strength:.5549976054637141,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"tōḻaṉ makiḻ",source:"tōḻaṉ",target:"makiḻ",strength:.5551052306313018,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40"]},{id:"muṉ yām",source:"muṉ",target:"yām",strength:.5555100669462931,citations:["Aink38","Aink40"]},{id:"tōḻaṉ nām",source:"tōḻaṉ",target:"nām",strength:.5580875975290384,citations:["Aink116","Aink34","Aink35","Aink36"]},{id:"al poy",source:"al",target:"poy",strength:.5593093057211695,citations:["Aink66","Aink80"]},{id:"al nī",source:"al",target:"nī",strength:.5599041621140611,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128","Aink69"]},{id:"pōl uṇ",source:"pōl",target:"uṇ",strength:.5605998807145509,citations:["Aink101","Aink16"]},{id:"i- maruntu",source:"i-",target:"maruntu",strength:.5605998807145509,citations:["Aink59","Aink99"]},{id:"yūra nī",source:"yūra",target:"nī",strength:.5605998807145509,citations:["Aink60","Aink81"]},{id:"uṇ kaṇ",source:"uṇ",target:"kaṇ",strength:.5625844958934104,citations:["Aink101","Aink16","Aink21","Aink37","Aink406"]},{id:"nal miku",source:"nal",target:"miku",strength:.5632186825647524,citations:["Aink120","Aink64"]},{id:"no/nō ākkam",source:"no/nō",target:"ākkam",strength:.5634052993525396,citations:["Aink101","Aink28","Aink99"]},{id:"varavu eṉap",source:"varavu",target:"eṉap",strength:.5658893452337569,citations:["Aink105","Aink72"]},{id:"kaṇ ēr",source:"kaṇ",target:"ēr",strength:.5672447743075586,citations:["Aink101","Aink72"]},{id:"vēṉal ākkam",source:"vēṉal",target:"ākkam",strength:.5713947650555288,citations:["Aink45","Aink54"]},{id:"a- vivaḷ",source:"a-",target:"vivaḷ",strength:.574186672497416,citations:["Aink54","Aink55","Aink56","Aink57"]},{id:"pūk ūr",source:"pūk",target:"ūr",strength:.5763273035809512,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"aṉṉai vāḻ",source:"aṉṉai",target:"vāḻ",strength:.5768699054918945,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204"],curvature:.25},{id:"vāḻ aṉṉai",source:"vāḻ",target:"aṉṉai",strength:.5768699054918945,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204"],curvature:.25},{id:"niṟaikkum ūr",source:"niṟaikkum",target:"ūr",strength:.5771345273474459,citations:["Aink47","Aink48"]},{id:"uṭai tuṟai",source:"uṭai",target:"tuṟai",strength:.58009869188993,citations:["Aink113","Aink20"]},{id:"mel tōḷ",source:"mel",target:"tōḷ",strength:.58009869188993,citations:["Aink120","Aink28"]},{id:"maṉai neṭu(m)",source:"maṉai",target:"neṭu(m)",strength:.58009869188993,citations:["Aink324","Aink60"]},{id:"e- taṭa(m)",source:"e-",target:"taṭa(m)",strength:.5878073075083894,citations:["Aink11"]},{id:"veḷ maṇal",source:"veḷ",target:"maṇal",strength:.5894033504865785,citations:["Aink105","Aink113"]},{id:"em tōḷ",source:"em",target:"tōḷ",strength:.5943080385461034,citations:["Aink108","Aink109"]},{id:"kaḷvaṉ kaḻaṉi",source:"kaḷvaṉ",target:"kaḻaṉi",strength:.5943080385461034,citations:["Aink25","Aink29"]},{id:"maṉai yāṅkaṇ",source:"maṉai",target:"yāṅkaṇ",strength:.5959833899991658,citations:["Aink48","Aink87"]},{id:"yāṉ i-",source:"yāṉ",target:"i-",strength:.5993978523143613,citations:["Aink118","Aink59"]},{id:"taṇṇ peru(m)",source:"taṇṇ",target:"peru(m)",strength:.5993978523143613,citations:["Aink123","Aink73"]},{id:"poṉ cey",source:"poṉ",target:"cey",strength:.5993978523143613,citations:["Aink316","Aink41"]},{id:"maka i-",source:"maka",target:"i-",strength:.6027173152024174,citations:["Aink100","Aink52","Aink79","Aink91","Aink96","Aink97","Aink98","Aink99"]},{id:"tāṉ col",source:"tāṉ",target:"col",strength:.6029010118097583,citations:["Aink38","Aink41"]},{id:"vēḻam pū(m)",source:"vēḻam",target:"pū(m)",strength:.604447571991156,citations:["Aink12","Aink17","Aink19"]},{id:"kaṇ al",source:"kaṇ",target:"al",strength:.6048576874827015,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"kēḷ talaimakaḷ",source:"kēḷ",target:"talaimakaḷ",strength:.610192736655339,citations:["Aink201","Aink221"]},{id:"puṉal aṭu",source:"puṉal",target:"aṭu",strength:.6126020989118534,citations:["Aink100","Aink15","Aink72"]},{id:"nōkkam nal",source:"nōkkam",target:"nal",strength:.6179013522737984,citations:["Aink204"]},{id:"maruntu ākkam",source:"maruntu",target:"ākkam",strength:.6212511337161343,citations:["Aink101","Aink59","Aink99"]},{id:"yuṇ kaṇ",source:"yuṇ",target:"kaṇ",strength:.6219274440166046,citations:["Aink126","Aink72"]},{id:"taṭpam ṇakam",source:"taṭpam",target:"ṇakam",strength:.6219274440166046,citations:["Aink27","Aink30"]},{id:"taṭpam maṇ",source:"taṭpam",target:"maṇ",strength:.6219274440166046,citations:["Aink27","Aink30"]},{id:"kāl āmpal",source:"kāl",target:"āmpal",strength:.6219274440166046,citations:["Aink34","Aink68"]},{id:"āṭu em",source:"āṭu",target:"em",strength:.6282013220863888,citations:["Aink77","Aink78"]},{id:"tēṉūr a-",source:"tēṉūr",target:"a-",strength:.6304585464605111,citations:["Aink54","Aink55","Aink57"]},{id:"puṉal āṭu",source:"puṉal",target:"āṭu",strength:.6316524059928701,citations:["Aink77","Aink78","Aink98"]},{id:"tuṟai yūraṉai",source:"tuṟai",target:"yūraṉai",strength:.6347813615989761,citations:["Aink20","Aink88"]},{id:"marutattup tuṟai",source:"marutattup",target:"tuṟai",strength:.6347813615989761,citations:["Aink31","Aink75"]},{id:"kañal ūr",source:"kañal",target:"ūr",strength:.6366488722102172,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"yūraṉ mārpu",source:"yūraṉ",target:"mārpu",strength:.6399187025939431,citations:["Aink14","Aink25","Aink29","Aink4"]},{id:"vēḻam veḷ",source:"vēḻam",target:"veḷ",strength:.6403014407971512,citations:["Aink13","Aink17","Aink19"]},{id:"koṇkaṉ nī",source:"koṇkaṉ",target:"nī",strength:.641039262700783,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128","Aink307"]},{id:"aṉṉai ūrp",source:"aṉṉai",target:"ūrp",strength:.6440860201956246,citations:["Aink104","Aink202"]},{id:"taṭpam yūraṉ",source:"taṭpam",target:"yūraṉ",strength:.6450917183112536,citations:["Aink10","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"ōkku pū(m)",source:"ōkku",target:"pū(m)",strength:.6489907082551493,citations:["Aink16","Aink33"]},{id:"aṟu kaḻaṉi",source:"aṟu",target:"kaḻaṉi",strength:.6489907082551493,citations:["Aink25","Aink29"]},{id:"poykaip pū(m)",source:"poykaip",target:"pū(m)",strength:.6489907082551493,citations:["Aink34","Aink97"]},{id:"marutattup peru(m)",source:"marutattup",target:"peru(m)",strength:.6540805220234072,citations:["Aink31","Aink75"]},{id:"tōḻaṉ mūrp",source:"tōḻaṉ",target:"mūrp",strength:.6540805220234072,citations:["Aink34","Aink35"]},{id:"aruḷ nī",source:"aruḷ",target:"nī",strength:.6540805220234072,citations:["Aink50"]},{id:"taṭpam tuṟai",source:"taṭpam",target:"tuṟai",strength:.6571487884501824,citations:["Aink10","Aink105","Aink115","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"vuṇ kaṇ",source:"vuṇ",target:"kaṇ",strength:.6579033559293629,citations:["Aink125","Aink36","Aink69"]},{id:"maṇal aṭu",source:"maṇal",target:"aṭu",strength:.664875406364385,citations:["Aink100","Aink15"]},{id:"vēḻam karuppu",source:"vēḻam",target:"karuppu",strength:.664875406364385,citations:["Aink12","Aink18"]},{id:"toṭi maṭa(m)",source:"toṭi",target:"maṭa(m)",strength:.664875406364385,citations:["Aink76","Aink98"]},{id:"mūtu ūr",source:"mūtu",target:"ūr",strength:.6683651899854924,citations:["Aink15","Aink372"]},{id:"peṟu nutal",source:"peṟu",target:"nutal",strength:.6735793331987864,citations:["Aink56","Aink94"]},{id:"aṉṉai namm",source:"aṉṉai",target:"namm",strength:.6813437134357675,citations:["Aink102","Aink104","Aink202"]},{id:"al urai",source:"al",target:"urai",strength:.6828839917954348,citations:["Aink66","Aink80"]},{id:"vāḻ yātaṉ",source:"vāḻ",target:"yātaṉ",strength:.6829610053930205,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"yātaṉ vāḻ",source:"yātaṉ",target:"vāḻ",strength:.6829610053930205,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"vāḻ yaviṉi",source:"vāḻ",target:"yaviṉi",strength:.6829610053930205,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"kaṇ koṇkaṉ",source:"kaṇ",target:"koṇkaṉ",strength:.6844076156153587,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"kaḻaṉi mārpu",source:"kaḻaṉi",target:"mārpu",strength:.6865321172683887,citations:["Aink25","Aink29","Aink4"]},{id:"ciṟa vēṭṭōḷ",source:"ciṟa",target:"vēṭṭōḷ",strength:.6883043808241058,citations:["Aink1","Aink10","Aink3"]},{id:"vāl iḻai",source:"vāl",target:"iḻai",strength:.6894640313080221,citations:["Aink0","Aink73"]},{id:"puṇar tuṇai",source:"puṇar",target:"tuṇai",strength:.6894640313080221,citations:["Aink15","Aink72"]},{id:"aṭu puṇar",source:"aṭu",target:"puṇar",strength:.6894640313080221,citations:["Aink15","Aink72"]},{id:"māṇ iḻai",source:"māṇ",target:"iḻai",strength:.6894640313080221,citations:["Aink42","Aink47"]},{id:"vāḻ vēṇṭu",source:"vāḻ",target:"vēṇṭu",strength:.689470702377854,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204"]},{id:"yāṇar ūr",source:"yāṇar",target:"ūr",strength:.6903113188080968,citations:["Aink1","Aink100","Aink42","Aink43","Aink49","Aink50","Aink70","Aink87"]},{id:"tuṟai yūraṉ",source:"tuṟai",target:"yūraṉ",strength:.6913652256945577,citations:["Aink10","Aink13","Aink14","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"tātu uṇ",source:"tātu",target:"uṇ",strength:.6919163555608268,citations:["Aink67","Aink82","Aink93"]},{id:"pūp uṇ",source:"pūp",target:"uṇ",strength:.6928784936232175,citations:["Aink101","Aink16"]},{id:"il lākuka",source:"il",target:"lākuka",strength:.6928784936232175,citations:["Aink8","Aink9"]},{id:"tāṉ uṇarntōr",source:"tāṉ",target:"uṇarntōr",strength:.6963816531186146,citations:["Aink38","Aink41"]},{id:"ciṟa veṉa",source:"ciṟa",target:"veṉa",strength:.7033356789933669,citations:["Aink1","Aink10","Aink3"]},{id:"pari neṭu(m)",source:"pari",target:"neṭu(m)",strength:.7036733779641954,citations:["Aink134","Aink95"]},{id:"yaḻi puṉal",source:"yaḻi",target:"puṉal",strength:.7113819935826547,citations:["Aink53","Aink78"]},{id:"puṉal āṭit",source:"puṉal",target:"āṭit",strength:.7113819935826547,citations:["Aink76","Aink80"]},{id:"vekuḷvōḷ kaṇ",source:"vekuḷvōḷ",target:"kaṇ",strength:.715408085325461,citations:["Aink84"]},{id:"naṉi ciṟa",source:"naṉi",target:"ciṟa",strength:.719558076073431,citations:["Aink10","Aink7"]},{id:"kaṭal tirai",source:"kaṭal",target:"tirai",strength:.719558076073431,citations:["Aink105","Aink107"]},{id:"karai vēḻam",source:"karai",target:"vēḻam",strength:.719558076073431,citations:["Aink12","Aink13"]},{id:"kaḻaṉit malar",source:"kaḻaṉit",target:"malar",strength:.719558076073431,citations:["Aink53","Aink94"]},{id:"ciṟu(m) miṉ",source:"ciṟu(m)",target:"miṉ",strength:.7282620029078324,citations:["Aink1","Aink10"]},{id:"oṇmai muṉ",source:"oṇmai",target:"muṉ",strength:.7282620029078324,citations:["Aink40","Aink83"]},{id:"lākuka vēṭṭōḷ",source:"lākuka",target:"vēṭṭōḷ",strength:.7282620029078324,citations:["Aink8","Aink9"]},{id:"taṭa(m) erumai",source:"taṭa(m)",target:"erumai",strength:.7282620029078324,citations:["Aink94","Aink98"]},{id:"pāvai yaṉṉa",source:"pāvai",target:"yaṉṉa",strength:.7375666615044809,citations:["Aink221","Aink307"]},{id:"curam cel",source:"curam",target:"cel",strength:.7391895477993621,citations:["Aink301","Aink307","Aink317"]},{id:"vāḻ tōḻaṉ",source:"vāḻ",target:"tōḻaṉ",strength:.7408538157049929,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink221","Aink31","Aink32","Aink33","Aink34","Aink35","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"tōḷ tuṟa",source:"tōḷ",target:"tuṟa",strength:.7424713495640056,citations:["Aink108","Aink109"]},{id:"em tuṟa",source:"em",target:"tuṟa",strength:.7424713495640056,citations:["Aink108","Aink109"]},{id:"puḷḷik kaḷvaṉ",source:"puḷḷik",target:"kaḷvaṉ",strength:.7424713495640056,citations:["Aink21","Aink22"]},{id:"lākuka veṉa",source:"lākuka",target:"veṉa",strength:.7424713495640056,citations:["Aink8","Aink9"]},{id:"kaḷvaṉ aṟu",source:"kaḷvaṉ",target:"aṟu",strength:.7443779516319833,citations:["Aink21","Aink25","Aink29"]},{id:"kaḻaṉi yūraṉ",source:"kaḻaṉi",target:"yūraṉ",strength:.7451913844630338,citations:["Aink18","Aink25","Aink29","Aink4","Aink91","Aink96"]},{id:"aṉpu il",source:"aṉpu",target:"il",strength:.7475611633322635,citations:["Aink138","Aink41"]},{id:"kuṇam koḷ",source:"kuṇam",target:"koḷ",strength:.7475611633322635,citations:["Aink90"]},{id:"putup puṉal",source:"putup",target:"puṉal",strength:.7515426364428741,citations:["Aink53","Aink64","Aink78","Aink79"]},{id:"yoḷ arivai",source:"yoḷ",target:"arivai",strength:.7528506278514695,citations:["Aink322","Aink73"]},{id:"val poy",source:"val",target:"poy",strength:.7528506278514695,citations:["Aink37"]},{id:"peṟu cuṭar",source:"peṟu",target:"cuṭar",strength:.7528506278514695,citations:["Aink56","Aink94"]},{id:"pūp pōl",source:"pūp",target:"pōl",strength:.7583560476732414,citations:["Aink101","Aink16"]},{id:"no/nō maruntu",source:"no/nō",target:"maruntu",strength:.7583560476732414,citations:["Aink101","Aink99"]},{id:"nām mūrp",source:"nām",target:"mūrp",strength:.7583560476732414,citations:["Aink34","Aink35"]},{id:"nām maṟa",source:"nām",target:"maṟa",strength:.7583560476732414,citations:["Aink36"]},{id:"puṟavam aṇi",source:"puṟavam",target:"aṇi",strength:.7583560476732414,citations:["Aink404","Aink405"]},{id:"al koṇkaṉ",source:"al",target:"koṇkaṉ",strength:.759381348693028,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"toṭi muṉ",source:"toṭi",target:"muṉ",strength:.7611815133569616,citations:["Aink38","Aink40","Aink83"]},{id:"tāmarai malar",source:"tāmarai",target:"malar",strength:.7611815133569616,citations:["Aink53","Aink68","Aink94"]},{id:"vēṇṭu namm",source:"vēṇṭu",target:"namm",strength:.7703889261013386,citations:["Aink102","Aink104","Aink202"]},{id:"cuṭar nutal",source:"cuṭar",target:"nutal",strength:.7703889261013386,citations:["Aink107","Aink56","Aink94"]},{id:"yoḷ nutal",source:"yoḷ",target:"nutal",strength:.7703889261013386,citations:["Aink123","Aink322","Aink73"]},{id:"keḻu koṭu(m)",source:"keḻu",target:"koṭu(m)",strength:.7763646331042912,citations:["Aink11","Aink12"]},{id:"poykai yāmpal",source:"poykai",target:"yāmpal",strength:.7763646331042912,citations:["Aink35","Aink91"]},{id:"aṇaṅku uṟu",source:"aṇaṅku",target:"uṟu",strength:.7763646331042912,citations:["Aink53","Aink58"]},{id:"mel pulak",source:"mel",target:"pulak",strength:.7829446726168784,citations:["Aink119","Aink138"]},{id:"maṉai nakar",source:"maṉai",target:"nakar",strength:.7829446726168784,citations:["Aink324","Aink60"]},{id:"yaviṉi pakai",source:"yaviṉi",target:"pakai",strength:.7829446726168784,citations:["Aink4","Aink6"]},{id:"vaṭṭi maṉai",source:"vaṭṭi",target:"maṉai",strength:.7829446726168784,citations:["Aink47","Aink48"]},{id:"pāy eṉak",source:"pāy",target:"eṉak",strength:.7829446726168784,citations:["Aink53","Aink73"]},{id:"taṭa(m) kōṭṭam",source:"taṭa(m)",target:"kōṭṭam",strength:.7829446726168784,citations:["Aink94","Aink98"]},{id:"koṇkaṉ kēḷ",source:"koṇkaṉ",target:"kēḷ",strength:.7849513316769816,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"amaintaṉaṉ tāṉ",source:"amaintaṉaṉ",target:"tāṉ",strength:.7898622944274709,citations:["Aink103"]},{id:"paṇait tōḷ",source:"paṇait",target:"tōḷ",strength:.7971540192730516,citations:["Aink135","Aink39"]},{id:"paca paṉi",source:"paca",target:"paṉi",strength:.7971540192730516,citations:["Aink141","Aink37"]},{id:"vayalaic ce(m)",source:"vayalaic",target:"ce(m)",strength:.7971540192730516,citations:["Aink25","Aink52"]},{id:"kaḷvaṉ ṇakam",source:"kaḷvaṉ",target:"ṇakam",strength:.7971540192730516,citations:["Aink27","Aink30"]},{id:"neṭu(m) nakar",source:"neṭu(m)",target:"nakar",strength:.7971540192730516,citations:["Aink324","Aink60"]},{id:"amma vāḻ",source:"amma",target:"vāḻ",strength:.8042419311333029,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink132","Aink139","Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40","Aink77","Aink89"]},{id:"yallaṉ e-",source:"yallaṉ",target:"e-",strength:.804862634891511,citations:["Aink11"]},{id:"aru(m) curam",source:"aru(m)",target:"curam",strength:.8130387173822874,citations:["Aink301","Aink317"]},{id:"vaḷai nekiḻ",source:"vaḷai",target:"nekiḻ",strength:.8217426442166887,citations:["Aink136","Aink54"]},{id:"maṇi niṟam",source:"maṇi",target:"niṟam",strength:.8217426442166887,citations:["Aink45","Aink96"]},{id:"mūr oṇmai",source:"mūr",target:"oṇmai",strength:.8217426442166887,citations:["Aink83","Aink92"]},{id:"vēṇṭu aṉṉai",source:"vēṇṭu",target:"aṉṉai",strength:.8357668782393644,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204"],curvature:.25},{id:"aṉṉai vēṇṭu",source:"aṉṉai",target:"vēṇṭu",strength:.8357668782393644,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204"],curvature:.25},{id:"nutal arivai",source:"nutal",target:"arivai",strength:.8461595079614669,citations:["Aink322","Aink404","Aink46","Aink73"]},{id:"vuṇ civa",source:"vuṇ",target:"civa",strength:.8518366889820976,citations:["Aink125","Aink69"]},{id:"mell am",source:"mell",target:"am",strength:.8518366889820976,citations:["Aink133","Aink302"]},{id:"maṟa amai",source:"maṟa",target:"amai",strength:.8518366889820976,citations:["Aink36"]},{id:"tēr taḷar",source:"tēr",target:"taḷar",strength:.8518366889820976,citations:["Aink403","Aink66"]},{id:"karu(m) kōṭṭam",source:"karu(m)",target:"kōṭṭam",strength:.8518366889820976,citations:["Aink92","Aink95"]},{id:"kōṭṭam erumai",source:"kōṭṭam",target:"erumai",strength:.8600696203591727,citations:["Aink94","Aink95","Aink98"]},{id:"malai nāṭu",source:"malai",target:"nāṭu",strength:.8764253139257348,citations:["Aink202","Aink221"]},{id:"mal val",source:"mal",target:"val",strength:.8764253139257348,citations:["Aink37"]},{id:"yaḻi putup",source:"yaḻi",target:"putup",strength:.8764253139257348,citations:["Aink53","Aink78"]},{id:"ciṟai putup",source:"ciṟai",target:"putup",strength:.8764253139257348,citations:["Aink53","Aink78"]},{id:"poy urai",source:"poy",target:"urai",strength:.8764253139257348,citations:["Aink66","Aink80"]},{id:"māṇ kuṇam",source:"māṇ",target:"kuṇam",strength:.8764253139257348,citations:["Aink90"]},{id:"tēṉūr vivaḷ",source:"tēṉūr",target:"vivaḷ",strength:.8791199274401895,citations:["Aink54","Aink55","Aink57"]},{id:"yāy yām",source:"yāy",target:"yām",strength:.8823349650912887,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"num mūr",source:"num",target:"mūr",strength:.890634660581908,citations:["Aink83","Aink92"]},{id:"vēṭṭōḷ yām",source:"vēṭṭōḷ",target:"yām",strength:.898752367280653,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"karai cēr",source:"karai",target:"cēr",strength:.9065193586911436,citations:["Aink12","Aink74"]},{id:"iv vūr",source:"iv",target:"vūr",strength:.9065193586911436,citations:["Aink132","Aink62"]},{id:"peyar uḻi",source:"peyar",target:"uḻi",strength:.9065193586911436,citations:["Aink204"]},{id:"nekiḻac cā",source:"nekiḻac",target:"cā",strength:.9065193586911436,citations:["Aink27","Aink28"]},{id:"col uṇarntōr",source:"col",target:"uṇarntōr",strength:.9065193586911436,citations:["Aink38","Aink41"]},{id:"kai vaḷ",source:"kai",target:"vaḷ",strength:.9065193586911436,citations:["Aink58","Aink61"]},{id:"amma tōḻaṉ",source:"amma",target:"tōḻaṉ",strength:.9130162974354511,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"el vaḷai",source:"el",target:"vaḷai",strength:.9271228674671441,citations:["Aink140","Aink20","Aink27"]},{id:"malir niṟai",source:"malir",target:"niṟai",strength:.9271228674671441,citations:["Aink15","Aink42","Aink72"]},{id:"oṇmai toṭi",source:"oṇmai",target:"toṭi",strength:.9276759861493247,citations:["Aink28","Aink40","Aink76","Aink83","Aink92"]},{id:"pūk kañal",source:"pūk",target:"kañal",strength:.939678431370734,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"ekkar ñāḻal",source:"ekkar",target:"ñāḻal",strength:.9438888298798713,citations:["Aink141","Aink142","Aink143","Aink144","Aink145"]},{id:"namm ūrp",source:"namm",target:"ūrp",strength:.945317330290954,citations:["Aink104","Aink202"]},{id:"muḷḷi vēr",source:"muḷḷi",target:"vēr",strength:.945317330290954,citations:["Aink22","Aink23"]},{id:"kaḻaṉit tāmarai",source:"kaḻaṉit",target:"tāmarai",strength:.945317330290954,citations:["Aink53","Aink94"]},{id:"veṉa yāy",source:"veṉa",target:"yāy",strength:.9660501439066637,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"veṉa vēṭṭōḷ",source:"veṉa",target:"vēṭṭōḷ",strength:.9821749043313723,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"vēṭṭōḷ yāy",source:"vēṭṭōḷ",target:"yāy",strength:.9835825978106357,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"yātaṉ yaviṉi",source:"yātaṉ",target:"yaviṉi",strength:1,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"ṇakam maṇ",source:"ṇakam",target:"maṇ",strength:1,citations:["Aink27","Aink30"]},{id:"titti yalkul",source:"titti",target:"yalkul",strength:1,citations:["Aink29","Aink72"]},{id:"ciṟai yaḻi",source:"ciṟai",target:"yaḻi",strength:1,citations:["Aink53","Aink78"]}],Ma={nodes:OA,links:IA},NA=n=>{const t=1+200/Math.hypot(n.x,n.y,n.z),i=n.x||n.y||n.z?{x:n.x*t,y:n.y*t,z:n.z*t}:{x:0,y:0,z:200};Sa.cameraPosition(i,n,1e3)},Sa=_A(),UA=()=>{const n=new Map([["adjective","#66c2a5"],["noun","#fc8d62"],["pronoun","#8da0cb"],["verb","#e78ac3"],["other","#a6d854"]]),e=document.getElementById("panellegend");e.innerHTML=[...n].map(i=>`<div><input type="checkbox" name="${i[0]}" checked autocomplete="off"/><label><span style="color:${i[1]}; font-size: 150%">●</span> ${i[0]}</div>`).join("")+'<div id="solonodes"><input type="checkbox" name="solonodes" checked autocomplete="off"/><label>Show unconnected nodes</label></div>';const t=structuredClone(Ma.links).filter(i=>i.strength>=.45);Sa(document.getElementById("colgraph")).graphData({nodes:Ma.nodes,links:t}).nodeLabel(i=>`${i.size} occurences`).nodeThreeObject(i=>{const r=new DA(i.id);return r.material.depthWrite=!1,r.color=n.get(i.type)||n.get("other"),r.textHeight=i.size/2<8?8:i.size/2,r}).linkWidth(i=>i.strength*5).linkOpacity(.3).linkDirectionalArrowLength(5).linkCurvature(i=>i.curvature||0).linkLabel(i=>`${i.citations.join(", ")} (NPMI: ${i.strength.toPrecision(4)})`).onNodeClick(NA),Sa.d3Force("link").distance(i=>40/i.strength)},FA=n=>{const e=document.getElementById("panel");e.style.display!=="flex"?(e.animate([{marginTop:"-25px"},{marginTop:"0px"}],{duration:200,iterations:1}),e.style.display="flex",n.target.textContent="⇧"):(e.animate([{marginTop:"0px"},{marginTop:"-25px"}],{duration:200,iterations:1}),setTimeout(()=>e.style.display="none",200),n.target.textContent="⇩")},BA=n=>{const e=new Set;for(const t of n)e.add(t.source),e.add(t.target);return e},HA=()=>{const n={};n.nodes=Ma.nodes,n.links=structuredClone(Ma.links);const e=document.getElementById("npmi").value;n.links=n.links.filter(r=>r.strength>=e);const t=document.getElementById("panellegend").querySelectorAll('input:not([name="solonodes"])'),i=new Set([...t].filter(r=>r.checked).map(r=>r.getAttribute("name")));if(i.size!==t.length){n.nodes=n.nodes.filter(a=>i.has(a.type));const r=new Set(n.nodes.map(a=>a.id));n.links=n.links.filter(a=>r.has(a.target)&&r.has(a.source))}if(!document.querySelector('input[name="solonodes"]').checked){const r=BA(n.links);n.nodes=n.nodes.filter(a=>r.has(a.id))}Sa.graphData(n)};document.getElementById("paneltoggle").addEventListener("click",FA);document.getElementById("graphupdate").addEventListener("click",HA);UA();
