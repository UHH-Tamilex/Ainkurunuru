...
void main() {
	...
	#include <fog_fragment>
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function qc(){return new Tn({name:"EquirectangularToCubeUV",uniforms:{envMap:{value:null}},vertexShader:bo(),fragmentShader:`
		...
		`,blending:An,depthTest:!1,depthWrite:!1})}function Yc(){return new Tn({name:"CubemapToCubeUV",uniforms:{envMap:{value:null},flipEnvMap:{value:-1}},vertexShader:bo(),fragmentShader:`
...
`:"";t.isRawShaderMaterial?(h=["#define SHADER_TYPE "+t.shaderType,"#define SHADER_NAME "+t.shaderName,v].filter(ki).join(`
`),h.length>0&&(h+=`
...
Object.defineProperty(this, '{var}', {
  ...
  Vector.prototype.reset = function () {
    ${t("this.{var} = ",{join:""})}0;
  };`}var My=xr.exports,Gn={exports:{}};const Lo=Vi,On=vd;Gn.exports=Ay;Gn.exports.generateQuadTreeFunctionBody=Md;Gn.exports.getInsertStackCode=Td;Gn.exports.getQuadNodeCode=wd;Gn.exports.isSamePosition=Ad;Gn.exports.getChildBodyCode=Ed;Gn.exports.setChildBodyCode=Sd;function Ay(n){let e=Md(n);return new Function(e)()}function Md(n){let e=Lo(n),t=Math.pow(2,n);return`
${Td()}
${wd(n)}
${Ad(n)}
${Ed(n)}
...
`)}}function Ad(n){let e=Lo(n);return`
...
`}var Sy=Gn.exports,zo={exports:{}};zo.exports=wy;zo.exports.generateFunctionBody=Cd;const Ey=Vi;function wy(n){let e=Cd(n);return new Function("bodies","settings","random",e)}function Cd(n){let e=Ey(n);return`
  var boundingBox = {
...
`}var Ty=zo.exports,Do={exports:{}};const Cy=Vi;Do.exports=Ry;Do.exports.generateCreateDragForceFunctionBody=Rd;function Ry(n){let e=Rd(n);return new Function("options",e)}function Rd(n){return`
...
`}var ky=Do.exports,Oo={exports:{}};const Py=Vi;Oo.exports=Ly;Oo.exports.generateCreateSpringForceFunctionBody=kd;function Ly(n){let e=kd(n);return new Function("options","random",e)}function kd(n){let e=Py(n);return`
...
`}var Iy=Io.exports,Ss,Ol;function Ny(){if(Ol)return Ss;Ol=1,Ss=n;function n(e,t,i,r){this.from=e,this.to=t,this.length=i,this.coefficient=r}return Ss}var Es,Il;function Uy(){if(Il)return Es;Il=1,Es=n;function n(e,t){var i;if(e||(e={}),t){for(i in t)if(t.hasOwnProperty(i)){var r=e.hasOwnProperty(i),a=typeof t[i],s=!r||typeof e[i]!==a;s?e[i]=t[i]:a==="object"&&(e[i]=n(e[i],t[i]))}}return e}return Es}var er={exports:{}},Nl;function Fy(){if(Nl)return er.exports;Nl=1,er.exports=n,er.exports.random=n,er.exports.randomIterator=o;function n(c){var l=typeof c=="number"?c:+new Date;return new e(l)}function e(c){this.seed=c}e.prototype.next=s,e.prototype.nextDouble=a,e.prototype.uniform=a,e.prototype.gaussian=t;function t(){var c,l,u;do l=this.nextDouble()*2-1,u=this.nextDouble()*2-1,c=l*l+u*u;while(c>=1||c===0);return l*Math.sqrt(-2*Math.log(c)/c)}e.prototype.levy=i;function i(){var c=1.5,l=Math.pow(r(1+c)*Math.sin(Math.PI*c/2)/(r((1+c)/2)*c*Math.pow(2,(c-1)/2)),1/c);return this.gaussian()*l/Math.pow(Math.abs(this.gaussian()),1/c)}function r(c){return Math.sqrt(2*Math.PI/c)*Math.pow(1/Math.E*(c+1/(12*c-1/(10*c))),c)}function a(){var c=this.seed;return c=c+2127912214+(c<<12)&4294967295,c=(c^3345072700^c>>>19)&4294967295,c=c+374761393+(c<<5)&4294967295,c=(c+3550635116^c<<9)&4294967295,c=c+4251993797+(c<<3)&4294967295,c=(c^3042594569^c>>>16)&4294967295,this.seed=c,(c&268435455)/268435456}function s(c){return Math.floor(this.nextDouble()*c)}function o(c,l){var u=l||n();if(typeof u.next!="function")throw new Error("customRandom does not match expected API: next() function is missing");return{forEach:f,shuffle:d};function d(){var m,g,v;for(m=c.length-1;m>0;--m)g=u.next(m+1),v=c[g],c[g]=c[m],c[m]=v;return c}function f(m){var g,v,p;for(g=c.length-1;g>0;--g)v=u.next(g+1),p=c[v],c[v]=c[g],c[g]=p,m(p);c.length&&m(c[0])}}return er.exports}var Ld=Xy,By=My,Hy=Sy,Gy=Ty,Vy=ky,Wy=zy,jy=Iy,Ul={};function Xy(n){var e=Ny(),t=Uy(),i=ko;if(n){if(n.springCoeff!==void 0)throw new Error("springCoeff was renamed to springCoefficient");if(n.dragCoeff!==void 0)throw new Error("dragCoeff was renamed to dragCoefficient")}n=t(n,{springLength:10,springCoefficient:.8,gravity:-12,theta:.8,dragCoefficient:.9,timeStep:.5,adaptiveTimeStepWeight:0,dimensions:2,debug:!1});var r=Ul[n.dimensions];if(!r){var a=n.dimensions;r={Body:By(a,n.debug),createQuadTree:Hy(a),createBounds:Gy(a),createDragForce:Vy(a),createSpringForce:Wy(a),integrate:jy(a)},Ul[a]=r}var s=r.Body,o=r.createQuadTree,c=r.createBounds,l=r.createDragForce,u=r.createSpringForce,d=r.integrate,f=k=>new s(k),m=Fy().random(42),g=[],v=[],p=o(n,m),h=c(g,n,m),x=u(n,m),_=l(n),y=0,M=[],A=new Map,E=0;w("nbody",ee),w("spring",C);var P={bodies:g,quadTree:p,springs:v,settings:n,addForce:w,removeForce:N,getForces:U,step:function(){for(var k=0;k<M.length;++k)M[k](E);var D=d(g,n.timeStep,n.adaptiveTimeStepWeight);return E+=1,D},addBody:function(k){if(!k)throw new Error("Body is required");return g.push(k),k},addBodyAt:function(k){if(!k)throw new Error("Body position is required");var D=f(k);return g.push(D),D},removeBody:function(k){if(k){var D=g.indexOf(k);if(!(D<0))return g.splice(D,1),g.length===0&&h.reset(),!0}},addSpring:function(k,D,K,J){if(!k||!D)throw new Error("Cannot add null spring to force simulator");typeof K!="number"&&(K=-1);var te=new e(k,D,K,J>=0?J:-1);return v.push(te),te},getTotalMovement:function(){return y},removeSpring:function(k){if(k){var D=v.indexOf(k);if(D>-1)return v.splice(D,1),!0}},getBestNewBodyPosition:function(k){return h.getBestNewPosition(k)},getBBox:b,getBoundingBox:b,invalidateBBox:function(){console.warn("invalidateBBox() is deprecated, bounds always recomputed on `getBBox()` call")},gravity:function(k){return k!==void 0?(n.gravity=k,p.options({gravity:k}),this):n.gravity},theta:function(k){return k!==void 0?(n.theta=k,p.options({theta:k}),this):n.theta},random:m};return $y(n,P),i(P),P;function b(){return h.update(),h.box}function w(k,D){if(A.has(k))throw new Error("Force "+k+" is already added");A.set(k,D),M.push(D)}function N(k){var D=M.indexOf(A.get(k));D<0||(M.splice(D,1),A.delete(k))}function U(){return A}function ee(){if(g.length!==0){p.insertBodies(g);for(var k=g.length;k--;){var D=g[k];D.isPinned||(D.reset(),p.updateBodyForce(D),_.update(D))}}}function C(){for(var k=v.length;k--;)x.update(v[k])}}function $y(n,e){for(var t in n)qy(n,e,t)}function qy(n,e,t){if(n.hasOwnProperty(t)&&typeof e[t]!="function"){var i=Number.isFinite(n[t]);i?e[t]=function(r){if(r!==void 0){if(!Number.isFinite(r))throw new Error("Value of "+t+" should be a valid number.");return n[t]=r,e}return n[t]}:e[t]=function(r){return r!==void 0?(n[t]=r,e):n[t]}}}Po.exports=Ky;Po.exports.simulator=Ld;var Yy=ko;function Ky(n,e){if(!n)throw new Error("Graph structure cannot be undefined");var t=e&&e.createSimulator||Ld,i=t(e);if(Array.isArray(e))throw new Error("Physics settings is expected to be an object");var r=n.version>19?ee:U;e&&typeof e.nodeMass=="function"&&(r=e.nodeMass);var a=new Map,s={},o=0,c=i.settings.springTransform||Zy;_(),p();var l=!1,u={step:function(){if(o===0)return d(!0),!0;var C=i.step();u.lastMove=C,u.fire("step");var k=C/o,D=k<=.01;return d(D),D},getNodePosition:function(C){return N(C).pos},setNodePosition:function(C){var k=N(C);k.setPosition.apply(k,Array.prototype.slice.call(arguments,1))},getLinkPosition:function(C){var k=s[C];if(k)return{from:k.from.pos,to:k.to.pos}},getGraphRect:function(){return i.getBBox()},forEachBody:f,pinNode:function(C,k){var D=N(C.id);D.isPinned=!!k},isNodePinned:function(C){return N(C.id).isPinned},dispose:function(){n.off("changed",x),u.fire("disposed")},getBody:v,getSpring:g,getForceVectorLength:m,simulator:i,graph:n,lastMove:0};return Yy(u),u;function d(C){l!==C&&(l=C,h(C))}function f(C){a.forEach(C)}function m(){var C=0,k=0;return f(function(D){C+=Math.abs(D.force.x),k+=Math.abs(D.force.y)}),Math.sqrt(C*C+k*k)}function g(C,k){var D;if(k===void 0)typeof C!="object"?D=C:D=C.id;else{var K=n.hasLink(C,k);if(!K)return;D=K.id}return s[D]}function v(C){return a.get(C)}function p(){n.on("changed",x)}function h(C){u.fire("stable",C)}function x(C){for(var k=0;k<C.length;++k){var D=C[k];D.changeType==="add"?(D.node&&y(D.node.id),D.link&&A(D.link)):D.changeType==="remove"&&(D.node&&M(D.node),D.link&&E(D.link))}o=n.getNodesCount()}function _(){o=0,n.forEachNode(function(C){y(C.id),o+=1}),n.forEachLink(A)}function y(C){var k=a.get(C);if(!k){var D=n.getNode(C);if(!D)throw new Error("initBody() was called with unknown node id");var K=D.position;if(!K){var J=P(D);K=i.getBestNewBodyPosition(J)}k=i.addBodyAt(K),k.id=C,a.set(C,k),b(C),w(D)&&(k.isPinned=!0)}}function M(C){var k=C.id,D=a.get(k);D&&(a.delete(k),i.removeBody(D))}function A(C){b(C.fromId),b(C.toId);var k=a.get(C.fromId),D=a.get(C.toId),K=i.addSpring(k,D,C.length);c(C,K),s[C.id]=K}function E(C){var k=s[C.id];if(k){var D=n.getNode(C.fromId),K=n.getNode(C.toId);D&&b(D.id),K&&b(K.id),delete s[C.id],i.removeSpring(k)}}function P(C){var k=[];if(!C.links)return k;for(var D=Math.min(C.links.length,2),K=0;K<D;++K){var J=C.links[K],te=J.fromId!==C.id?a.get(J.fromId):a.get(J.toId);te&&te.pos&&k.push(te)}return k}function b(C){var k=a.get(C);if(k.mass=r(C),Number.isNaN(k.mass))throw new Error("Node mass should be a number")}function w(C){return C&&(C.isPinned||C.data&&C.data.isPinned)}function N(C){var k=a.get(C);return k||(y(C),k=a.get(C)),k}function U(C){var k=n.getLinks(C);return k?1+k.length/3:1}function ee(C){var k=n.getLinks(C);return k?1+k.size/3:1}}function Zy(){}var Jy=Po.exports;const Qy=gd(Jy);function Ys(n){var e=typeof n;return n!=null&&(e=="object"||e=="function")}var ex=typeof global=="object"&&global&&global.Object===Object&&global,tx=typeof self=="object"&&self&&self.Object===Object&&self,zd=ex||tx||Function("return this")(),ws=function(){return zd.Date.now()},nx=/\s/;function ix(n){for(var e=n.length;e--&&nx.test(n.charAt(e)););return e}var rx=/^\s+/;function ax(n){return n&&n.slice(0,ix(n)+1).replace(rx,"")}var va=zd.Symbol,Dd=Object.prototype,sx=Dd.hasOwnProperty,ox=Dd.toString,tr=va?va.toStringTag:void 0;function cx(n){var e=sx.call(n,tr),t=n[tr];try{n[tr]=void 0;var i=!0}catch{}var r=ox.call(n);return i&&(e?n[tr]=t:delete n[tr]),r}var lx=Object.prototype,ux=lx.toString;function dx(n){return ux.call(n)}var hx="[object Null]",fx="[object Undefined]",Fl=va?va.toStringTag:void 0;function px(n){return n==null?n===void 0?fx:hx:Fl&&Fl in Object(n)?cx(n):dx(n)}function mx(n){return n!=null&&typeof n=="object"}var gx="[object Symbol]";function vx(n){return typeof n=="symbol"||mx(n)&&px(n)==gx}var Bl=NaN,_x=/^[-+]0x[0-9a-f]+$/i,yx=/^0b[01]+$/i,xx=/^0o[0-7]+$/i,bx=parseInt;function Hl(n){if(typeof n=="number")return n;if(vx(n))return Bl;if(Ys(n)){var e=typeof n.valueOf=="function"?n.valueOf():n;n=Ys(e)?e+"":e}if(typeof n!="string")return n===0?n:+n;n=ax(n);var t=yx.test(n);return t||xx.test(n)?bx(n.slice(2),t?2:8):_x.test(n)?Bl:+n}var Mx="Expected a function",Ax=Math.max,Sx=Math.min;function Ex(n,e,t){var i,r,a,s,o,c,l=0,u=!1,d=!1,f=!0;if(typeof n!="function")throw new TypeError(Mx);e=Hl(e)||0,Ys(t)&&(u=!!t.leading,d="maxWait"in t,a=d?Ax(Hl(t.maxWait)||0,e):a,f="trailing"in t?!!t.trailing:f);function m(A){var E=i,P=r;return i=r=void 0,l=A,s=n.apply(P,E),s}function g(A){return l=A,o=setTimeout(h,e),u?m(A):s}function v(A){var E=A-c,P=A-l,b=e-E;return d?Sx(b,a-P):b}function p(A){var E=A-c,P=A-l;return c===void 0||E>=e||E<0||d&&P>=a}function h(){var A=ws();if(p(A))return x(A);o=setTimeout(h,v(A))}function x(A){return o=void 0,f&&i?m(A):(i=r=void 0,s)}function _(){o!==void 0&&clearTimeout(o),l=0,i=c=r=o=void 0}function y(){return o===void 0?s:x(ws())}function M(){var A=ws(),E=p(A);if(i=arguments,r=this,c=A,E){if(o===void 0)return g(c);if(d)return clearTimeout(o),o=setTimeout(h,e),m(c)}return o===void 0&&(o=setTimeout(h,e)),s}return M.cancel=_,M.flush=y,M}function wx(n,e){var t=n==null?null:typeof Symbol<"u"&&n[Symbol.iterator]||n["@@iterator"];if(t!=null){var i,r,a,s,o=[],c=!0,l=!1;try{if(a=(t=t.call(n)).next,e===0){if(Object(t)!==t)return;c=!1}else for(;!(c=(i=a.call(t)).done)&&(o.push(i.value),o.length!==e);c=!0);}catch(u){l=!0,r=u}finally{try{if(!c&&t.return!=null&&(s=t.return(),Object(s)!==s))return}finally{if(l)throw r}}return o}}function Tx(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function Gl(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,Dx(i.key),i)}}function Cx(n,e,t){return e&&Gl(n.prototype,e),t&&Gl(n,t),Object.defineProperty(n,"prototype",{writable:!1}),n}function Rx(n,e){return kx(n)||wx(n,e)||Px(n,e)||Lx()}function kx(n){if(Array.isArray(n))return n}function Px(n,e){if(n){if(typeof n=="string")return Vl(n,e);var t=Object.prototype.toString.call(n).slice(8,-1);if(t==="Object"&&n.constructor&&(t=n.constructor.name),t==="Map"||t==="Set")return Array.from(n);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Vl(n,e)}}function Vl(n,e){(e==null||e>n.length)&&(e=n.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=n[t];return i}function Lx(){throw new TypeError(`Invalid attempt to destructure non-iterable instance.
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function zx(n,e){if(typeof n!="object"||n===null)return n;var t=n[Symbol.toPrimitive];if(t!==void 0){var i=t.call(n,e||"default");if(typeof i!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function Dx(n){var e=zx(n,"string");return typeof e=="symbol"?e:String(e)}var Ox=Cx(function n(e,t){var i=t.default,r=i===void 0?null:i,a=t.triggerUpdate,s=a===void 0?!0:a,o=t.onChange,c=o===void 0?function(l,u){}:o;Tx(this,n),this.name=e,this.defaultVal=r,this.triggerUpdate=s,this.onChange=c});function No(n){var e=n.stateInit,t=e===void 0?function(){return{}}:e,i=n.props,r=i===void 0?{}:i,a=n.methods,s=a===void 0?{}:a,o=n.aliases,c=o===void 0?{}:o,l=n.init,u=l===void 0?function(){}:l,d=n.update,f=d===void 0?function(){}:d,m=Object.keys(r).map(function(g){return new Ox(g,r[g])});return function(){var g=arguments.length>0&&arguments[0]!==void 0?arguments[0]:{},v=Object.assign({},t instanceof Function?t(g):t,{initialised:!1}),p={};function h(y){return x(y,g),_(),h}var x=function(M,A){u.call(h,M,v,A),v.initialised=!0},_=Ex(function(){v.initialised&&(f.call(h,v,p),p={})},1);return m.forEach(function(y){h[y.name]=M(y);function M(A){var E=A.name,P=A.triggerUpdate,b=P===void 0?!1:P,w=A.onChange,N=w===void 0?function(C,k){}:w,U=A.defaultVal,ee=U===void 0?null:U;return function(C){var k=v[E];if(!arguments.length)return k;var D=C===void 0?ee:C;return v[E]=D,N.call(h,D,v,k),!p.hasOwnProperty(E)&&(p[E]=k),b&&_(),h}}}),Object.keys(s).forEach(function(y){h[y]=function(){for(var M,A=arguments.length,E=new Array(A),P=0;P<A;P++)E[P]=arguments[P];return(M=s[y]).call.apply(M,[h,v].concat(E))}}),Object.entries(c).forEach(function(y){var M=Rx(y,2),A=M[0],E=M[1];return h[A]=h[E]}),h.resetProps=function(){return m.forEach(function(y){h[y.name](y.defaultVal)}),h},h.resetProps(),v._rerender=_,h}}var Ye=function(n){return typeof n=="function"?n:typeof n=="string"?function(e){return e[n]}:function(e){return n}};class Wl extends Map{constructor(e,t=Ux){if(super(),Object.defineProperties(this,{_intern:{value:new Map},_key:{value:t}}),e!=null)for(const[i,r]of e)this.set(i,r)}get(e){return super.get(jl(this,e))}has(e){return super.has(jl(this,e))}set(e,t){return super.set(Ix(this,e),t)}delete(e){return super.delete(Nx(this,e))}}function jl({_intern:n,_key:e},t){const i=e(t);return n.has(i)?n.get(i):t}function Ix({_intern:n,_key:e},t){const i=e(t);return n.has(i)?n.get(i):(n.set(i,t),t)}function Nx({_intern:n,_key:e},t){const i=e(t);return n.has(i)&&(t=n.get(i),n.delete(i)),t}function Ux(n){return n!==null&&typeof n=="object"?n.valueOf():n}function Fx(n,e){let t;if(e===void 0)for(const i of n)i!=null&&(t<i||t===void 0&&i>=i)&&(t=i);else{let i=-1;for(let r of n)(r=e(r,++i,n))!=null&&(t<r||t===void 0&&r>=r)&&(t=r)}return t}function Bx(n,e){let t;if(e===void 0)for(const i of n)i!=null&&(t>i||t===void 0&&i>=i)&&(t=i);else{let i=-1;for(let r of n)(r=e(r,++i,n))!=null&&(t>r||t===void 0&&r>=r)&&(t=r)}return t}function Hx(n,e){var t=n==null?null:typeof Symbol<"u"&&n[Symbol.iterator]||n["@@iterator"];if(t!=null){var i,r,a,s,o=[],c=!0,l=!1;try{if(a=(t=t.call(n)).next,e===0){if(Object(t)!==t)return;c=!1}else for(;!(c=(i=a.call(t)).done)&&(o.push(i.value),o.length!==e);c=!0);}catch(u){l=!0,r=u}finally{try{if(!c&&t.return!=null&&(s=t.return(),Object(s)!==s))return}finally{if(l)throw r}}return o}}function Gx(n,e){if(n==null)return{};var t={},i=Object.keys(n),r,a;for(a=0;a<i.length;a++)r=i[a],!(e.indexOf(r)>=0)&&(t[r]=n[r]);return t}function Vx(n,e){if(n==null)return{};var t=Gx(n,e),i,r;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(n);for(r=0;r<a.length;r++)i=a[r],!(e.indexOf(i)>=0)&&Object.prototype.propertyIsEnumerable.call(n,i)&&(t[i]=n[i])}return t}function Wx(n,e){return $x(n)||Hx(n,e)||Od(n,e)||Kx()}function jx(n){return Xx(n)||qx(n)||Od(n)||Yx()}function Xx(n){if(Array.isArray(n))return Ks(n)}function $x(n){if(Array.isArray(n))return n}function qx(n){if(typeof Symbol<"u"&&n[Symbol.iterator]!=null||n["@@iterator"]!=null)return Array.from(n)}function Od(n,e){if(n){if(typeof n=="string")return Ks(n,e);var t=Object.prototype.toString.call(n).slice(8,-1);if(t==="Object"&&n.constructor&&(t=n.constructor.name),t==="Map"||t==="Set")return Array.from(n);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return Ks(n,e)}}function Ks(n,e){(e==null||e>n.length)&&(e=n.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=n[t];return i}function Yx(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function cb(n,e){if(typeof n!="object"||n===null)return n;var t=n[Symbol.toPrimitive];if(t!==void 0){var i=t.call(n,e||"default");if(typeof i!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function lb(n){var e=cb(n,"string");return typeof e=="symbol"?e:String(e)}var ub=["createObj","updateObj","exitObj","objBindAttr","dataBindAttr"];function db(n,e,t){var i={enter:[],update:[],exit:[]};if(t){var s=Xl(n,t,!1),o=Xl(e,t,!1),c=Object.assign({},s,o);Object.entries(c).forEach(function(l){var u=Nd(l,2),d=u[0],f=u[1],m=s.hasOwnProperty(d)?o.hasOwnProperty(d)?"update":"exit":"enter";i[m].push(m==="update"?[s[d],o[d]]:f)})}else{var r=new Set(n),a=new Set(e);new Set([].concat(_a(r),_a(a))).forEach(function(l){var u=r.has(l)?a.has(l)?"update":"exit":"enter";i[u].push(u==="update"?[l,l]:l)})}return i}function hb(n,e,t){var i=t.objBindAttr,r=i===void 0?"__obj":i,a=t.dataBindAttr,s=a===void 0?"__data":a,o=t.idAccessor,c=t.purge,l=c===void 0?!1:c,u=function(p){return p.hasOwnProperty(s)},d=e.filter(function(v){return!u(v)}),f=e.filter(u).map(function(v){return v[s]}),m=n,g=l?{enter:m,exit:f,update:[]}:db(f,m,o);return g.update=g.update.map(function(v){var p=Nd(v,2),h=p[0],x=p[1];return h!==x&&(x[r]=h[r],x[r][s]=x),x}),g.exit=g.exit.concat(d.map(function(v){return Id({},r,v)})),g}function fb(n,e,t,i,r){var a=r.createObj,s=a===void 0?function(P){return{}}:a,o=r.updateObj,c=o===void 0?function(P,b){}:o,l=r.exitObj,u=l===void 0?function(P){}:l,d=r.objBindAttr,f=d===void 0?"__obj":d,m=r.dataBindAttr,g=m===void 0?"__data":m,v=nb(r,ub),p=hb(n,e,eb({objBindAttr:f,dataBindAttr:g},v)),h=p.enter,x=p.update,_=p.exit;_.forEach(function(P){var b=P[f];delete P[f],u(b),i(b)});var y=A(h),M=[].concat(_a(h),_a(x));E(M),y.forEach(t);function A(P){var b=[];return P.forEach(function(w){var N=s(w);N&&(N[g]=w,w[f]=N,b.push(N))}),b}function E(P){P.forEach(function(b){var w=b[f];w&&(w[g]=b,c(w,b))})}}function pb(n,e){switch(arguments.length){case 0:break;case 1:this.range(n);break;default:this.range(e).domain(n);break}return this}const ql=Symbol("implicit");function Fd(){var n=new Wl,e=[],t=[],i=ql;function r(a){let s=n.get(a);if(s===void 0){if(i!==ql)return i;n.set(a,s=e.push(a)-1)}return t[s%t.length]}return r.domain=function(a){if(!arguments.length)return e.slice();e=[],n=new Wl;for(const s of a)n.has(s)||n.set(s,e.push(s)-1);return r},r.range=function(a){return arguments.length?(t=Array.from(a),r):t.slice()},r.unknown=function(a){return arguments.length?(i=a,r):i},r.copy=function(){return Fd(e,t).unknown(i)},pb.apply(r,arguments),r}function mb(n){for(var e=n.length/6|0,t=new Array(e),i=0;i<e;)t[i]="#"+n.slice(i*6,++i*6);return t}const gb=mb("a6cee31f78b4b2df8a33a02cfb9a99e31a1cfdbf6fff7f00cab2d66a3d9affff99b15928");function ya(n){"@babel/helpers - typeof";return ya=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},ya(n)}var vb=/^\s+/,_b=/\s+$/;function Ae(n,e){if(n=n||"",e=e||{},n instanceof Ae)return n;if(!(this instanceof Ae))return new Ae(n,e);var t=yb(n);this._originalInput=n,this._r=t.r,this._g=t.g,this._b=t.b,this._a=t.a,this._roundA=Math.round(100*this._a)/100,this._format=e.format||t.format,this._gradientType=e.gradientType,this._r<1&&(this._r=Math.round(this._r)),this._g<1&&(this._g=Math.round(this._g)),this._b<1&&(this._b=Math.round(this._b)),this._ok=t.ok}Ae.prototype={isDark:function(){return this.getBrightness()<128},isLight:function(){return!this.isDark()},isValid:function(){return this._ok},getOriginalInput:function(){return this._originalInput},getFormat:function(){return this._format},getAlpha:function(){return this._a},getBrightness:function(){var e=this.toRgb();return(e.r*299+e.g*587+e.b*114)/1e3},getLuminance:function(){var e=this.toRgb(),t,i,r,a,s,o;return t=e.r/255,i=e.g/255,r=e.b/255,t<=.03928?a=t/12.92:a=Math.pow((t+.055)/1.055,2.4),i<=.03928?s=i/12.92:s=Math.pow((i+.055)/1.055,2.4),r<=.03928?o=r/12.92:o=Math.pow((r+.055)/1.055,2.4),.2126*a+.7152*s+.0722*o},setAlpha:function(e){return this._a=Bd(e),this._roundA=Math.round(100*this._a)/100,this},toHsv:function(){var e=Kl(this._r,this._g,this._b);return{h:e.h*360,s:e.s,v:e.v,a:this._a}},toHsvString:function(){var e=Kl(this._r,this._g,this._b),t=Math.round(e.h*360),i=Math.round(e.s*100),r=Math.round(e.v*100);return this._a==1?"hsv("+t+", "+i+"%, "+r+"%)":"hsva("+t+", "+i+"%, "+r+"%, "+this._roundA+")"},toHsl:function(){var e=Yl(this._r,this._g,this._b);return{h:e.h*360,s:e.s,l:e.l,a:this._a}},toHslString:function(){var e=Yl(this._r,this._g,this._b),t=Math.round(e.h*360),i=Math.round(e.s*100),r=Math.round(e.l*100);return this._a==1?"hsl("+t+", "+i+"%, "+r+"%)":"hsla("+t+", "+i+"%, "+r+"%, "+this._roundA+")"},toHex:function(e){return Zl(this._r,this._g,this._b,e)},toHexString:function(e){return"#"+this.toHex(e)},toHex8:function(e){return Ab(this._r,this._g,this._b,this._a,e)},toHex8String:function(e){return"#"+this.toHex8(e)},toRgb:function(){return{r:Math.round(this._r),g:Math.round(this._g),b:Math.round(this._b),a:this._a}},toRgbString:function(){return this._a==1?"rgb("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+")":"rgba("+Math.round(this._r)+", "+Math.round(this._g)+", "+Math.round(this._b)+", "+this._roundA+")"},toPercentageRgb:function(){return{r:Math.round(rt(this._r,255)*100)+"%",g:Math.round(rt(this._g,255)*100)+"%",b:Math.round(rt(this._b,255)*100)+"%",a:this._a}},toPercentageRgbString:function(){return this._a==1?"rgb("+Math.round(rt(this._r,255)*100)+"%, "+Math.round(rt(this._g,255)*100)+"%, "+Math.round(rt(this._b,255)*100)+"%)":"rgba("+Math.round(rt(this._r,255)*100)+"%, "+Math.round(rt(this._g,255)*100)+"%, "+Math.round(rt(this._b,255)*100)+"%, "+this._roundA+")"},toName:function(){return this._a===0?"transparent":this._a<1?!1:Ob[Zl(this._r,this._g,this._b,!0)]||!1},toFilter:function(e){var t="#"+Jl(this._r,this._g,this._b,this._a),i=t,r=this._gradientType?"GradientType = 1, ":"";if(e){var a=Ae(e);i="#"+Jl(a._r,a._g,a._b,a._a)}return"progid:DXImageTransform.Microsoft.gradient("+r+"startColorstr="+t+",endColorstr="+i+")"},toString:function(e){var t=!!e;e=e||this._format;var i=!1,r=this._a<1&&this._a>=0,a=!t&&r&&(e==="hex"||e==="hex6"||e==="hex3"||e==="hex4"||e==="hex8"||e==="name");return a?e==="name"&&this._a===0?this.toName():this.toRgbString():(e==="rgb"&&(i=this.toRgbString()),e==="prgb"&&(i=this.toPercentageRgbString()),(e==="hex"||e==="hex6")&&(i=this.toHexString()),e==="hex3"&&(i=this.toHexString(!0)),e==="hex4"&&(i=this.toHex8String(!0)),e==="hex8"&&(i=this.toHex8String()),e==="name"&&(i=this.toName()),e==="hsl"&&(i=this.toHslString()),e==="hsv"&&(i=this.toHsvString()),i||this.toHexString())},clone:function(){return Ae(this.toString())},_applyModification:function(e,t){var i=e.apply(null,[this].concat([].slice.call(t)));return this._r=i._r,this._g=i._g,this._b=i._b,this.setAlpha(i._a),this},lighten:function(){return this._applyModification(Tb,arguments)},brighten:function(){return this._applyModification(Cb,arguments)},darken:function(){return this._applyModification(Rb,arguments)},desaturate:function(){return this._applyModification(Sb,arguments)},saturate:function(){return this._applyModification(Eb,arguments)},greyscale:function(){return this._applyModification(wb,arguments)},spin:function(){return this._applyModification(kb,arguments)},_applyCombination:function(e,t){return e.apply(null,[this].concat([].slice.call(t)))},analogous:function(){return this._applyCombination(zb,arguments)},complement:function(){return this._applyCombination(Pb,arguments)},monochromatic:function(){return this._applyCombination(Db,arguments)},splitcomplement:function(){return this._applyCombination(Lb,arguments)},triad:function(){return this._applyCombination(Ql,[3])},tetrad:function(){return this._applyCombination(Ql,[4])}};Ae.fromRatio=function(n,e){if(ya(n)=="object"){var t={};for(var i in n)n.hasOwnProperty(i)&&(i==="a"?t[i]=n[i]:t[i]=or(n[i]));n=t}return Ae(n,e)};function yb(n){var e={r:0,g:0,b:0},t=1,i=null,r=null,a=null,s=!1,o=!1;return typeof n=="string"&&(n=Fb(n)),ya(n)=="object"&&(mn(n.r)&&mn(n.g)&&mn(n.b)?(e=xb(n.r,n.g,n.b),s=!0,o=String(n.r).substr(-1)==="%"?"prgb":"rgb"):mn(n.h)&&mn(n.s)&&mn(n.v)?(i=or(n.s),r=or(n.v),e=Mb(n.h,i,r),s=!0,o="hsv"):mn(n.h)&&mn(n.s)&&mn(n.l)&&(i=or(n.s),a=or(n.l),e=bb(n.h,i,a),s=!0,o="hsl"),n.hasOwnProperty("a")&&(t=n.a)),t=Bd(t),{ok:s,format:n.format||o,r:Math.min(255,Math.max(e.r,0)),g:Math.min(255,Math.max(e.g,0)),b:Math.min(255,Math.max(e.b,0)),a:t}}function xb(n,e,t){return{r:rt(n,255)*255,g:rt(e,255)*255,b:rt(t,255)*255}}function Yl(n,e,t){n=rt(n,255),e=rt(e,255),t=rt(t,255);var i=Math.max(n,e,t),r=Math.min(n,e,t),a,s,o=(i+r)/2;if(i==r)a=s=0;else{var c=i-r;switch(s=o>.5?c/(2-i-r):c/(i+r),i){case n:a=(e-t)/c+(e<t?6:0);break;case e:a=(t-n)/c+2;break;case t:a=(n-e)/c+4;break}a/=6}return{h:a,s,l:o}}function bb(n,e,t){var i,r,a;n=rt(n,360),e=rt(e,100),t=rt(t,100);function s(l,u,d){return d<0&&(d+=1),d>1&&(d-=1),d<1/6?l+(u-l)*6*d:d<1/2?u:d<2/3?l+(u-l)*(2/3-d)*6:l}if(e===0)i=r=a=t;else{var o=t<.5?t*(1+e):t+e-t*e,c=2*t-o;i=s(c,o,n+1/3),r=s(c,o,n),a=s(c,o,n-1/3)}return{r:i*255,g:r*255,b:a*255}}function Kl(n,e,t){n=rt(n,255),e=rt(e,255),t=rt(t,255);var i=Math.max(n,e,t),r=Math.min(n,e,t),a,s,o=i,c=i-r;if(s=i===0?0:c/i,i==r)a=0;else{switch(i){case n:a=(e-t)/c+(e<t?6:0);break;case e:a=(t-n)/c+2;break;case t:a=(n-e)/c+4;break}a/=6}return{h:a,s,v:o}}function Mb(n,e,t){n=rt(n,360)*6,e=rt(e,100),t=rt(t,100);var i=Math.floor(n),r=n-i,a=t*(1-e),s=t*(1-r*e),o=t*(1-(1-r)*e),c=i%6,l=[t,s,a,a,o,t][c],u=[o,t,t,s,a,a][c],d=[a,a,o,t,t,s][c];return{r:l*255,g:u*255,b:d*255}}function Zl(n,e,t,i){var r=[en(Math.round(n).toString(16)),en(Math.round(e).toString(16)),en(Math.round(t).toString(16))];return i&&r[0].charAt(0)==r[0].charAt(1)&&r[1].charAt(0)==r[1].charAt(1)&&r[2].charAt(0)==r[2].charAt(1)?r[0].charAt(0)+r[1].charAt(0)+r[2].charAt(0):r.join("")}function Ab(n,e,t,i,r){var a=[en(Math.round(n).toString(16)),en(Math.round(e).toString(16)),en(Math.round(t).toString(16)),en(Hd(i))];return r&&a[0].charAt(0)==a[0].charAt(1)&&a[1].charAt(0)==a[1].charAt(1)&&a[2].charAt(0)==a[2].charAt(1)&&a[3].charAt(0)==a[3].charAt(1)?a[0].charAt(0)+a[1].charAt(0)+a[2].charAt(0)+a[3].charAt(0):a.join("")}function Jl(n,e,t,i){var r=[en(Hd(i)),en(Math.round(n).toString(16)),en(Math.round(e).toString(16)),en(Math.round(t).toString(16))];return r.join("")}Ae.equals=function(n,e){return!n||!e?!1:Ae(n).toRgbString()==Ae(e).toRgbString()};Ae.random=function(){return Ae.fromRatio({r:Math.random(),g:Math.random(),b:Math.random()})};function Sb(n,e){e=e===0?0:e||10;var t=Ae(n).toHsl();return t.s-=e/100,t.s=Da(t.s),Ae(t)}function Eb(n,e){e=e===0?0:e||10;var t=Ae(n).toHsl();return t.s+=e/100,t.s=Da(t.s),Ae(t)}function wb(n){return Ae(n).desaturate(100)}function Tb(n,e){e=e===0?0:e||10;var t=Ae(n).toHsl();return t.l+=e/100,t.l=Da(t.l),Ae(t)}function Cb(n,e){e=e===0?0:e||10;var t=Ae(n).toRgb();return t.r=Math.max(0,Math.min(255,t.r-Math.round(255*-(e/100)))),t.g=Math.max(0,Math.min(255,t.g-Math.round(255*-(e/100)))),t.b=Math.max(0,Math.min(255,t.b-Math.round(255*-(e/100)))),Ae(t)}function Rb(n,e){e=e===0?0:e||10;var t=Ae(n).toHsl();return t.l-=e/100,t.l=Da(t.l),Ae(t)}function kb(n,e){var t=Ae(n).toHsl(),i=(t.h+e)%360;return t.h=i<0?360+i:i,Ae(t)}function Pb(n){var e=Ae(n).toHsl();return e.h=(e.h+180)%360,Ae(e)}function Ql(n,e){if(isNaN(e)||e<=0)throw new Error("Argument to polyad must be a positive number");for(var t=Ae(n).toHsl(),i=[Ae(n)],r=360/e,a=1;a<e;a++)i.push(Ae({h:(t.h+a*r)%360,s:t.s,l:t.l}));return i}function Lb(n){var e=Ae(n).toHsl(),t=e.h;return[Ae(n),Ae({h:(t+72)%360,s:e.s,l:e.l}),Ae({h:(t+216)%360,s:e.s,l:e.l})]}function zb(n,e,t){e=e||6,t=t||30;var i=Ae(n).toHsl(),r=360/t,a=[Ae(n)];for(i.h=(i.h-(r*e>>1)+720)%360;--e;)i.h=(i.h+r)%360,a.push(Ae(i));return a}function Db(n,e){e=e||6;for(var t=Ae(n).toHsv(),i=t.h,r=t.s,a=t.v,s=[],o=1/e;e--;)s.push(Ae({h:i,s:r,v:a})),a=(a+o)%1;return s}Ae.mix=function(n,e,t){t=t===0?0:t||50;var i=Ae(n).toRgb(),r=Ae(e).toRgb(),a=t/100,s={r:(r.r-i.r)*a+i.r,g:(r.g-i.g)*a+i.g,b:(r.b-i.b)*a+i.b,a:(r.a-i.a)*a+i.a};return Ae(s)};Ae.readability=function(n,e){var t=Ae(n),i=Ae(e);return(Math.max(t.getLuminance(),i.getLuminance())+.05)/(Math.min(t.getLuminance(),i.getLuminance())+.05)};Ae.isReadable=function(n,e,t){var i=Ae.readability(n,e),r,a;switch(a=!1,r=Bb(t),r.level+r.size){case"AAsmall":case"AAAlarge":a=i>=4.5;break;case"AAlarge":a=i>=3;break;case"AAAsmall":a=i>=7;break}return a};Ae.mostReadable=function(n,e,t){var i=null,r=0,a,s,o,c;t=t||{},s=t.includeFallbackColors,o=t.level,c=t.size;for(var l=0;l<e.length;l++)a=Ae.readability(n,e[l]),a>r&&(r=a,i=Ae(e[l]));return Ae.isReadable(n,i,{level:o,size:c})||!s?i:(t.includeFallbackColors=!1,Ae.mostReadable(n,["#fff","#000"],t))};var Js=Ae.names={aliceblue:"f0f8ff",antiquewhite:"faebd7",aqua:"0ff",aquamarine:"7fffd4",azure:"f0ffff",beige:"f5f5dc",bisque:"ffe4c4",black:"000",blanchedalmond:"ffebcd",blue:"00f",blueviolet:"8a2be2",brown:"a52a2a",burlywood:"deb887",burntsienna:"ea7e5d",cadetblue:"5f9ea0",chartreuse:"7fff00",chocolate:"d2691e",coral:"ff7f50",cornflowerblue:"6495ed",cornsilk:"fff8dc",crimson:"dc143c",cyan:"0ff",darkblue:"00008b",darkcyan:"008b8b",darkgoldenrod:"b8860b",darkgray:"a9a9a9",darkgreen:"006400",darkgrey:"a9a9a9",darkkhaki:"bdb76b",darkmagenta:"8b008b",darkolivegreen:"556b2f",darkorange:"ff8c00",darkorchid:"9932cc",darkred:"8b0000",darksalmon:"e9967a",darkseagreen:"8fbc8f",darkslateblue:"483d8b",darkslategray:"2f4f4f",darkslategrey:"2f4f4f",darkturquoise:"00ced1",darkviolet:"9400d3",deeppink:"ff1493",deepskyblue:"00bfff",dimgray:"696969",dimgrey:"696969",dodgerblue:"1e90ff",firebrick:"b22222",floralwhite:"fffaf0",forestgreen:"228b22",fuchsia:"f0f",gainsboro:"dcdcdc",ghostwhite:"f8f8ff",gold:"ffd700",goldenrod:"daa520",gray:"808080",green:"008000",greenyellow:"adff2f",grey:"808080",honeydew:"f0fff0",hotpink:"ff69b4",indianred:"cd5c5c",indigo:"4b0082",ivory:"fffff0",khaki:"f0e68c",lavender:"e6e6fa",lavenderblush:"fff0f5",lawngreen:"7cfc00",lemonchiffon:"fffacd",lightblue:"add8e6",lightcoral:"f08080",lightcyan:"e0ffff",lightgoldenrodyellow:"fafad2",lightgray:"d3d3d3",lightgreen:"90ee90",lightgrey:"d3d3d3",lightpink:"ffb6c1",lightsalmon:"ffa07a",lightseagreen:"20b2aa",lightskyblue:"87cefa",lightslategray:"789",lightslategrey:"789",lightsteelblue:"b0c4de",lightyellow:"ffffe0",lime:"0f0",limegreen:"32cd32",linen:"faf0e6",magenta:"f0f",maroon:"800000",mediumaquamarine:"66cdaa",mediumblue:"0000cd",mediumorchid:"ba55d3",mediumpurple:"9370db",mediumseagreen:"3cb371",mediumslateblue:"7b68ee",mediumspringgreen:"00fa9a",mediumturquoise:"48d1cc",mediumvioletred:"c71585",midnightblue:"191970",mintcream:"f5fffa",mistyrose:"ffe4e1",moccasin:"ffe4b5",navajowhite:"ffdead",navy:"000080",oldlace:"fdf5e6",olive:"808000",olivedrab:"6b8e23",orange:"ffa500",orangered:"ff4500",orchid:"da70d6",palegoldenrod:"eee8aa",palegreen:"98fb98",paleturquoise:"afeeee",palevioletred:"db7093",papayawhip:"ffefd5",peachpuff:"ffdab9",peru:"cd853f",pink:"ffc0cb",plum:"dda0dd",powderblue:"b0e0e6",purple:"800080",rebeccapurple:"663399",red:"f00",rosybrown:"bc8f8f",royalblue:"4169e1",saddlebrown:"8b4513",salmon:"fa8072",sandybrown:"f4a460",seagreen:"2e8b57",seashell:"fff5ee",sienna:"a0522d",silver:"c0c0c0",skyblue:"87ceeb",slateblue:"6a5acd",slategray:"708090",slategrey:"708090",snow:"fffafa",springgreen:"00ff7f",steelblue:"4682b4",tan:"d2b48c",teal:"008080",thistle:"d8bfd8",tomato:"ff6347",turquoise:"40e0d0",violet:"ee82ee",wheat:"f5deb3",white:"fff",whitesmoke:"f5f5f5",yellow:"ff0",yellowgreen:"9acd32"},Ob=Ae.hexNames=Ib(Js);function Ib(n){var e={};for(var t in n)n.hasOwnProperty(t)&&(e[n[t]]=t);return e}function Bd(n){return n=parseFloat(n),(isNaN(n)||n<0||n>1)&&(n=1),n}function rt(n,e){Nb(n)&&(n="100%");var t=Ub(n);return n=Math.min(e,Math.max(0,parseFloat(n))),t&&(n=parseInt(n*e,10)/100),Math.abs(n-e)<1e-6?1:n%e/parseFloat(e)}function Da(n){return Math.min(1,Math.max(0,n))}function Ut(n){return parseInt(n,16)}function Nb(n){return typeof n=="string"&&n.indexOf(".")!=-1&&parseFloat(n)===1}function Ub(n){return typeof n=="string"&&n.indexOf("%")!=-1}function en(n){return n.length==1?"0"+n:""+n}function or(n){return n<=1&&(n=n*100+"%"),n}function Hd(n){return Math.round(parseFloat(n)*255).toString(16)}function eu(n){return Ut(n)/255}var Yt=function(){var n="[-\\+]?\\d+%?",e="[-\\+]?\\d*\\.\\d+%?",t="(?:"+e+")|(?:"+n+")",i="[\\s|\\(]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")\\s*\\)?",r="[\\s|\\(]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")[,|\\s]+("+t+")\\s*\\)?";return{CSS_UNIT:new RegExp(t),rgb:new RegExp("rgb"+i),rgba:new RegExp("rgba"+r),hsl:new RegExp("hsl"+i),hsla:new RegExp("hsla"+r),hsv:new RegExp("hsv"+i),hsva:new RegExp("hsva"+r),hex3:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex6:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/,hex4:/^#?([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})([0-9a-fA-F]{1})$/,hex8:/^#?([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})([0-9a-fA-F]{2})$/}}();function mn(n){return!!Yt.CSS_UNIT.exec(n)}function Fb(n){n=n.replace(vb,"").replace(_b,"").toLowerCase();var e=!1;if(Js[n])n=Js[n],e=!0;else if(n=="transparent")return{r:0,g:0,b:0,a:0,format:"name"};var t;return(t=Yt.rgb.exec(n))?{r:t[1],g:t[2],b:t[3]}:(t=Yt.rgba.exec(n))?{r:t[1],g:t[2],b:t[3],a:t[4]}:(t=Yt.hsl.exec(n))?{h:t[1],s:t[2],l:t[3]}:(t=Yt.hsla.exec(n))?{h:t[1],s:t[2],l:t[3],a:t[4]}:(t=Yt.hsv.exec(n))?{h:t[1],s:t[2],v:t[3]}:(t=Yt.hsva.exec(n))?{h:t[1],s:t[2],v:t[3],a:t[4]}:(t=Yt.hex8.exec(n))?{r:Ut(t[1]),g:Ut(t[2]),b:Ut(t[3]),a:eu(t[4]),format:e?"name":"hex8"}:(t=Yt.hex6.exec(n))?{r:Ut(t[1]),g:Ut(t[2]),b:Ut(t[3]),format:e?"name":"hex"}:(t=Yt.hex4.exec(n))?{r:Ut(t[1]+""+t[1]),g:Ut(t[2]+""+t[2]),b:Ut(t[3]+""+t[3]),a:eu(t[4]+""+t[4]),format:e?"name":"hex8"}:(t=Yt.hex3.exec(n))?{r:Ut(t[1]+""+t[1]),g:Ut(t[2]+""+t[2]),b:Ut(t[3]+""+t[3]),format:e?"name":"hex"}:!1}function Bb(n){var e,t;return n=n||{level:"AA",size:"small"},e=(n.level||"AA").toUpperCase(),t=(n.size||"small").toLowerCase(),e!=="AA"&&e!=="AAA"&&(e="AA"),t!=="small"&&t!=="large"&&(t="small"),{level:e,size:t}}function Hb(n,e){var t=n==null?null:typeof Symbol<"u"&&n[Symbol.iterator]||n["@@iterator"];if(t!=null){var i,r,a,s,o=[],c=!0,l=!1;try{if(a=(t=t.call(n)).next,e===0){if(Object(t)!==t)return;c=!1}else for(;!(c=(i=a.call(t)).done)&&(o.push(i.value),o.length!==e);c=!0);}catch(u){l=!0,r=u}finally{try{if(!c&&t.return!=null&&(s=t.return(),Object(s)!==s))return}finally{if(l)throw r}}return o}}function tu(n,e){var t=Object.keys(n);if(Object.getOwnPropertySymbols){var i=Object.getOwnPropertySymbols(n);e&&(i=i.filter(function(r){return Object.getOwnPropertyDescriptor(n,r).enumerable})),t.push.apply(t,i)}return t}function Gd(n){for(var e=1;e<arguments.length;e++){var t=arguments[e]!=null?arguments[e]:{};e%2?tu(Object(t),!0).forEach(function(i){Uo(n,i,t[i])}):Object.getOwnPropertyDescriptors?Object.defineProperties(n,Object.getOwnPropertyDescriptors(t)):tu(Object(t)).forEach(function(i){Object.defineProperty(n,i,Object.getOwnPropertyDescriptor(t,i))})}return n}function Qs(n){"@babel/helpers - typeof";return Qs=typeof Symbol=="function"&&typeof Symbol.iterator=="symbol"?function(e){return typeof e}:function(e){return e&&typeof Symbol=="function"&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e},Qs(n)}function Gb(n,e){if(!(n instanceof e))throw new TypeError("Cannot call a class as a function")}function nu(n,e){for(var t=0;t<e.length;t++){var i=e[t];i.enumerable=i.enumerable||!1,i.configurable=!0,"value"in i&&(i.writable=!0),Object.defineProperty(n,Xd(i.key),i)}}function Vb(n,e,t){return e&&nu(n.prototype,e),t&&nu(n,t),Object.defineProperty(n,"prototype",{writable:!1}),n}function Uo(n,e,t){return e=Xd(e),e in n?Object.defineProperty(n,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):n[e]=t,n}function Wb(n,e){if(typeof e!="function"&&e!==null)throw new TypeError("Super expression must either be null or a function");n.prototype=Object.create(e&&e.prototype,{constructor:{value:n,writable:!0,configurable:!0}}),Object.defineProperty(n,"prototype",{writable:!1}),e&&ba(n,e)}function xa(n){return xa=Object.setPrototypeOf?Object.getPrototypeOf.bind():function(t){return t.__proto__||Object.getPrototypeOf(t)},xa(n)}function ba(n,e){return ba=Object.setPrototypeOf?Object.setPrototypeOf.bind():function(i,r){return i.__proto__=r,i},ba(n,e)}function Vd(){if(typeof Reflect>"u"||!Reflect.construct||Reflect.construct.sham)return!1;if(typeof Proxy=="function")return!0;try{return Boolean.prototype.valueOf.call(Reflect.construct(Boolean,[],function(){})),!0}catch{return!1}}function aa(n,e,t){return Vd()?aa=Reflect.construct.bind():aa=function(r,a,s){var o=[null];o.push.apply(o,a);var c=Function.bind.apply(r,o),l=new c;return s&&ba(l,s.prototype),l},aa.apply(null,arguments)}function jb(n,e){if(n==null)return{};var t={},i=Object.keys(n),r,a;for(a=0;a<i.length;a++)r=i[a],!(e.indexOf(r)>=0)&&(t[r]=n[r]);return t}function Xb(n,e){if(n==null)return{};var t=jb(n,e),i,r;if(Object.getOwnPropertySymbols){var a=Object.getOwnPropertySymbols(n);for(r=0;r<a.length;r++)i=a[r],!(e.indexOf(i)>=0)&&Object.prototype.propertyIsEnumerable.call(n,i)&&(t[i]=n[i])}return t}function Wd(n){if(n===void 0)throw new ReferenceError("this hasn't been initialised - super() hasn't been called");return n}function $b(n,e){if(e&&(typeof e=="object"||typeof e=="function"))return e;if(e!==void 0)throw new TypeError("Derived constructors may only return object or undefined");return Wd(n)}function qb(n){var e=Vd();return function(){var i=xa(n),r;if(e){var a=xa(this).constructor;r=Reflect.construct(i,arguments,a)}else r=i.apply(this,arguments);return $b(this,r)}}function iu(n,e){return Kb(n)||Hb(n,e)||jd(n,e)||Qb()}function Kt(n){return Yb(n)||Zb(n)||jd(n)||Jb()}function Yb(n){if(Array.isArray(n))return eo(n)}function Kb(n){if(Array.isArray(n))return n}function Zb(n){if(typeof Symbol<"u"&&n[Symbol.iterator]!=null||n["@@iterator"]!=null)return Array.from(n)}function jd(n,e){if(n){if(typeof n=="string")return eo(n,e);var t=Object.prototype.toString.call(n).slice(8,-1);if(t==="Object"&&n.constructor&&(t=n.constructor.name),t==="Map"||t==="Set")return Array.from(n);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return eo(n,e)}}function eo(n,e){(e==null||e>n.length)&&(e=n.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=n[t];return i}function Jb(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
.scene-container canvas:focus {
  outline: none;
}`;$1(q1);function Y1(n,e){var t=n==null?null:typeof Symbol<"u"&&n[Symbol.iterator]||n["@@iterator"];if(t!=null){var i,r,a,s,o=[],c=!0,l=!1;try{if(a=(t=t.call(n)).next,e===0){if(Object(t)!==t)return;c=!1}else for(;!(c=(i=a.call(t)).done)&&(o.push(i.value),o.length!==e);c=!0);}catch(u){l=!0,r=u}finally{try{if(!c&&t.return!=null&&(s=t.return(),Object(s)!==s))return}finally{if(l)throw r}}return o}}function K1(n,e,t){return e=rM(e),e in n?Object.defineProperty(n,e,{value:t,enumerable:!0,configurable:!0,writable:!0}):n[e]=t,n}function Z1(n,e){return Q1(n)||Y1(n,e)||Yd(n,e)||nM()}function rr(n){return J1(n)||eM(n)||Yd(n)||tM()}function J1(n){if(Array.isArray(n))return so(n)}function Q1(n){if(Array.isArray(n))return n}function eM(n){if(typeof Symbol<"u"&&n[Symbol.iterator]!=null||n["@@iterator"]!=null)return Array.from(n)}function Yd(n,e){if(n){if(typeof n=="string")return so(n,e);var t=Object.prototype.toString.call(n).slice(8,-1);if(t==="Object"&&n.constructor&&(t=n.constructor.name),t==="Map"||t==="Set")return Array.from(n);if(t==="Arguments"||/^(?:Ui|I)nt(?:8|16|32)(?:Clamped)?Array$/.test(t))return so(n,e)}}function so(n,e){(e==null||e>n.length)&&(e=n.length);for(var t=0,i=new Array(e);t<e;t++)i[t]=n[t];return i}function tM(){throw new TypeError(`Invalid attempt to spread non-iterable instance.
...
In order to be iterable, non-array objects must have a [Symbol.iterator]() method.`)}function LM(n,e){if(typeof n!="object"||n===null)return n;var t=n[Symbol.toPrimitive];if(t!==void 0){var i=t.call(n,e||"default");if(typeof i!="object")return i;throw new TypeError("@@toPrimitive must return a primitive value.")}return(e==="string"?String:Number)(n)}function zM(n){var e=LM(n,"string");return typeof e=="symbol"?e:String(e)}var Ci=typeof window<"u"&&window.THREE?window.THREE:{LinearFilter:Ft,Sprite:w0,SpriteMaterial:Zu,SRGBColorSpace:ut,Texture:Pt},DM=function(n){MM(t,n);var e=wM(t);function t(){var i,r=arguments.length>0&&arguments[0]!==void 0?arguments[0]:"",a=arguments.length>1&&arguments[1]!==void 0?arguments[1]:10,s=arguments.length>2&&arguments[2]!==void 0?arguments[2]:"rgba(255, 255, 255, 1)";return xM(this,t),i=e.call(this,new Ci.SpriteMaterial),i._text="".concat(r),i._textHeight=a,i._color=s,i._backgroundColor=!1,i._padding=0,i._borderWidth=0,i._borderRadius=0,i._borderColor="white",i._strokeWidth=0,i._strokeColor="white",i._fontFace="system-ui",i._fontSize=90,i._fontWeight="normal",i._canvas=document.createElement("canvas"),i._genCanvas(),i}return bM(t,[{key:"text",get:function(){return this._text},set:function(r){this._text=r,this._genCanvas()}},{key:"textHeight",get:function(){return this._textHeight},set:function(r){this._textHeight=r,this._genCanvas()}},{key:"color",get:function(){return this._color},set:function(r){this._color=r,this._genCanvas()}},{key:"backgroundColor",get:function(){return this._backgroundColor},set:function(r){this._backgroundColor=r,this._genCanvas()}},{key:"padding",get:function(){return this._padding},set:function(r){this._padding=r,this._genCanvas()}},{key:"borderWidth",get:function(){return this._borderWidth},set:function(r){this._borderWidth=r,this._genCanvas()}},{key:"borderRadius",get:function(){return this._borderRadius},set:function(r){this._borderRadius=r,this._genCanvas()}},{key:"borderColor",get:function(){return this._borderColor},set:function(r){this._borderColor=r,this._genCanvas()}},{key:"fontFace",get:function(){return this._fontFace},set:function(r){this._fontFace=r,this._genCanvas()}},{key:"fontSize",get:function(){return this._fontSize},set:function(r){this._fontSize=r,this._genCanvas()}},{key:"fontWeight",get:function(){return this._fontWeight},set:function(r){this._fontWeight=r,this._genCanvas()}},{key:"strokeWidth",get:function(){return this._strokeWidth},set:function(r){this._strokeWidth=r,this._genCanvas()}},{key:"strokeColor",get:function(){return this._strokeColor},set:function(r){this._strokeColor=r,this._genCanvas()}},{key:"_genCanvas",value:function(){var r=this,a=this._canvas,s=a.getContext("2d"),o=Array.isArray(this.borderWidth)?this.borderWidth:[this.borderWidth,this.borderWidth],c=o.map(function(P){return P*r.fontSize*.1}),l=Array.isArray(this.borderRadius)?this.borderRadius:[this.borderRadius,this.borderRadius,this.borderRadius,this.borderRadius],u=l.map(function(P){return P*r.fontSize*.1}),d=Array.isArray(this.padding)?this.padding:[this.padding,this.padding],f=d.map(function(P){return P*r.fontSize*.1}),m=this.text.split(`
`),g="".concat(this.fontWeight," ").concat(this.fontSize,"px ").concat(this.fontFace);s.font=g;var v=Math.max.apply(Math,na(m.map(function(P){return s.measureText(P).width}))),p=this.fontSize*m.length;if(a.width=v+c[0]*2+f[0]*2,a.height=p+c[1]*2+f[1]*2,this.borderWidth){if(s.strokeStyle=this.borderColor,c[0]){var h=c[0]/2;s.lineWidth=c[0],s.beginPath(),s.moveTo(h,u[0]),s.lineTo(h,a.height-u[3]),s.moveTo(a.width-h,u[1]),s.lineTo(a.width-h,a.height-u[2]),s.stroke()}if(c[1]){var x=c[1]/2;s.lineWidth=c[1],s.beginPath(),s.moveTo(Math.max(c[0],u[0]),x),s.lineTo(a.width-Math.max(c[0],u[1]),x),s.moveTo(Math.max(c[0],u[3]),a.height-x),s.lineTo(a.width-Math.max(c[0],u[2]),a.height-x),s.stroke()}if(this.borderRadius){var _=Math.max.apply(Math,na(c)),y=_/2;s.lineWidth=_,s.beginPath(),[!!u[0]&&[u[0],y,y,u[0]],!!u[1]&&[a.width-u[1],a.width-y,y,u[1]],!!u[2]&&[a.width-u[2],a.width-y,a.height-y,a.height-u[2]],!!u[3]&&[u[3],y,a.height-y,a.height-u[3]]].filter(function(P){return P}).forEach(function(P){var b=yu(P,4),w=b[0],N=b[1],U=b[2],ee=b[3];s.moveTo(w,U),s.quadraticCurveTo(N,U,N,ee)}),s.stroke()}}this.backgroundColor&&(s.fillStyle=this.backgroundColor,this.borderRadius?(s.beginPath(),s.moveTo(c[0],u[0]),[[c[0],u[0],a.width-u[1],c[1],c[1],c[1]],[a.width-c[0],a.width-c[0],a.width-c[0],c[1],u[1],a.height-u[2]],[a.width-c[0],a.width-u[2],u[3],a.height-c[1],a.height-c[1],a.height-c[1]],[c[0],c[0],c[0],a.height-c[1],a.height-u[3],u[0]]].forEach(function(P){var b=yu(P,6),w=b[0],N=b[1],U=b[2],ee=b[3],C=b[4],k=b[5];s.quadraticCurveTo(w,ee,N,C),s.lineTo(U,k)}),s.closePath(),s.fill()):s.fillRect(c[0],c[1],a.width-c[0]*2,a.height-c[1]*2)),s.translate.apply(s,na(c)),s.translate.apply(s,na(f)),s.font=g,s.fillStyle=this.color,s.textBaseline="bottom";var M=this.strokeWidth>0;M&&(s.lineWidth=this.strokeWidth*this.fontSize/10,s.strokeStyle=this.strokeColor),m.forEach(function(P,b){var w=(v-s.measureText(P).width)/2,N=(b+1)*r.fontSize;M&&s.strokeText(P,w,N),s.fillText(P,w,N)}),this.material.map&&this.material.map.dispose();var A=this.material.map=new Ci.Texture(a);A.minFilter=Ci.LinearFilter,A.colorSpace=Ci.SRGBColorSpace,A.needsUpdate=!0;var E=this.textHeight*m.length+o[1]*2+d[1]*2;this.scale.set(E*a.width/a.height,E,0)}},{key:"clone",value:function(){return new this.constructor(this.text,this.textHeight,this.color).copy(this)}},{key:"copy",value:function(r){return Ci.Sprite.prototype.copy.call(this,r),this.color=r.color,this.backgroundColor=r.backgroundColor,this.padding=r.padding,this.borderWidth=r.borderWidth,this.borderColor=r.borderColor,this.fontFace=r.fontFace,this.fontSize=r.fontSize,this.fontWeight=r.fontWeight,this.strokeWidth=r.strokeWidth,this.strokeColor=r.strokeColor,this}}]),t}(Ci.Sprite);const OM=[{id:"nīl",size:5,type:"noun"},{id:"mēṉi",size:5,type:"noun"},{id:"vāl",size:4,type:"noun"},{id:"iḻai",size:7,type:"noun"},{id:"pākattu",size:1},{id:"oru",size:3,type:"noun"},{id:"iru",size:4,type:"noun"},{id:"tāḷ",size:2,type:"noun"},{id:"niḻal",size:3,type:"noun"},{id:"kīḻ",size:1},{id:"mu",size:1,type:"noun"},{id:"vaku",size:1,type:"verb"},{id:"ulakam",size:1,type:"noun"},{id:"vāḻ",size:43,type:"verb"},{id:"yātaṉ",size:10},{id:"yaviṉi",size:10},{id:"nel",size:9,type:"noun"},{id:"pal",size:19,type:"noun"},{id:"poli",size:2,type:"noun"},{id:"poṉ",size:6,type:"noun"},{id:"peru(m)",size:21,type:"adjective"},{id:"ciṟa",size:8,type:"verb"},{id:"veṉa",size:9},{id:"vēṭṭōḷ",size:10},{id:"yāy",size:11,type:"noun"},{id:"yām",size:18,type:"pronoun"},{id:"naṉai",size:2,type:"noun"},{id:"kāñcic",size:1},{id:"ciṉai",size:4,type:"verb"},{id:"ciṟu(m)",size:6,type:"adjective"},{id:"miṉ",size:5,type:"noun"},{id:"yāṇar",size:9,type:"noun"},{id:"ūr",size:44,type:"noun"},{id:"pāṇ",size:11,type:"noun"},{id:"māri",size:3,type:"noun"},{id:"vāy",size:3,type:"noun"},{id:"vaḷam",size:4,type:"noun"},{id:"naṉi",size:4},{id:"pū(m)",size:18,type:"noun"},{id:"māattup",size:2},{id:"pulavu",size:2,type:"noun"},{id:"taṭpam",size:28,type:"noun"},{id:"tuṟai",size:21,type:"noun"},{id:"yūraṉ",size:20},{id:"tāṉ",size:16,type:"pronoun"},{id:"koḷ",size:13,type:"verb"},{id:"cel",size:10,type:"noun"},{id:"puṉal",size:17,type:"noun"},{id:"aṭu",size:8,type:"verb"},{id:"maka",size:26,type:"noun"},{id:"iṭu",size:1,type:"verb"},{id:"voḷ",size:4},{id:"ḷiḻai",size:1},{id:"maṇal",size:3,type:"noun"},{id:"cimaiyattu",size:1},{id:"erumai",size:6,type:"noun"},{id:"kiḷai",size:1,type:"noun"},{id:"i-",size:22,type:"pronoun"},{id:"narampu",size:1,type:"noun"},{id:"aṉṉai",size:12,type:"noun"},{id:"vēṇṭu",size:8,type:"verb"},{id:"yutuk",size:1},{id:"kaṇ",size:19,type:"noun"},{id:"ēr",size:3,type:"noun"},{id:"koṭip",size:3},{id:"pācu",size:1},{id:"aṭumpu",size:1,type:"noun"},{id:"pari",size:3,type:"noun"},{id:"vūrpu",size:1},{id:"iḻi",size:2,type:"verb"},{id:"neytal",size:4,type:"noun"},{id:"mayakkam",size:1},{id:"varavu",size:16,type:"noun"},{id:"nī",size:39,type:"pronoun"},{id:"pūp",size:3},{id:"pōl",size:8,type:"verb"},{id:"uṇ",size:12},{id:"maruvu",size:1,type:"verb"},{id:"no/nō",size:6,type:"verb"},{id:"maruntu",size:4,type:"noun"},{id:"ākkam",size:25,type:"noun"},{id:"namm",size:1},{id:"niṟap",size:1},{id:"kaṭal",size:2,type:"noun"},{id:"puḷ",size:1,type:"noun"},{id:"°āṉ",size:1,type:"verb"},{id:"tuṉpam",size:1,type:"noun"},{id:"uṟu",size:7,type:"verb"},{id:"tuyara",size:1},{id:"nīkku",size:2,type:"verb"},{id:"viṉpu",size:1},{id:"vicaikkum",size:1},{id:"a-",size:37,type:"pronoun"},{id:"tēr",size:6,type:"noun"},{id:"puṉṉai",size:1,type:"noun"},{id:"ñāḻal",size:1,type:"noun"},{id:"taṇṇ",size:2},{id:"am",size:3,type:"adjective"},{id:"amaintaṉaṉ",size:1},{id:"amai",size:6,type:"noun"},{id:"mā",size:3,type:"adjective"},{id:"muḻakkam",size:2},{id:"tirai",size:1,type:"verb"},{id:"taru",size:1},{id:"muttam",size:1,type:"noun"},{id:"veḷ",size:12,type:"adjective"},{id:"imai",size:1,type:"noun"},{id:"eṉap",size:4},{id:"civantaṉṟu",size:1},{id:"maṉai",size:10,type:"noun"},{id:"naṭu",size:2,type:"verb"},{id:"vayalai",size:1,type:"noun"},{id:"vēḻam",size:8,type:"noun"},{id:"cuṟṟam",size:1,type:"noun"},{id:"keḻu",size:4},{id:"koṭu(m)",size:2,type:"adjective"},{id:"nāṇ",size:1,type:"noun"},{id:"nallaṉ",size:1},{id:"e-",size:12,type:"pronoun"},{id:"yallaṉ",size:1},{id:"taṭa(m)",size:4,type:"adjective"},{id:"karai",size:3,type:"noun"},{id:"cēr",size:2,type:"verb"},{id:"karuppu",size:6,type:"adjective"},{id:"nal",size:24,type:"adjective"},{id:"āṟṟuka",size:1},{id:"tōṟka",size:1},{id:"vel",size:5,type:"verb"},{id:"yuṭai",size:1},{id:"poṅku",size:1,type:"verb"},{id:"uḷai",size:1,type:"noun"},{id:"yaṉṉa",size:6},{id:"vaṭai",size:1},{id:"pakar",size:1,type:"verb"},{id:"peṇ",size:7,type:"noun"},{id:"tuñcu",size:3,type:"verb"},{id:"yāmam",size:1,type:"noun"},{id:"pai",size:2},{id:"al",size:12,type:"verb"},{id:"paṇait",size:2},{id:"tōḷ",size:5,type:"noun"},{id:"ai",size:1,type:"noun"},{id:"akal",size:3,type:"noun"},{id:"valkul",size:1},{id:"kaṇṇi",size:1,type:"noun"},{id:"nēr",size:1,type:"noun"},{id:"tīṇṭu",size:1,type:"verb"},{id:"yayala",size:1},{id:"vaṭuk",size:1},{id:"mā(m)",size:4,type:"noun"},{id:"val",size:4,type:"noun"},{id:"taḷir",size:2,type:"noun"},{id:"nuṭaṅku",size:4,type:"verb"},{id:"aṇit",size:1},{id:"mārpu",size:9,type:"noun"},{id:"paṉit",size:1},{id:"tuyil",size:1,type:"noun"},{id:"cey",size:8,type:"noun"},{id:"malir",size:3,type:"verb"},{id:"niṟai",size:5,type:"noun"},{id:"virumpiya",size:1},{id:"taḻaip",size:1},{id:"makaḷirkkup",size:1},{id:"puṇar",size:5,type:"verb"},{id:"tuṇai",size:7,type:"noun"},{id:"yutavum",size:1},{id:"mūtu",size:1},{id:"ōkku",size:2,type:"verb"},{id:"vēḻattut",size:2},{id:"tūmpu",size:2,type:"noun"},{id:"uṭait",size:1},{id:"tiraḷ",size:1,type:"noun"},{id:"kāl",size:7,type:"noun"},{id:"toḻumakaḷir",size:1},{id:"añcaṉam",size:1},{id:"pey",size:3,type:"verb"},{id:"pūk",size:5},{id:"kañal",size:4,type:"verb"},{id:"yuḷḷip",size:1},{id:"putal",size:1,type:"noun"},{id:"micai",size:1,type:"noun"},{id:"vicumpu",size:2,type:"noun"},{id:"kuruku",size:4,type:"noun"},{id:"tōṟṟam",size:3,type:"noun"},{id:"putu",size:1,type:"adjective"},{id:"mēvu",size:1,type:"noun"},{id:"vaṟu(m)",size:1,type:"adjective"},{id:"maṭa(m)",size:6,type:"noun"},{id:"iru(m)",size:2,type:"adjective"},{id:"cāy",size:1,type:"noun"},{id:"ceruntiyoṭu",size:1},{id:"alamvaru",size:2,type:"verb"},{id:"kaḻaṉi",size:9,type:"noun"},{id:"poru",size:1,type:"verb"},{id:"malar",size:14,type:"noun"},{id:"ṇaḻap",size:1},{id:"piri",size:4,type:"verb"},{id:"ekkar",size:1,type:"noun"},{id:"putup",size:5},{id:"meym",size:1},{id:"maṇa",size:3,type:"verb"},{id:"kamaḻ",size:1,type:"verb"},{id:"poḻil",size:2,type:"noun"},{id:"ḷuḷai",size:1},{id:"cī",size:2,type:"verb"},{id:"kalakkam",size:2,type:"noun"},{id:"viḷaika",size:1},{id:"vayal",size:3,type:"noun"},{id:"viravalar",size:1},{id:"eṉ",size:15,type:"pronoun"},{id:"litaḻ",size:1},{id:"nikar",size:1,type:"noun"},{id:"kēḷ",size:5,type:"verb"},{id:"vaḻi",size:1,type:"noun"},{id:"vaḻic",size:1},{id:"aṟu",size:6,type:"noun"},{id:"cil",size:3,type:"noun"},{id:"vam",size:3},{id:"ciṟait",size:1},{id:"tumpi",size:1,type:"noun"},{id:"nūṟṟu",size:1},{id:"itaḻt",size:1},{id:"tāmaraip",size:1},{id:"pūc",size:1},{id:"kāmpu",size:1,type:"noun"},{id:"uṭai",size:2,type:"noun"},{id:"naṇṇu",size:2,type:"verb"},{id:"yūraṉai",size:2},{id:"yuḷḷi",size:2},{id:"yeṉ",size:1},{id:"ṉiṟai",size:1},{id:"yēr",size:1},{id:"el",size:2,type:"noun"},{id:"vaḷai",size:3,type:"noun"},{id:"yeṉṉai",size:2},{id:"tāṉum",size:1},{id:"malaintāṉ",size:1},{id:"em",size:8,type:"pronoun"},{id:"taḻai",size:2,type:"noun"},{id:"yāyiṉa",size:1},{id:"vī",size:2,type:"noun"},{id:"maṇi",size:4,type:"noun"},{id:"arumpu",size:1,type:"noun"},{id:"yeṉṉa",size:1},{id:"maram",size:1,type:"noun"},{id:"yaḵtu",size:1},{id:"varaiyara",size:1},{id:"niraiyuṭaṉ",size:1},{id:"kuḻīip",size:1},{id:"peyarvuḻip",size:1},{id:"peyarvuḻit",size:1},{id:"tavir",size:1,type:"verb"},{id:"nōkkam",size:2,type:"noun"},{id:"tīyēṉ",size:1},{id:"muḷḷi",size:3,type:"noun"},{id:"nīṭṭu",size:2,type:"verb"},{id:"mutu",size:1,type:"adjective"},{id:"nīr",size:3,type:"pronoun"},{id:"aṭai",size:1,type:"noun"},{id:"karaip",size:1},{id:"puḷḷik",size:3},{id:"kaḷvaṉ",size:9,type:"noun"},{id:"āmpal",size:6,type:"noun"},{id:"teḷ",size:1,type:"adjective"},{id:"pacappatu",size:2},{id:"aḷḷal",size:1,type:"noun"},{id:"āṭu",size:6,type:"noun"},{id:"vēr",size:2,type:"noun"},{id:"aḷaic",size:1},{id:"col",size:4,type:"noun"},{id:"nīyēṉ",size:1},{id:"amma",size:12},{id:"tōḻaṉ",size:12},{id:"kātal",size:3,type:"noun"},{id:"pāvai",size:2,type:"noun"},{id:"veṉṉ",size:1},{id:"kaviṉ",size:3,type:"noun"},{id:"tolai",size:1,type:"verb"},{id:"pacappac",size:1},{id:"tām",size:2,type:"pronoun"},{id:"malai",size:1,type:"noun"},{id:"nāṭu",size:3,type:"noun"},{id:"vaḻit",size:1},{id:"taṇantu",size:1},{id:"varaitaṟku",size:1},{id:"vēṇṭuvaṉa",size:1},{id:"muṭi",size:1,type:"noun"},{id:"talaimakaṉ",size:1},{id:"kūṟak",size:1},{id:"talaimakaḷ",size:2},{id:"ciṟaippuṟattāṉ",size:1},{id:"āyk",size:1},{id:"kēṭpat",size:1},{id:"aḷaik",size:1},{id:"āṭṭip",size:1},{id:"kuṟṟu",size:2,type:"verb"},{id:"eytu",size:1,type:"verb"},{id:"aṇi",size:8,type:"noun"},{id:"tēṟṟam",size:1},{id:"nap",size:1},{id:"iṉit",size:1},{id:"tākku",size:1,type:"verb"},{id:"aṇaṅku",size:3,type:"noun"},{id:"tāy",size:2,type:"noun"},{id:"cāp",size:1},{id:"piṟa",size:3,type:"noun"},{id:"kaḷvaṉoṭu",size:1},{id:"piḷḷai",size:1,type:"noun"},{id:"tiṉṉum",size:2},{id:"mutalaittu",size:1},{id:"eytiṉaṉ",size:1},{id:"makiḻ",size:23,type:"noun"},{id:"polam",size:2,type:"noun"},{id:"toṭi",size:8,type:"noun"},{id:"teḷir",size:1,type:"verb"},{id:"muyaṅkiyavar",size:1},{id:"tuṟappatu",size:1},{id:"ayal",size:1,type:"noun"},{id:"puṟantā",size:1,type:"verb"},{id:"puṉiṟu",size:2,type:"noun"},{id:"pai(m)",size:2,type:"adjective"},{id:"kāy",size:2,type:"noun"},{id:"vayalaic",size:2},{id:"ce(m)",size:9,type:"adjective"},{id:"koṭi",size:1,type:"noun"},{id:"palarkku",size:1},{id:"nekiḻ",size:2,type:"verb"},{id:"poy",size:5,type:"noun"},{id:"paṭu",size:2,type:"verb"},{id:"aṟiyāk",size:1},{id:"kaḻaṅku",size:1,type:"noun"},{id:"mey",size:1,type:"noun"},{id:"varaik",size:1},{id:"kaṭci",size:1,type:"noun"},{id:"mayil",size:2,type:"noun"},{id:"ālu",size:2,type:"verb"},{id:"nām",size:8,type:"pronoun"},{id:"vaḷḷi",size:1,type:"noun"},{id:"kāṉ",size:1,type:"noun"},{id:"kiḻamai",size:1,type:"noun"},{id:"āṇ",size:1,type:"noun"},{id:"taku",size:2,type:"verb"},{id:"viṟal",size:1,type:"noun"},{id:"vēṭkai",size:1,type:"noun"},{id:"pūṭṭu",size:1,type:"noun"},{id:"tāṅku",size:1,type:"verb"},{id:"iḷa(m)",size:1,type:"adjective"},{id:"karantai",size:1,type:"noun"},{id:"ceṟu",size:3,type:"verb"},{id:"tuṟa",size:1,type:"verb"},{id:"vaḷḷai",size:1,type:"noun"},{id:"mel",size:5,type:"adjective"},{id:"aṟi",size:7,type:"verb"},{id:"iṉṉaṉ",size:1},{id:"katir",size:5,type:"noun"},{id:"ṇakam",size:2},{id:"maṇ",size:2,type:"noun"},{id:"ṇaḷaic",size:1},{id:"nekiḻac",size:2},{id:"cā",size:2,type:"verb"},{id:"allal",size:1,type:"noun"},{id:"uḻa",size:1,type:"verb"},{id:"yaṇaṅku",size:1},{id:"uṟai",size:3,type:"noun"},{id:"cēṟu",size:1,type:"noun"},{id:"vari",size:3,type:"noun"},{id:"oṇmai",size:5,type:"noun"},{id:"kaṭi",size:1,type:"noun"},{id:"koḷak",size:1},{id:"kā",size:1,type:"noun"},{id:"kaṭuka",size:1},{id:"vittu",size:2,type:"noun"},{id:"muḷai",size:1,type:"noun"},{id:"marīit",size:1},{id:"titti",size:2,type:"noun"},{id:"yalkul",size:2},{id:"paca",size:6,type:"verb"},{id:"koḷvatu",size:1},{id:"pāl",size:2,type:"noun"},{id:"vūṟuka",size:1},{id:"pakaṭu",size:1},{id:"vuḻavar",size:1},{id:"peyar",size:2,type:"noun"},{id:"vēppa(m)",size:1,type:"noun"},{id:"neṭu(m)",size:7,type:"adjective"},{id:"ṇaḷai",size:1},{id:"vuṟaikkum",size:1},{id:"iḻa",size:1,type:"verb"},{id:"ñeli",size:1,type:"noun"},{id:"kaḻai",size:2,type:"noun"},{id:"aḻal",size:1,type:"noun"},{id:"vayamā",size:1},{id:"veru",size:2,type:"noun"},{id:"kuṉṟam",size:1,type:"noun"},{id:"yarum",size:1},{id:"curam",size:3,type:"noun"},{id:"ayar",size:1,type:"verb"},{id:"il",size:7,type:"noun"},{id:"koṇkaṉ",size:1,type:"noun"},{id:"poruḷ",size:1,type:"noun"},{id:"tuṇaip",size:1},{id:"kaṭam",size:1,type:"noun"},{id:"mūr",size:3},{id:"muṭam",size:1},{id:"mutir",size:2,type:"verb"},{id:"marutattup",size:2},{id:"yuṭaṉ",size:1},{id:"āyamōṭu",size:2},{id:"pāṇṭil",size:2,type:"noun"},{id:"kalam",size:1,type:"noun"},{id:"nantat",size:1},{id:"alkul",size:1,type:"noun"},{id:"vāṭṭam",size:1,type:"noun"},{id:"viṟantōr",size:1},{id:"maṉ",size:3},{id:"piṟaṅku",size:1,type:"verb"},{id:"malaip",size:1},{id:"pull",size:1},{id:"arai",size:1,type:"noun"},{id:"yōmai",size:1},{id:"puli",size:1,type:"noun"},{id:"vaḻakku",size:1,type:"noun"},{id:"cūḻkam",size:1},{id:"pāḻ",size:1,type:"noun"},{id:"paṭṭup",size:1},{id:"veppa(m)",size:2,type:"noun"},{id:"pālai",size:1,type:"noun"},{id:"vem",size:6},{id:"kāṭṭu",size:1,type:"noun"},{id:"aru(m)",size:2,type:"adjective"},{id:"iṟa",size:1,type:"verb"},{id:"neñcam",size:3,type:"noun"},{id:"nāḷ",size:5,type:"noun"},{id:"mil",size:1},{id:"vantataṟku",size:1},{id:"eḻu",size:2,type:"noun"},{id:"aḻupa",size:1},{id:"veṉpa",size:1},{id:"vavaṉ",size:1},{id:"tī",size:3,type:"noun"},{id:"yuṟu",size:1},{id:"meḻukiṉ",size:1},{id:"muḷiya",size:1},{id:"vēṉal",size:3,type:"noun"},{id:"nīṭik",size:1},{id:"kaṭu(m)",size:1,type:"adjective"},{id:"ñāyiṟu",size:1,type:"noun"},{id:"kal",size:1,type:"noun"},{id:"pakat",size:1},{id:"teṟu",size:1,type:"verb"},{id:"vāyiṉa",size:2},{id:"muṉ",size:6},{id:"yoḷ",size:4},{id:"nutal",size:7,type:"noun"},{id:"arivai",size:4,type:"noun"},{id:"yuḷḷu",size:1},{id:"toṟum",size:1},{id:"eri",size:1,type:"noun"},{id:"kavar",size:1,type:"verb"},{id:"veṉṟūḻ",size:1},{id:"nīḷ",size:2,type:"noun"},{id:"iṭaic",size:1},{id:"kaṇpaṭuppiṉum",size:1},{id:"kāṇkuveṉ",size:1},{id:"naḷḷeṉ",size:1,type:"verb"},{id:"kaṅkul",size:1,type:"noun"},{id:"naḷi",size:1,type:"noun"},{id:"nakar",size:2,type:"noun"},{id:"vēṅkai",size:1,type:"noun"},{id:"cuṇaṅku",size:2,type:"noun"},{id:"tēm",size:1,type:"noun"},{id:"pāy",size:4,type:"verb"},{id:"maruta(m)",size:3,type:"noun"},{id:"uyar",size:1,type:"verb"},{id:"viri",size:2,type:"verb"},{id:"tuṟaip",size:1},{id:"peṇṭirōṭu",size:1},{id:"tār",size:1,type:"noun"},{id:"talait",size:1},{id:"mūrp",size:2},{id:"poykaip",size:3},{id:"puḻaik",size:1},{id:"tātu",size:6,type:"noun"},{id:"vaṇṇa(m)",size:2,type:"noun"},{id:"vētilāḷarkkup",size:1},{id:"tiṇ",size:3,type:"adjective"},{id:"nilaik",size:1},{id:"kōṅkam",size:1,type:"noun"},{id:"paya",size:2,type:"verb"},{id:"vaṇi",size:1},{id:"miku",size:2,type:"verb"},{id:"koḻu",size:1,type:"verb"},{id:"mukiḻ",size:2,type:"noun"},{id:"poykai",size:7,type:"noun"},{id:"yāmpal",size:3},{id:"nār",size:1,type:"noun"},{id:"uri",size:1,type:"noun"},{id:"niṟam",size:3,type:"noun"},{id:"niḻaṟṟutal",size:1},{id:"yiṉip",size:1},{id:"maṟa",size:2,type:"verb"},{id:"uḷḷu",size:1,type:"verb"},{id:"amaikuva",size:1},{id:"kayal",size:2,type:"noun"},{id:"eṉak",size:3},{id:"karutiya",size:1},{id:"vuṇ",size:2},{id:"olku",size:1,type:"verb"},{id:"naya",size:4,type:"verb"},{id:"paṉi",size:1,type:"noun"},{id:"mal",size:1,type:"noun"},{id:"tēṟṟāṉ",size:1},{id:"uṇarntōr",size:2},{id:"vauvu",size:1,type:"verb"},{id:"mulai",size:3,type:"noun"},{id:"yaṭaiya",size:1},{id:"muyakkam",size:1,type:"noun"},{id:"vayiṉ",size:2,type:"noun"},{id:"tiruttu",size:1,type:"verb"},{id:"ñekiḻap",size:1},{id:"pakai",size:2,type:"noun"},{id:"pul",size:2,type:"noun"},{id:"lārka",size:1},{id:"pār",size:1,type:"noun"},{id:"ōtuka",size:1},{id:"kāytta",size:1},{id:"paḻaṉa(m)",size:5,type:"noun"},{id:"ākaṟka",size:2},{id:"aḻap",size:1},{id:"iṟai",size:1,type:"noun"},{id:"keṇṭai",size:1,type:"noun"},{id:"taru/tā",size:3,type:"verb"},{id:"vaviḻnta",size:1},{id:"vaṇṭu",size:6,type:"noun"},{id:"piṇi",size:4,type:"noun"},{id:"maṟi",size:1,type:"noun"},{id:"yiṭaip",size:1},{id:"piṇa",size:1,type:"noun"},{id:"pōlap",size:3},{id:"putalvaṉ",size:4,type:"noun"},{id:"naṭuvaṇaṉ",size:1},{id:"naṉṟum",size:1},{id:"iṉitumaṉṟa",size:1},{id:"vavar",size:1},{id:"kiṭa",size:1,type:"verb"},{id:"muṉi",size:1,type:"noun"},{id:"niṟa",size:1,type:"verb"},{id:"viyal",size:1,type:"noun"},{id:"aka(m)",size:1,type:"noun"},{id:"kavai",size:2,type:"noun"},{id:"vīṉum",size:1},{id:"umparum",size:1},{id:"kātaliyiṉ",size:1},{id:"talai",size:1},{id:"amar",size:2,type:"noun"},{id:"vuḷḷam",size:1},{id:"yakaṉ",size:1},{id:"tantai",size:2,type:"noun"},{id:"muṟuvaliṉ",size:1},{id:"iṉ",size:3,type:"adjective"},{id:"naku",size:1,type:"verb"},{id:"payiṟṟic",size:1},{id:"uruṭṭu",size:1,type:"verb"},{id:"taḷar",size:2,type:"verb"},{id:"vāḷ",size:1,type:"noun"},{id:"yūṭṭat",size:1},{id:"puṟam",size:1,type:"noun"},{id:"naṟu(m)",size:7,type:"adjective"},{id:"puṟavam",size:3},{id:"kuṟu(m)",size:2,type:"adjective"},{id:"poṟu",size:1,type:"verb"},{id:"oṇ",size:1},{id:"cuṭar",size:4,type:"noun"},{id:"maṉaikku",size:1},{id:"viḷakkam",size:1,type:"noun"},{id:"kaṉai",size:1,type:"verb"},{id:"vai",size:1,type:"noun"},{id:"mātar",size:1,type:"noun"},{id:"viḷaiyāṭak",size:1},{id:"kātalit",size:1},{id:"taḻuvu",size:3,type:"verb"},{id:"yiṉitu",size:1},{id:"iruntaṉaṉ",size:1},{id:"piracam",size:1,type:"noun"},{id:"ūtu",size:2,type:"verb"},{id:"poḻutu",size:3,type:"noun"},{id:"pārpput",size:2},{id:"aṉpu",size:1,type:"noun"},{id:"mutalai",size:1,type:"noun"},{id:"poykaittu",size:1},{id:"mikac",size:1},{id:"mayaṅkiṉaḷ",size:1},{id:"māṇ",size:4,type:"noun"},{id:"yarivai",size:1},{id:"kāviri",size:1,type:"noun"},{id:"ampaṇattu",size:1},{id:"yāmai",size:3,type:"noun"},{id:"yēṟic",size:1},{id:"cempiṉ",size:1},{id:"pārppup",size:1},{id:"tīm",size:2,type:"adjective"},{id:"yiḷam",size:1},{id:"mukam",size:1,type:"noun"},{id:"vaḷarnticiṉāaṅku",size:1},{id:"yaiya",size:1},{id:"yaṟintaṉai",size:1},{id:"yoḻukumati",size:1},{id:"kūtir",size:1,type:"noun"},{id:"kaliḻ",size:1,type:"verb"},{id:"yāṟu",size:1,type:"noun"},{id:"aṇintaṉa",size:1},{id:"yaṉṟu",size:1},{id:"aḵtu",size:1},{id:"kuṟippiṉai",size:1},{id:"yāki",size:2},{id:"yīṇṭu",size:1},{id:"yaruḷātu",size:1},{id:"muḷ",size:1,type:"noun"},{id:"ḷeyiṟṟup",size:1},{id:"keṭiṟu",size:1,type:"noun"},{id:"cori",size:3,type:"verb"},{id:"vakaṉ",size:1},{id:"vaṭṭi",size:2,type:"noun"},{id:"ari",size:1,type:"noun"},{id:"payaṟu",size:1,type:"noun"},{id:"niṟaikkum",size:2},{id:"yāyam",size:1},{id:"valai",size:1,type:"noun"},{id:"eyiṟu",size:1,type:"noun"},{id:"varāal",size:1,type:"noun"},{id:"yuḷ",size:1},{id:"yāṅkaṇ",size:8,type:"pronoun"},{id:"kaḻi",size:1},{id:"vēṇṭēm",size:1},{id:"parattaṉ",size:1,type:"noun"},{id:"yāṇṭuc",size:1},{id:"kuṟiyōṭu",size:1},{id:"ōti",size:1,type:"noun"},{id:"yacai",size:1},{id:"naṭaip",size:2},{id:"peṟu",size:5,type:"verb"},{id:"citaiyap",size:1},{id:"paci",size:2,type:"noun"},{id:"yil",size:1},{id:"lākuka",size:3},{id:"cēṇ",size:1,type:"noun"},{id:"mutalaip",size:1},{id:"pōttu",size:2,type:"noun"},{id:"muḻu",size:1,type:"noun"},{id:"kaṭai",size:1,type:"noun"},{id:"niṟka",size:1},{id:"celvam",size:1,type:"noun"},{id:"varuttam",size:1,type:"noun"},{id:"vañci",size:1,type:"noun"},{id:"yōṅkiya",size:1},{id:"tañcam",size:1,type:"noun"},{id:"aruḷ",size:1,type:"noun"},{id:"kōḻi",size:1,type:"noun"},{id:"nīlac",size:1},{id:"cēval",size:1,type:"noun"},{id:"kūr",size:1,type:"noun"},{id:"ukirp",size:1},{id:"pēṭai",size:3,type:"noun"},{id:"vayāam",size:1},{id:"puḷim",size:1},{id:"vēṭkaittu",size:1},{id:"taiic",size:1},{id:"viral",size:1,type:"noun"},{id:"civa",size:3,type:"verb"},{id:"yari",size:1},{id:"maḻaik",size:1},{id:"vāyk",size:1},{id:"vev",size:1},{id:"yevaṉ",size:1},{id:"ciṟai",size:2,type:"noun"},{id:"yaḻi",size:2},{id:"kalaṅkik",size:1},{id:"kaḻaṉit",size:2},{id:"tāmarai",size:3,type:"noun"},{id:"vūra",size:1},{id:"tērt",size:1},{id:"teṉ",size:1,type:"noun"},{id:"nāṭṭu",size:1,type:"verb"},{id:"uḷ",size:1},{id:"oḻukku",size:1,type:"verb"},{id:"tēṉūr",size:3},{id:"vivaḷ",size:6},{id:"teri",size:1,type:"verb"},{id:"vūriṉ",size:1},{id:"pañcāyk",size:1},{id:"kōtai",size:1,type:"noun"},{id:"accam",size:2,type:"noun"},{id:"entiram",size:1},{id:"kaḷiṟu",size:1,type:"noun"},{id:"etir",size:1,type:"noun"},{id:"piḷiṟṟum",size:1},{id:"vaḷ",size:4,type:"noun"},{id:"kō",size:1,type:"noun"},{id:"laṇi",size:1},{id:"tuṟattaliṉ",size:1},{id:"aṟiyap",size:1},{id:"pakal",size:3,type:"noun"},{id:"viḷakkōṭu",size:1},{id:"ira(m)",size:1,type:"noun"},{id:"pōrc",size:1},{id:"cōḻaṉ",size:1,type:"noun"},{id:"āmūr",size:1,type:"noun"},{id:"tēmpa",size:1},{id:"vevaṉ",size:1},{id:"katirt",size:1},{id:"pulampap",size:1},{id:"vaṉai",size:1,type:"verb"},{id:"-uṭai",size:2},{id:"viṇṭu",size:1,type:"noun"},{id:"vaṉṉa",size:1},{id:"pōr",size:2,type:"verb"},{id:"kai",size:2,type:"noun"},{id:"virāaṉ",size:1,type:"noun"},{id:"iruppai",size:1,type:"noun"},{id:"maṉaiyai",size:1},{id:"vāṟṟu",size:1},{id:"maintu",size:1,type:"noun"},{id:"evvam",size:1,type:"noun"},{id:"tīr",size:1,type:"verb"},{id:"yāṉ",size:1,type:"pronoun"},{id:"yivaṭku",size:1},{id:"vēttu",size:1,type:"adjective"},{id:"taṇika",size:1},{id:"nantuka",size:1},{id:"tāmarait",size:1},{id:"varaika",size:1},{id:"entai",size:1,type:"noun"},{id:"koṭukka",size:1},{id:"paḻaṉak",size:1},{id:"kampuḷ",size:2,type:"noun"},{id:"payirp",size:1},{id:"peṭai",size:1,type:"noun"},{id:"yakavum",size:1},{id:"yūra",size:2},{id:"moḻi",size:2,type:"noun"},{id:"vaṭi",size:1,type:"noun"},{id:"viḷai",size:1,type:"noun"},{id:"uku",size:1,type:"verb"},{id:"paḻa(m)",size:1,type:"adjective"},{id:"nīrp",size:2},{id:"poykait",size:2},{id:"tuṭumeṉ",size:1},{id:"viḻūum",size:1},{id:"matti",size:1,type:"noun"},{id:"kaḻāar",size:1,type:"noun"},{id:"vatuvai",size:1,type:"noun"},{id:"yayara",size:1},{id:"intira",size:1},{id:"viḻavu",size:1,type:"noun"},{id:"talaip",size:2},{id:"akavu",size:1,type:"verb"},{id:"iv",size:1},{id:"vūr",size:2},{id:"maṅkaiyart",size:1},{id:"toku",size:1,type:"verb"},{id:"yev",size:1},{id:"nil",size:2,type:"verb"},{id:"paḷḷip",size:1},{id:"nīrnāy",size:1,type:"noun"},{id:"vāḷai",size:1,type:"noun"},{id:"irai",size:1,type:"noun"},{id:"tolaivatu",size:1},{id:"tuṉṉu",size:1,type:"verb"},{id:"piṟart",size:1},{id:"āṭak",size:1},{id:"oruvar",size:1},{id:"ē",size:1,type:"noun"},{id:"pāttiyiṉ",size:1},{id:"kali",size:1,type:"noun"},{id:"vāmpal",size:1},{id:"curumpu",size:1,type:"noun"},{id:"kaḷai",size:1,type:"verb"},{id:"yīṉṟa",size:1},{id:"muyaṅkaṉmō",size:1},{id:"uṭaliṉēṉ",size:1},{id:"urai",size:2,type:"verb"},{id:"yiṉik",size:1},{id:"nikarā",size:1},{id:"veṉṉoṭu",size:1},{id:"nikarip",size:1},{id:"tarukkum",size:1},{id:"malart",size:1},{id:"yōti",size:1},{id:"kaṉṉi",size:1,type:"noun"},{id:"viṭiyal",size:1,type:"noun"},{id:"kaṇaik",size:1},{id:"pēṇāḷ",size:1},{id:"naṭa",size:2,type:"verb"},{id:"kaṇṭaṉem",size:1},{id:"vaṇṭal",size:1,type:"noun"},{id:"uy",size:1,type:"verb"},{id:"vaḻutu",size:1},{id:"yaṟam",size:1},{id:"vallatu",size:1},{id:"keṭu",size:1,type:"verb"},{id:"yuḷaip",size:1},{id:"marutattuk",size:1},{id:"kiḷaik",size:1},{id:"ṉūrk",size:1},{id:"paḻaṉap",size:2},{id:"nārai",size:2,type:"noun"},{id:"ceṉṉic",size:1},{id:"cē",size:2,type:"noun"},{id:"tūyar",size:1},{id:"naṟiyar",size:1},{id:"pēy",size:1,type:"noun"},{id:"(i)yām",size:1},{id:"cūtu",size:1},{id:"toṭic",size:1},{id:"cūr",size:1,type:"noun"},{id:"nuṭakkattu",size:1},{id:"nerunal",size:1},{id:"yāṭiṉai",size:1},{id:"yeṉpa",size:1},{id:"maṟai",size:1,type:"noun"},{id:"ol(lu)",size:3,type:"verb"},{id:"putaittal",size:1},{id:"kayil",size:1},{id:"taḻait",size:1},{id:"tuyal",size:1,type:"verb"},{id:"kūntal",size:3,type:"noun"},{id:"kuvaḷai",size:2,type:"noun"},{id:"yuṇ",size:1},{id:"liyal",size:1},{id:"paṇṇai",size:2,type:"noun"},{id:"kaḷ",size:1,type:"verb"},{id:"nāṟit",size:1},{id:"tōkaic",size:1},{id:"cīr",size:1,type:"noun"},{id:"pacu(m)",size:3,type:"adjective"},{id:"avir",size:1,type:"verb"},{id:"niḻaṟṟak",size:1},{id:"ēṟip",size:1},{id:"pāyvōḷ",size:1},{id:"ovvāy",size:1},{id:"vataṉāl",size:1},{id:"toṭakku",size:1,type:"verb"},{id:"tol",size:1,type:"adjective"},{id:"niṉṉōṭu",size:2},{id:"āṭiṉaḷ",size:1},{id:"paiñcāyk",size:1},{id:"malarc",size:1},{id:"āṭit",size:2},{id:"mēmpaṭṭaṉaḷ",size:1},{id:"antaram",size:1},{id:"makaḷirkkut",size:2},{id:"pēr",size:1,type:"noun"},{id:"alaik",size:1},{id:"vēl",size:1,type:"noun"},{id:"kaṭu",size:1,type:"verb"},{id:"kiḷḷi",size:1,type:"noun"},{id:"matil",size:1,type:"noun"},{id:"kol",size:1,type:"verb"},{id:"yāṉai",size:1,type:"noun"},{id:"kataḻpu",size:1},{id:"neṟi",size:2,type:"noun"},{id:"āṭi",size:1,type:"noun"},{id:"yamartta",size:1},{id:"paṟṟu",size:1,type:"noun"},{id:"makaṉai",size:1},{id:"yaracu",size:1},{id:"muṟai",size:1,type:"noun"},{id:"ceyka",size:1},{id:"kaḷavu",size:1,type:"noun"},{id:"yalaṅku",size:1},{id:"cūḷ",size:1,type:"noun"},{id:"vāyppatu",size:1},{id:"pulakkuvēm",size:1},{id:"nalat",size:1},{id:"yākit",size:1},{id:"tava",size:1},{id:"ḷakaṭṭu",size:1},{id:"yarip",size:1},{id:"paṟai",size:2,type:"noun"},{id:"viṉai",size:1,type:"noun"},{id:"micaik",size:1},{id:"kūṭṭam",size:1,type:"noun"},{id:"nayantaṉeṉ",size:1},{id:"kēṭkiṉ",size:1},{id:"vekuṇṭaṉaḷ",size:1},{id:"aviḻ",size:2,type:"noun"},{id:"iṇar",size:1,type:"noun"},{id:"tārt",size:1},{id:"paṟa",size:1,type:"verb"},{id:"yaruḷāy",size:1},{id:"paipayat",size:1},{id:"taṇa",size:1,type:"verb"},{id:"yuymmō",size:1},{id:"num",size:3,type:"pronoun"},{id:"āy",size:1,type:"verb"},{id:"cevi",size:1,type:"noun"},{id:"liṟantu",size:1},{id:"vekuḷvōḷ",size:1},{id:"yaim",size:1},{id:"taiit",size:1},{id:"kayam",size:1,type:"noun"},{id:"paṭintu",size:1},{id:"arik",size:1},{id:"kural",size:2,type:"noun"},{id:"paḻaṉattuk",size:1},{id:"kiḷaiyōṭu",size:1},{id:"mali",size:2,type:"verb"},{id:"ciṟuvariṉ",size:1},{id:"nakār",size:1},{id:"talaik",size:1},{id:"viḷik",size:1},{id:"yimiḻum",size:1},{id:"mivaṇ",size:1},{id:"alku",size:1,type:"verb"},{id:"pakaṉṟaik",size:1},{id:"kaṇṇip",size:1},{id:"lāṉ",size:1},{id:"kōvalar",size:1,type:"noun"},{id:"kuṇil",size:1,type:"noun"},{id:"ā",size:1},{id:"kaṉi",size:1,type:"noun"},{id:"yutirkkum",size:1},{id:"pula",size:2,type:"verb"},{id:"malarp",size:2},{id:"yevvai",size:1},{id:"yem",size:1},{id:"vevvaikku",size:1},{id:"aḷi",size:1,type:"noun"},{id:"virumpiṉṟu",size:1},{id:"yampal",size:1},{id:"kuṇam",size:2,type:"noun"},{id:"maruppu",size:1,type:"noun"},{id:"virum",size:1},{id:"veṟi",size:1,type:"noun"},{id:"mayakkum",size:2},{id:"vetir",size:1,type:"noun"},{id:"karu(m)",size:3,type:"adjective"},{id:"kōṭṭam",size:4,type:"noun"},{id:"erumaic",size:1},{id:"āk",size:1},{id:"kuḻavikku",size:1},{id:"ūṟṟu",size:1,type:"noun"},{id:"maṭukkum",size:1},{id:"nuntai",size:2,type:"noun"},{id:"maṭantai",size:1,type:"noun"},{id:"niṉṉai",size:1},{id:"lēṟṟu",size:1},{id:"iṉam",size:1,type:"noun"},{id:"mēy",size:2,type:"verb"},{id:"aruttu",size:1,type:"verb"},{id:"mōrōṭamōṭu",size:1},{id:"viṉaiya",size:1},{id:"veṟukkaiya",size:1},{id:"vāki",size:1},{id:"yivaḷ",size:1},{id:"mucci",size:1,type:"noun"},{id:"maḷḷar",size:1,type:"noun"},{id:"vati",size:1,type:"noun"},{id:"ilañcip",size:1},{id:"paḻaṉattatu",size:1},{id:"kayiṟu",size:1,type:"noun"},{id:"acai",size:1,type:"verb"},{id:"muṟṟi",size:1,type:"verb"},{id:"paṭar",size:1,type:"noun"},{id:"yaru",size:1},{id:"yerumai",size:2},{id:"yāṭiya",size:1},{id:"āmpaloṭu",size:1},{id:"kalikkum",size:1},{id:"vūraṉ",size:1},{id:"pāyal",size:1,type:"noun"},{id:"pakaṉṟai",size:1,type:"noun"},{id:"miṭai",size:1,type:"noun"},{id:"kōṭṭaik",size:1},{id:"erumaik",size:1},{id:"kaṉṟu",size:1,type:"noun"},{id:"yampiyiṉ",size:1},{id:"pākal",size:1,type:"noun"},{id:"muyiṟu",size:1,type:"noun"},{id:"mūcu",size:1,type:"verb"},{id:"kuṭampai",size:1,type:"noun"}],IM=[{id:"a- ūr",source:"a-",target:"ūr",strength:.1616945944110503,citations:["Aink24","Aink41"]},{id:"a- nī",source:"a-",target:"nī",strength:.17852372374286282,citations:["Aink44","Aink51"]},{id:"ūr ūr",source:"ūr",target:"ūr",strength:.20572590954112346,citations:["Aink15"],curvature:.5},{id:"ūr maka",source:"ūr",target:"maka",strength:.21091763670334998,citations:["Aink100","Aink99"]},{id:"tuṟai ūr",source:"tuṟai",target:"ūr",strength:.2407139237983484,citations:["Aink11","Aink12"]},{id:"ūr peru(m)",source:"ūr",target:"peru(m)",strength:.2407139237983484,citations:["Aink30","Aink48"]},{id:"makiḻ nī",source:"makiḻ",target:"nī",strength:.24485133996279898,citations:["Aink69","Aink77"]},{id:"vāḻ yūraṉ",source:"vāḻ",target:"yūraṉ",strength:.25072809696456333,citations:["Aink36","Aink39"]},{id:"makiḻ a-",source:"makiḻ",target:"a-",strength:.252195806330655,citations:["Aink31","Aink90"]},{id:"puṉal ūr",source:"puṉal",target:"ūr",strength:.27019421383307235,citations:["Aink65","Aink95"]},{id:"nī pal",source:"nī",target:"pal",strength:.27150596090063706,citations:["Aink55","Aink69"]},{id:"pū(m) a-",source:"pū(m)",target:"a-",strength:.286393488178733,citations:["Aink41","Aink62"]},{id:"ūr eṉ",source:"ūr",target:"eṉ",strength:.2876560546460044,citations:["Aink41","Aink89"]},{id:"ūr nal",source:"ūr",target:"nal",strength:.2953598880461306,citations:["Aink12","Aink22","Aink63"]},{id:"nī maka",source:"nī",target:"maka",strength:.3013615465919991,citations:["Aink101","Aink29","Aink49"]},{id:"tāṉ a-",source:"tāṉ",target:"a-",strength:.30282571072088704,citations:["Aink103","Aink404"],curvature:.25},{id:"eṉ nī",source:"eṉ",target:"nī",strength:.3044851839778169,citations:["Aink81","Aink82"]},{id:"nal nal",source:"nal",target:"nal",strength:.3066482140107437,citations:["Aink204","Aink61"],curvature:.5},{id:"eṉ a-",source:"eṉ",target:"a-",strength:.31182965034567295,citations:["Aink41","Aink89"]},{id:"ākkam peru(m)",source:"ākkam",target:"peru(m)",strength:.31958234712175354,citations:["Aink403","Aink63"]},{id:"malar a-",source:"malar",target:"a-",strength:.3214550281581727,citations:["Aink18","Aink72"]},{id:"kaṇ maka",source:"kaṇ",target:"maka",strength:.3280734695607928,citations:["Aink406","Aink79"]},{id:"vāḻ pāṇ",source:"vāḻ",target:"pāṇ",strength:.3341339167042573,citations:["Aink1","Aink89"]},{id:"tuṟai i-",source:"tuṟai",target:"i-",strength:.33741671857650585,citations:["Aink103","Aink28"]},{id:"cel ūr",source:"cel",target:"ūr",strength:.3442235633061601,citations:["Aink22","Aink27"]},{id:"ūr maṉai",source:"ūr",target:"maṉai",strength:.3442235633061601,citations:["Aink3","Aink87"]},{id:"ūr ākkam",source:"ūr",target:"ākkam",strength:.3466104123902956,citations:["Aink15","Aink19","Aink24"]},{id:"ākkam taṭpam",source:"ākkam",target:"taṭpam",strength:.35616175269383216,citations:["Aink28","Aink45","Aink54"]},{id:"pū(m) peru(m)",source:"pū(m)",target:"peru(m)",strength:.36541281756603106,citations:["Aink19","Aink33"]},{id:"ūr i-",source:"ūr",target:"i-",strength:.36635404865049237,citations:["Aink100","Aink30","Aink8","Aink99"]},{id:"makiḻ tāṉ",source:"makiḻ",target:"tāṉ",strength:.3691533269408232,citations:["Aink38","Aink66"]},{id:"ūr toṭi",source:"ūr",target:"toṭi",strength:.37535490979937597,citations:["Aink28","Aink98"]},{id:"vāḻ nām",source:"vāḻ",target:"nām",strength:.3785622382359366,citations:["Aink34","Aink35"]},{id:"a- tāṉ",source:"a-",target:"tāṉ",strength:.3809421688144741,citations:["Aink343","Aink41","Aink66"],curvature:.25},{id:"tuṟai tāṉ",source:"tuṟai",target:"tāṉ",strength:.3818450401081851,citations:["Aink10","Aink7"]},{id:"tuṟai varavu",source:"tuṟai",target:"varavu",strength:.3818450401081851,citations:["Aink105","Aink69"]},{id:"yūraṉ tāṉ",source:"yūraṉ",target:"tāṉ",strength:.3886518848378394,citations:["Aink10","Aink7"]},{id:"nī yāṅkaṇ",source:"nī",target:"yāṅkaṇ",strength:.39218403913118843,citations:["Aink79","Aink87"]},{id:"peṇ ūr",source:"peṇ",target:"ūr",strength:.3939842272366616,citations:["Aink13","Aink40"]},{id:"ūr nī",source:"ūr",target:"nī",strength:.39883293347291676,citations:["Aink42","Aink43","Aink49","Aink54","Aink68","Aink85","Aink87"]},{id:"em a-",source:"em",target:"a-",strength:.3995285054990445,citations:["Aink82","Aink90"]},{id:"yūraṉ maka",source:"yūraṉ",target:"maka",strength:.40011862920263647,citations:["Aink91","Aink96","Aink97"]},{id:"ūr pāṇ",source:"ūr",target:"pāṇ",strength:.4107279540240775,citations:["Aink1","Aink43","Aink49"]},{id:"aṟi nī",source:"aṟi",target:"nī",strength:.41081335656847406,citations:["Aink47","Aink79"]},{id:"varavu puṉal",source:"varavu",target:"puṉal",strength:.41132533014290906,citations:["Aink69","Aink72"]},{id:"ūr vem",source:"ūr",target:"vem",strength:.4154901959173777,citations:["Aink63","Aink86"]},{id:"kaḷvaṉ taṭpam",source:"kaḷvaṉ",target:"taṭpam",strength:.4219803262261868,citations:["Aink27","Aink30"]},{id:"peru(m) tuṟai",source:"peru(m)",target:"tuṟai",strength:.4244865013889071,citations:["Aink31","Aink69","Aink75"]},{id:"yūraṉ i-",source:"yūraṉ",target:"i-",strength:.4248222057702511,citations:["Aink91","Aink96","Aink97"]},{id:"nī pāṇ",source:"nī",target:"pāṇ",strength:.4285661454010907,citations:["Aink43","Aink47","Aink49"]},{id:"cel nal",source:"cel",target:"nal",strength:.4287871709558411,citations:["Aink22","Aink307"]},{id:"tōḻaṉ yūraṉ",source:"tōḻaṉ",target:"yūraṉ",strength:.4287871709558411,citations:["Aink36","Aink39"]},{id:"varavu eṉ",source:"varavu",target:"eṉ",strength:.4287871709558412,citations:["Aink2","Aink88"]},{id:"eṉ tāṉ",source:"eṉ",target:"tāṉ",strength:.4287871709558412,citations:["Aink33","Aink41"]},{id:"a- nal",source:"a-",target:"nal",strength:.4289233975260466,citations:["Aink55","Aink56","Aink57","Aink61"]},{id:"nī paca",source:"nī",target:"paca",strength:.43231932524919015,citations:["Aink29","Aink45"]},{id:"yaṉṉa nī",source:"yaṉṉa",target:"nī",strength:.43231932524919015,citations:["Aink307","Aink42"]},{id:"kaḻaṉi maka",source:"kaḻaṉi",target:"maka",strength:.43231932524919015,citations:["Aink91","Aink96"]},{id:"kaṇ e-",source:"kaṇ",target:"e-",strength:.435943233996663,citations:["Aink84"]},{id:"peṟu ūr",source:"peṟu",target:"ūr",strength:.44092635808431757,citations:["Aink49","Aink63"]},{id:"nī maṉai",source:"nī",target:"maṉai",strength:.44266039714726424,citations:["Aink66","Aink81","Aink87"]},{id:"tāṉ koḷ",source:"tāṉ",target:"koḷ",strength:.4487515477913442,citations:["Aink10","Aink7"]},{id:"yāṅkaṇ maka",source:"yāṅkaṇ",target:"maka",strength:.4487515477913442,citations:["Aink79"]},{id:"nal eṉ",source:"nal",target:"eṉ",strength:.45449692997840896,citations:["Aink204","Aink67"]},{id:"yāy pū(m)",source:"yāy",target:"pū(m)",strength:.45562548203537934,citations:["Aink10","Aink4"]},{id:"yaviṉi pal",source:"yaviṉi",target:"pal",strength:.4613793961636029,citations:["Aink1","Aink3"]},{id:"makiḻ toṭi",source:"makiḻ",target:"toṭi",strength:.46585612171898066,citations:["Aink24","Aink40"]},{id:"yām pū(m)",source:"yām",target:"pū(m)",strength:.47007740244039337,citations:["Aink10","Aink4","Aink7"]},{id:"ūr māṇ",source:"ūr",target:"māṇ",strength:.4720577045775334,citations:["Aink42","Aink47"]},{id:"ākkam aṟi",source:"ākkam",target:"aṟi",strength:.4728526505600667,citations:["Aink79","Aink90"]},{id:"pal veṉa",source:"pal",target:"veṉa",strength:.47607852011466467,citations:["Aink3","Aink6"]},{id:"taṭpam āṭu",source:"taṭpam",target:"āṭu",strength:.47854783488634256,citations:["Aink77","Aink98"]},{id:"maṭa(m) maka",source:"maṭa(m)",target:"maka",strength:.48888683390934584,citations:["Aink48","Aink98"]},{id:"pōl kaṇ",source:"pōl",target:"kaṇ",strength:.4925107426568187,citations:["Aink101","Aink16"]},{id:"nī peṇ",source:"nī",target:"peṇ",strength:.4954046733803547,citations:["Aink68","Aink69","Aink70"]},{id:"toṭi yām",source:"toṭi",target:"yām",strength:.5000538035670586,citations:["Aink38","Aink40"]},{id:"vāḻ vāḻ",source:"vāḻ",target:"vāḻ",strength:.5009007514588774,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.5},{id:"miṉ taṭpam",source:"miṉ",target:"taṭpam",strength:.5039839970532826,citations:["Aink10","Aink5"]},{id:"puṉal em",source:"puṉal",target:"em",strength:.5080281249210665,citations:["Aink77","Aink78"]},{id:"tuñcu ūr",source:"tuñcu",target:"ūr",strength:.512192990695535,citations:["Aink13","Aink43"]},{id:"tōṟṟam ūr",source:"tōṟṟam",target:"ūr",strength:.512192990695535,citations:["Aink17","Aink98"]},{id:"i- no/nō",source:"i-",target:"no/nō",strength:.512192990695535,citations:["Aink28","Aink99"]},{id:"koḷ cel",source:"koḷ",target:"cel",strength:.5143229960762858,citations:["Aink10","Aink7"]},{id:"maka paḻaṉa(m)",source:"maka",target:"paḻaṉa(m)",strength:.5143229960762858,citations:["Aink91","Aink96"]},{id:"nī mārpu",source:"nī",target:"mārpu",strength:.5230334032209928,citations:["Aink42","Aink44","Aink46","Aink51"]},{id:"yāṇar nī",source:"yāṇar",target:"nī",strength:.5230334032209928,citations:["Aink42","Aink43","Aink49","Aink87"]},{id:"aṟu yūraṉ",source:"aṟu",target:"yūraṉ",strength:.5254899657339986,citations:["Aink25","Aink29"]},{id:"vāḻ makiḻ",source:"vāḻ",target:"makiḻ",strength:.5264543407761556,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40","Aink59","Aink77"]},{id:"taṭpam puṉal",source:"taṭpam",target:"puṉal",strength:.528667786589978,citations:["Aink54","Aink69","Aink76","Aink77","Aink98"]},{id:"nī neñcam",source:"nī",target:"neñcam",strength:.5290221200273476,citations:["Aink50"]},{id:"veḷ pū(m)",source:"veḷ",target:"pū(m)",strength:.5300366567372427,citations:["Aink17","Aink19","Aink41"]},{id:"kaṇ paca",source:"kaṇ",target:"paca",strength:.5326460287748205,citations:["Aink36","Aink37"]},{id:"poḻutu a-",source:"poḻutu",target:"a-",strength:.5363665863952036,citations:["Aink406","Aink82"]},{id:"i- paḻaṉa(m)",source:"i-",target:"paḻaṉa(m)",strength:.537629152862475,citations:["Aink91","Aink96"]},{id:"muṉ yām",source:"muṉ",target:"yām",strength:.5401890896850604,citations:["Aink38","Aink40"]},{id:"veḷ nel",source:"veḷ",target:"nel",strength:.5401890896850604,citations:["Aink48","Aink58"]},{id:"tuṟai kēḷ",source:"tuṟai",target:"kēḷ",strength:.5441192831712842,citations:["Aink2","Aink9"]},{id:"yūraṉ kēḷ",source:"yūraṉ",target:"kēḷ",strength:.5509261279009385,citations:["Aink2","Aink9"]},{id:"pāṇ maka",source:"pāṇ",target:"maka",strength:.5546635350374791,citations:["Aink47","Aink48","Aink49"]},{id:"pōl uṇ",source:"pōl",target:"uṇ",strength:.5566213122272143,citations:["Aink101","Aink16"]},{id:"tāṉ amai",source:"tāṉ",target:"amai",strength:.5566213122272143,citations:["Aink103"]},{id:"keḻu ūr",source:"keḻu",target:"ūr",strength:.560321186825934,citations:["Aink11","Aink12","Aink85"]},{id:"aṉṉai vāḻ",source:"aṉṉai",target:"vāḻ",strength:.5612948677057172,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"vāḻ aṉṉai",source:"vāḻ",target:"aṉṉai",strength:.5612948677057172,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"peru(m) ciṟa",source:"peru(m)",target:"ciṟa",strength:.5672004605083487,citations:["Aink1","Aink403","Aink9"]},{id:"ūr koṭu(m)",source:"ūr",target:"koṭu(m)",strength:.5687604993556908,citations:["Aink11","Aink12"]},{id:"niṟaikkum ūr",source:"niṟaikkum",target:"ūr",strength:.5687604993556908,citations:["Aink47","Aink48"]},{id:"i- maruntu",source:"i-",target:"maruntu",strength:.5687604993556908,citations:["Aink59","Aink99"]},{id:"tuṟai keḻu",source:"tuṟai",target:"keḻu",strength:.5752506296645,citations:["Aink11","Aink12"]},{id:"kaḷvaṉ kaḻaṉi",source:"kaḷvaṉ",target:"kaḻaṉi",strength:.5803243758030621,citations:["Aink25","Aink29"]},{id:"maṉai yāṅkaṇ",source:"maṉai",target:"yāṅkaṇ",strength:.5820574743941543,citations:["Aink48","Aink87"]},{id:"em cel",source:"em",target:"cel",strength:.5820574743941543,citations:["Aink77"]},{id:"no/nō ākkam",source:"no/nō",target:"ākkam",strength:.5839592477025294,citations:["Aink101","Aink28","Aink99"]},{id:"yūra nī",source:"yūra",target:"nī",strength:.5855896286875034,citations:["Aink60","Aink81"]},{id:"nī moḻi",source:"nī",target:"moḻi",strength:.5855896286875034,citations:["Aink60","Aink77"]},{id:"vēḻam pū(m)",source:"vēḻam",target:"pū(m)",strength:.5899959110340919,citations:["Aink12","Aink17","Aink19"]},{id:"vivaḷ nal",source:"vivaḷ",target:"nal",strength:.5899959110340919,citations:["Aink55","Aink56","Aink57"]},{id:"vēṉal ākkam",source:"vēṉal",target:"ākkam",strength:.5910614140189402,citations:["Aink45","Aink54"]},{id:"a- vivaḷ",source:"a-",target:"vivaḷ",strength:.5937874968443817,citations:["Aink54","Aink55","Aink56","Aink57"]},{id:"pūk ūr",source:"pūk",target:"ūr",strength:.5951852278015602,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"nal nāṭu",source:"nal",target:"nāṭu",strength:.5967565983452161,citations:["Aink61"]},{id:"puṉal aṭu",source:"puṉal",target:"aṭu",strength:.5984483667500096,citations:["Aink100","Aink15","Aink72"]},{id:"maṉai neṭu(m)",source:"maṉai",target:"neṭu(m)",strength:.60068679183144,citations:["Aink324","Aink60"]},{id:"varavu eṉap",source:"varavu",target:"eṉap",strength:.6131888208873701,citations:["Aink105","Aink72"]},{id:"tāṉ col",source:"tāṉ",target:"col",strength:.6131888208873701,citations:["Aink38","Aink41"]},{id:"il veṉa",source:"il",target:"veṉa",strength:.6153859157825017,citations:["Aink8","Aink9"]},{id:"maka i-",source:"maka",target:"i-",strength:.6211622775345319,citations:["Aink100","Aink52","Aink79","Aink91","Aink96","Aink97","Aink98","Aink99"]},{id:"al poy",source:"al",target:"poy",strength:.622192760512156,citations:["Aink66","Aink80"]},{id:"yūraṉ mārpu",source:"yūraṉ",target:"mārpu",strength:.6261784588529612,citations:["Aink14","Aink25","Aink29","Aink4"]},{id:"vāḻ vēṇṭu",source:"vāḻ",target:"vēṇṭu",strength:.6281019123739973,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"]},{id:"tēṉūr a-",source:"tēṉūr",target:"a-",strength:.6284859812420559,citations:["Aink54","Aink55","Aink57"]},{id:"kaṇ ēr",source:"kaṇ",target:"ēr",strength:.6293488235529779,citations:["Aink101","Aink72"]},{id:"kañal ūr",source:"kañal",target:"ūr",strength:.6296493513627199,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"taṭpam ṇakam",source:"taṭpam",target:"ṇakam",strength:.6318181383246558,citations:["Aink27","Aink30"]},{id:"taṭpam maṇ",source:"taṭpam",target:"maṇ",strength:.6318181383246558,citations:["Aink27","Aink30"]},{id:"aṟu kaḻaṉi",source:"aṟu",target:"kaḻaṉi",strength:.6368918844632179,citations:["Aink25","Aink29"]},{id:"poykaip pū(m)",source:"poykaip",target:"pū(m)",strength:.6368918844632179,citations:["Aink34","Aink97"]},{id:"puṉal āṭu",source:"puṉal",target:"āṭu",strength:.6409901346946373,citations:["Aink77","Aink78","Aink98"]},{id:"maruntu ākkam",source:"maruntu",target:"ākkam",strength:.6439185019993787,citations:["Aink101","Aink59","Aink99"]},{id:"uṇ kaṇ",source:"uṇ",target:"kaṇ",strength:.6464107367030688,citations:["Aink101","Aink16","Aink21","Aink37","Aink406"]},{id:"vēḻam veḷ",source:"vēḻam",target:"veḷ",strength:.6499551653309411,citations:["Aink13","Aink17","Aink19"]},{id:"tōḻaṉ nām",source:"tōḻaṉ",target:"nām",strength:.6499551653309411,citations:["Aink34","Aink35","Aink36"]},{id:"e- taṭa(m)",source:"e-",target:"taṭa(m)",strength:.6533241070053719,citations:["Aink11"]},{id:"vēḻam karuppu",source:"vēḻam",target:"karuppu",strength:.6533241070053719,citations:["Aink12","Aink18"]},{id:"nōkkam nal",source:"nōkkam",target:"nal",strength:.6533241070053719,citations:["Aink204"]},{id:"poṉ cey",source:"poṉ",target:"cey",strength:.6533241070053719,citations:["Aink316","Aink41"]},{id:"toṭi maṭa(m)",source:"toṭi",target:"maṭa(m)",strength:.6533241070053719,citations:["Aink76","Aink98"]},{id:"āṭu em",source:"āṭu",target:"em",strength:.6533241070053719,citations:["Aink77","Aink78"]},{id:"taṭpam yūraṉ",source:"taṭpam",target:"yūraṉ",strength:.6586194930151353,citations:["Aink10","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"tōḻaṉ makiḻ",source:"tōḻaṉ",target:"makiḻ",strength:.6643902047861553,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40"]},{id:"mūtu ūr",source:"mūtu",target:"ūr",strength:.6654632941338483,citations:["Aink15"]},{id:"tuṟai yūraṉai",source:"tuṟai",target:"yūraṉai",strength:.6719534244426575,citations:["Aink20","Aink88"]},{id:"marutattup peru(m)",source:"marutattup",target:"peru(m)",strength:.6719534244426575,citations:["Aink31","Aink75"]},{id:"marutattup tuṟai",source:"marutattup",target:"tuṟai",strength:.6719534244426575,citations:["Aink31","Aink75"]},{id:"kāl āmpal",source:"kāl",target:"āmpal",strength:.6719534244426575,citations:["Aink34","Aink68"]},{id:"kaḻaṉi mārpu",source:"kaḻaṉi",target:"mārpu",strength:.6750794469233474,citations:["Aink25","Aink29","Aink4"]},{id:"ciṟa vēṭṭōḷ",source:"ciṟa",target:"vēṭṭōḷ",strength:.6769164608135846,citations:["Aink1","Aink10","Aink3"]},{id:"aṭu puṇar",source:"aṭu",target:"puṇar",strength:.6787602691723118,citations:["Aink15","Aink72"]},{id:"aruḷ nī",source:"aruḷ",target:"nī",strength:.6822924234656609,citations:["Aink50"]},{id:"yāṇar ūr",source:"yāṇar",target:"ūr",strength:.6847658124852569,citations:["Aink1","Aink100","Aink42","Aink43","Aink49","Aink50","Aink70","Aink87"]},{id:"vuṇ kaṇ",source:"vuṇ",target:"kaṇ",strength:.6859163322131336,citations:["Aink36","Aink69"]},{id:"tātu uṇ",source:"tātu",target:"uṇ",strength:.6924969332755688,citations:["Aink67","Aink82","Aink93"]},{id:"ciṟa veṉa",source:"ciṟa",target:"veṉa",strength:.6924969332755689,citations:["Aink1","Aink10","Aink3"]},{id:"pūp uṇ",source:"pūp",target:"uṇ",strength:.6934593931233736,citations:["Aink101","Aink16"]},{id:"ōkku pū(m)",source:"ōkku",target:"pū(m)",strength:.6934593931233736,citations:["Aink16","Aink33"]},{id:"puṇar tuṇai",source:"puṇar",target:"tuṇai",strength:.6973895866095975,citations:["Aink15","Aink72"]},{id:"mel kāl",source:"mel",target:"kāl",strength:.6973895866095975,citations:["Aink26","Aink35"]},{id:"peṟu nutal",source:"peṟu",target:"nutal",strength:.6973895866095975,citations:["Aink56","Aink94"]},{id:"yaḻi puṉal",source:"yaḻi",target:"puṉal",strength:.7014337144773815,citations:["Aink53","Aink78"]},{id:"puṉal āṭit",source:"puṉal",target:"āṭit",strength:.7014337144773815,citations:["Aink76","Aink80"]},{id:"naṉi ciṟa",source:"naṉi",target:"ciṟa",strength:.7098916156655276,citations:["Aink10","Aink7"]},{id:"tāṉ uṇarntōr",source:"tāṉ",target:"uṇarntōr",strength:.7098916156655276,citations:["Aink38","Aink41"]},{id:"taṭpam tuṟai",source:"taṭpam",target:"tuṟai",strength:.7106134499219859,citations:["Aink10","Aink105","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"ciṟu(m) miṉ",source:"ciṟu(m)",target:"miṉ",strength:.7188955552903135,citations:["Aink1","Aink10"]},{id:"curam cel",source:"curam",target:"cel",strength:.7188955552903135,citations:["Aink307","Aink317"]},{id:"oṇmai muṉ",source:"oṇmai",target:"muṉ",strength:.7188955552903135,citations:["Aink40","Aink83"]},{id:"lākuka vēṭṭōḷ",source:"lākuka",target:"vēṭṭōḷ",strength:.7188955552903135,citations:["Aink8","Aink9"]},{id:"vāl iḻai",source:"vāl",target:"iḻai",strength:.7285209331028133,citations:["Aink0","Aink73"]},{id:"yoḷ nutal",source:"yoḷ",target:"nutal",strength:.7285209331028133,citations:["Aink322","Aink73"]},{id:"māṇ iḻai",source:"māṇ",target:"iḻai",strength:.7285209331028133,citations:["Aink42","Aink47"]},{id:"kaḻaṉit malar",source:"kaḻaṉit",target:"malar",strength:.7285209331028133,citations:["Aink53","Aink94"]},{id:"cuṭar nutal",source:"cuṭar",target:"nutal",strength:.7285209331028133,citations:["Aink56","Aink94"]},{id:"puḷḷik kaḷvaṉ",source:"puḷḷik",target:"kaḷvaṉ",strength:.7335946792413753,citations:["Aink21","Aink22"]},{id:"lākuka veṉa",source:"lākuka",target:"veṉa",strength:.7335946792413753,citations:["Aink8","Aink9"]},{id:"vāḻ tōḻaṉ",source:"vāḻ",target:"tōḻaṉ",strength:.734523155527599,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink35","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"kaḻaṉi yūraṉ",source:"kaḻaṉi",target:"yūraṉ",strength:.7348186357921456,citations:["Aink18","Aink25","Aink29","Aink4","Aink91","Aink96"]},{id:"kaḷvaṉ aṟu",source:"kaḷvaṉ",target:"aṟu",strength:.7350387012201968,citations:["Aink21","Aink25","Aink29"]},{id:"vāḻ yātaṉ",source:"vāḻ",target:"yātaṉ",strength:.7375822968001278,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"yātaṉ vāḻ",source:"yātaṉ",target:"vāḻ",strength:.7375822968001278,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"vāḻ yaviṉi",source:"vāḻ",target:"yaviṉi",strength:.7375822968001278,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"kuṇam koḷ",source:"kuṇam",target:"koḷ",strength:.7388599321258166,citations:["Aink90"]},{id:"tuṟai yūraṉ",source:"tuṟai",target:"yūraṉ",strength:.7418156407527395,citations:["Aink10","Aink13","Aink14","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"putup puṉal",source:"putup",target:"puṉal",strength:.7420618198630924,citations:["Aink53","Aink64","Aink78","Aink79"]},{id:"maṇal aṭu",source:"maṇal",target:"aṭu",strength:.7500269017835293,citations:["Aink100","Aink15"]},{id:"pūp pōl",source:"pūp",target:"pōl",strength:.7500269017835293,citations:["Aink101","Aink16"]},{id:"no/nō maruntu",source:"no/nō",target:"maruntu",strength:.7500269017835293,citations:["Aink101","Aink99"]},{id:"karai vēḻam",source:"karai",target:"vēḻam",strength:.7500269017835293,citations:["Aink12","Aink13"]},{id:"tōḻaṉ mūrp",source:"tōḻaṉ",target:"mūrp",strength:.7500269017835293,citations:["Aink34","Aink35"]},{id:"puṟavam aṇi",source:"puṟavam",target:"aṇi",strength:.7500269017835293,citations:["Aink404","Aink405"]},{id:"al urai",source:"al",target:"urai",strength:.7500269017835293,citations:["Aink66","Aink80"]},{id:"taṭa(m) erumai",source:"taṭa(m)",target:"erumai",strength:.7500269017835293,citations:["Aink94","Aink98"]},{id:"toṭi muṉ",source:"toṭi",target:"muṉ",strength:.7524561875724182,citations:["Aink38","Aink40","Aink83"]},{id:"amma vāḻ",source:"amma",target:"vāḻ",strength:.7625964167847026,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40","Aink77","Aink89"]},{id:"poykai yāmpal",source:"poykai",target:"yāmpal",strength:.768656219220815,citations:["Aink35","Aink91"]},{id:"aṇaṅku uṟu",source:"aṇaṅku",target:"uṟu",strength:.768656219220815,citations:["Aink53","Aink58"]},{id:"il lākuka",source:"il",target:"lākuka",strength:.768656219220815,citations:["Aink8","Aink9"]},{id:"tāmarai malar",source:"tāmarai",target:"malar",strength:.7722025049913027,citations:["Aink53","Aink68","Aink94"]},{id:"maṉai nakar",source:"maṉai",target:"nakar",strength:.7754630639504693,citations:["Aink324","Aink60"]},{id:"val poy",source:"val",target:"poy",strength:.7754630639504693,citations:["Aink37"]},{id:"yaviṉi pakai",source:"yaviṉi",target:"pakai",strength:.7754630639504693,citations:["Aink4","Aink6"]},{id:"vaṭṭi maṉai",source:"vaṭṭi",target:"maṉai",strength:.7754630639504693,citations:["Aink47","Aink48"]},{id:"peṟu cuṭar",source:"peṟu",target:"cuṭar",strength:.7754630639504693,citations:["Aink56","Aink94"]},{id:"vekuḷvōḷ kaṇ",source:"vekuḷvōḷ",target:"kaṇ",strength:.7826191269912911,citations:["Aink84"]},{id:"vayalaic ce(m)",source:"vayalaic",target:"ce(m)",strength:.790162187901531,citations:["Aink25","Aink52"]},{id:"kaḷvaṉ ṇakam",source:"kaḷvaṉ",target:"ṇakam",strength:.790162187901531,citations:["Aink27","Aink30"]},{id:"amaintaṉaṉ tāṉ",source:"amaintaṉaṉ",target:"tāṉ",strength:.8065944104436851,citations:["Aink103"]},{id:"yoḷ arivai",source:"yoḷ",target:"arivai",strength:.8065944104436851,citations:["Aink322","Aink73"]},{id:"nām mūrp",source:"nām",target:"mūrp",strength:.8065944104436851,citations:["Aink34","Aink35"]},{id:"nām maṟa",source:"nām",target:"maṟa",strength:.8065944104436851,citations:["Aink36"]},{id:"taṭa(m) kōṭṭam",source:"taṭa(m)",target:"kōṭṭam",strength:.8065944104436851,citations:["Aink94","Aink98"]},{id:"mūr oṇmai",source:"mūr",target:"oṇmai",strength:.8155983500684709,citations:["Aink83","Aink92"]},{id:"neṭu(m) nakar",source:"neṭu(m)",target:"nakar",strength:.8252237278809708,citations:["Aink324","Aink60"]},{id:"vēṇṭu aṉṉai",source:"vēṇṭu",target:"aṉṉai",strength:.8383922502637887,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"aṉṉai vēṇṭu",source:"aṉṉai",target:"vēṇṭu",strength:.8383922502637887,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"yallaṉ e-",source:"yallaṉ",target:"e-",strength:.8467296965616867,citations:["Aink11"]},{id:"pāvai yaṉṉa",source:"pāvai",target:"yaṉṉa",strength:.8467296965616867,citations:["Aink221","Aink307"]},{id:"maṟa amai",source:"maṟa",target:"amai",strength:.8467296965616867,citations:["Aink36"]},{id:"tēr taḷar",source:"tēr",target:"taḷar",strength:.8467296965616867,citations:["Aink403","Aink66"]},{id:"maṇi niṟam",source:"maṇi",target:"niṟam",strength:.8467296965616867,citations:["Aink45","Aink96"]},{id:"pāy eṉak",source:"pāy",target:"eṉak",strength:.8467296965616867,citations:["Aink53","Aink73"]},{id:"karu(m) kōṭṭam",source:"karu(m)",target:"kōṭṭam",strength:.8467296965616867,citations:["Aink92","Aink95"]},{id:"kōṭṭam erumai",source:"kōṭṭam",target:"erumai",strength:.8549572098138952,citations:["Aink94","Aink95","Aink98"]},{id:"paṇait tōḷ",source:"paṇait",target:"tōḷ",strength:.8721658587286267,citations:["Aink135","Aink39"]},{id:"yaḻi putup",source:"yaḻi",target:"putup",strength:.8721658587286267,citations:["Aink53","Aink78"]},{id:"ciṟai putup",source:"ciṟai",target:"putup",strength:.8721658587286267,citations:["Aink53","Aink78"]},{id:"poy urai",source:"poy",target:"urai",strength:.8721658587286267,citations:["Aink66","Aink80"]},{id:"yāy yām",source:"yāy",target:"yām",strength:.8771048547688839,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"num mūr",source:"num",target:"mūr",strength:.8868649826796884,citations:["Aink83","Aink92"]},{id:"vēṭṭōḷ yām",source:"vēṭṭōḷ",target:"yām",strength:.8942519964660323,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"tēṉūr vivaḷ",source:"tēṉūr",target:"vivaḷ",strength:.8974989777585229,citations:["Aink54","Aink55","Aink57"]},{id:"keḻu koṭu(m)",source:"keḻu",target:"koṭu(m)",strength:.9032972052218425,citations:["Aink11","Aink12"]},{id:"col uṇarntōr",source:"col",target:"uṇarntōr",strength:.9032972052218425,citations:["Aink38","Aink41"]},{id:"kai vaḷ",source:"kai",target:"vaḷ",strength:.9032972052218425,citations:["Aink58","Aink61"]},{id:"māṇ kuṇam",source:"māṇ",target:"kuṇam",strength:.9032972052218425,citations:["Aink90"]},{id:"nutal arivai",source:"nutal",target:"arivai",strength:.9135683395348294,citations:["Aink322","Aink404","Aink46","Aink73"]},{id:"malir niṟai",source:"malir",target:"niṟai",strength:.9244602732411664,citations:["Aink15","Aink42","Aink72"]},{id:"oṇmai toṭi",source:"oṇmai",target:"toṭi",strength:.9248176850438442,citations:["Aink28","Aink40","Aink76","Aink83","Aink92"]},{id:"amma tōḻaṉ",source:"amma",target:"tōḻaṉ",strength:.9343974888053093,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"karai cēr",source:"karai",target:"cēr",strength:.9434324913398442,citations:["Aink12","Aink74"]},{id:"el vaḷai",source:"el",target:"vaḷai",strength:.9434324913398442,citations:["Aink20","Aink27"]},{id:"muḷḷi vēr",source:"muḷḷi",target:"vēr",strength:.9434324913398442,citations:["Aink22","Aink23"]},{id:"kaḻaṉit tāmarai",source:"kaḻaṉit",target:"tāmarai",strength:.9434324913398442,citations:["Aink53","Aink94"]},{id:"veṉa yāy",source:"veṉa",target:"yāy",strength:.9645691740022694,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"pūk kañal",source:"pūk",target:"kañal",strength:.9655358764388403,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"veṉa vēṭṭōḷ",source:"veṉa",target:"vēṭṭōḷ",strength:.9813973331347341,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"vēṭṭōḷ yāy",source:"vēṭṭōḷ",target:"yāy",strength:.9828528583028517,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"yātaṉ yaviṉi",source:"yātaṉ",target:"yaviṉi",strength:1,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"ṇakam maṇ",source:"ṇakam",target:"maṇ",strength:1,citations:["Aink27","Aink30"]},{id:"nekiḻac cā",source:"nekiḻac",target:"cā",strength:1,citations:["Aink27","Aink28"]},{id:"titti yalkul",source:"titti",target:"yalkul",strength:1,citations:["Aink29","Aink72"]},{id:"mal val",source:"mal",target:"val",strength:1,citations:["Aink37"]},{id:"ciṟai yaḻi",source:"ciṟai",target:"yaḻi",strength:1,citations:["Aink53","Aink78"]}],Aa={nodes:OM,links:IM},NM=n=>{const t=1+200/Math.hypot(n.x,n.y,n.z),i=n.x||n.y||n.z?{x:n.x*t,y:n.y*t,z:n.z*t}:{x:0,y:0,z:200};Sa.cameraPosition(i,n,1e3)},Sa=_M(),UM=()=>{const n=new Map([["adjective","#66c2a5"],["noun","#fc8d62"],["pronoun","#8da0cb"],["verb","#e78ac3"],["other","#a6d854"]]),e=document.getElementById("panellegend");e.innerHTML=[...n].map(i=>`<div><input type="checkbox" name="${i[0]}" checked autocomplete="off"/><label><span style="color:${i[1]}; font-size: 150%">●</span> ${i[0]}</div>`).join("")+'<div id="solonodes"><input type="checkbox" name="solonodes" checked autocomplete="off"/><label>Show unconnected nodes</label></div>';const t=structuredClone(Aa.links).filter(i=>i.strength>=.45);Sa(document.getElementById("colgraph")).graphData({nodes:Aa.nodes,links:t}).nodeLabel(i=>`${i.size} occurences`).nodeThreeObject(i=>{const r=new DM(i.id);return r.material.depthWrite=!1,r.color=n.get(i.type)||n.get("other"),r.textHeight=i.size/2<8?8:i.size/2,r}).linkWidth(i=>i.strength*5).linkOpacity(.3).linkDirectionalArrowLength(5).linkCurvature(i=>i.curvature||0).linkLabel(i=>`${i.citations.join(", ")} (NPMI: ${i.strength.toPrecision(4)})`).onNodeClick(NM),Sa.d3Force("link").distance(i=>40/i.strength)},FM=n=>{const e=document.getElementById("panel");e.style.display!=="flex"?(e.animate([{marginTop:"-25px"},{marginTop:"0px"}],{duration:200,iterations:1}),e.style.display="flex",n.target.textContent="⇧"):(e.animate([{marginTop:"0px"},{marginTop:"-25px"}],{duration:200,iterations:1}),setTimeout(()=>e.style.display="none",200),n.target.textContent="⇩")},BM=n=>{const e=new Set;for(const t of n)e.add(t.source),e.add(t.target);return e},HM=()=>{const n={};n.nodes=Aa.nodes,n.links=structuredClone(Aa.links);const e=document.getElementById("npmi").value;n.links=n.links.filter(r=>r.strength>=e);const t=document.getElementById("panellegend").querySelectorAll('input:not([name="solonodes"])'),i=new Set([...t].filter(r=>r.checked).map(r=>r.getAttribute("name")));if(i.size!==t.length){n.nodes=n.nodes.filter(a=>i.has(a.type));const r=new Set(n.nodes.map(a=>a.id));n.links=n.links.filter(a=>r.has(a.target)&&r.has(a.source))}if(!document.querySelector('input[name="solonodes"]').checked){const r=BM(n.links);n.nodes=n.nodes.filter(a=>r.has(a.id))}Sa.graphData(n)};document.getElementById("paneltoggle").addEventListener("click",FM);document.getElementById("graphupdate").addEventListener("click",HM);UM();
