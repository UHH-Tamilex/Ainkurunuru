...
`),g="".concat(this.fontWeight," ").concat(this.fontSize,"px ").concat(this.fontFace);s.font=g;var v=Math.max.apply(Math,ia(m.map(function(R){return s.measureText(R).width}))),p=this.fontSize*m.length;if(a.width=v+c[0]*2+f[0]*2,a.height=p+c[1]*2+f[1]*2,this.borderWidth){if(s.strokeStyle=this.borderColor,c[0]){var h=c[0]/2;s.lineWidth=c[0],s.beginPath(),s.moveTo(h,l[0]),s.lineTo(h,a.height-l[3]),s.moveTo(a.width-h,l[1]),s.lineTo(a.width-h,a.height-l[2]),s.stroke()}if(c[1]){var A=c[1]/2;s.lineWidth=c[1],s.beginPath(),s.moveTo(Math.max(c[0],l[0]),A),s.lineTo(a.width-Math.max(c[0],l[1]),A),s.moveTo(Math.max(c[0],l[3]),a.height-A),s.lineTo(a.width-Math.max(c[0],l[2]),a.height-A),s.stroke()}if(this.borderRadius){var y=Math.max.apply(Math,ia(c)),_=y/2;s.lineWidth=y,s.beginPath(),[!!l[0]&&[l[0],_,_,l[0]],!!l[1]&&[a.width-l[1],a.width-_,_,l[1]],!!l[2]&&[a.width-l[2],a.width-_,a.height-_,a.height-l[2]],!!l[3]&&[l[3],_,a.height-_,a.height-l[3]]].filter(function(R){return R}).forEach(function(R){var x=_l(R,4),E=x[0],N=x[1],U=x[2],ee=x[3];s.moveTo(E,U),s.quadraticCurveTo(N,U,N,ee)}),s.stroke()}}this.backgroundColor&&(s.fillStyle=this.backgroundColor,this.borderRadius?(s.beginPath(),s.moveTo(c[0],l[0]),[[c[0],l[0],a.width-l[1],c[1],c[1],c[1]],[a.width-c[0],a.width-c[0],a.width-c[0],c[1],l[1],a.height-l[2]],[a.width-c[0],a.width-l[2],l[3],a.height-c[1],a.height-c[1],a.height-c[1]],[c[0],c[0],c[0],a.height-c[1],a.height-l[3],l[0]]].forEach(function(R){var x=_l(R,6),E=x[0],N=x[1],U=x[2],ee=x[3],T=x[4],C=x[5];s.quadraticCurveTo(E,ee,N,T),s.lineTo(U,C)}),s.closePath(),s.fill()):s.fillRect(c[0],c[1],a.width-c[0]*2,a.height-c[1]*2)),s.translate.apply(s,ia(c)),s.translate.apply(s,ia(f)),s.font=g,s.fillStyle=this.color,s.textBaseline="bottom";var b=this.strokeWidth>0;b&&(s.lineWidth=this.strokeWidth*this.fontSize/10,s.strokeStyle=this.strokeColor),m.forEach(function(R,x){var E=(v-s.measureText(R).width)/2,N=(x+1)*r.fontSize;b&&s.strokeText(R,E,N),s.fillText(R,E,N)}),this.material.map&&this.material.map.dispose();var k=this.material.map=new Tn.Texture(a);k.minFilter=Tn.LinearFilter,k.colorSpace=Tn.SRGBColorSpace,k.needsUpdate=!0;var S=this.textHeight*m.length+o[1]*2+d[1]*2;this.scale.set(S*a.width/a.height,S,0)}},{key:"clone",value:function(){return new this.constructor(this.text,this.textHeight,this.color).copy(this)}},{key:"copy",value:function(r){return Tn.Sprite.prototype.copy.call(this,r),this.color=r.color,this.backgroundColor=r.backgroundColor,this.padding=r.padding,this.borderWidth=r.borderWidth,this.borderColor=r.borderColor,this.fontFace=r.fontFace,this.fontSize=r.fontSize,this.fontWeight=r.fontWeight,this.strokeWidth=r.strokeWidth,this.strokeColor=r.strokeColor,this}}]),t}(Tn.Sprite);const Ob=[{id:"nīl",size:6,type:"noun"},{id:"mēṉi",size:6,type:"noun"},{id:"vāl",size:6,type:"noun"},{id:"iḻai",size:12,type:"noun"},{id:"pākattu",size:1},{id:"oru",size:6,type:"noun"},{id:"iru",size:7,type:"noun"},{id:"tāḷ",size:3,type:"noun"},{id:"niḻal",size:7,type:"noun"},{id:"kīḻ",size:1},{id:"mu",size:1,type:"noun"},{id:"vaku",size:1,type:"verb"},{id:"ulakam",size:1,type:"noun"},{id:"vāḻ",size:83,type:"verb"},{id:"yātaṉ",size:10},{id:"yaviṉi",size:10},{id:"nel",size:9,type:"noun"},{id:"pal",size:31,type:"noun"},{id:"poli",size:3,type:"noun"},{id:"poṉ",size:9,type:"noun"},{id:"peru(m)",size:39,type:"adjective"},{id:"ciṟa",size:9,type:"verb"},{id:"veṉa",size:9},{id:"vēṭṭōḷ",size:10},{id:"yāy",size:13,type:"noun"},{id:"yām",size:20,type:"pronoun"},{id:"naṉai",size:3,type:"noun"},{id:"kāñcic",size:1},{id:"ciṉai",size:11,type:"verb"},{id:"ciṟu(m)",size:16,type:"adjective"},{id:"miṉ",size:5,type:"noun"},{id:"yāṇar",size:9,type:"noun"},{id:"ūr",size:49,type:"noun"},{id:"pāṇ",size:21,type:"noun"},{id:"māri",size:3,type:"noun"},{id:"vāy",size:5,type:"noun"},{id:"vaḷam",size:5,type:"noun"},{id:"naṉi",size:12},{id:"pū(m)",size:27,type:"noun"},{id:"māattup",size:2},{id:"pulavu",size:2,type:"noun"},{id:"taṭpam",size:39,type:"noun"},{id:"tuṟai",size:31,type:"noun"},{id:"yūraṉ",size:20},{id:"tāṉ",size:31,type:"pronoun"},{id:"koḷ",size:24,type:"verb"},{id:"cel",size:34,type:"noun"},{id:"puṉal",size:17,type:"noun"},{id:"aṭu",size:8,type:"verb"},{id:"maka",size:44,type:"noun"},{id:"iṭu",size:1,type:"verb"},{id:"voḷ",size:4},{id:"ḷiḻai",size:1},{id:"maṇal",size:7,type:"noun"},{id:"cimaiyattu",size:1},{id:"erumai",size:6,type:"noun"},{id:"kiḷai",size:2,type:"noun"},{id:"i-",size:34,type:"pronoun"},{id:"narampu",size:1,type:"noun"},{id:"aṉṉai",size:44,type:"noun"},{id:"vēṇṭu",size:25,type:"verb"},{id:"yutuk",size:1},{id:"kaṇ",size:62,type:"noun"},{id:"ēr",size:5,type:"noun"},{id:"koṭip",size:3},{id:"pācu",size:2},{id:"aṭumpu",size:1,type:"noun"},{id:"pari",size:5,type:"noun"},{id:"vūrpu",size:1},{id:"iḻi",size:2,type:"verb"},{id:"neytal",size:5,type:"noun"},{id:"mayakkam",size:4},{id:"varavu",size:55,type:"noun"},{id:"nī",size:77,type:"pronoun"},{id:"pūp",size:4},{id:"pōl",size:8,type:"verb"},{id:"uṇ",size:19},{id:"maruvu",size:1,type:"verb"},{id:"no/nō",size:10,type:"verb"},{id:"maruntu",size:4,type:"noun"},{id:"ākkam",size:50,type:"noun"},{id:"namm",size:4},{id:"niṟap",size:1},{id:"kaṭal",size:8,type:"noun"},{id:"puḷ",size:3,type:"noun"},{id:"°āṉ",size:2,type:"verb"},{id:"tuṉpam",size:1,type:"noun"},{id:"uṟu",size:15,type:"verb"},{id:"tuyara",size:1},{id:"nīkku",size:2,type:"verb"},{id:"viṉpu",size:1},{id:"vicaikkum",size:1},{id:"a-",size:69,type:"pronoun"},{id:"tēr",size:9,type:"noun"},{id:"puṉṉai",size:3,type:"noun"},{id:"ñāḻal",size:6,type:"noun"},{id:"taṇṇ",size:3},{id:"am",size:13,type:"adjective"},{id:"amaintaṉaṉ",size:1},{id:"amai",size:7,type:"noun"},{id:"mā",size:13,type:"adjective"},{id:"ūrp",size:3},{id:"maṭi",size:1,type:"noun"},{id:"poḻutu",size:6,type:"noun"},{id:"nal",size:52,type:"adjective"},{id:"mikac",size:2},{id:"cā",size:6,type:"verb"},{id:"naḷḷeṉ",size:2,type:"verb"},{id:"viyal",size:3,type:"noun"},{id:"tērc",size:1},{id:"celvak",size:1},{id:"koṇkaṉ",size:13,type:"noun"},{id:"muḻakkam",size:4},{id:"tirai",size:4,type:"verb"},{id:"taru",size:1},{id:"muttam",size:2,type:"noun"},{id:"veḷ",size:19,type:"adjective"},{id:"imai",size:1,type:"noun"},{id:"eṉap",size:5},{id:"civantaṉṟu",size:1},{id:"yavar",size:4},{id:"nāṭṭut",size:1},{id:"tutik",size:1},{id:"kāl",size:21,type:"noun"},{id:"aṉṉam",size:1,type:"noun"},{id:"tuṇai",size:12,type:"noun"},{id:"miti",size:1,type:"noun"},{id:"vaḷaiyiṉum",size:1},{id:"ilaṅku",size:3,type:"verb"},{id:"kaliḻ",size:7,type:"verb"},{id:"ākam",size:1,type:"noun"},{id:"yeṉ",size:6},{id:"tōḻaṉ",size:48},{id:"cuṭar",size:7,type:"noun"},{id:"nutal",size:13,type:"noun"},{id:"pacappac",size:2},{id:"cāayp",size:1},{id:"paṭar",size:6,type:"noun"},{id:"mel",size:13,type:"adjective"},{id:"paṭu",size:14,type:"verb"},{id:"kēḷ",size:19,type:"verb"},{id:"tuñcu",size:5,type:"verb"},{id:"kaḻi",size:12},{id:"muṇṭakam",size:1,type:"noun"},{id:"malar",size:26,type:"noun"},{id:"cērppu",size:2,type:"noun"},{id:"em",size:12,type:"pronoun"},{id:"tōḷ",size:15,type:"noun"},{id:"tuṟa",size:4,type:"verb"},{id:"e-",size:27,type:"pronoun"},{id:"kol",size:7,type:"verb"},{id:"nīrp",size:4},{id:"tūmpu",size:4,type:"noun"},{id:"pūk",size:7},{id:"keḻu",size:11},{id:"yevaṉ",size:2},{id:"nāḷ",size:9,type:"noun"},{id:"maṉai",size:12,type:"noun"},{id:"naṭu",size:3,type:"verb"},{id:"vayalai",size:2,type:"noun"},{id:"vēḻam",size:8,type:"noun"},{id:"cuṟṟam",size:1,type:"noun"},{id:"koṭu(m)",size:6,type:"adjective"},{id:"nāṇ",size:3,type:"noun"},{id:"nallaṉ",size:1},{id:"yallaṉ",size:1},{id:"taṭa(m)",size:7,type:"adjective"},{id:"amma",size:36},{id:"cūḻ",size:2,type:"verb"},{id:"maruṅku",size:3,type:"noun"},{id:"iraik",size:1},{id:"koḷīic",size:1},{id:"ciṉaik",size:2},{id:"kayal",size:3,type:"noun"},{id:"māy",size:1,type:"verb"},{id:"pirintum",size:1},{id:"nām",size:23,type:"pronoun"},{id:"yarum",size:8},{id:"tavam",size:1,type:"noun"},{id:"ilaic",size:1},{id:"cerunti",size:1,type:"noun"},{id:"tāvu",size:2,type:"verb"},{id:"virum",size:4},{id:"kaḻic",size:1},{id:"varak",size:2},{id:"maṟantōm",size:1},{id:"neṉṉal",size:1},{id:"ōkku",size:3,type:"verb"},{id:"uṭai",size:7,type:"noun"},{id:"ūrār",size:1},{id:"peṇ",size:10,type:"noun"},{id:"eṉ",size:34,type:"pronoun"},{id:"moḻi",size:5,type:"noun"},{id:"veṉṉai",size:1},{id:"yatu",size:1},{id:"pai",size:4},{id:"vem",size:20},{id:"mai",size:4,type:"noun"},{id:"nērēm",size:1},{id:"celkuvam",size:1},{id:"nārai",size:3,type:"noun"},{id:"yiraṟṟum",size:1},{id:"maṭalam",size:1},{id:"peṇṇai",size:1,type:"noun"},{id:"nuṇ",size:4,type:"adjective"},{id:"aṭai",size:2,type:"noun"},{id:"karai",size:4,type:"noun"},{id:"nammōṭu",size:1},{id:"āṭu",size:7,type:"noun"},{id:"ṇam",size:1},{id:"maṟaii",size:1},{id:"yaṉṉai",size:1},{id:"kaṭi",size:4,type:"noun"},{id:"aḻu",size:1,type:"verb"},{id:"nīla",size:1},{id:"kūmpum",size:1},{id:"mālai",size:4,type:"noun"},{id:"yaṉṉa",size:9},{id:"yaṇi",size:2},{id:"toṟum",size:9},{id:"vari",size:8,type:"noun"},{id:"maṇi",size:9,type:"noun"},{id:"nīrc",size:1},{id:"yāṉ",size:7,type:"pronoun"},{id:"aṟam",size:7,type:"noun"},{id:"il",size:23,type:"noun"},{id:"āḷ",size:3,type:"noun"},{id:"ciṉavuveṉ",size:1},{id:"takaikkuveṉ",size:1},{id:"ceṉṟaṉeṉ",size:1},{id:"piṉ",size:3},{id:"niṉai",size:7,type:"verb"},{id:"iraṅkip",size:1},{id:"eyyāmaiyiṉ",size:1},{id:"ētil",size:1,type:"adjective"},{id:"paṟṟu",size:3,type:"noun"},{id:"yaṉpu",size:1},{id:"pulak",size:2},{id:"cēr",size:3,type:"verb"},{id:"karuppu",size:6,type:"adjective"},{id:"āṟṟuka",size:1},{id:"tōṟka",size:1},{id:"vel",size:16,type:"verb"},{id:"miku",size:4,type:"verb"},{id:"vāyiṉa",size:5},{id:"vaḷiya",size:1},{id:"mal",size:3,type:"noun"},{id:"iru(m)",size:7,type:"adjective"},{id:"nīr",size:10,type:"pronoun"},{id:"aṟal",size:3,type:"noun"},{id:"viri",size:7,type:"verb"},{id:"lam",size:1},{id:"pulampu",size:5,type:"noun"},{id:"al",size:23,type:"verb"},{id:"muṇṭakak",size:1},{id:"kōtai",size:2,type:"noun"},{id:"naṉaiyat",size:1},{id:"teḷ",size:4,type:"adjective"},{id:"tiraip",size:1},{id:"pauvam",size:1,type:"noun"},{id:"yoḷḷ",size:1},{id:"yuyar",size:1},{id:"vīḻ",size:2,type:"noun"},{id:"veḷḷām ",size:1},{id:"yoḷ",size:6},{id:"āy",size:2,type:"verb"},{id:"ārppat",size:1},{id:"vaṇṭal",size:2,type:"noun"},{id:"pāvai",size:9,type:"noun"},{id:"vauvu",size:3,type:"verb"},{id:"poṭi",size:1},{id:"yaḷaiik",size:1},{id:"vauva",size:1},{id:"vuṇ",size:3},{id:"civa",size:5,type:"verb"},{id:"yuṇ",size:3},{id:"vaṇṭu",size:9,type:"noun"},{id:"iṉam",size:2,type:"noun"},{id:"moyppat",size:1},{id:"tumpai",size:1},{id:"yiḷa",size:3},{id:"mulai",size:8,type:"noun"},{id:"pūṭṭu",size:3,type:"noun"},{id:"yuṟāa",size:1},{id:"vaṟu(m)",size:2,type:"adjective"},{id:"maṭāa",size:1},{id:"vuṇṇāp",size:1},{id:"yuṭai",size:2},{id:"poṅku",size:1,type:"verb"},{id:"uḷai",size:1,type:"noun"},{id:"vaṭai",size:1},{id:"pakar",size:1,type:"verb"},{id:"yāmam",size:1,type:"noun"},{id:"koṇkaṉatu",size:1},{id:"naṭpu",size:1,type:"noun"},{id:"tillai",size:1,type:"noun"},{id:"vēli",size:1,type:"noun"},{id:"yiv",size:1},{id:"vūrk",size:1},{id:"kal",size:9,type:"noun"},{id:"leṉ",size:1},{id:"kauvai",size:1,type:"noun"},{id:"yarumpu",size:1},{id:"mali",size:4,type:"verb"},{id:"kāṉal",size:2,type:"noun"},{id:"iv",size:4},{id:"vūr",size:4},{id:"cey",size:19,type:"noun"},{id:"vāṉātu",size:1},{id:"mell",size:4},{id:"piri",size:16,type:"verb"},{id:"pull",size:2},{id:"eṉṟaṉa",size:1},{id:"puri",size:4,type:"noun"},{id:"kāṇmati",size:1},{id:"kaḻip",size:1},{id:"pāy",size:6,type:"verb"},{id:"neṭu(m)",size:23,type:"adjective"},{id:"tērk",size:2},{id:"koṇkaṉōṭu",size:1},{id:"paṇait",size:3},{id:"ai",size:4,type:"noun"},{id:"akal",size:5,type:"noun"},{id:"valkul",size:1},{id:"kaṇṇi",size:1,type:"noun"},{id:"nēr",size:3,type:"noun"},{id:"kōḷ",size:5,type:"noun"},{id:"vaḷai",size:6,type:"noun"},{id:"nekiḻ",size:5,type:"verb"},{id:"tuṟaivaṟkuc",size:1},{id:"niṉṉ",size:3},{id:"viṉavu",size:1,type:"verb"},{id:"numm",size:2},{id:"ūrt",size:1},{id:"tiṇ",size:6,type:"adjective"},{id:"koṇkaṉai",size:1},{id:"naya",size:10,type:"verb"},{id:"paṇṭait",size:1},{id:"tām",size:8,type:"pronoun"},{id:"paṇpu",size:4,type:"noun"},{id:"viv",size:1},{id:"aṉpu",size:3,type:"noun"},{id:"kaḻaṟu",size:1,type:"verb"},{id:"vayiṉ",size:7,type:"noun"},{id:"māṇ",size:7,type:"noun"},{id:"maruṭṭum",size:1},{id:"tīṇṭu",size:1,type:"verb"},{id:"yayala",size:1},{id:"vaṭuk",size:1},{id:"mā(m)",size:5,type:"noun"},{id:"val",size:15,type:"noun"},{id:"taḷir",size:3,type:"noun"},{id:"nuṭaṅku",size:4,type:"verb"},{id:"aṇit",size:1},{id:"mārpu",size:11,type:"noun"},{id:"paṉit",size:1},{id:"tuyil",size:1,type:"noun"},{id:"mati",size:1,type:"noun"},{id:"yuraittaṟku",size:1},{id:"uri-",size:4},{id:"viṟai",size:1},{id:"el",size:5,type:"noun"},{id:"ekkar",size:6,type:"noun"},{id:"ceruntiyoṭu",size:2},{id:"kamaḻat",size:1},{id:"tuvalait",size:1},{id:"tuḷi",size:1,type:"noun"},{id:"vīcip",size:1},{id:"paca",size:11,type:"verb"},{id:"paṉi",size:7,type:"noun"},{id:"iṟakku",size:1,type:"verb"},{id:"iṇarp",size:1},{id:"ḷiṟai",size:1},{id:"kūr",size:3,type:"noun"},{id:"yuḷḷēṉ",size:1},{id:"paṭi",size:1,type:"noun"},{id:"puḷḷ",size:4},{id:"imiḻ",size:1,type:"noun"},{id:"yiṉiya",size:4},{id:"nil",size:14,type:"verb"},{id:"muṉi",size:3,type:"noun"},{id:"vivaḷ",size:7},{id:"iṇar",size:6,type:"noun"},{id:"potumpart",size:1},{id:"taṉik",size:1},{id:"kuruku",size:5,type:"noun"},{id:"uṟaṅku",size:1,type:"verb"},{id:"tuṟaivarku",size:1},{id:"iṉip",size:2},{id:"ciṟi",size:3},{id:"yilaip",size:1},{id:"yōtam",size:1},{id:"vāṅku",size:1,type:"verb"},{id:"malir",size:3,type:"verb"},{id:"niṟai",size:5,type:"noun"},{id:"virumpiya",size:2},{id:"taḻaip",size:1},{id:"makaḷirkkup",size:1},{id:"puṇar",size:14,type:"verb"},{id:"yutavum",size:1},{id:"mūtu",size:2},{id:"vēḻattut",size:2},{id:"uṭait",size:1},{id:"tiraḷ",size:1,type:"noun"},{id:"toḻumakaḷir",size:1},{id:"añcaṉam",size:1},{id:"pey",size:4,type:"verb"},{id:"kañal",size:4,type:"verb"},{id:"yuḷḷip",size:1},{id:"putal",size:1,type:"noun"},{id:"micai",size:1,type:"noun"},{id:"vicumpu",size:3,type:"noun"},{id:"tōṟṟam",size:7,type:"noun"},{id:"putu",size:3,type:"adjective"},{id:"mēvu",size:1,type:"noun"},{id:"maṭa(m)",size:13,type:"noun"},{id:"cāy",size:2,type:"noun"},{id:"alamvaru",size:2,type:"verb"},{id:"kaḻaṉi",size:9,type:"noun"},{id:"poru",size:3,type:"verb"},{id:"ṇaḻap",size:1},{id:"putup",size:5},{id:"meym",size:1},{id:"maṇa",size:6,type:"verb"},{id:"kamaḻ",size:4,type:"verb"},{id:"poḻil",size:4,type:"noun"},{id:"ḷuḷai",size:1},{id:"cī",size:2,type:"verb"},{id:"kalakkam",size:5,type:"noun"},{id:"viḷaika",size:1},{id:"vayal",size:3,type:"noun"},{id:"viravalar",size:1},{id:"litaḻ",size:1},{id:"nikar",size:1,type:"noun"},{id:"vaḻi",size:2,type:"noun"},{id:"vaḻic",size:1},{id:"aṟu",size:8,type:"noun"},{id:"cil",size:5,type:"noun"},{id:"vam",size:4},{id:"ciṟait",size:1},{id:"tumpi",size:1,type:"noun"},{id:"nūṟṟu",size:2},{id:"itaḻt",size:1},{id:"tāmaraip",size:1},{id:"pūc",size:1},{id:"kāmpu",size:1,type:"noun"},{id:"naṇṇu",size:2,type:"verb"},{id:"yūraṉai",size:2},{id:"yuḷḷi",size:3},{id:"ṉiṟai",size:1},{id:"yēr",size:2},{id:"yeṉṉai",size:2},{id:"tāṉum",size:1},{id:"malaintāṉ",size:1},{id:"emakkum",size:1},{id:"taḻāi",size:1},{id:"yāyiṉa",size:1},{id:"vī",size:4,type:"noun"},{id:"yarumpiṉavē",size:1},{id:"yeṉṉa",size:1},{id:"maram",size:2,type:"noun"},{id:"cāral",size:2,type:"noun"},{id:"avvē",size:1},{id:"notumal",size:2,type:"noun"},{id:"varaiviṉkaṇ",size:1},{id:"cevili",size:1,type:"noun"},{id:"āṟṟāl",size:1},{id:"talaimakaḷ",size:6},{id:"aṟattoṭu",size:2},{id:"pārppaṉak",size:1},{id:"kuṟu(m)",size:6,type:"adjective"},{id:"makap",size:1},{id:"pōlat",size:1},{id:"kuṭumit",size:1},{id:"talai",size:5},{id:"malai",size:8,type:"noun"},{id:"nāṭu",size:9,type:"noun"},{id:"talaimakaṉ",size:4},{id:"varaital",size:1},{id:"vēṇṭit",size:1},{id:"varukiṉṟamaik",size:1},{id:"yuvanta",size:1},{id:"vuḷḷattaḷ",size:1},{id:"āyt",size:1},{id:"talaimakaṭkuk",size:1},{id:"paṭappait",size:1},{id:"tēm",size:3,type:"noun"},{id:"pāl",size:3,type:"noun"},{id:"iṉum",size:1},{id:"iṉ",size:15,type:"adjective"},{id:"vavar",size:3},{id:"nāṭṭu",size:4,type:"verb"},{id:"uvalaik",size:1},{id:"kūval",size:1,type:"noun"},{id:"kīḻa",size:1},{id:"eñcu",size:1,type:"verb"},{id:"kaliḻi",size:1},{id:"-uṭaṉ",size:2},{id:"pōy",size:1},{id:"mīḷ",size:1,type:"verb"},{id:"eṅṅaṉam",size:1},{id:"nukarntāy",size:1},{id:"eṉak",size:5},{id:"aḵtu",size:2},{id:"varaiyara",size:1},{id:"nirai",size:3,type:"noun"},{id:"kuḻuvu",size:1,type:"verb"},{id:"peyar",size:7,type:"noun"},{id:"uḻi",size:2,type:"noun"},{id:"tavir",size:1,type:"verb"},{id:"nōkkam",size:6,type:"noun"},{id:"tīyēṉ",size:1},{id:"-uṭai",size:3},{id:"accam",size:3,type:"noun"},{id:"oli",size:2,type:"verb"},{id:"veḷḷ",size:1},{id:"aruvi",size:1,type:"noun"},{id:"yōṅku",size:1},{id:"pāyal",size:3,type:"noun"},{id:"veppa(m)",size:5,type:"noun"},{id:"varai",size:10,type:"noun"},{id:"viṭu",size:3,type:"verb"},{id:"uḻit",size:2},{id:"talaimakaṭku",size:1},{id:"uḷ",size:2},{id:"varuttam",size:3,type:"noun"},{id:"vāṟu",size:3},{id:"ātaṟkkuk",size:1},{id:"kāraṇam",size:1},{id:"yeṉṟu",size:2},{id:"viṉāviya",size:1},{id:"cevilikkut",size:1},{id:"yuvak",size:2},{id:"mārik",size:1},{id:"kuṉṟattuk",size:1},{id:"kā",size:4,type:"noun"},{id:"tūvu",size:1,type:"verb"},{id:"toṭalai",size:2,type:"noun"},{id:"vāḷ",size:3,type:"noun"},{id:"pāci",size:1,type:"noun"},{id:"kaḻal",size:5,type:"noun"},{id:"vaiku",size:1,type:"verb"},{id:"varik",size:1},{id:"kaccu",size:1,type:"noun"},{id:"iravuk",size:1},{id:"kuṟik",size:1},{id:"kuṟi",size:3,type:"noun"},{id:"yiṭattu",size:1},{id:"niṉṟamai",size:1},{id:"yaṟinta",size:1},{id:"naṉṟum",size:2},{id:"uṇaṅkala",size:1},{id:"tiṉai",size:2,type:"noun"},{id:"niṇa",size:3,type:"verb"},{id:"poti",size:1,type:"noun"},{id:"vaḻukkiṉ",size:1},{id:"maḻai",size:4,type:"noun"},{id:"vai",size:5,type:"noun"},{id:"kuṉṟam",size:9,type:"noun"},{id:"yiṉmaiyāl",size:1},{id:"yuṇaṅkum",size:1},{id:"viḷaiya",size:1},{id:"māṭṭā",size:1},{id:"puṉam",size:1,type:"noun"},{id:"kāppac",size:1},{id:"avarai",size:1,type:"noun"},{id:"yetirppaṭalām",size:1},{id:"eṇṇu",size:1,type:"verb"},{id:"yirunta",size:1},{id:"vitu",size:1},{id:"kūṭṭam",size:3,type:"noun"},{id:"veṟuttu",size:1},{id:"talaimakaṭkut",size:1},{id:"kāṉ",size:7,type:"noun"},{id:"kiḻaṅku",size:1,type:"noun"},{id:"akaḻ",size:1,type:"verb"},{id:"kuḻi",size:1,type:"noun"},{id:"vēṅkaip",size:2},{id:"vīt",size:1},{id:"tāam",size:1},{id:"niṟam",size:4,type:"noun"},{id:"māl",size:2,type:"adjective"},{id:"maṟai",size:3,type:"noun"},{id:"toṟu",size:1},{id:"aṟai",size:1,type:"noun"},{id:"ār",size:1,type:"noun"},{id:"cevilikku",size:2},{id:"yavaḷāl",size:1},{id:"māṭcimaip",size:1},{id:"piṉpu",size:1},{id:"ellavum",size:1},{id:"tīrntatu",size:1},{id:"maṟṟu",size:3},{id:"maṟa",size:5,type:"verb"},{id:"yāyiṉ",size:3},{id:"koṇṭal",size:1,type:"noun"},{id:"avaraip",size:1},{id:"cūṭit",size:1},{id:"iṭai",size:12,type:"noun"},{id:"vaittup",size:1},{id:"kaṇṇ",size:1},{id:"avaṉai",size:1},{id:"viṭātu",size:1},{id:"āṟṟu",size:4,type:"verb"},{id:"tōḻikkut",size:1},{id:"muḷḷi",size:3,type:"noun"},{id:"nīṭṭu",size:6,type:"verb"},{id:"mutu",size:2,type:"adjective"},{id:"karaip",size:1},{id:"puḷḷik",size:3},{id:"kaḷvaṉ",size:9,type:"noun"},{id:"āmpal",size:6,type:"noun"},{id:"pacappatu",size:2},{id:"paṭappaip",size:1},{id:"pulavuc",size:1},{id:"tuṟṟu",size:1,type:"verb"},{id:"ēl",size:1,type:"verb"},{id:"nāṭṭup",size:2},{id:"purai",size:3,type:"noun"},{id:"vayakku",size:2,type:"noun"},{id:"peṟat",size:1},{id:"taṇitaṟku",size:1},{id:"mikutik",size:1},{id:"melivu",size:1},{id:"tevyattiṉāṉ",size:1},{id:"veṟi",size:2,type:"noun"},{id:"yeṭuppu",size:1},{id:"ney",size:1,type:"noun"},{id:"vuḻuntu",size:1},{id:"yam",size:4},{id:"cilampu",size:2,type:"noun"},{id:"talaiyatu",size:1},{id:"ceyalai",size:1,type:"noun"},{id:"pakait",size:1},{id:"taḻai",size:3,type:"noun"},{id:"vāṭṭam",size:3,type:"noun"},{id:"āṟṟāmai",size:1},{id:"kaiyuṟai",size:1,type:"noun"},{id:"yēṟṟa",size:1},{id:"yēṟka",size:1},{id:"aḷḷal",size:1,type:"noun"},{id:"vēr",size:2,type:"noun"},{id:"aḷaic",size:1},{id:"col",size:6,type:"noun"},{id:"nīyēṉ",size:1},{id:"kātal",size:9,type:"noun"},{id:"veṉṉ",size:2},{id:"kaviṉ",size:4,type:"noun"},{id:"tolai",size:3,type:"verb"},{id:"vaḻit",size:1},{id:"taṇantu",size:1},{id:"varaitaṟku",size:1},{id:"vēṇṭuvaṉa",size:1},{id:"muṭi",size:2,type:"noun"},{id:"kūṟak",size:1},{id:"ciṟaippuṟattāṉ",size:1},{id:"āyk",size:1},{id:"kēṭpat",size:1},{id:"aḷaik",size:1},{id:"āṭṭip",size:1},{id:"kuṟṟu",size:5,type:"verb"},{id:"eytu",size:1,type:"verb"},{id:"aṇi",size:15,type:"noun"},{id:"tēṟṟam",size:1},{id:"nap",size:1},{id:"iṉit",size:1},{id:"tākku",size:1,type:"verb"},{id:"aṇaṅku",size:4,type:"noun"},{id:"tāy",size:3,type:"noun"},{id:"cāp",size:1},{id:"piṟa",size:5,type:"noun"},{id:"kaḷvaṉoṭu",size:1},{id:"piḷḷai",size:1,type:"noun"},{id:"tiṉṉum",size:2},{id:"mutalaittu",size:1},{id:"eytiṉaṉ",size:1},{id:"makiḻ",size:24,type:"noun"},{id:"polam",size:4,type:"noun"},{id:"toṭi",size:13,type:"noun"},{id:"teḷir",size:1,type:"verb"},{id:"muyaṅkiyavar",size:1},{id:"tuṟappatu",size:1},{id:"ayal",size:2,type:"noun"},{id:"puṟantā",size:1,type:"verb"},{id:"puṉiṟu",size:2,type:"noun"},{id:"pai(m)",size:6,type:"adjective"},{id:"kāy",size:6,type:"noun"},{id:"vayalaic",size:2},{id:"ce(m)",size:14,type:"adjective"},{id:"koṭi",size:3,type:"noun"},{id:"palarkku",size:1},{id:"poy",size:6,type:"noun"},{id:"aṟiyāk",size:2},{id:"kaḻaṅku",size:2,type:"noun"},{id:"mey",size:1,type:"noun"},{id:"varaik",size:1},{id:"kaṭci",size:1,type:"noun"},{id:"mayil",size:2,type:"noun"},{id:"ālu",size:3,type:"verb"},{id:"vaḷḷi",size:1,type:"noun"},{id:"kiḻamai",size:1,type:"noun"},{id:"āṇ",size:1,type:"noun"},{id:"taku",size:3,type:"verb"},{id:"viṟal",size:4,type:"noun"},{id:"vēṭkai",size:1,type:"noun"},{id:"tāṅku",size:1,type:"verb"},{id:"iḷa(m)",size:2,type:"adjective"},{id:"karantai",size:1,type:"noun"},{id:"ceṟu",size:3,type:"verb"},{id:"vaḷḷai",size:1,type:"noun"},{id:"aṟi",size:8,type:"verb"},{id:"iṉṉaṉ",size:1},{id:"katir",size:7,type:"noun"},{id:"ṇakam",size:2},{id:"maṇ",size:3,type:"noun"},{id:"ṇaḷaic",size:1},{id:"nekiḻac",size:2},{id:"allal",size:1,type:"noun"},{id:"uḻa",size:1,type:"verb"},{id:"yaṇaṅku",size:2},{id:"uṟai",size:6,type:"noun"},{id:"cēṟu",size:1,type:"noun"},{id:"oṇmai",size:9,type:"noun"},{id:"koḷak",size:1},{id:"kaṭuka",size:1},{id:"vittu",size:2,type:"noun"},{id:"muḷai",size:2,type:"noun"},{id:"marīit",size:1},{id:"titti",size:2,type:"noun"},{id:"yalkul",size:3},{id:"koḷvatu",size:1},{id:"vūṟuka",size:1},{id:"pakaṭu",size:1},{id:"vuḻavar",size:1},{id:"vēppa(m)",size:3,type:"noun"},{id:"ṇaḷai",size:1},{id:"vuṟaikkum",size:1},{id:"iḻa",size:2,type:"verb"},{id:"lōttirattu",size:1},{id:"maiy",size:1},{id:"aru(m)",size:15,type:"adjective"},{id:"curam",size:34,type:"noun"},{id:"ceṉṉik",size:1},{id:"av",size:1},{id:"varaiy",size:1},{id:"iṟakkuvaiy",size:1},{id:"poruḷ",size:6,type:"noun"},{id:"viṉai",size:3,type:"noun"},{id:"tappal",size:1,type:"noun"},{id:"arivai",size:5,type:"noun"},{id:"takaittaṟku",size:1},{id:"pulampav",size:1},{id:"putuk",size:1},{id:"kalam",size:2,type:"noun"},{id:"kaṉiya",size:1},{id:"vālam",size:1},{id:"pōkil",size:2,type:"noun"},{id:"taṉait",size:1},{id:"taṭukkum",size:1},{id:"vēṉal",size:10,type:"noun"},{id:"viṉiya",size:2},{id:"vāka",size:2},{id:"kallāk",size:1},{id:"kōvalar",size:2,type:"noun"},{id:"kōl",size:2,type:"noun"},{id:"tōṇṭiyav",size:1},{id:"ā",size:2},{id:"pattar",size:1,type:"noun"},{id:"yāṉai",size:10,type:"noun"},{id:"kall",size:2},{id:"atark",size:1},{id:"kavalai",size:3,type:"noun"},{id:"celliṉ",size:1},{id:"iyal",size:2,type:"noun"},{id:"puyal",size:1,type:"noun"},{id:"kūntal",size:7,type:"noun"},{id:"vaya(m)",size:2,type:"noun"},{id:"pōrk",size:1},{id:"kuricil",size:1,type:"noun"},{id:"iṟa",size:9,type:"verb"},{id:"kāḻ",size:1,type:"noun"},{id:"alkul",size:3,type:"noun"},{id:"vāṭak",size:1},{id:"kuḻal",size:1,type:"noun"},{id:"iṉaikuvaḷ",size:1},{id:"viḻavu",size:2,type:"noun"},{id:"ñeli",size:1,type:"noun"},{id:"kaḻai",size:3,type:"noun"},{id:"aḻal",size:3,type:"noun"},{id:"vayamā",size:1},{id:"veru",size:3,type:"noun"},{id:"ayar",size:2,type:"verb"},{id:"tuṇaip",size:1},{id:"pall",size:6},{id:"yiṇark",size:2},{id:"eṟuḻ",size:1,type:"noun"},{id:"muruku",size:1,type:"noun"},{id:"amar",size:5,type:"noun"},{id:"tiṅkaḷ",size:1,type:"noun"},{id:"kaṭuñcūl",size:1},{id:"muṟuval",size:3,type:"noun"},{id:"viṟu",size:1},{id:"yiṟantu",size:1},{id:"kaṭam",size:4,type:"noun"},{id:"mūr",size:3},{id:"muṭam",size:1},{id:"mutir",size:3,type:"verb"},{id:"marutattup",size:2},{id:"yuṭaṉ",size:1},{id:"āyamōṭu",size:2},{id:"pacu(m)",size:5,type:"adjective"},{id:"pāṇṭil",size:3,type:"noun"},{id:"kācu",size:1,type:"noun"},{id:"nekiḻap",size:1},{id:"viṭalai",size:2,type:"noun"},{id:"yivaḷ",size:2},{id:"vēṅkai",size:3,type:"noun"},{id:"koyyunar",size:1},{id:"pañcuram",size:1},{id:"viḷippiṉum",size:1},{id:"iṭaic",size:2},{id:"kāṭu",size:5,type:"noun"},{id:"nīṭuvar",size:1},{id:"cāliyar",size:3},{id:"vaṟṟu",size:5,type:"verb"},{id:"uṇṭāyiṉum",size:1},{id:"vaṉappu",size:2,type:"noun"},{id:"varuvik",size:1},{id:"eṉṉ",size:2},{id:"aiyai",size:1,type:"noun"},{id:"teṟu",size:5,type:"verb"},{id:"num",size:5,type:"pronoun"},{id:"viruppam",size:2,type:"noun"},{id:"yuṟu",size:4},{id:"tuyar",size:3,type:"noun"},{id:"avala(m)",size:1,type:"noun"},{id:"uyir",size:2,type:"noun"},{id:"celac",size:2},{id:"ppāḻ",size:1},{id:"neñcam",size:11,type:"noun"},{id:"aṭak",size:1},{id:"vilakku",size:2,type:"verb"},{id:"avir",size:6,type:"verb"},{id:"koṭpak",size:1},{id:"kaḻutu",size:1,type:"noun"},{id:"pukavu",size:1,type:"noun"},{id:"ayarak",size:1},{id:"karu(m)",size:7,type:"adjective"},{id:"kākkaiyoṭu",size:1},{id:"kaḻuku",size:1},{id:"akavac",size:1},{id:"yāḷ",size:1},{id:"vīḻttut",size:1},{id:"tiri",size:2,type:"noun"},{id:"taru/tā",size:11,type:"verb"},{id:"nīḷ",size:6,type:"noun"},{id:"pūcal",size:1,type:"noun"},{id:"cēy",size:1,type:"noun"},{id:"viḻai",size:1,type:"verb"},{id:"uṟīik",size:1},{id:"cōlaik",size:1},{id:"nantat",size:1},{id:"viṟantōr",size:1},{id:"maṉ",size:17},{id:"piṟaṅku",size:2,type:"verb"},{id:"malaip",size:1},{id:"arai",size:2,type:"noun"},{id:"yōmai",size:1},{id:"puli",size:2,type:"noun"},{id:"vaḻakku",size:4,type:"noun"},{id:"cūḻkam",size:1},{id:"pāḻ",size:2,type:"noun"},{id:"paṭṭup",size:1},{id:"pālai",size:1,type:"noun"},{id:"kāṭṭu",size:1,type:"noun"},{id:"nali",size:1,type:"verb"},{id:"vēy",size:4,type:"noun"},{id:"maruṭkai",size:4,type:"noun"},{id:"vill",size:2},{id:"nacai",size:2,type:"noun"},{id:"vicai",size:1,type:"noun"},{id:"nimir",size:1,type:"verb"},{id:"ōṭṭu",size:1,type:"verb"},{id:"eri",size:4,type:"noun"},{id:"naṭa",size:4,type:"verb"},{id:"uyar",size:7,type:"verb"},{id:"piṟaṅkal",size:2,type:"noun"},{id:"viḷakkam",size:4,type:"noun"},{id:"muḷi",size:3,type:"verb"},{id:"til",size:2},{id:"mil",size:1},{id:"vantataṟku",size:1},{id:"eḻu",size:3,type:"noun"},{id:"aḻupa",size:1},{id:"veṉpa",size:2},{id:"vavaṉ",size:1},{id:"tī",size:6,type:"noun"},{id:"meḻukiṉ",size:1},{id:"muḷḷ",size:1},{id:"yilavattu",size:1},{id:"oḷḷ",size:2},{id:"vāṉ",size:3,type:"noun"},{id:"acai",size:2,type:"verb"},{id:"vaḷi",size:2,type:"noun"},{id:"yeṭuppa",size:1},{id:"urumup",size:1},{id:"kaṉaliṉ",size:1},{id:"nilam",size:2,type:"noun"},{id:"pōyiṉar",size:1},{id:"tavu",size:1,type:"verb"},{id:"ulaṟu",size:1,type:"verb"},{id:"talaip",size:3},{id:"paruntu",size:1,type:"noun"},{id:"uḷi",size:1,type:"noun"},{id:"vāyp",size:1},{id:"pēṭaiy",size:1},{id:"alaṟu",size:1,type:"verb"},{id:"talaiy",size:1},{id:"ōmaiy",size:1},{id:"kavaṭu",size:1},{id:"ēṟip",size:2},{id:"viḷi",size:2,type:"noun"},{id:"malaiy",size:1},{id:"iṟappiṉum",size:1},{id:"oḻi",size:3,type:"verb"},{id:"muḷiya",size:1},{id:"nīṭik",size:1},{id:"kaṭu(m)",size:2,type:"adjective"},{id:"ñāyiṟu",size:1,type:"noun"},{id:"pakat",size:1},{id:"muṉ",size:9},{id:"yuḷḷu",size:1},{id:"vaḷḷ",size:1},{id:"eyiṟṟuc",size:1},{id:"piṇaviṟkuk",size:1},{id:"kaḷḷi",size:1,type:"noun"},{id:"kaṭattiṭaik",size:1},{id:"kēḻal",size:1,type:"noun"},{id:"pār",size:2,type:"noun"},{id:"curak",size:1},{id:"nīttam",size:3,type:"noun"},{id:"kavar",size:3,type:"verb"},{id:"veṉṟūḻ",size:3},{id:"kaṇpaṭuppiṉum",size:1},{id:"kāṇkuveṉ",size:1},{id:"kaṅkul",size:1,type:"noun"},{id:"naḷi",size:1,type:"noun"},{id:"nakar",size:3,type:"noun"},{id:"cuṇaṅku",size:3,type:"noun"},{id:"araiyattu",size:1},{id:"yoli",size:1},{id:"verīip",size:1},{id:"pukarvu",size:1},{id:"pulam",size:2,type:"noun"},{id:"alai",size:1,type:"noun"},{id:"naliyātu",size:1},{id:"naṉam",size:1,type:"adjective"},{id:"iṭam",size:1,type:"noun"},{id:"peṟu",size:6,type:"verb"},{id:"piṇa",size:6,type:"noun"},{id:"maṟiyoṭu",size:1},{id:"tiraṅku",size:1,type:"verb"},{id:"nirappu",size:1,type:"verb"},{id:"viyaviṉ",size:1},{id:"poṟi",size:2,type:"noun"},{id:"varit",size:1},{id:"taṭak",size:1},{id:"kai",size:6,type:"noun"},{id:"vētal",size:1},{id:"añcic",size:1},{id:"nilan",size:1},{id:"toṭal",size:1},{id:"veyil",size:4,type:"noun"},{id:"cōlai",size:5,type:"noun"},{id:"vār",size:3,type:"noun"},{id:"iṭaiyāṉ",size:1},{id:"taṇmai",size:1},{id:"vit",size:1},{id:"taḷittu",size:1},{id:"naṟu(m)",size:11,type:"adjective"},{id:"tāayt",size:1},{id:"vāyiṉum",size:2},{id:"yoḻiyak",size:1},{id:"utir",size:1,type:"verb"},{id:"naṉantalai",size:1},{id:"maṟu",size:2,type:"noun"},{id:"ceṟi",size:3,type:"verb"},{id:"uku",size:2,type:"verb"},{id:"nilai",size:1,type:"verb"},{id:"voḻintōḷ",size:1},{id:"urappu",size:1,type:"noun"},{id:"maruta(m)",size:3,type:"noun"},{id:"tuṟaip",size:1},{id:"peṇṭirōṭu",size:1},{id:"tār",size:2,type:"noun"},{id:"talait",size:1},{id:"tukaḷ",size:1,type:"noun"},{id:"iṉic",size:1},{id:"yaḻuta",size:1},{id:"citaiyak",size:1},{id:"niṉaikkum",size:1},{id:"yaviḻ",size:1},{id:"iṇark",size:1},{id:"marām",size:3,type:"noun"},{id:"vaikal",size:1,type:"noun"},{id:"oḻintōr",size:1},{id:"-uḷ",size:2},{id:"veṟpu",size:1,type:"noun"},{id:"yeṉṉatūum",size:1},{id:"micaik",size:2},{id:"kāṉatta",size:1},{id:"māk",size:2},{id:"kaṇam",size:1,type:"noun"},{id:"kātalip",size:1},{id:"yāṅkaṇ",size:10,type:"pronoun"},{id:"yavaṇa",size:1},{id:"iṉap",size:1},{id:"tōṭu",size:1,type:"noun"},{id:"(i)yāam",size:1},{id:"uṟaitum",size:1},{id:"yāṅkup",size:1},{id:"uṟaiti",size:1},{id:"yilai",size:1},{id:"nelli",size:2,type:"noun"},{id:"iṭaip",size:2},{id:"pētai",size:2,type:"noun"},{id:"vali",size:1,type:"noun"},{id:"itaḻ",size:2,type:"noun"},{id:"neyttōr",size:1,type:"noun"},{id:"cevviya",size:1},{id:"veruvai",size:1},{id:"puṭai",size:1,type:"noun"},{id:"muṭai",size:1,type:"noun"},{id:"yārkkum",size:1},{id:"yivaṇ",size:1},{id:"pōlap",size:5},{id:"piṇi",size:7,type:"noun"},{id:"muṟṟi",size:2,type:"verb"},{id:"meyy",size:1},{id:"muyakkiṉum",size:1},{id:"yirum",size:4},{id:"yila",size:1},{id:"vōṅku",size:1},{id:"yilavam",size:1},{id:"mutal",size:1,type:"noun"},{id:"yilaik",size:1},{id:"paḻa(m)",size:3,type:"adjective"},{id:"vāval",size:2,type:"noun"},{id:"ukakkum",size:2},{id:"mūrp",size:2},{id:"poykaip",size:3},{id:"puḻaik",size:1},{id:"tātu",size:6,type:"noun"},{id:"vaṇṇa(m)",size:2,type:"noun"},{id:"vētilāḷarkkup",size:1},{id:"uḷḷu",size:3,type:"verb"},{id:"viṭṭuc",size:1},{id:"taṭṭait",size:1},{id:"kuyil",size:3,type:"noun"},{id:"peṭai",size:2,type:"noun"},{id:"kural",size:4,type:"noun"},{id:"akavu",size:2,type:"verb"},{id:"vayir",size:1},{id:"kkēḻ",size:1},{id:"nuṇṇ",size:1},{id:"curumpu",size:3,type:"noun"},{id:"kaḷi",size:1,type:"noun"},{id:"kkarum",size:1},{id:"nuṇavam",size:1},{id:"nilaik",size:1},{id:"kōṅkam",size:2,type:"noun"},{id:"paya",size:4,type:"verb"},{id:"koḻu",size:1,type:"verb"},{id:"mukiḻ",size:4,type:"noun"},{id:"kuravam",size:2,type:"noun"},{id:"ceyyāp",size:1},{id:"ppū",size:1},{id:"vatiral",size:1},{id:"tāayk",size:1},{id:"katuppu",size:2,type:"noun"},{id:"ciṉaip",size:1},{id:"pātiri",size:2,type:"noun"},{id:"yalarntu",size:1},{id:"eṉac",size:4},{id:"yeḻil",size:1},{id:"poliyap",size:1},{id:"porip",size:2},{id:"puṉku",size:2,type:"noun"},{id:"muṟi",size:2,type:"noun"},{id:"curi",size:2,type:"noun"},{id:"pori",size:2,type:"noun"},{id:"putai",size:1,type:"noun"},{id:"veri",size:1},{id:"poykai",size:7,type:"noun"},{id:"yāmpal",size:3},{id:"nār",size:1,type:"noun"},{id:"uri",size:1,type:"noun"},{id:"niḻaṟṟutal",size:1},{id:"yiṉip",size:1},{id:"vuṟaippat",size:1},{id:"kiḷa",size:1,type:"verb"},{id:"attap",size:1},{id:"palavu",size:1,type:"noun"},{id:"tiṉ",size:1,type:"verb"},{id:"aruntiṉar",size:1},{id:"piṉṉ",size:1},{id:"tīr",size:2,type:"verb"},{id:"maṭantai",size:5,type:"noun"},{id:"nall",size:3},{id:"eḻil",size:2,type:"noun"},{id:"viḻut",size:1},{id:"toṭai",size:1,type:"noun"},{id:"maṟam",size:1,type:"noun"},{id:"iṭat",size:1},{id:"eḻuttu",size:1,type:"noun"},{id:"viḻup",size:1},{id:"piṇarp",size:1},{id:"ciṉa(m)",size:4,type:"noun"},{id:"ari",size:3,type:"noun"},{id:"veṉṉār",size:1},{id:"erik",size:1},{id:"koṭik",size:1},{id:"kavai",size:3,type:"noun"},{id:"cev",size:1},{id:"pōlac",size:1},{id:"cuṭarp",size:1},{id:"ēntal",size:1,type:"noun"},{id:"yiṉitu",size:3},{id:"muyakkam",size:2,type:"noun"},{id:"īr(m)",size:1,type:"noun"},{id:"ēṟṟai",size:2,type:"noun"},{id:"maṟi",size:2,type:"noun"},{id:"teri",size:2,type:"verb"},{id:"yiḻai",size:3},{id:"yarivai",size:3},{id:"tiruttu",size:3,type:"verb"},{id:"uḷḷi",size:2,type:"noun"},{id:"tiru",size:1,type:"noun"},{id:"vuṟuka",size:1},{id:"poṟic",size:1},{id:"neṟi",size:4,type:"noun"},{id:"uḷḷutaṟku",size:1},{id:"puṉai",size:3,type:"noun"},{id:"kayiṟu",size:2,type:"noun"},{id:"mēy",size:3,type:"verb"},{id:"yuḷḷam",size:1},{id:"vāṅkat",size:1},{id:"maravam",size:2},{id:"pūppac",size:1},{id:"vaḻuṅkuka",size:1},{id:"kaviṉa",size:2},{id:"yiṟantaṉar",size:1},{id:"nīṭa",size:1},{id:"tuṭait",size:2},{id:"yuṭaittu",size:1},{id:"veḷḷam",size:1,type:"noun"},{id:"vēṭkaiyam",size:1},{id:"atar",size:1,type:"noun"},{id:"kālait",size:1},{id:"tava",size:2},{id:"amaikuva",size:1},{id:"karutiya",size:1},{id:"olku",size:1,type:"verb"},{id:"yariya",size:1},{id:"eḷitu",size:1,type:"adjective"},{id:"yavavu",size:1},{id:"kavavu",size:1,type:"verb"},{id:"virumpik",size:1},{id:"kaṭu",size:2,type:"verb"},{id:"kaṭavu",size:1,type:"verb"},{id:"karaik",size:1},{id:"yāṟu",size:2,type:"noun"},{id:"aka(m)",size:2,type:"noun"},{id:"kuvaiit",size:1},{id:"tai",size:1,type:"noun"},{id:"katam",size:2,type:"noun"},{id:"mulaiyiṉum",size:1},{id:"patukku",size:1,type:"noun"},{id:"āya",size:1},{id:"votukku",size:1},{id:"kavalaic",size:1},{id:"pakai",size:3,type:"noun"},{id:"(i)yāṅku",size:1},{id:"varuḷ",size:1},{id:"uyttara",size:1},{id:"viruḷ",size:1},{id:"cilai",size:1,type:"noun"},{id:"vil",size:4,type:"noun"},{id:"pakaḻic",size:1},{id:"cen",size:1},{id:"tuvar",size:1,type:"noun"},{id:"āṭaik",size:1},{id:"eyiṉar",size:1,type:"noun"},{id:"taṅkai",size:2,type:"noun"},{id:"muḷ",size:2,type:"noun"},{id:"valci",size:2,type:"noun"},{id:"yeyiṉar",size:1},{id:"eyiṟṟikku",size:1},{id:"in",size:1},{id:"yaṟiyac",size:1},{id:"colliṉeṉ",size:1},{id:"irakkum",size:1},{id:"aḷa",size:2,type:"verb"},{id:"vēl",size:9,type:"noun"},{id:"kaṇa",size:1},{id:"tolaiccit",size:1},{id:"taṉṉ",size:2},{id:"vūṉ",size:1},{id:"valcip",size:1},{id:"ōppu",size:1,type:"verb"},{id:"eyiṟṟi",size:1},{id:"nayavaravu",size:1},{id:"nōṟṟaṉai",size:1},{id:"koṉ",size:1},{id:"kaṭavuti",size:1},{id:"yaraik",size:1},{id:"kōṅkamōṭ’",size:2,type:"noun"},{id:"yiṇar",size:1},{id:"vēṅkaiyoṭu",size:1},{id:"vēṟupaṭu",size:1,type:"verb"},{id:"milaicci",size:1},{id:"yāṟṟut",size:1},{id:"kuṟuku",size:1,type:"verb"},{id:"pēroṭu",size:1},{id:"erip",size:1},{id:"vilavattu",size:1},{id:"ūḻ",size:3,type:"verb"},{id:"pukar",size:1,type:"noun"},{id:"pata(m)",size:3,type:"noun"},{id:"iṉpa",size:1},{id:"nukarcci",size:1},{id:"yemmoṭu",size:1},{id:"ōti",size:3,type:"noun"},{id:"yaḻivu",size:1},{id:"vaḷa",size:1},{id:"tatai",size:1,type:"verb"},{id:"nerunal",size:2},{id:"yeṉpa",size:2},{id:"kurava",size:1},{id:"yaṟaiyum",size:1},{id:"paruva",size:1},{id:"tēṟṟāṉ",size:1},{id:"vaḷ",size:5,type:"noun"},{id:"paṭalai",size:1,type:"noun"},{id:"ciṟai",size:3,type:"noun"},{id:"moyppa",size:1},{id:"uṟaiyappaṭṭōḷ",size:1},{id:"yāvaḷ",size:1},{id:"maḷḷar",size:3,type:"noun"},{id:"koṭṭiṉ",size:1},{id:"maññai",size:1,type:"noun"},{id:"yālum",size:1},{id:"paṭumaḻai",size:1},{id:"talaiic",size:1},{id:"vākuka",size:2},{id:"yitu",size:2},{id:"veṉat",size:1},{id:"teḷintav",size:1},{id:"piṟai",size:1,type:"noun"},{id:"taṉṉai",size:1},{id:"uṇat",size:1},{id:"tēṟṟu",size:1,type:"verb"},{id:"vañcu",size:1},{id:"iṉak",size:1},{id:"kāḷai",size:8,type:"noun"},{id:"aḻuṅkal",size:1,type:"noun"},{id:"eḻac",size:1},{id:"ceḻu(m)",size:1,type:"adjective"},{id:"niṉait",size:2},{id:"iṭumpai",size:2,type:"noun"},{id:"yeytuka",size:1},{id:"pulik",size:1},{id:"piḻai",size:1,type:"verb"},{id:"kavaik",size:1},{id:"kōṭṭam",size:5,type:"noun"},{id:"yaṇai",size:1},{id:"vāṇ",size:1},{id:"uy",size:2,type:"verb"},{id:"vampu",size:1,type:"noun"},{id:"niṉaippiṉum",size:1},{id:"eṉṟūḻa",size:1},{id:"mīḷi",size:1,type:"noun"},{id:"yakam",size:1},{id:"pukāak",size:1},{id:"kaṭuvaṉ",size:1,type:"noun"},{id:"ṉalamaru",size:1},{id:"varu",size:1},{id:"kiḷḷai",size:2,type:"noun"},{id:"yeṭutta",size:1},{id:"nīṅkiṉaḷ",size:1},{id:"eṉṉiṉ",size:1},{id:"kaṉaliyar",size:1},{id:"kalleṉak",size:1},{id:"kalaṅkap",size:1},{id:"pōkku",size:3,type:"verb"},{id:"ūkku",size:1,type:"verb"},{id:"vuyaval",size:1},{id:"yiyam",size:1},{id:"attam",size:3,type:"noun"},{id:"pantu",size:1,type:"noun"},{id:"muyalip",size:1},{id:"ciṟakar",size:1,type:"noun"},{id:"pulampap",size:2},{id:"tē",size:1},{id:"moḻit",size:1},{id:"yilaḷ",size:1},{id:"iṇai",size:1,type:"noun"},{id:"āyam",size:1,type:"noun"},{id:"nukar",size:1,type:"verb"},{id:"yiṉak",size:1},{id:"kaḷiṟu",size:2,type:"noun"},{id:"uṇarntōr",size:2},{id:"yavaṉoṭu",size:1},{id:"naku",size:3,type:"verb"},{id:"vall",size:1},{id:"eṭuttēṉ",size:1},{id:"koṭuttōr",size:1},{id:"palavuṭaṉ",size:1},{id:"micaintu",size:1},{id:"iruntōr",size:1},{id:"aḷi",size:2,type:"noun"},{id:"ciṟaik",size:1},{id:"makaṉṟil",size:1,type:"noun"},{id:"vuṭaṉ",size:1},{id:"olikku",size:1},{id:"kaḻivōḷ",size:1},{id:"ell",size:1},{id:"yacainta",size:1},{id:"kalleṉ",size:1,type:"verb"},{id:"cīṟu",size:1},{id:"makaḷirp",size:1},{id:"araṟṟu",size:1,type:"verb"},{id:"amal",size:1,type:"verb"},{id:"marāattuk",size:1},{id:"koytaṟku",size:1},{id:"maḷḷaṉ",size:1},{id:"kūrntaṉṟu",size:1},{id:"pañcāyp",size:1},{id:"pāvaikku",size:1},{id:"cēṇ",size:2,type:"noun"},{id:"muṉṉu",size:1,type:"verb"},{id:"vacai",size:1,type:"noun"},{id:"yantaṇir",size:1},{id:"irantaṉeṉ",size:1},{id:"emm",size:1},{id:"eṭu",size:1,type:"verb"},{id:"yiṟantaṉaḷ",size:1},{id:"eṉmiṉ",size:1},{id:"iṟai",size:2,type:"noun"},{id:"kaṭuṅkaṇ",size:1},{id:"ēṟik",size:1},{id:"piṟak",size:1},{id:"koḻiya",size:1},{id:"vēṟu",size:1,type:"noun"},{id:"kūṟumiṉ",size:1},{id:"makkaḷ",size:1,type:"noun"},{id:"pārāṭṭu",size:1,type:"verb"},{id:"keṭu",size:2,type:"verb"},{id:"pul",size:3,type:"noun"},{id:"cuvar",size:1,type:"noun"},{id:"viṭumpai",size:1},{id:"yuṟuvi",size:1},{id:"yaru",size:2},{id:"navil",size:1,type:"verb"},{id:"nā",size:1,type:"noun"},{id:"tiṟam",size:1,type:"noun"},{id:"yantaṇīr",size:1},{id:"toḻuval",size:1},{id:"viṉavum",size:1},{id:"kaṇṭaṉem",size:3},{id:"yavaḷai",size:1},{id:"yiṉ",size:1},{id:"pārāṭṭak",size:1},{id:"neruppu",size:1,type:"noun"},{id:"kaṉal",size:1,type:"verb"},{id:"yuruppuc",size:1},{id:"taṇiyak",size:1},{id:"(y)ākkai",size:1,type:"noun"},{id:"irīic",size:1},{id:"yiṟappiṉ",size:1},{id:"kāṇkuvai",size:1},{id:"toṭip",size:1},{id:"poṉṉ",size:2},{id:"viṉaip",size:1},{id:"nōṉ",size:1,type:"verb"},{id:"yaṇal",size:1},{id:"viyalip",size:1},{id:"oṉṟiṉa",size:1},{id:"vavaḷ",size:1},{id:"yaṭaiya",size:1},{id:"ñekiḻap",size:1},{id:"para",size:1,type:"verb"},{id:"maruki",size:1},{id:"viṉavuvōy",size:1},{id:"tūvic",size:1},{id:"kākkaiy",size:1},{id:"marapu",size:1},{id:"kiḷaiyōṭu",size:2},{id:"ārap",size:1},{id:"paccūṉ",size:1},{id:"kalattil",size:1},{id:"nōkkip",size:1},{id:"pariyiṉ",size:1},{id:"yil",size:2},{id:"tuṟantataṉ",size:1},{id:"aṭac",size:1},{id:"pula",size:3,type:"verb"},{id:"paḻikkum",size:1},{id:"aḷai",size:1,type:"noun"},{id:"āṭṭi",size:1,type:"noun"},{id:"yevva",size:1},{id:"ēm",size:1,type:"noun"},{id:"tiṟal",size:1,type:"noun"},{id:"vaṉpu",size:1},{id:"aruḷiṟṟu",size:1},{id:"ōtip",size:1},{id:"yalaitta",size:1},{id:"vayirp",size:1},{id:"eric",size:1},{id:"viṭar",size:1,type:"noun"},{id:"tīrntaṉam",size:1},{id:"vēkumati",size:1},{id:"kala",size:1,type:"verb"},{id:"kaṟakku",size:1,type:"verb"},{id:"icai",size:1,type:"noun"},{id:"yaruvi",size:1},{id:"pulip",size:1},{id:"koy",size:1,type:"verb"},{id:"paipayac",size:1},{id:"yayarcciyai",size:1},{id:"yāṟuka",size:1},{id:"viruntu",size:1,type:"noun"},{id:"ākip",size:1},{id:"kaviḻ",size:1,type:"verb"},{id:"mayir",size:1,type:"noun"},{id:"eruttam",size:1,type:"noun"},{id:"kuruḷaip",size:1},{id:"paṉṟi",size:1,type:"noun"},{id:"muṉṉ",size:1},{id:"virai",size:1,type:"verb"},{id:"urai",size:3,type:"verb"},{id:"aṟiyāp",size:1},{id:"paḻuṉi",size:1},{id:"aṟiyāt",size:1},{id:"nilaiic",size:1},{id:"mikap",size:1},{id:"maṉaic",size:1},{id:"ayariṉ",size:1},{id:"vatuvai",size:2,type:"noun"},{id:"maṟṟē",size:1},{id:"yaṟa",size:1},{id:"aṭip",size:1},{id:"lārka",size:1},{id:"ōtuka",size:1},{id:"kāytta",size:1},{id:"paḻaṉa(m)",size:5,type:"noun"},{id:"ākaṟka",size:2},{id:"aḻap",size:1},{id:"keṇṭai",size:1,type:"noun"},{id:"vaviḻnta",size:1},{id:"taḻuvu",size:4,type:"verb"},{id:"nuṭakkum",size:1},{id:"kāḷaiyōṭu",size:1},{id:"puku",size:1,type:"verb"},{id:"yiṭaip",size:1},{id:"putalvaṉ",size:4,type:"noun"},{id:"naṭuvaṇaṉ",size:1},{id:"iṉitumaṉṟa",size:1},{id:"kiṭa",size:1,type:"verb"},{id:"niṟa",size:1,type:"verb"},{id:"vīṉum",size:1},{id:"umparum",size:1},{id:"kātaliyiṉ",size:1},{id:"vuḷḷam",size:1},{id:"yakaṉ",size:1},{id:"tantai",size:2,type:"noun"},{id:"muṟuvaliṉ",size:1},{id:"payiṟṟic",size:1},{id:"uruṭṭu",size:1,type:"verb"},{id:"taḷar",size:2,type:"verb"},{id:"yūṭṭat",size:1},{id:"puṟam",size:1,type:"noun"},{id:"puṟavam",size:3},{id:"poṟu",size:1,type:"verb"},{id:"oṇ",size:1},{id:"maṉaikku",size:1},{id:"kaṉai",size:1,type:"verb"},{id:"mātar",size:1,type:"noun"},{id:"viḷaiyāṭak",size:1},{id:"kātalit",size:1},{id:"iruntaṉaṉ",size:1},{id:"piracam",size:1,type:"noun"},{id:"ūtu",size:2,type:"verb"},{id:"pārpput",size:2},{id:"mutalai",size:1,type:"noun"},{id:"poykaittu",size:1},{id:"mayaṅkiṉaḷ",size:1},{id:"kāviri",size:1,type:"noun"},{id:"ampaṇattu",size:1},{id:"yāmai",size:3,type:"noun"},{id:"yēṟic",size:1},{id:"cempiṉ",size:1},{id:"pārppup",size:1},{id:"tīm",size:2,type:"adjective"},{id:"yiḷam",size:1},{id:"mukam",size:1,type:"noun"},{id:"vaḷarnticiṉāaṅku",size:1},{id:"yaiya",size:1},{id:"yaṟintaṉai",size:1},{id:"yoḻukumati",size:1},{id:"kūtir",size:1,type:"noun"},{id:"aṇintaṉa",size:1},{id:"yaṉṟu",size:1},{id:"kuṟippiṉai",size:1},{id:"yāki",size:2},{id:"yīṇṭu",size:1},{id:"yaruḷātu",size:1},{id:"ḷeyiṟṟup",size:1},{id:"keṭiṟu",size:1,type:"noun"},{id:"cori",size:3,type:"verb"},{id:"vakaṉ",size:1},{id:"vaṭṭi",size:2,type:"noun"},{id:"payaṟu",size:1,type:"noun"},{id:"niṟaikkum",size:2},{id:"yāyam",size:1},{id:"valai",size:1,type:"noun"},{id:"eyiṟu",size:1,type:"noun"},{id:"varāal",size:1,type:"noun"},{id:"yuḷ",size:1},{id:"vēṇṭēm",size:1},{id:"parattaṉ",size:1,type:"noun"},{id:"yāṇṭuc",size:1},{id:"kuṟiyōṭu",size:1},{id:"yacai",size:1},{id:"naṭaip",size:2},{id:"citaiyap",size:1},{id:"paci",size:2,type:"noun"},{id:"lākuka",size:3},{id:"mutalaip",size:1},{id:"pōttu",size:2,type:"noun"},{id:"muḻu",size:1,type:"noun"},{id:"kaṭai",size:1,type:"noun"},{id:"niṟka",size:1},{id:"celvam",size:1,type:"noun"},{id:"vañci",size:1,type:"noun"},{id:"yōṅkiya",size:1},{id:"tañcam",size:1,type:"noun"},{id:"aruḷ",size:1,type:"noun"},{id:"kōḻi",size:1,type:"noun"},{id:"nīlac",size:1},{id:"cēval",size:1,type:"noun"},{id:"ukirp",size:1},{id:"pēṭai",size:3,type:"noun"},{id:"vayāam",size:1},{id:"puḷim",size:1},{id:"vēṭkaittu",size:1},{id:"taiic",size:1},{id:"viral",size:1,type:"noun"},{id:"yari",size:1},{id:"maḻaik",size:1},{id:"vāyk",size:1},{id:"vev",size:1},{id:"yaḻi",size:2},{id:"kalaṅkik",size:1},{id:"kaḻaṉit",size:2},{id:"tāmarai",size:3,type:"noun"},{id:"vūra",size:1},{id:"tērt",size:1},{id:"teṉ",size:1,type:"noun"},{id:"oḻukku",size:1,type:"verb"},{id:"tēṉūr",size:3},{id:"vūriṉ",size:1},{id:"pañcāyk",size:1},{id:"entiram",size:1},{id:"etir",size:1,type:"noun"},{id:"piḷiṟṟum",size:1},{id:"kō",size:1,type:"noun"},{id:"laṇi",size:1},{id:"tuṟattaliṉ",size:1},{id:"aṟiyap",size:1},{id:"pakal",size:3,type:"noun"},{id:"viḷakkōṭu",size:1},{id:"ira(m)",size:1,type:"noun"},{id:"pōrc",size:1},{id:"cōḻaṉ",size:1,type:"noun"},{id:"āmūr",size:1,type:"noun"},{id:"tēmpa",size:1},{id:"vevaṉ",size:1},{id:"katirt",size:1},{id:"vaṉai",size:1,type:"verb"},{id:"viṇṭu",size:1,type:"noun"},{id:"vaṉṉa",size:1},{id:"pōr",size:2,type:"verb"},{id:"virāaṉ",size:1,type:"noun"},{id:"iruppai",size:1,type:"noun"},{id:"maṉaiyai",size:1},{id:"vāṟṟu",size:1},{id:"maintu",size:1,type:"noun"},{id:"evvam",size:1,type:"noun"},{id:"yivaṭku",size:1},{id:"vēttu",size:1,type:"adjective"},{id:"taṇika",size:1},{id:"nantuka",size:1},{id:"tāmarait",size:1},{id:"varaika",size:1},{id:"entai",size:1,type:"noun"},{id:"koṭukka",size:1},{id:"paḻaṉak",size:1},{id:"kampuḷ",size:2,type:"noun"},{id:"payirp",size:1},{id:"yakavum",size:1},{id:"yūra",size:2},{id:"vaṭi",size:1,type:"noun"},{id:"viḷai",size:1,type:"noun"},{id:"poykait",size:2},{id:"tuṭumeṉ",size:1},{id:"viḻūum",size:1},{id:"matti",size:1,type:"noun"},{id:"kaḻāar",size:1,type:"noun"},{id:"yayara",size:1},{id:"intira",size:1},{id:"maṅkaiyart",size:1},{id:"toku",size:1,type:"verb"},{id:"yev",size:1},{id:"paḷḷip",size:1},{id:"nīrnāy",size:1,type:"noun"},{id:"vāḷai",size:1,type:"noun"},{id:"irai",size:1,type:"noun"},{id:"tolaivatu",size:1},{id:"tuṉṉu",size:1,type:"verb"},{id:"piṟart",size:1},{id:"āṭak",size:1},{id:"oruvar",size:1},{id:"ē",size:1,type:"noun"},{id:"pāttiyiṉ",size:1},{id:"kali",size:1,type:"noun"},{id:"vāmpal",size:1},{id:"kaḷai",size:1,type:"verb"},{id:"yīṉṟa",size:1},{id:"muyaṅkaṉmō",size:1},{id:"uṭaliṉēṉ",size:1},{id:"yiṉik",size:1},{id:"nikarā",size:1},{id:"veṉṉoṭu",size:1},{id:"nikarip",size:1},{id:"tarukkum",size:1},{id:"malart",size:1},{id:"yōti",size:1},{id:"kaṉṉi",size:1,type:"noun"},{id:"viṭiyal",size:1,type:"noun"},{id:"kaṇaik",size:1},{id:"pēṇāḷ",size:1},{id:"vaḻutu",size:1},{id:"yaṟam",size:1},{id:"vallatu",size:1},{id:"yuḷaip",size:1},{id:"marutattuk",size:1},{id:"kiḷaik",size:1},{id:"ṉūrk",size:1},{id:"paḻaṉap",size:2},{id:"ceṉṉic",size:1},{id:"cē",size:2,type:"noun"},{id:"tūyar",size:1},{id:"naṟiyar",size:1},{id:"pēy",size:1,type:"noun"},{id:"(i)yām",size:1},{id:"cūtu",size:1},{id:"toṭic",size:1},{id:"cūr",size:1,type:"noun"},{id:"nuṭakkattu",size:1},{id:"yāṭiṉai",size:1},{id:"ol(lu)",size:3,type:"verb"},{id:"putaittal",size:1},{id:"kayil",size:1},{id:"taḻait",size:1},{id:"tuyal",size:1,type:"verb"},{id:"kuvaḷai",size:2,type:"noun"},{id:"liyal",size:1},{id:"paṇṇai",size:2,type:"noun"},{id:"kaḷ",size:1,type:"verb"},{id:"nāṟit",size:1},{id:"tōkaic",size:1},{id:"cīr",size:1,type:"noun"},{id:"niḻaṟṟak",size:1},{id:"pāyvōḷ",size:1},{id:"ovvāy",size:1},{id:"vataṉāl",size:1},{id:"toṭakku",size:1,type:"verb"},{id:"tol",size:1,type:"adjective"},{id:"niṉṉōṭu",size:2},{id:"āṭiṉaḷ",size:1},{id:"paiñcāyk",size:1},{id:"malarc",size:1},{id:"āṭit",size:2},{id:"mēmpaṭṭaṉaḷ",size:1},{id:"antaram",size:1},{id:"makaḷirkkut",size:2},{id:"pēr",size:1,type:"noun"},{id:"alaik",size:1},{id:"kiḷḷi",size:1,type:"noun"},{id:"matil",size:1,type:"noun"},{id:"kataḻpu",size:1},{id:"āṭi",size:1,type:"noun"},{id:"yamartta",size:1},{id:"makaṉai",size:1},{id:"yaracu",size:1},{id:"muṟai",size:1,type:"noun"},{id:"ceyka",size:1},{id:"kaḷavu",size:1,type:"noun"},{id:"yalaṅku",size:1},{id:"cūḷ",size:1,type:"noun"},{id:"vāyppatu",size:1},{id:"pulakkuvēm",size:1},{id:"nalat",size:1},{id:"yākit",size:1},{id:"ḷakaṭṭu",size:1},{id:"yarip",size:1},{id:"paṟai",size:2,type:"noun"},{id:"nayantaṉeṉ",size:1},{id:"kēṭkiṉ",size:1},{id:"vekuṇṭaṉaḷ",size:1},{id:"aviḻ",size:2,type:"noun"},{id:"tārt",size:1},{id:"paṟa",size:1,type:"verb"},{id:"yaruḷāy",size:1},{id:"paipayat",size:1},{id:"taṇa",size:1,type:"verb"},{id:"yuymmō",size:1},{id:"cevi",size:1,type:"noun"},{id:"liṟantu",size:1},{id:"vekuḷvōḷ",size:1},{id:"yaim",size:1},{id:"taiit",size:1},{id:"kayam",size:1,type:"noun"},{id:"paṭintu",size:1},{id:"arik",size:1},{id:"paḻaṉattuk",size:1},{id:"ciṟuvariṉ",size:1},{id:"nakār",size:1},{id:"talaik",size:1},{id:"viḷik",size:1},{id:"yimiḻum",size:1},{id:"mivaṇ",size:1},{id:"alku",size:1,type:"verb"},{id:"pakaṉṟaik",size:1},{id:"kaṇṇip",size:1},{id:"lāṉ",size:1},{id:"kuṇil",size:1,type:"noun"},{id:"kaṉi",size:1,type:"noun"},{id:"yutirkkum",size:1},{id:"malarp",size:2},{id:"yevvai",size:1},{id:"yem",size:1},{id:"vevvaikku",size:1},{id:"virumpiṉṟu",size:1},{id:"yampal",size:1},{id:"kuṇam",size:2,type:"noun"},{id:"maruppu",size:1,type:"noun"},{id:"mayakkum",size:2},{id:"vetir",size:1,type:"noun"},{id:"erumaic",size:1},{id:"āk",size:1},{id:"kuḻavikku",size:1},{id:"ūṟṟu",size:1,type:"noun"},{id:"maṭukkum",size:1},{id:"nuntai",size:2,type:"noun"},{id:"niṉṉai",size:1},{id:"lēṟṟu",size:1},{id:"aruttu",size:1,type:"verb"},{id:"mōrōṭamōṭu",size:1},{id:"viṉaiya",size:1},{id:"veṟukkaiya",size:1},{id:"vāki",size:1},{id:"mucci",size:1,type:"noun"},{id:"vati",size:1,type:"noun"},{id:"ilañcip",size:1},{id:"paḻaṉattatu",size:1},{id:"yerumai",size:2},{id:"yāṭiya",size:1},{id:"āmpaloṭu",size:1},{id:"kalikkum",size:1},{id:"vūraṉ",size:1},{id:"pakaṉṟai",size:1,type:"noun"},{id:"miṭai",size:1,type:"noun"},{id:"kōṭṭaik",size:1},{id:"erumaik",size:1},{id:"kaṉṟu",size:1,type:"noun"},{id:"yampiyiṉ",size:1},{id:"pākal",size:1,type:"noun"},{id:"muyiṟu",size:1,type:"noun"},{id:"mūcu",size:1,type:"verb"},{id:"kuṭampai",size:1,type:"noun"}],Ib=[{id:"nī nī",source:"nī",target:"nī",strength:.08278647668899203,citations:["Aink309","Aink50"],curvature:.5},{id:"a- nī",source:"a-",target:"nī",strength:.09656718741973831,citations:["Aink44","Aink51"]},{id:"kaṇ nī",source:"kaṇ",target:"nī",strength:.110005349551798,citations:["Aink351","Aink361"]},{id:"nal nī",source:"nal",target:"nī",strength:.13210126859453558,citations:["Aink139","Aink309"],curvature:.25},{id:"kaṇ kaṇ",source:"kaṇ",target:"kaṇ",strength:.1372242224146039,citations:["Aink375","Aink84"],curvature:.5},{id:"a- ūr",source:"a-",target:"ūr",strength:.15334692965132216,citations:["Aink24","Aink41"]},{id:"maka a-",source:"maka",target:"a-",strength:.1668678201586185,citations:["Aink400","Aink94"]},{id:"aṉṉai kaṇ",source:"aṉṉai",target:"kaṇ",strength:.1803059822906782,citations:["Aink101","Aink206"]},{id:"kaṇ maka",source:"kaṇ",target:"maka",strength:.1803059822906782,citations:["Aink406","Aink79"]},{id:"varavu tōḻaṉ",source:"varavu",target:"tōḻaṉ",strength:.1844251392936576,citations:["Aink352","Aink357"]},{id:"varavu nī",source:"varavu",target:"nī",strength:.18543623118673058,citations:["Aink101","Aink323","Aink393"]},{id:"nī eṉ",source:"nī",target:"eṉ",strength:.18547638420031867,citations:["Aink208","Aink363"],curvature:.25},{id:"nal ākkam",source:"nal",target:"ākkam",strength:.18634308545289194,citations:["Aink117","Aink63"],curvature:.25},{id:"varavu maka",source:"varavu",target:"maka",strength:.19535577239895177,citations:["Aink101","Aink393"]},{id:"nī pal",source:"nī",target:"pal",strength:.19708060086718457,citations:["Aink55","Aink69"]},{id:"ākkam nī",source:"ākkam",target:"nī",strength:.1980519776681347,citations:["Aink359","Aink393","Aink79"]},{id:"eṉ a-",source:"eṉ",target:"a-",strength:.19925709493106497,citations:["Aink41","Aink89"]},{id:"ūr maka",source:"ūr",target:"maka",strength:.20986685165945612,citations:["Aink100","Aink99"]},{id:"tāṉ a-",source:"tāṉ",target:"a-",strength:.21086131159793087,citations:["Aink103","Aink404"],curvature:.25},{id:"ākkam peru(m)",source:"ākkam",target:"peru(m)",strength:.22248258000790685,citations:["Aink403","Aink63"]},{id:"tāṉ kaṇ",source:"tāṉ",target:"kaṇ",strength:.2242994737299905,citations:["Aink112","Aink202"]},{id:"ūr peru(m)",source:"ūr",target:"peru(m)",strength:.2250205053811344,citations:["Aink30","Aink48"]},{id:"kaṇ ākkam",source:"kaṇ",target:"ākkam",strength:.2267316724903676,citations:["Aink210","Aink330","Aink84"]},{id:"varavu curam",source:"varavu",target:"curam",strength:.2277450471713982,citations:["Aink331","Aink395"],curvature:.25},{id:"curam varavu",source:"curam",target:"varavu",strength:.2277450471713982,citations:["Aink354","Aink397"],curvature:.25},{id:"makiḻ nī",source:"makiḻ",target:"nī",strength:.22923172763796462,citations:["Aink69","Aink77"]},{id:"vāḻ nal",source:"vāḻ",target:"nal",strength:.2297564750577731,citations:["Aink117","Aink119","Aink120","Aink9"]},{id:"malar a-",source:"malar",target:"a-",strength:.23295723064066845,citations:["Aink18","Aink72"]},{id:"il nī",source:"il",target:"nī",strength:.23457819549549655,citations:["Aink136","Aink307"]},{id:"tuṟai varavu",source:"tuṟai",target:"varavu",strength:.2393492638382641,citations:["Aink105","Aink69"]},{id:"i- ākkam",source:"i-",target:"ākkam",strength:.23971820105867503,citations:["Aink117","Aink8"]},{id:"nī nal",source:"nī",target:"nal",strength:.2400816937274648,citations:["Aink139","Aink309","Aink355","Aink357"],curvature:.25},{id:"kaṇ e-",source:"kaṇ",target:"e-",strength:.24165433829541383,citations:["Aink84"]},{id:"cel ūr",source:"cel",target:"ūr",strength:.24225612643190253,citations:["Aink22","Aink27"]},{id:"ūr eṉ",source:"ūr",target:"eṉ",strength:.24225612643190253,citations:["Aink41","Aink89"]},{id:"vāḻ yūraṉ",source:"vāḻ",target:"yūraṉ",strength:.24270936697139364,citations:["Aink36","Aink39"]},{id:"makiḻ a-",source:"makiḻ",target:"a-",strength:.24301243836871092,citations:["Aink31","Aink90"]},{id:"tōḻaṉ i-",source:"tōḻaṉ",target:"i-",strength:.2448463838339047,citations:["Aink117","Aink118"]},{id:"a- neṭu(m)",source:"a-",target:"neṭu(m)",strength:.24835890622624282,citations:["Aink207","Aink209"]},{id:"kēḷ vāḻ",source:"kēḷ",target:"vāḻ",strength:.24915298619809523,citations:["Aink111","Aink59"]},{id:"nī vem",source:"nī",target:"vem",strength:.25213551463053563,citations:["Aink393","Aink71"]},{id:"ūr nal",source:"ūr",target:"nal",strength:.2526876018085743,citations:["Aink12","Aink22","Aink63"]},{id:"tuṟai ūr",source:"tuṟai",target:"ūr",strength:.2538603430987684,citations:["Aink11","Aink12"]},{id:"tōḻaṉ nal",source:"tōḻaṉ",target:"nal",strength:.2554168769029139,citations:["Aink117","Aink119","Aink120"]},{id:"varavu e-",source:"varavu",target:"e-",strength:.25670412840368745,citations:["Aink134","Aink221"]},{id:"varavu pū(m)",source:"varavu",target:"pū(m)",strength:.25670412840368745,citations:["Aink344","Aink362"]},{id:"ūr ūr",source:"ūr",target:"ūr",strength:.2605531919192698,citations:["Aink15"],curvature:.5},{id:"nī maka",source:"nī",target:"maka",strength:.26306917529544077,citations:["Aink101","Aink29","Aink393","Aink49"]},{id:"e- ākkam",source:"e-",target:"ākkam",strength:.26867728229096416,citations:["Aink366","Aink84"],curvature:.25},{id:"eṉ peru(m)",source:"eṉ",target:"peru(m)",strength:.27093067066087717,citations:["Aink398","Aink73"]},{id:"aṉṉai tōḻaṉ",source:"aṉṉai",target:"tōḻaṉ",strength:.277529016289497,citations:["Aink107","Aink205","Aink366"]},{id:"e- maka",source:"e-",target:"maka",strength:.28473609817148815,citations:["Aink204","Aink373"]},{id:"ākkam taṭpam",source:"ākkam",target:"taṭpam",strength:.28809254875619983,citations:["Aink28","Aink45","Aink54"]},{id:"varavu kāl",source:"varavu",target:"kāl",strength:.28827500918555055,citations:["Aink116","Aink349"]},{id:"iṉ nī",source:"iṉ",target:"nī",strength:.28827500918555055,citations:["Aink203","Aink46"]},{id:"ūr al",source:"ūr",target:"al",strength:.29135793772708046,citations:["Aink372","Aink77"]},{id:"varavu eṉ",source:"varavu",target:"eṉ",strength:.29363744964249594,citations:["Aink2","Aink397","Aink88"]},{id:"nal nal",source:"nal",target:"nal",strength:.29410015688841945,citations:["Aink120","Aink204","Aink365","Aink61"],curvature:.5},{id:"pū(m) a-",source:"pū(m)",target:"a-",strength:.2941338638687318,citations:["Aink209","Aink41","Aink62"]},{id:"a- nal",source:"a-",target:"nal",strength:.29493878425354886,citations:["Aink55","Aink56","Aink57","Aink61"]},{id:"vāḻ koṇkaṉ",source:"vāḻ",target:"koṇkaṉ",strength:.29682562356616676,citations:["Aink114","Aink139"]},{id:"eṉ nī",source:"eṉ",target:"nī",strength:.2985477564371115,citations:["Aink357","Aink363","Aink81","Aink82"],curvature:.25},{id:"ākkam nal",source:"ākkam",target:"nal",strength:.2994971241191927,citations:["Aink302","Aink308","Aink318","Aink330"],curvature:.25},{id:"tuṟai i-",source:"tuṟai",target:"i-",strength:.2997705083785112,citations:["Aink103","Aink28"]},{id:"eṉ tāṉ",source:"eṉ",target:"tāṉ",strength:.2997705083785112,citations:["Aink33","Aink41"]},{id:"e- peru(m)",source:"e-",target:"peru(m)",strength:.2998897518931664,citations:["Aink123","Aink89"]},{id:"pū(m) peru(m)",source:"pū(m)",target:"peru(m)",strength:.2998897518931664,citations:["Aink19","Aink33"]},{id:"nal eṉ",source:"nal",target:"eṉ",strength:.3010617404475231,citations:["Aink204","Aink67"]},{id:"a- uṟu",source:"a-",target:"uṟu",strength:.30205571991629676,citations:["Aink210","Aink360"]},{id:"aṉṉai nām",source:"aṉṉai",target:"nām",strength:.30487882823437673,citations:["Aink203","Aink210"]},{id:"ūr ākkam",source:"ūr",target:"ākkam",strength:.3076740854041137,citations:["Aink15","Aink19","Aink24"]},{id:"ūr vem",source:"ūr",target:"vem",strength:.3089152568621195,citations:["Aink63","Aink86"]},{id:"tuṟai tāṉ",source:"tuṟai",target:"tāṉ",strength:.3113747250453771,citations:["Aink10","Aink7"]},{id:"tōḻaṉ yūraṉ",source:"tōḻaṉ",target:"yūraṉ",strength:.31150551426412165,citations:["Aink36","Aink39"]},{id:"pāṇ nī",source:"pāṇ",target:"nī",strength:.31287882257710137,citations:["Aink136","Aink140","Aink82"],curvature:.25},{id:"malar kaṇ",source:"malar",target:"kaṇ",strength:.31328874905049703,citations:["Aink19","Aink208","Aink315"]},{id:"koḷ peru(m)",source:"koḷ",target:"peru(m)",strength:.31468601409852315,citations:["Aink368","Aink400"]},{id:"varavu puṉal",source:"varavu",target:"puṉal",strength:.3148202984867848,citations:["Aink69","Aink72"]},{id:"ce(m) kaṇ",source:"ce(m)",target:"kaṇ",strength:.3241609758376486,citations:["Aink346","Aink92"]},{id:"vēṇṭu eṉ",source:"vēṇṭu",target:"eṉ",strength:.3267934523740616,citations:["Aink209","Aink88"]},{id:"nī paca",source:"nī",target:"paca",strength:.3272376120586454,citations:["Aink29","Aink45"]},{id:"nī neñcam",source:"nī",target:"neñcam",strength:.3272376120586454,citations:["Aink50"]},{id:"puṉal ūr",source:"puṉal",target:"ūr",strength:.3293313777472891,citations:["Aink65","Aink95"]},{id:"piri nal",source:"piri",target:"nal",strength:.32948227630387994,citations:["Aink308","Aink57"]},{id:"neṭu(m) kaṇ",source:"neṭu(m)",target:"kaṇ",strength:.3295170241069893,citations:["Aink208","Aink30","Aink315"]},{id:"em a-",source:"em",target:"a-",strength:.33008768968409746,citations:["Aink82","Aink90"]},{id:"koḷ cel",source:"koḷ",target:"cel",strength:.3319216351492913,citations:["Aink10","Aink7"]},{id:"ākkam e-",source:"ākkam",target:"e-",strength:.3367664953431789,citations:["Aink108","Aink17","Aink210"],curvature:.25},{id:"curam nām",source:"curam",target:"nām",strength:.3372681030068232,citations:["Aink314","Aink329"]},{id:"nī yāṅkaṇ",source:"nī",target:"yāṅkaṇ",strength:.3392107659459222,citations:["Aink79","Aink87"]},{id:"amma pāṇ",source:"amma",target:"pāṇ",strength:.3415158404030719,citations:["Aink132","Aink89"]},{id:"vāḻ kātal",source:"vāḻ",target:"kātal",strength:.34302032584922415,citations:["Aink221","Aink340"]},{id:"tāṉ koḷ",source:"tāṉ",target:"koḷ",strength:.3435258518161572,citations:["Aink10","Aink7"]},{id:"makiḻ tāṉ",source:"makiḻ",target:"tāṉ",strength:.3435258518161572,citations:["Aink38","Aink66"]},{id:"peru(m) tuṟai",source:"peru(m)",target:"tuṟai",strength:.351367830432441,citations:["Aink31","Aink69","Aink75"]},{id:"ūr nī",source:"ūr",target:"nī",strength:.3524016193644835,citations:["Aink42","Aink43","Aink49","Aink54","Aink68","Aink85","Aink87"]},{id:"yaṉṉa nī",source:"yaṉṉa",target:"nī",strength:.35244647350836616,citations:["Aink307","Aink42"]},{id:"cel nal",source:"cel",target:"nal",strength:.35256621959806617,citations:["Aink22","Aink302","Aink307","Aink385"]},{id:"a- no/nō",source:"a-",target:"no/nō",strength:.35299147667666847,citations:["Aink210","Aink378"]},{id:"vāḻ vāḻ",source:"vāḻ",target:"vāḻ",strength:.35387389279408865,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.5},{id:"kaṇ paca",source:"kaṇ",target:"paca",strength:.3544564849214513,citations:["Aink36","Aink37"]},{id:"vāḻ pāṇ",source:"vāḻ",target:"pāṇ",strength:.35452587996661733,citations:["Aink1","Aink111","Aink132","Aink89"]},{id:"nal mā",source:"nal",target:"mā",strength:.35556656313085233,citations:["Aink221","Aink357"]},{id:"cel eṉ",source:"cel",target:"eṉ",strength:.3573014691971673,citations:["Aink221","Aink357","Aink389"]},{id:"ākkam toṭi",source:"ākkam",target:"toṭi",strength:.36049358808366505,citations:["Aink330","Aink389"]},{id:"ūr i-",source:"ūr",target:"i-",strength:.3607431808829871,citations:["Aink100","Aink30","Aink8","Aink99"]},{id:"kēḷ eṉ",source:"kēḷ",target:"eṉ",strength:.3612690413685639,citations:["Aink113","Aink315"]},{id:"ūr toṭi",source:"ūr",target:"toṭi",strength:.3630315134568926,citations:["Aink28","Aink98"]},{id:"nī pāṇ",source:"nī",target:"pāṇ",strength:.36485109863630905,citations:["Aink139","Aink43","Aink47","Aink49"],curvature:.25},{id:"nāḷ a-",source:"nāḷ",target:"a-",strength:.3662271842391124,citations:["Aink109","Aink95"]},{id:"yūraṉ tāṉ",source:"yūraṉ",target:"tāṉ",strength:.36642963880872814,citations:["Aink10","Aink7"]},{id:"nī mulai",source:"nī",target:"mulai",strength:.36724273571372285,citations:["Aink361","Aink363"]},{id:"aṟi nī",source:"aṟi",target:"nī",strength:.36724273571372285,citations:["Aink47","Aink79"]},{id:"malar neṭu(m)",source:"malar",target:"neṭu(m)",strength:.3709682387164267,citations:["Aink208","Aink315"]},{id:"ūr pāṇ",source:"ūr",target:"pāṇ",strength:.37270590239391793,citations:["Aink1","Aink43","Aink49"]},{id:"ūr maṉai",source:"ūr",target:"maṉai",strength:.3730867211849351,citations:["Aink3","Aink87"]},{id:"malar taṭpam",source:"malar",target:"taṭpam",strength:.3746496253163292,citations:["Aink108","Aink328","Aink69"]},{id:"vēṇṭu nām",source:"vēṇṭu",target:"nām",strength:.3758952636692394,citations:["Aink203","Aink210"]},{id:"kaṇ toṟum",source:"kaṇ",target:"toṟum",strength:.37966534637117205,citations:["Aink375"]},{id:"nī maṉai",source:"nī",target:"maṉai",strength:.3869524516698055,citations:["Aink66","Aink81","Aink87"]},{id:"pū(m) veḷ",source:"pū(m)",target:"veḷ",strength:.39022812260085304,citations:["Aink19","Aink209"],curvature:.25},{id:"aru(m) cel",source:"aru(m)",target:"cel",strength:.39096491669687716,citations:["Aink301","Aink351"]},{id:"iṉ curam",source:"iṉ",target:"curam",strength:.39096491669687716,citations:["Aink326","Aink395"]},{id:"curam aṇi",source:"curam",target:"aṇi",strength:.39096491669687716,citations:["Aink357","Aink397"]},{id:"yūraṉ maka",source:"yūraṉ",target:"maka",strength:.3934105691889555,citations:["Aink91","Aink96","Aink97"]},{id:"vēṉal ākkam",source:"vēṉal",target:"ākkam",strength:.39345258280427853,citations:["Aink45","Aink54"]},{id:"pōl kaṇ",source:"pōl",target:"kaṇ",strength:.3944616085765289,citations:["Aink101","Aink16"]},{id:"varavu oṇmai",source:"varavu",target:"oṇmai",strength:.39471513647944567,citations:["Aink350","Aink92"]},{id:"peṇ ūr",source:"peṇ",target:"ūr",strength:.3959905081775061,citations:["Aink13","Aink40"]},{id:"il pāṇ",source:"il",target:"pāṇ",strength:.39779806502097553,citations:["Aink136","Aink138"]},{id:"yaṉṉa ākkam",source:"yaṉṉa",target:"ākkam",strength:.4066882903667225,citations:["Aink221","Aink389"]},{id:"am i-",source:"am",target:"i-",strength:.4089416787366354,citations:["Aink103","Aink302"]},{id:"yāṅkaṇ maka",source:"yāṅkaṇ",target:"maka",strength:.4095113986848024,citations:["Aink79"]},{id:"nī naya",source:"nī",target:"naya",strength:.41108547233275766,citations:["Aink309","Aink370","Aink46"]},{id:"nī peṇ",source:"nī",target:"peṇ",strength:.41108547233275766,citations:["Aink68","Aink69","Aink70"]},{id:"kaṇ paṉi",source:"kaṇ",target:"paṉi",strength:.4112362271530352,citations:["Aink208","Aink37"]},{id:"tōḻaṉ kātal",source:"tōḻaṉ",target:"kātal",strength:.41181647314195213,citations:["Aink221","Aink340"]},{id:"peru(m) ciṉai",source:"peru(m)",target:"ciṉai",strength:.4126918985192039,citations:["Aink145","Aink19"]},{id:"poḻutu a-",source:"poḻutu",target:"a-",strength:.41716294099948403,citations:["Aink406","Aink82"]},{id:"kaḻi curam",source:"kaḻi",target:"curam",strength:.41899688646467786,citations:["Aink354","Aink397"]},{id:"curam naṉi",source:"curam",target:"naṉi",strength:.41899688646467786,citations:["Aink371","Aink398"]},{id:"aṟi ākkam",source:"aṟi",target:"ākkam",strength:.42148455257207923,citations:["Aink26","Aink366"],curvature:.25},{id:"ākkam aṟi",source:"ākkam",target:"aṟi",strength:.42148455257207923,citations:["Aink79","Aink90"],curvature:.25},{id:"kaḻaṉi maka",source:"kaḻaṉi",target:"maka",strength:.4227471062472464,citations:["Aink91","Aink96"]},{id:"malar aṇi",source:"malar",target:"aṇi",strength:.4246650524064806,citations:["Aink367","Aink81"]},{id:"nī moḻi",source:"nī",target:"moḻi",strength:.42628601726130877,citations:["Aink60","Aink77"]},{id:"a- varavu",source:"a-",target:"varavu",strength:.42743899574961164,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"]},{id:"yūraṉ i-",source:"yūraṉ",target:"i-",strength:.42753815855201666,citations:["Aink91","Aink96","Aink97"]},{id:"yūraṉ kēḷ",source:"yūraṉ",target:"kēḷ",strength:.42792817179878084,citations:["Aink2","Aink9"]},{id:"malar nil",source:"malar",target:"nil",strength:.4333321461957728,citations:["Aink338","Aink75"]},{id:"nal cuṭar",source:"nal",target:"cuṭar",strength:.4333321461957728,citations:["Aink375","Aink56"]},{id:"yāy pū(m)",source:"yāy",target:"pū(m)",strength:.43790075996892464,citations:["Aink10","Aink4"]},{id:"kaḷvaṉ taṭpam",source:"kaḷvaṉ",target:"taṭpam",strength:.43790075996892464,citations:["Aink27","Aink30"]},{id:"a- maṇi",source:"a-",target:"maṇi",strength:.43955184695980054,citations:["Aink207","Aink208","Aink209"]},{id:"tōṟṟam ūr",source:"tōṟṟam",target:"ūr",strength:.44079709652181315,citations:["Aink17","Aink98"]},{id:"ūr māṇ",source:"ūr",target:"māṇ",strength:.44079709652181315,citations:["Aink42","Aink47"]},{id:"pāṇ maka",source:"pāṇ",target:"maka",strength:.4418570433652397,citations:["Aink47","Aink48","Aink49"]},{id:"peṇ eṉ",source:"peṇ",target:"eṉ",strength:.4419006734572488,citations:["Aink113","Aink89"]},{id:"i- no/nō",source:"i-",target:"no/nō",strength:.4419006734572488,citations:["Aink28","Aink99"]},{id:"tuṟai kēḷ",source:"tuṟai",target:"kēḷ",strength:.44655461188710516,citations:["Aink111","Aink2","Aink9"]},{id:"maṉ curam",source:"maṉ",target:"curam",strength:.4490500014336737,citations:["Aink326","Aink390","Aink394"]},{id:"nutal maka",source:"nutal",target:"maka",strength:.4504312155574747,citations:["Aink371","Aink394","Aink404"]},{id:"peru(m) kaṭal",source:"peru(m)",target:"kaṭal",strength:.45269702217428137,citations:["Aink102","Aink123"]},{id:"kaḻi malar",source:"kaḻi",target:"malar",strength:.45269702217428137,citations:["Aink108","Aink368"]},{id:"makiḻ toṭi",source:"makiḻ",target:"toṭi",strength:.45269702217428137,citations:["Aink24","Aink40"]},{id:"yaviṉi pal",source:"yaviṉi",target:"pal",strength:.4535048901241147,citations:["Aink1","Aink3"]},{id:"kaṇ ēr",source:"kaṇ",target:"ēr",strength:.4535048901241147,citations:["Aink101","Aink72"]},{id:"tuṟai peṇ",source:"tuṟai",target:"peṇ",strength:.4535048901241147,citations:["Aink113","Aink13"]},{id:"kaṇ civa",source:"kaṇ",target:"civa",strength:.4535048901241147,citations:["Aink125","Aink69"]},{id:"nī mārpu",source:"nī",target:"mārpu",strength:.45383024610844885,citations:["Aink42","Aink44","Aink46","Aink51"]},{id:"vāḻ nām",source:"vāḻ",target:"nām",strength:.4539722097334999,citations:["Aink111","Aink116","Aink335","Aink336","Aink337","Aink34","Aink35"]},{id:"iṟa cel",source:"iṟa",target:"cel",strength:.4551363810196928,citations:["Aink309","Aink317"]},{id:"yām pū(m)",source:"yām",target:"pū(m)",strength:.45805145777129547,citations:["Aink10","Aink4","Aink7"]},{id:"keḻu ūr",source:"keḻu",target:"ūr",strength:.4582968056681701,citations:["Aink11","Aink12","Aink85"]},{id:"paca e-",source:"paca",target:"e-",strength:.45888660080226124,citations:["Aink144","Aink35"]},{id:"naṟu(m) pū(m)",source:"naṟu(m)",target:"pū(m)",strength:.45888660080226124,citations:["Aink344","Aink404"]},{id:"ūr koṭu(m)",source:"ūr",target:"koṭu(m)",strength:.46016197250032165,citations:["Aink11","Aink12"]},{id:"peṟu ūr",source:"peṟu",target:"ūr",strength:.46016197250032165,citations:["Aink49","Aink63"]},{id:"koḷ kaḻi",source:"koḷ",target:"kaḻi",strength:.46275222990232384,citations:["Aink354","Aink397"]},{id:"nal naya",source:"nal",target:"naya",strength:.4630469620388788,citations:["Aink309","Aink385","Aink55"]},{id:"varavu varavu",source:"varavu",target:"varavu",strength:.463146348940986,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"],curvature:.5},{id:"malar mārpu",source:"malar",target:"mārpu",strength:.46362765527957556,citations:["Aink205","Aink51"]},{id:"veḷ pū(m)",source:"veḷ",target:"pū(m)",strength:.46484090250341004,citations:["Aink17","Aink19","Aink41"],curvature:.25},{id:"pal veṉa",source:"pal",target:"veṉa",strength:.4667405976865586,citations:["Aink3","Aink6"]},{id:"maṉai neṭu(m)",source:"maṉai",target:"neṭu(m)",strength:.46809869775985574,citations:["Aink324","Aink60"]},{id:"no/nō ākkam",source:"no/nō",target:"ākkam",strength:.46823841771525576,citations:["Aink101","Aink28","Aink99"]},{id:"varavu eṉap",source:"varavu",target:"eṉap",strength:.4685546802323883,citations:["Aink105","Aink72"]},{id:"āṭu taṭpam",source:"āṭu",target:"taṭpam",strength:.46947164075078773,citations:["Aink115","Aink84"],curvature:.25},{id:"mel kāl",source:"mel",target:"kāl",strength:.46947164075078773,citations:["Aink26","Aink35"]},{id:"taṭpam āṭu",source:"taṭpam",target:"āṭu",strength:.46947164075078773,citations:["Aink77","Aink98"],curvature:.25},{id:"toṭi yām",source:"toṭi",target:"yām",strength:.4756008091668523,citations:["Aink38","Aink40"]},{id:"nal nāṭu",source:"nal",target:"nāṭu",strength:.4769930227578707,citations:["Aink392","Aink61"]},{id:"vāḻ makiḻ",source:"vāḻ",target:"makiḻ",strength:.47703132818335175,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40","Aink59","Aink77"]},{id:"ciṟu(m) kaṇ",source:"ciṟu(m)",target:"kaṇ",strength:.4774517189093792,citations:["Aink309","Aink314","Aink327","Aink355","Aink362"]},{id:"vāḻ ciṟi",source:"vāḻ",target:"ciṟi",strength:.4810313339249824,citations:["Aink334","Aink339"]},{id:"yāṇar nī",source:"yāṇar",target:"nī",strength:.4814435422602323,citations:["Aink42","Aink43","Aink49","Aink87"]},{id:"eṉac kaṇ",source:"eṉac",target:"kaṇ",strength:.4815368598919154,citations:["Aink346","Aink366"]},{id:"tuñcu ūr",source:"tuñcu",target:"ūr",strength:.48306575949289265,citations:["Aink13","Aink43"]},{id:"ūr el",source:"ūr",target:"el",strength:.48306575949289265,citations:["Aink27","Aink396"]},{id:"moḻi ūr",source:"moḻi",target:"ūr",strength:.48306575949289265,citations:["Aink384","Aink77"]},{id:"piri val",source:"piri",target:"val",strength:.4856560168948948,citations:["Aink310","Aink338"]},{id:"em vem",source:"em",target:"vem",strength:.4856560168948948,citations:["Aink325","Aink78"]},{id:"piri aru(m)",source:"piri",target:"aru(m)",strength:.4856560168948948,citations:["Aink338"]},{id:"yāṉ i-",source:"yāṉ",target:"i-",strength:.4867072618015559,citations:["Aink118","Aink59"]},{id:"maṇa taṭpam",source:"maṇa",target:"taṭpam",strength:.4888365167292963,citations:["Aink19","Aink348"]},{id:"yarivai nī",source:"yarivai",target:"nī",strength:.4904574815841244,citations:["Aink354","Aink355"]},{id:"curam cel",source:"curam",target:"cel",strength:.4944115339988695,citations:["Aink301","Aink307","Aink309","Aink317","Aink331","Aink351"]},{id:"tōḻaṉ makiḻ",source:"tōḻaṉ",target:"makiḻ",strength:.4949166861110019,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40"]},{id:"em cel",source:"em",target:"cel",strength:.4951536701255709,citations:["Aink303","Aink77"]},{id:"curam iṭai",source:"curam",target:"iṭai",strength:.4951536701255709,citations:["Aink356","Aink387","Aink396"]},{id:"maka paḻaṉa(m)",source:"maka",target:"paḻaṉa(m)",strength:.49658665000018903,citations:["Aink91","Aink96"]},{id:"tāṉ amai",source:"tāṉ",target:"amai",strength:.4983114784684218,citations:["Aink103"]},{id:"uṭai tuṟai",source:"uṭai",target:"tuṟai",strength:.4983114784684218,citations:["Aink113","Aink20"]},{id:"maṇal tuṟai",source:"maṇal",target:"tuṟai",strength:.4983114784684218,citations:["Aink113","Aink361"]},{id:"peyar pal",source:"peyar",target:"pal",strength:.4983114784684218,citations:["Aink321","Aink355"]},{id:"nal miku",source:"nal",target:"miku",strength:.5036327789346531,citations:["Aink120","Aink64"],curvature:.25},{id:"maṇi neṭu(m)",source:"maṇi",target:"neṭu(m)",strength:.5042381923148707,citations:["Aink207","Aink209"]},{id:"maḷḷar a-",source:"maḷḷar",target:"a-",strength:.5042381923148707,citations:["Aink400","Aink94"]},{id:"il veṉa",source:"il",target:"veṉa",strength:.5042381923148707,citations:["Aink8","Aink9"]},{id:"puṉal em",source:"puṉal",target:"em",strength:.5060721377800644,citations:["Aink77","Aink78"]},{id:"vivaḷ nal",source:"vivaḷ",target:"nal",strength:.5102582953742912,citations:["Aink55","Aink56","Aink57"]},{id:"namm ūr",source:"namm",target:"ūr",strength:.5110977292606933,citations:["Aink102","Aink396"]},{id:"miṉ taṭpam",source:"miṉ",target:"taṭpam",strength:.5117403037218672,citations:["Aink10","Aink5"]},{id:"peru(m) ciṟa",source:"peru(m)",target:"ciṟa",strength:.5150721041398146,citations:["Aink1","Aink403","Aink9"]},{id:"e- kol",source:"e-",target:"kol",strength:.5156663430338451,citations:["Aink108","Aink372"]},{id:"e- taṭa(m)",source:"e-",target:"taṭa(m)",strength:.5156663430338451,citations:["Aink11"]},{id:"tāṉ col",source:"tāṉ",target:"col",strength:.5176763544469304,citations:["Aink38","Aink41"]},{id:"tuṟai keḻu",source:"tuṟai",target:"keḻu",strength:.5188979529100929,citations:["Aink11","Aink12","Aink140"]},{id:"viri malar",source:"viri",target:"malar",strength:.5204073975111594,citations:["Aink361","Aink367"]},{id:"maka i-",source:"maka",target:"i-",strength:.5205882196932026,citations:["Aink100","Aink52","Aink79","Aink91","Aink96","Aink97","Aink98","Aink99"]},{id:"tōḻaṉ vayiṉ",source:"tōḻaṉ",target:"vayiṉ",strength:.5208531605793263,citations:["Aink335","Aink336","Aink337"]},{id:"em tōḷ",source:"em",target:"tōḷ",strength:.5217955114499097,citations:["Aink108","Aink109"]},{id:"vem iṟa",source:"vem",target:"iṟa",strength:.5217955114499097,citations:["Aink309","Aink394"]},{id:"tōḷ iḻai",source:"tōḷ",target:"iḻai",strength:.5217955114499097,citations:["Aink310","Aink318"]},{id:"vem kātal",source:"vem",target:"kātal",strength:.5217955114499097,citations:["Aink325","Aink71"]},{id:"muṉ yām",source:"muṉ",target:"yām",strength:.5217955114499097,citations:["Aink38","Aink40"]},{id:"al nī",source:"al",target:"nī",strength:.5221913210740784,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128","Aink69"]},{id:"nī kēḷ",source:"nī",target:"kēḷ",strength:.5239812312854655,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"kaṇ al",source:"kaṇ",target:"al",strength:.5278777457367259,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"poṉ cey",source:"poṉ",target:"cey",strength:.5282391306766113,citations:["Aink316","Aink41"]},{id:"veḷ nel",source:"veḷ",target:"nel",strength:.5282391306766113,citations:["Aink48","Aink58"]},{id:"nekiḻ cel",source:"nekiḻ",target:"cel",strength:.5289759247726354,citations:["Aink25","Aink315"]},{id:"vāyiṉa curam",source:"vāyiṉa",target:"curam",strength:.5289759247726354,citations:["Aink322","Aink359"]},{id:"vāyiṉa i-",source:"vāyiṉa",target:"i-",strength:.5289759247726354,citations:["Aink322","Aink359"]},{id:"i- paḻaṉa(m)",source:"i-",target:"paḻaṉa(m)",strength:.5289759247726354,citations:["Aink91","Aink96"]},{id:"toṭi maṭa(m)",source:"toṭi",target:"maṭa(m)",strength:.5297170657616255,citations:["Aink76","Aink98"]},{id:"puṇar tuṇai",source:"puṇar",target:"tuṇai",strength:.5304626052392019,citations:["Aink15","Aink72"]},{id:"iḻai nil",source:"iḻai",target:"nil",strength:.5304626052392019,citations:["Aink210","Aink310"]},{id:"kāl vari",source:"kāl",target:"vari",strength:.5304626052392019,citations:["Aink381","Aink388"]},{id:"taṭpam kaṭal",source:"taṭpam",target:"kaṭal",strength:.530662473612433,citations:["Aink106","Aink107","Aink108"]},{id:"nōkkam nal",source:"nōkkam",target:"nal",strength:.530662473612433,citations:["Aink204","Aink375"]},{id:"nal maṇa",source:"nal",target:"maṇa",strength:.530662473612433,citations:["Aink22","Aink379","Aink399"]},{id:"vem curam",source:"vem",target:"curam",strength:.5310616770997824,citations:["Aink309","Aink330","Aink352","Aink373","Aink394"]},{id:"a- vivaḷ",source:"a-",target:"vivaḷ",strength:.5311207928528515,citations:["Aink54","Aink55","Aink56","Aink57"]},{id:"nīttam varavu",source:"nīttam",target:"varavu",strength:.532726144555204,citations:["Aink323","Aink330"]},{id:"ari varavu",source:"ari",target:"varavu",strength:.532726144555204,citations:["Aink352","Aink354"]},{id:"uṟu neñcam",source:"uṟu",target:"neñcam",strength:.532726144555204,citations:["Aink360","Aink59"]},{id:"taṭpam puṉal",source:"taṭpam",target:"puṉal",strength:.5346558976767597,citations:["Aink54","Aink69","Aink76","Aink77","Aink98"]},{id:"tōḻaṉ nām",source:"tōḻaṉ",target:"nām",strength:.5356173300081714,citations:["Aink116","Aink335","Aink336","Aink337","Aink34","Aink35","Aink36"]},{id:"aṟam il",source:"aṟam",target:"il",strength:.5358090730967339,citations:["Aink118","Aink332"]},{id:"aṟu yūraṉ",source:"aṟu",target:"yūraṉ",strength:.5365917736552666,citations:["Aink25","Aink29"]},{id:"kamaḻ taṭpam",source:"kamaḻ",target:"taṭpam",strength:.5397722734896679,citations:["Aink19","Aink348"]},{id:"taṭpam poḻil",source:"taṭpam",target:"poḻil",strength:.5397722734896679,citations:["Aink19","Aink348"]},{id:"pōlap pal",source:"pōlap",target:"pal",strength:.5405801414395014,citations:["Aink365","Aink84"]},{id:"yeṉ tōḻaṉ",source:"yeṉ",target:"tōḻaṉ",strength:.5412573388174681,citations:["Aink107","Aink205","Aink366"]},{id:"katam nī",source:"katam",target:"nī",strength:.541393238344496,citations:["Aink361"]},{id:"yūra nī",source:"yūra",target:"nī",strength:.541393238344496,citations:["Aink60","Aink81"]},{id:"pōl uṇ",source:"pōl",target:"uṇ",strength:.543035392881968,citations:["Aink101","Aink16"]},{id:"kaṇ yāṉai",source:"kaṇ",target:"yāṉai",strength:.5441753751017826,citations:["Aink314","Aink327","Aink355","Aink362","Aink386"]},{id:"nīr iṉ",source:"nīr",target:"iṉ",strength:.5446992984424807,citations:["Aink203","Aink397"]},{id:"uṟu no/nō",source:"uṟu",target:"no/nō",strength:.5446992984424807,citations:["Aink210","Aink53"]},{id:"karu(m) kāl",source:"karu(m)",target:"kāl",strength:.5472372238157083,citations:["Aink331","Aink388"]},{id:"tōḻaṉ ciṟi",source:"tōḻaṉ",target:"ciṟi",strength:.5498274812177104,citations:["Aink334","Aink339"]},{id:"vel pāvai",source:"vel",target:"pāvai",strength:.5498274812177104,citations:["Aink375"]},{id:"aṉṉai yeṉ",source:"aṉṉai",target:"yeṉ",strength:.5527746129990161,citations:["Aink107","Aink205","Aink366"]},{id:"varavu tāṉ",source:"varavu",target:"tāṉ",strength:.5534244623131649,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"],curvature:.25},{id:"al poy",source:"al",target:"poy",strength:.5551739490752423,citations:["Aink66","Aink80"]},{id:"uṇ kaṇ",source:"uṇ",target:"kaṇ",strength:.5569398671501269,citations:["Aink101","Aink16","Aink21","Aink334","Aink351","Aink37","Aink378","Aink406"]},{id:"i- iv",source:"i-",target:"iv",strength:.5570078945404362,citations:["Aink205","Aink208"]},{id:"cel ai",source:"cel",target:"ai",strength:.5570078945404362,citations:["Aink332","Aink389"]},{id:"i- maruntu",source:"i-",target:"maruntu",strength:.5570078945404362,citations:["Aink59","Aink99"]},{id:"iṉ maṉ",source:"iṉ",target:"maṉ",strength:.5573657721704671,citations:["Aink326","Aink337","Aink356"]},{id:"aru(m) iṟa",source:"aru(m)",target:"iṟa",strength:.5579350060049245,citations:["Aink317","Aink385"]},{id:"veḷ maṇal",source:"veḷ",target:"maṇal",strength:.5598100114584744,citations:["Aink105","Aink113"]},{id:"aṉṉai ūrp",source:"aṉṉai",target:"ūrp",strength:.5607581143230046,citations:["Aink104","Aink202"]},{id:"a- tāṉ",source:"a-",target:"tāṉ",strength:.5625756108628924,citations:["Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350","Aink41","Aink66"],curvature:.25},{id:"eṉ niṉai",source:"eṉ",target:"niṉai",strength:.5664980241239355,citations:["Aink311","Aink363"]},{id:"kāl āmpal",source:"kāl",target:"āmpal",strength:.5666020997942167,citations:["Aink34","Aink68"]},{id:"kātal puṇar",source:"kātal",target:"puṇar",strength:.5666020997942167,citations:["Aink386","Aink400"]},{id:"maṟa vēṇṭu",source:"maṟa",target:"vēṇṭu",strength:.5676030854350517,citations:["Aink209"]},{id:"yuvak kaṇ",source:"yuvak",target:"kaṇ",strength:.568612111207302,citations:["Aink206","Aink207"]},{id:"itaḻ kaṇ",source:"itaḻ",target:"kaṇ",strength:.568612111207302,citations:["Aink334","Aink351"]},{id:"val kāḷai",source:"val",target:"kāḷai",strength:.5727312682102814,citations:["Aink390","Aink399"]},{id:"maṉai yāṅkaṇ",source:"maṉai",target:"yāṅkaṇ",strength:.5727312682102814,citations:["Aink48","Aink87"]},{id:"maṉ yāṉ",source:"maṉ",target:"yāṉ",strength:.5737825131169425,citations:["Aink326","Aink380"]},{id:"aṟam maṉ",source:"aṟam",target:"maṉ",strength:.5737825131169425,citations:["Aink332","Aink394"]},{id:"taṇṇ peru(m)",source:"taṇṇ",target:"peru(m)",strength:.5759117680446829,citations:["Aink123","Aink73"]},{id:"taṭpam maṇ",source:"taṭpam",target:"maṇ",strength:.5759117680446829,citations:["Aink27","Aink30"]},{id:"tāṉ varavu",source:"tāṉ",target:"varavu",strength:.57709249476548,citations:["Aink134","Aink341","Aink342","Aink343","Aink344","Aink345","Aink346","Aink347","Aink348","Aink349","Aink350"],curvature:.25},{id:"pari neṭu(m)",source:"pari",target:"neṭu(m)",strength:.5780777360678132,citations:["Aink134","Aink95"]},{id:"pūk ūr",source:"pūk",target:"ūr",strength:.5782210950002001,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"kēḷ talaimakaḷ",source:"kēḷ",target:"talaimakaḷ",strength:.579174887436983,citations:["Aink201","Aink221"]},{id:"uṇ nīḷ",source:"uṇ",target:"nīḷ",strength:.579174887436983,citations:["Aink324","Aink360"]},{id:"pall uṇ",source:"pall",target:"uṇ",strength:.579174887436983,citations:["Aink334","Aink351"]},{id:"cey poruḷ",source:"cey",target:"poruḷ",strength:.579174887436983,citations:["Aink355","Aink357"]},{id:"vēḻam pū(m)",source:"vēḻam",target:"pū(m)",strength:.5793364201994121,citations:["Aink12","Aink17","Aink19"]},{id:"aṭu puṇar",source:"aṭu",target:"puṇar",strength:.5813983619995735,citations:["Aink15","Aink72"]},{id:"vayiṉ piri",source:"vayiṉ",target:"piri",strength:.5813983619995735,citations:["Aink308","Aink336"]},{id:"miku nal",source:"miku",target:"nal",strength:.5843319244669954,citations:["Aink120","Aink365"],curvature:.25},{id:"neṭu(m) kuṉṟam",source:"neṭu(m)",target:"kuṉṟam",strength:.5849698300508693,citations:["Aink207","Aink209","Aink371"]},{id:"tēṉūr a-",source:"tēṉūr",target:"a-",strength:.5849698300508693,citations:["Aink54","Aink55","Aink57"]},{id:"naṉi ciṟa",source:"naṉi",target:"ciṟa",strength:.5859669757727253,citations:["Aink10","Aink7"]},{id:"aṇi kāṉ",source:"aṇi",target:"kāṉ",strength:.5895058867867877,citations:["Aink357","Aink367"]},{id:"maruntu ākkam",source:"maruntu",target:"ākkam",strength:.5895233801433725,citations:["Aink101","Aink59","Aink99"]},{id:"am vari",source:"am",target:"vari",strength:.5907080302500396,citations:["Aink306","Aink316"]},{id:"ayar nal",source:"ayar",target:"nal",strength:.5907080302500396,citations:["Aink307","Aink309"]},{id:"mel tōḷ",source:"mel",target:"tōḷ",strength:.5928745756573292,citations:["Aink120","Aink28","Aink310"]},{id:"i- vāṟu",source:"i-",target:"vāṟu",strength:.5931473890954511,citations:["Aink205","Aink208"]},{id:"oḻi cel",source:"oḻi",target:"cel",strength:.5931473890954511,citations:["Aink321","Aink330"]},{id:"kaṇṭaṉem curam",source:"kaṇṭaṉem",target:"curam",strength:.5931473890954511,citations:["Aink387","Aink390"]},{id:"uḷ ākkam",source:"uḷ",target:"ākkam",strength:.5956350552028524,citations:["Aink205","Aink54"]},{id:"veṉṉ ākkam",source:"veṉṉ",target:"ākkam",strength:.5956350552028524,citations:["Aink221","Aink389"]},{id:"maṭa(m) maka",source:"maṭa(m)",target:"maka",strength:.5969489365418381,citations:["Aink326","Aink361","Aink394","Aink398","Aink48","Aink98"]},{id:"niṟaikkum ūr",source:"niṟaikkum",target:"ūr",strength:.5981729805760799,citations:["Aink47","Aink48"]},{id:"vuṇ kaṇ",source:"vuṇ",target:"kaṇ",strength:.5991292109650512,citations:["Aink125","Aink36","Aink69"]},{id:"yuṇ kaṇ",source:"yuṇ",target:"kaṇ",strength:.5991292109650512,citations:["Aink126","Aink376","Aink72"]},{id:"tōḻaṉ mūrp",source:"tōḻaṉ",target:"mūrp",strength:.6007632379780821,citations:["Aink34","Aink35"]},{id:"paṇpu il",source:"paṇpu",target:"il",strength:.606109705835614,citations:["Aink138","Aink332"]},{id:"aṉṉai namm",source:"aṉṉai",target:"namm",strength:.6064440638535785,citations:["Aink102","Aink104","Aink202"]},{id:"aru(m) poruḷ",source:"aru(m)",target:"poruḷ",strength:.6088707627652963,citations:["Aink302","Aink359"]},{id:"val poy",source:"val",target:"poy",strength:.6088707627652963,citations:["Aink37"]},{id:"aṉṉai vāḻ",source:"aṉṉai",target:"vāḻ",strength:.609107829837973,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink210","Aink366"],curvature:.25},{id:"vāḻ aṉṉai",source:"vāḻ",target:"aṉṉai",strength:.609107829837973,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink210","Aink366"],curvature:.25},{id:"veḷ vēl",source:"veḷ",target:"vēl",strength:.6102588855944788,citations:["Aink379","Aink382","Aink393"]},{id:"koṇkaṉ nī",source:"koṇkaṉ",target:"nī",strength:.6105623090960062,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128","Aink307"]},{id:"yuṭai maka",source:"yuṭai",target:"maka",strength:.6116938710833763,citations:["Aink13","Aink354"]},{id:"kaṭu maka",source:"kaṭu",target:"maka",strength:.6116938710833763,citations:["Aink360","Aink78"]},{id:"aru(m) curam",source:"aru(m)",target:"curam",strength:.6136690024216991,citations:["Aink301","Aink303","Aink317","Aink351","Aink382","Aink385"]},{id:"kaṇ koṇkaṉ",source:"kaṇ",target:"koṇkaṉ",strength:.6146654424758181,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"māṇ iḻai",source:"māṇ",target:"iḻai",strength:.6175378565545885,citations:["Aink42","Aink47"]},{id:"āṭu em",source:"āṭu",target:"em",strength:.6175378565545885,citations:["Aink77","Aink78"]},{id:"ōkku pū(m)",source:"ōkku",target:"pū(m)",strength:.6221064703277402,citations:["Aink16","Aink33"]},{id:"maṇi kuṉṟam",source:"maṇi",target:"kuṉṟam",strength:.6221064703277402,citations:["Aink207","Aink209"]},{id:"kaḷvaṉ kaḻaṉi",source:"kaḷvaṉ",target:"kaḻaṉi",strength:.6221064703277402,citations:["Aink25","Aink29"]},{id:"iṟa kātal",source:"iṟa",target:"kātal",strength:.6221064703277402,citations:["Aink311","Aink319"]},{id:"vāṉ pū(m)",source:"vāṉ",target:"pū(m)",strength:.6221064703277402,citations:["Aink320","Aink331"]},{id:"poykaip pū(m)",source:"poykaip",target:"pū(m)",strength:.6221064703277402,citations:["Aink34","Aink97"]},{id:"toṟum toṟum",source:"toṟum",target:"toṟum",strength:.6221064703277402,citations:["Aink358","Aink375"],curvature:.5},{id:"oṇmai muṉ",source:"oṇmai",target:"muṉ",strength:.6221064703277402,citations:["Aink40","Aink83"]},{id:"ciṟu(m) miṉ",source:"ciṟu(m)",target:"miṉ",strength:.6236670249706531,citations:["Aink1","Aink10"]},{id:"vem ciṉa(m)",source:"vem",target:"ciṉa(m)",strength:.6236670249706531,citations:["Aink391","Aink400"]},{id:"vem viṟal",source:"vem",target:"viṟal",strength:.6236670249706531,citations:["Aink391","Aink400"]},{id:"vēḻam veḷ",source:"vēḻam",target:"veḷ",strength:.6258492550670972,citations:["Aink13","Aink17","Aink19"]},{id:"taṭpam ṇakam",source:"taṭpam",target:"ṇakam",strength:.6268475248050545,citations:["Aink27","Aink30"]},{id:"marutattup peru(m)",source:"marutattup",target:"peru(m)",strength:.6268475248050545,citations:["Aink31","Aink75"]},{id:"peṟu nutal",source:"peṟu",target:"nutal",strength:.6268475248050545,citations:["Aink56","Aink94"]},{id:"vēṇṭu yeṉ",source:"vēṇṭu",target:"yeṉ",strength:.6276024615253164,citations:["Aink107","Aink205","Aink366"]},{id:"pūk keḻu",source:"pūk",target:"keḻu",strength:.6284684896598826,citations:["Aink109","Aink210"]},{id:"paca paṉi",source:"paca",target:"paṉi",strength:.6284684896598826,citations:["Aink141","Aink37"]},{id:"aruḷ nī",source:"aruḷ",target:"nī",strength:.6284684896598826,citations:["Aink50"]},{id:"pūp uṇ",source:"pūp",target:"uṇ",strength:.6301106441973546,citations:["Aink101","Aink16"]},{id:"eri uṇ",source:"eri",target:"uṇ",strength:.6301106441973546,citations:["Aink324","Aink360"]},{id:"kōḷ val",source:"kōḷ",target:"val",strength:.6317745497578673,citations:["Aink312","Aink385"]},{id:"vel vēl",source:"vel",target:"vēl",strength:.6330058710539744,citations:["Aink364","Aink388","Aink399"]},{id:"vāl iḻai",source:"vāl",target:"iḻai",strength:.6369027325330969,citations:["Aink0","Aink73"]},{id:"aṟu kaḻaṉi",source:"aṟu",target:"kaḻaṉi",strength:.6369027325330969,citations:["Aink25","Aink29"]},{id:"koḷ tuyar",source:"koḷ",target:"tuyar",strength:.6369027325330969,citations:["Aink393","Aink394"]},{id:"yūraṉ mārpu",source:"yūraṉ",target:"mārpu",strength:.6393318859594332,citations:["Aink14","Aink25","Aink29","Aink4"]},{id:"kuṟṟu maka",source:"kuṟṟu",target:"maka",strength:.6393318859594332,citations:["Aink371","Aink394","Aink395","Aink52"]},{id:"puṉal aṭu",source:"puṉal",target:"aṭu",strength:.6405716532166397,citations:["Aink100","Aink15","Aink72"]},{id:"maṉ tām",source:"maṉ",target:"tām",strength:.6405716532166397,citations:["Aink316","Aink332","Aink337"]},{id:"curam yiṉiya",source:"curam",target:"yiṉiya",strength:.6405716532166397,citations:["Aink326","Aink371","Aink398"]},{id:"aṉpu il",source:"aṉpu",target:"il",strength:.6422492003906289,citations:["Aink138","Aink41"]},{id:"al urai",source:"al",target:"urai",strength:.6422492003906289,citations:["Aink66","Aink80"]},{id:"il lākuka",source:"il",target:"lākuka",strength:.6422492003906289,citations:["Aink8","Aink9"]},{id:"cel ayar",source:"cel",target:"ayar",strength:.6440831458558227,citations:["Aink307","Aink309"]},{id:"curam iṟa",source:"curam",target:"iṟa",strength:.6444211272702538,citations:["Aink306","Aink309","Aink317","Aink385","Aink394"]},{id:"keḻu koṭu(m)",source:"keḻu",target:"koṭu(m)",strength:.6478333656383912,citations:["Aink11","Aink12"]},{id:"kuṟu(m) ciṉai",source:"kuṟu(m)",target:"ciṉai",strength:.6478333656383912,citations:["Aink339","Aink383"]},{id:"taṭpam yūraṉ",source:"taṭpam",target:"yūraṉ",strength:.6492009933489007,citations:["Aink10","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"nutal kuṟṟu",source:"nutal",target:"kuṟṟu",strength:.6497513117976255,citations:["Aink371","Aink394"]},{id:"toṭi maṭantai",source:"toṭi",target:"maṭantai",strength:.6497513117976255,citations:["Aink389","Aink92"]},{id:"am cil",source:"am",target:"cil",strength:.6497513117976255,citations:["Aink391","Aink49"]},{id:"kāl marām",source:"kāl",target:"marām",strength:.6536773511096033,citations:["Aink331","Aink381"]},{id:"taṭpam tuṟai",source:"taṭpam",target:"tuṟai",strength:.6550679386844351,citations:["Aink10","Aink105","Aink115","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"kañal ūr",source:"kañal",target:"ūr",strength:.6552270397291307,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"tuṟai yūraṉai",source:"tuṟai",target:"yūraṉai",strength:.6556873625226886,citations:["Aink20","Aink88"]},{id:"marutattup tuṟai",source:"marutattup",target:"tuṟai",strength:.6556873625226886,citations:["Aink31","Aink75"]},{id:"tāṉ uṇarntōr",source:"tāṉ",target:"uṇarntōr",strength:.6556873625226886,citations:["Aink38","Aink41"]},{id:"vekuḷvōḷ kaṇ",source:"vekuḷvōḷ",target:"kaṇ",strength:.6556873625226886,citations:["Aink84"]},{id:"puṉal āṭu",source:"puṉal",target:"āṭu",strength:.6582465563604418,citations:["Aink77","Aink78","Aink98"]},{id:"tōḷ tuṟa",source:"tōḷ",target:"tuṟa",strength:.6598065195256679,citations:["Aink108","Aink109"]},{id:"iḻai nekiḻ",source:"iḻai",target:"nekiḻ",strength:.6598065195256679,citations:["Aink25","Aink318"]},{id:"val vil",source:"val",target:"vil",strength:.6598065195256679,citations:["Aink373","Aink390"]},{id:"aṇaṅku uṟu",source:"aṇaṅku",target:"uṟu",strength:.6598065195256679,citations:["Aink53","Aink58"]},{id:"toṭi muṉ",source:"toṭi",target:"muṉ",strength:.6604900872308834,citations:["Aink38","Aink40","Aink83"]},{id:"yarum curam",source:"yarum",target:"curam",strength:.6611420934233156,citations:["Aink307","Aink314","Aink320","Aink325","Aink329"]},{id:"nām maṟa",source:"nām",target:"maṟa",strength:.6627723015683837,citations:["Aink319","Aink36"]},{id:"tātu uṇ",source:"tātu",target:"uṇ",strength:.6639283364490411,citations:["Aink67","Aink82","Aink93"]},{id:"maka piṇa",source:"maka",target:"piṇa",strength:.6653801433565053,citations:["Aink326","Aink354","Aink373","Aink394","Aink401"]},{id:"kavar uṇ",source:"kavar",target:"uṇ",strength:.6662501387523695,citations:["Aink324","Aink360"]},{id:"uṇ veṉṟūḻ",source:"uṇ",target:"veṉṟūḻ",strength:.6662501387523695,citations:["Aink324","Aink360"]},{id:"vāḻ yātaṉ",source:"vāḻ",target:"yātaṉ",strength:.666777893793171,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"yātaṉ vāḻ",source:"yātaṉ",target:"vāḻ",strength:.666777893793171,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"vāḻ yaviṉi",source:"vāḻ",target:"yaviṉi",strength:.666777893793171,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"maṇal aṭu",source:"maṇal",target:"aṭu",strength:.6684736133149601,citations:["Aink100","Aink15"]},{id:"porip pū(m)",source:"porip",target:"pū(m)",strength:.6730422270881118,citations:["Aink347","Aink368"]},{id:"pū(m) puṉku",source:"pū(m)",target:"puṉku",strength:.6730422270881118,citations:["Aink347","Aink368"]},{id:"mell am",source:"mell",target:"am",strength:.6777832815654262,citations:["Aink133","Aink302"]},{id:"nal nayavaravu",source:"nal",target:"nayavaravu",strength:.6777832815654262,citations:["Aink365"]},{id:"kaḻaṉit malar",source:"kaḻaṉit",target:"malar",strength:.6777832815654262,citations:["Aink53","Aink94"]},{id:"vēṇṭu namm",source:"vēṇṭu",target:"namm",strength:.6812719123798788,citations:["Aink102","Aink104","Aink202"]},{id:"nām vayiṉ",source:"nām",target:"vayiṉ",strength:.6822953647708668,citations:["Aink335","Aink336","Aink337","Aink39"]},{id:"kaḻaṉi mārpu",source:"kaḻaṉi",target:"mārpu",strength:.6826022266174665,citations:["Aink25","Aink29","Aink4"]},{id:"ciṟu(m) yāṉai",source:"ciṟu(m)",target:"yāṉai",strength:.6831527197277354,citations:["Aink314","Aink327","Aink355","Aink362"]},{id:"mūtu ūr",source:"mūtu",target:"ūr",strength:.6839460468141974,citations:["Aink15","Aink372"]},{id:"em tuṟa",source:"em",target:"tuṟa",strength:.6878384892934687,citations:["Aink108","Aink109"]},{id:"vēḻam karuppu",source:"vēḻam",target:"karuppu",strength:.6878384892934687,citations:["Aink12","Aink18"]},{id:"naṉi yiṉiya",source:"naṉi",target:"yiṉiya",strength:.6878384892934687,citations:["Aink371","Aink398"]},{id:"kuṇam koḷ",source:"kuṇam",target:"koḷ",strength:.6878384892934687,citations:["Aink90"]},{id:"nām mūrp",source:"nām",target:"mūrp",strength:.6931849571510005,citations:["Aink34","Aink35"]},{id:"yeṉpa al",source:"yeṉpa",target:"al",strength:.6931849571510005,citations:["Aink369","Aink71"]},{id:"ciṟa vēṭṭōḷ",source:"ciṟa",target:"vēṭṭōḷ",strength:.6952179730988706,citations:["Aink1","Aink10","Aink3"]},{id:"varai nāṭu",source:"varai",target:"nāṭu",strength:.6952179730988706,citations:["Aink301","Aink309","Aink392"]},{id:"iṉ vavar",source:"iṉ",target:"vavar",strength:.6959460140806829,citations:["Aink203","Aink331"]},{id:"kāṭu iṟa",source:"kāṭu",target:"iṟa",strength:.6959460140806829,citations:["Aink311","Aink313"]},{id:"toṟum kalakkam",source:"toṟum",target:"kalakkam",strength:.6959460140806829,citations:["Aink358","Aink375"]},{id:"mal val",source:"mal",target:"val",strength:.6959460140806829,citations:["Aink37"]},{id:"iṉ naku",source:"iṉ",target:"naku",strength:.6959460140806829,citations:["Aink397","Aink403"]},{id:"puṟavam aṇi",source:"puṟavam",target:"aṇi",strength:.6959460140806829,citations:["Aink404","Aink405"]},{id:"koṭu(m) uyar",source:"koṭu(m)",target:"uyar",strength:.704613107869975,citations:["Aink318","Aink358"]},{id:"poruḷ piṇi",source:"poruḷ",target:"piṇi",strength:.704613107869975,citations:["Aink336","Aink355"]},{id:"peṟu cuṭar",source:"peṟu",target:"cuṭar",strength:.704613107869975,citations:["Aink56","Aink94"]},{id:"taṭa(m) erumai",source:"taṭa(m)",target:"erumai",strength:.704613107869975,citations:["Aink94","Aink98"]},{id:"yāṇar ūr",source:"yāṇar",target:"ūr",strength:.7063959235055425,citations:["Aink1","Aink100","Aink42","Aink43","Aink49","Aink50","Aink70","Aink87"]},{id:"vāḻ vēṇṭu",source:"vāḻ",target:"vēṇṭu",strength:.7090265173908744,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink210","Aink366"]},{id:"ciṟa veṉa",source:"ciṟa",target:"veṉa",strength:.7091640338178624,citations:["Aink1","Aink10","Aink3"]},{id:"pāvai yaṉṉa",source:"pāvai",target:"yaṉṉa",strength:.7091640338178624,citations:["Aink221","Aink307","Aink389"]},{id:"no/nō maruntu",source:"no/nō",target:"maruntu",strength:.7107422762860396,citations:["Aink101","Aink99"]},{id:"yāṉai neṟi",source:"yāṉai",target:"neṟi",strength:.7107422762860396,citations:["Aink355","Aink78"]},{id:"tuṟai yūraṉ",source:"tuṟai",target:"yūraṉ",strength:.7127094749557437,citations:["Aink10","Aink13","Aink14","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"alkul am",source:"alkul",target:"am",strength:.7139227761204411,citations:["Aink306","Aink316"]},{id:"yoḷ nutal",source:"yoḷ",target:"nutal",strength:.7141595380854457,citations:["Aink123","Aink322","Aink73"]},{id:"tāmarai malar",source:"tāmarai",target:"malar",strength:.7141595380854457,citations:["Aink53","Aink68","Aink94"]},{id:"muttam veḷ",source:"muttam",target:"veḷ",strength:.7171858955127413,citations:["Aink105","Aink380"]},{id:"itaḻ uṇ",source:"itaḻ",target:"uṇ",strength:.7171858955127413,citations:["Aink334","Aink351"]},{id:"pai(m) kāy",source:"pai(m)",target:"kāy",strength:.7239779838484836,citations:["Aink25","Aink381"]},{id:"vāl iṇar",source:"vāl",target:"iṇar",strength:.7239779838484836,citations:["Aink301","Aink383"]},{id:"maṉai nakar",source:"maṉai",target:"nakar",strength:.7239779838484836,citations:["Aink324","Aink60"]},{id:"tiruttu iḻai",source:"tiruttu",target:"iḻai",strength:.7239779838484836,citations:["Aink355","Aink39"]},{id:"iḻai yarivai",source:"iḻai",target:"yarivai",strength:.7239779838484836,citations:["Aink355","Aink42"]},{id:"viṟal vēl",source:"viṟal",target:"vēl",strength:.7239779838484836,citations:["Aink391","Aink400"]},{id:"ciṉa(m) vēl",source:"ciṉa(m)",target:"vēl",strength:.7239779838484836,citations:["Aink391","Aink400"]},{id:"malai nāṭu",source:"malai",target:"nāṭu",strength:.7247544032904808,citations:["Aink202","Aink205","Aink221"]},{id:"kaḷvaṉ aṟu",source:"kaḷvaṉ",target:"aṟu",strength:.7247544032904808,citations:["Aink21","Aink25","Aink29"]},{id:"nīḷ iṭai",source:"nīḷ",target:"iṭai",strength:.7247544032904808,citations:["Aink314","Aink360","Aink380"]},{id:"katir teṟu",source:"katir",target:"teṟu",strength:.727516894862546,citations:["Aink319","Aink330"]},{id:"maṟa amai",source:"maṟa",target:"amai",strength:.727516894862546,citations:["Aink36"]},{id:"karu(m) kōṭṭam",source:"karu(m)",target:"kōṭṭam",strength:.727516894862546,citations:["Aink92","Aink95"]},{id:"taṭa(m) kōṭṭam",source:"taṭa(m)",target:"kōṭṭam",strength:.727516894862546,citations:["Aink94","Aink98"]},{id:"neṭu(m) nakar",source:"neṭu(m)",target:"nakar",strength:.730387813141938,citations:["Aink324","Aink376","Aink60"]},{id:"yaḻi puṉal",source:"yaḻi",target:"puṉal",strength:.7311583971712092,citations:["Aink53","Aink78"]},{id:"puṉal āṭit",source:"puṉal",target:"āṭit",strength:.7311583971712092,citations:["Aink76","Aink80"]},{id:"vāḻ tōḻaṉ",source:"vāḻ",target:"tōḻaṉ",strength:.7381188828103603,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink221","Aink31","Aink32","Aink33","Aink331","Aink332","Aink333","Aink334","Aink335","Aink336","Aink337","Aink338","Aink339","Aink34","Aink340","Aink35","Aink36","Aink37","Aink38","Aink39","Aink392","Aink40"]},{id:"pūp pōl",source:"pūp",target:"pōl",strength:.7387742460538403,citations:["Aink101","Aink16"]},{id:"kaṭal tirai",source:"kaṭal",target:"tirai",strength:.7387742460538403,citations:["Aink105","Aink107"]},{id:"karai vēḻam",source:"karai",target:"vēḻam",strength:.7387742460538403,citations:["Aink12","Aink13"]},{id:"toṟum kaliḻ",source:"toṟum",target:"kaliḻ",strength:.7424293064342831,citations:["Aink373","Aink376","Aink398"]},{id:"amaintaṉaṉ tāṉ",source:"amaintaṉaṉ",target:"tāṉ",strength:.7427626138380751,citations:["Aink103"]},{id:"vaḷai nekiḻ",source:"vaḷai",target:"nekiḻ",strength:.7468817708410546,citations:["Aink136","Aink54"]},{id:"yoḷ arivai",source:"yoḷ",target:"arivai",strength:.7468817708410546,citations:["Aink322","Aink73"]},{id:"katuppu aṇi",source:"katuppu",target:"aṇi",strength:.7468817708410546,citations:["Aink345","Aink396"]},{id:"val curi",source:"val",target:"curi",strength:.7468817708410546,citations:["Aink348","Aink383"]},{id:"pata(m) vēṉal",source:"pata(m)",target:"vēṉal",strength:.7468817708410546,citations:["Aink368","Aink400"]},{id:"yaviṉi pakai",source:"yaviṉi",target:"pakai",strength:.7468817708410546,citations:["Aink4","Aink6"]},{id:"pāy eṉak",source:"pāy",target:"eṉak",strength:.7468817708410546,citations:["Aink53","Aink73"]},{id:"kai vaḷ",source:"kai",target:"vaḷ",strength:.7468817708410546,citations:["Aink58","Aink61"]},{id:"lākuka vēṭṭōḷ",source:"lākuka",target:"vēṭṭōḷ",strength:.7468817708410546,citations:["Aink8","Aink9"]},{id:"aṟattoṭu nil",source:"aṟattoṭu",target:"nil",strength:.7555488646303468,citations:["Aink201","Aink208"]},{id:"vayalaic ce(m)",source:"vayalaic",target:"ce(m)",strength:.7555488646303468,citations:["Aink25","Aink52"]},{id:"ce(m) ēṟṟai",source:"ce(m)",target:"ēṟṟai",strength:.7555488646303468,citations:["Aink354","Aink397"]},{id:"vari niḻal",source:"vari",target:"niḻal",strength:.7580196759069014,citations:["Aink381","Aink388","Aink62"]},{id:"yallaṉ e-",source:"yallaṉ",target:"e-",strength:.7601174784034984,citations:["Aink11"]},{id:"puḷḷik kaḷvaṉ",source:"puḷḷik",target:"kaḷvaṉ",strength:.7601174784034984,citations:["Aink21","Aink22"]},{id:"lākuka veṉa",source:"lākuka",target:"veṉa",strength:.7601174784034984,citations:["Aink8","Aink9"]},{id:"mūr oṇmai",source:"mūr",target:"oṇmai",strength:.7601174784034984,citations:["Aink83","Aink92"]},{id:"cuṭar nutal",source:"cuṭar",target:"nutal",strength:.7608052045282871,citations:["Aink107","Aink375","Aink56","Aink94"]},{id:"mel pulak",source:"mel",target:"pulak",strength:.7648585328808127,citations:["Aink119","Aink138"]},{id:"kaḻaṉi yūraṉ",source:"kaḻaṉi",target:"yūraṉ",strength:.7654465726444646,citations:["Aink18","Aink25","Aink29","Aink4","Aink91","Aink96"]},{id:"al koṇkaṉ",source:"al",target:"koṇkaṉ",strength:.7655075103592881,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"putup puṉal",source:"putup",target:"puṉal",strength:.770191002507608,citations:["Aink53","Aink64","Aink78","Aink79"]},{id:"yiḷa mulai",source:"yiḷa",target:"mulai",strength:.7749137406088552,citations:["Aink127","Aink347"]},{id:"maṇa kamaḻ",source:"maṇa",target:"kamaḻ",strength:.7749137406088552,citations:["Aink19","Aink348"]},{id:"alkul vari",source:"alkul",target:"vari",strength:.7749137406088552,citations:["Aink306","Aink316"]},{id:"eṉac col",source:"eṉac",target:"col",strength:.7749137406088552,citations:["Aink355","Aink399"]},{id:"tava naṉi",source:"tava",target:"naṉi",strength:.7749137406088552,citations:["Aink359","Aink80"]},{id:"naṉi vākuka",source:"naṉi",target:"vākuka",strength:.7749137406088552,citations:["Aink371","Aink398"]},{id:"vaṭṭi maṉai",source:"vaṭṭi",target:"maṉai",strength:.7749137406088552,citations:["Aink47","Aink48"]},{id:"paṇait tōḷ",source:"paṇait",target:"tōḷ",strength:.786966505335377,citations:["Aink135","Aink318","Aink39"]},{id:"aṟam cāliyar",source:"aṟam",target:"cāliyar",strength:.7916883591853615,citations:["Aink312"]},{id:"poykai yāmpal",source:"poykai",target:"yāmpal",strength:.7916883591853615,citations:["Aink35","Aink91"]},{id:"koṇkaṉ kēḷ",source:"koṇkaṉ",target:"kēḷ",strength:.7945696317726891,citations:["Aink121","Aink122","Aink123","Aink124","Aink125","Aink126","Aink127","Aink128"]},{id:"am ōti",source:"am",target:"ōti",strength:.8059080703219522,citations:["Aink368","Aink391","Aink49"]},{id:"nutal arivai",source:"nutal",target:"arivai",strength:.8071054752044653,citations:["Aink322","Aink404","Aink46","Aink73"]},{id:"ilaṅku vaḷai",source:"ilaṅku",target:"vaḷai",strength:.8110532351638701,citations:["Aink136","Aink310"]},{id:"yaṉṉa veṉṉ",source:"yaṉṉa",target:"veṉṉ",strength:.8110532351638701,citations:["Aink221","Aink389"]},{id:"pāvai veṉṉ",source:"pāvai",target:"veṉṉ",strength:.8110532351638701,citations:["Aink221","Aink389"]},{id:"kaḷvaṉ ṇakam",source:"kaḷvaṉ",target:"ṇakam",strength:.8110532351638701,citations:["Aink27","Aink30"]},{id:"veṉṟūḻ nīḷ",source:"veṉṟūḻ",target:"nīḷ",strength:.8110532351638701,citations:["Aink324","Aink360"]},{id:"tuṭait toṟum",source:"tuṭait",target:"toṟum",strength:.8110532351638701,citations:["Aink358"]},{id:"niṉait toṟum",source:"niṉait",target:"toṟum",strength:.8110532351638701,citations:["Aink373","Aink398"]},{id:"pall ūḻ",source:"pall",target:"ūḻ",strength:.8110532351638701,citations:["Aink374","Aink390"]},{id:"pāvai yitu",source:"pāvai",target:"yitu",strength:.8110532351638701,citations:["Aink375"]},{id:"tēr taḷar",source:"tēr",target:"taḷar",strength:.8110532351638701,citations:["Aink403","Aink66"]},{id:"poy urai",source:"poy",target:"urai",strength:.8110532351638701,citations:["Aink66","Aink80"]},{id:"amma vāḻ",source:"amma",target:"vāḻ",strength:.8147809498497596,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink132","Aink139","Aink221","Aink31","Aink32","Aink33","Aink331","Aink332","Aink333","Aink334","Aink335","Aink336","Aink337","Aink338","Aink339","Aink34","Aink340","Aink36","Aink37","Aink38","Aink39","Aink40","Aink77","Aink89"]},{id:"maṇi niṟam",source:"maṇi",target:"niṟam",strength:.8165029355269873,citations:["Aink208","Aink45","Aink96"]},{id:"vēṇṭu aṉṉai",source:"vēṇṭu",target:"aṉṉai",strength:.8212004840425162,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink210","Aink366"],curvature:.25},{id:"aṉṉai vēṇṭu",source:"aṉṉai",target:"vēṇṭu",strength:.8212004840425162,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink109","Aink201","Aink202","Aink203","Aink204","Aink205","Aink206","Aink207","Aink208","Aink209","Aink210","Aink366"],curvature:.25},{id:"iv vūr",source:"iv",target:"vūr",strength:.825849497369227,citations:["Aink132","Aink62"]},{id:"kamaḻ poḻil",source:"kamaḻ",target:"poḻil",strength:.825849497369227,citations:["Aink19","Aink348"]},{id:"ciṉa(m) viṟal",source:"ciṉa(m)",target:"viṟal",strength:.825849497369227,citations:["Aink391","Aink400"]},{id:"oṇmai toṭi",source:"oṇmai",target:"toṭi",strength:.8282272544185646,citations:["Aink28","Aink387","Aink40","Aink76","Aink83","Aink92"]},{id:"vuṇ civa",source:"vuṇ",target:"civa",strength:.8339570221564412,citations:["Aink125","Aink69"]},{id:"cāliyar vaṟṟu",source:"cāliyar",target:"vaṟṟu",strength:.8339570221564412,citations:["Aink312"]},{id:"cil ōti",source:"cil",target:"ōti",strength:.8339570221564412,citations:["Aink391","Aink49"]},{id:"ciṟai putup",source:"ciṟai",target:"putup",strength:.8339570221564412,citations:["Aink53","Aink78"]},{id:"num mūr",source:"num",target:"mūr",strength:.8339570221564412,citations:["Aink83","Aink92"]},{id:"el vaḷai",source:"el",target:"vaḷai",strength:.8406359561899394,citations:["Aink140","Aink20","Aink27"]},{id:"kōṭṭam erumai",source:"kōṭṭam",target:"erumai",strength:.8406359561899394,citations:["Aink94","Aink95","Aink98"]},{id:"peyar uḻi",source:"peyar",target:"uḻi",strength:.8426241159457333,citations:["Aink204"]},{id:"uyar piṟaṅkal",source:"uyar",target:"piṟaṅkal",strength:.8426241159457333,citations:["Aink318","Aink387"]},{id:"niṉait kaliḻ",source:"niṉait",target:"kaliḻ",strength:.8426241159457333,citations:["Aink373","Aink398"]},{id:"māṇ kuṇam",source:"māṇ",target:"kuṇam",strength:.8426241159457333,citations:["Aink90"]},{id:"yāy yām",source:"yāy",target:"yām",strength:.8495467423523857,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"namm ūrp",source:"namm",target:"ūrp",strength:.8619889919242418,citations:["Aink104","Aink202"]},{id:"karai cēr",source:"karai",target:"cēr",strength:.8619889919242418,citations:["Aink12","Aink74"]},{id:"iv vāṟu",source:"iv",target:"vāṟu",strength:.8619889919242418,citations:["Aink205","Aink208"]},{id:"kaviṉ tolai",source:"kaviṉ",target:"tolai",strength:.8619889919242418,citations:["Aink221","Aink392"]},{id:"nekiḻac cā",source:"nekiḻac",target:"cā",strength:.8619889919242418,citations:["Aink27","Aink28"]},{id:"muḻakkam aḻal",source:"muḻakkam",target:"aḻal",strength:.8619889919242418,citations:["Aink307","Aink320"]},{id:"eri kavar",source:"eri",target:"kavar",strength:.8619889919242418,citations:["Aink324","Aink360"]},{id:"pall itaḻ",source:"pall",target:"itaḻ",strength:.8619889919242418,citations:["Aink334","Aink351"]},{id:"pai(m) kiḷḷai",source:"pai(m)",target:"kiḷḷai",strength:.8619889919242418,citations:["Aink375"]},{id:"col uṇarntōr",source:"col",target:"uṇarntōr",strength:.8619889919242418,citations:["Aink38","Aink41"]},{id:"amma tōḻaṉ",source:"amma",target:"tōḻaṉ",strength:.8758013658321104,citations:["Aink111","Aink112","Aink113","Aink114","Aink115","Aink116","Aink117","Aink118","Aink119","Aink120","Aink221","Aink31","Aink32","Aink33","Aink331","Aink332","Aink333","Aink334","Aink335","Aink336","Aink337","Aink338","Aink339","Aink34","Aink340","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"yaḻi putup",source:"yaḻi",target:"putup",strength:.8848927789168127,citations:["Aink53","Aink78"]},{id:"tēṉūr vivaḷ",source:"tēṉūr",target:"vivaḷ",strength:.8878472895253517,citations:["Aink54","Aink55","Aink57"]},{id:"vēṭṭōḷ yām",source:"vēṭṭōḷ",target:"yām",strength:.8908581871130717,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"kavar veṉṟūḻ",source:"kavar",target:"veṉṟūḻ",strength:.8981284864792567,citations:["Aink324","Aink360"]},{id:"mell iyal",source:"mell",target:"iyal",strength:.9129247486846135,citations:["Aink304","Aink308"]},{id:"puli vaḻakku",source:"puli",target:"vaḻakku",strength:.9129247486846135,citations:["Aink316","Aink386"]},{id:"ukakkum mālai",source:"ukakkum",target:"mālai",strength:.9129247486846135,citations:["Aink339","Aink378"]},{id:"vāval mālai",source:"vāval",target:"mālai",strength:.9129247486846135,citations:["Aink339","Aink378"]},{id:"yiṉiya vākuka",source:"yiṉiya",target:"vākuka",strength:.9129247486846135,citations:["Aink371","Aink398"]},{id:"pūk kañal",source:"pūk",target:"kañal",strength:.9229940552710694,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"malir niṟai",source:"malir",target:"niṟai",strength:.9323844884264458,citations:["Aink15","Aink42","Aink72"]},{id:"veṉa yāy",source:"veṉa",target:"yāy",strength:.943043563257936,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"ekkar ñāḻal",source:"ekkar",target:"ñāḻal",strength:.9482337577200997,citations:["Aink141","Aink142","Aink143","Aink144","Aink145"]},{id:"muḷḷi vēr",source:"muḷḷi",target:"vēr",strength:.9490642432396285,citations:["Aink22","Aink23"]},{id:"ṇakam maṇ",source:"ṇakam",target:"maṇ",strength:.9490642432396285,citations:["Aink27","Aink30"]},{id:"titti yalkul",source:"titti",target:"yalkul",strength:.9490642432396285,citations:["Aink29","Aink72"]},{id:"ciṟai yaḻi",source:"ciṟai",target:"yaḻi",strength:.9490642432396285,citations:["Aink53","Aink78"]},{id:"kaḻaṉit tāmarai",source:"kaḻaṉit",target:"tāmarai",strength:.9490642432396285,citations:["Aink53","Aink94"]},{id:"vēṭṭōḷ yāy",source:"vēṭṭōḷ",target:"yāy",strength:.958688555239314,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"veṉa vēṭṭōḷ",source:"veṉa",target:"vēṭṭōḷ",strength:.9836808399392308,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"yātaṉ yaviṉi",source:"yātaṉ",target:"yaviṉi",strength:1,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"vāval ukakkum",source:"vāval",target:"ukakkum",strength:1.0000000000000002,citations:["Aink339","Aink378"]},{id:"porip puṉku",source:"porip",target:"puṉku",strength:1.0000000000000002,citations:["Aink347","Aink368"]}],ka={nodes:Ob,links:Ib},Nb=i=>{const t=1+200/Math.hypot(i.x,i.y,i.z),n=i.x||i.y||i.z?{x:i.x*t,y:i.y*t,z:i.z*t}:{x:0,y:0,z:200};Ma.cameraPosition(n,i,1e3)},Ma=yb(),Ub=()=>{const i=new Map([["adjective","#66c2a5"],["noun","#fc8d62"],["pronoun","#8da0cb"],["verb","#e78ac3"],["other","#a6d854"]]),e=document.getElementById("panellegend");e.innerHTML=[...i].map(n=>`<div><input type="checkbox" name="${n[0]}" checked autocomplete="off"/><label><span style="color:${n[1]}; font-size: 150%">●</span> ${n[0]}</div>`).join("")+'<div id="solonodes"><input type="checkbox" name="solonodes" checked autocomplete="off"/><label>Show unconnected nodes</label></div>';const t=structuredClone(ka.links).filter(n=>n.strength>=.45);Ma(document.getElementById("colgraph")).graphData({nodes:ka.nodes,links:t}).nodeLabel(n=>`${n.size} occurences`).nodeThreeObject(n=>{const r=new Db(n.id);return r.material.depthWrite=!1,r.color=i.get(n.type)||i.get("other"),r.textHeight=n.size/2<8?8:n.size/2,r}).linkWidth(n=>n.strength*5).linkOpacity(.3).linkDirectionalArrowLength(5).linkCurvature(n=>n.curvature||0).linkLabel(n=>`${n.citations.join(", ")} (NPMI: ${n.strength.toPrecision(4)})`).onNodeClick(Nb),Ma.d3Force("link").distance(n=>40/n.strength)},Fb=i=>{const e=document.getElementById("panel");e.style.display!=="flex"?(e.animate([{marginTop:"-25px"},{marginTop:"0px"}],{duration:200,iterations:1}),e.style.display="flex",i.target.textContent="⇧"):(e.animate([{marginTop:"0px"},{marginTop:"-25px"}],{duration:200,iterations:1}),setTimeout(()=>e.style.display="none",200),i.target.textContent="⇩")},Bb=i=>{const e=new Set;for(const t of i)e.add(t.source),e.add(t.target);return e},Hb=()=>{const i={};i.nodes=ka.nodes,i.links=structuredClone(ka.links);const e=document.getElementById("npmi").value;i.links=i.links.filter(r=>r.strength>=e);const t=document.getElementById("panellegend").querySelectorAll('input:not([name="solonodes"])'),n=new Set([...t].filter(r=>r.checked).map(r=>r.getAttribute("name")));if(n.size!==t.length){i.nodes=i.nodes.filter(a=>n.has(a.type));const r=new Set(i.nodes.map(a=>a.id));i.links=i.links.filter(a=>r.has(a.target)&&r.has(a.source))}if(!document.querySelector('input[name="solonodes"]').checked){const r=Bb(i.links);i.nodes=i.nodes.filter(a=>r.has(a.id))}Ma.graphData(i)};document.getElementById("paneltoggle").addEventListener("click",Fb);document.getElementById("graphupdate").addEventListener("click",Hb);Ub();
