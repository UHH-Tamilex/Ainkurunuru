...
`),g="".concat(this.fontWeight," ").concat(this.fontSize,"px ").concat(this.fontFace);s.font=g;var v=Math.max.apply(Math,na(m.map(function(P){return s.measureText(P).width}))),p=this.fontSize*m.length;if(a.width=v+c[0]*2+f[0]*2,a.height=p+c[1]*2+f[1]*2,this.borderWidth){if(s.strokeStyle=this.borderColor,c[0]){var h=c[0]/2;s.lineWidth=c[0],s.beginPath(),s.moveTo(h,u[0]),s.lineTo(h,a.height-u[3]),s.moveTo(a.width-h,u[1]),s.lineTo(a.width-h,a.height-u[2]),s.stroke()}if(c[1]){var x=c[1]/2;s.lineWidth=c[1],s.beginPath(),s.moveTo(Math.max(c[0],u[0]),x),s.lineTo(a.width-Math.max(c[0],u[1]),x),s.moveTo(Math.max(c[0],u[3]),a.height-x),s.lineTo(a.width-Math.max(c[0],u[2]),a.height-x),s.stroke()}if(this.borderRadius){var _=Math.max.apply(Math,na(c)),y=_/2;s.lineWidth=_,s.beginPath(),[!!u[0]&&[u[0],y,y,u[0]],!!u[1]&&[a.width-u[1],a.width-y,y,u[1]],!!u[2]&&[a.width-u[2],a.width-y,a.height-y,a.height-u[2]],!!u[3]&&[u[3],y,a.height-y,a.height-u[3]]].filter(function(P){return P}).forEach(function(P){var b=yu(P,4),w=b[0],N=b[1],U=b[2],ee=b[3];s.moveTo(w,U),s.quadraticCurveTo(N,U,N,ee)}),s.stroke()}}this.backgroundColor&&(s.fillStyle=this.backgroundColor,this.borderRadius?(s.beginPath(),s.moveTo(c[0],u[0]),[[c[0],u[0],a.width-u[1],c[1],c[1],c[1]],[a.width-c[0],a.width-c[0],a.width-c[0],c[1],u[1],a.height-u[2]],[a.width-c[0],a.width-u[2],u[3],a.height-c[1],a.height-c[1],a.height-c[1]],[c[0],c[0],c[0],a.height-c[1],a.height-u[3],u[0]]].forEach(function(P){var b=yu(P,6),w=b[0],N=b[1],U=b[2],ee=b[3],C=b[4],k=b[5];s.quadraticCurveTo(w,ee,N,C),s.lineTo(U,k)}),s.closePath(),s.fill()):s.fillRect(c[0],c[1],a.width-c[0]*2,a.height-c[1]*2)),s.translate.apply(s,na(c)),s.translate.apply(s,na(f)),s.font=g,s.fillStyle=this.color,s.textBaseline="bottom";var A=this.strokeWidth>0;A&&(s.lineWidth=this.strokeWidth*this.fontSize/10,s.strokeStyle=this.strokeColor),m.forEach(function(P,b){var w=(v-s.measureText(P).width)/2,N=(b+1)*r.fontSize;A&&s.strokeText(P,w,N),s.fillText(P,w,N)}),this.material.map&&this.material.map.dispose();var M=this.material.map=new Ci.Texture(a);M.minFilter=Ci.LinearFilter,M.colorSpace=Ci.SRGBColorSpace,M.needsUpdate=!0;var E=this.textHeight*m.length+o[1]*2+d[1]*2;this.scale.set(E*a.width/a.height,E,0)}},{key:"clone",value:function(){return new this.constructor(this.text,this.textHeight,this.color).copy(this)}},{key:"copy",value:function(r){return Ci.Sprite.prototype.copy.call(this,r),this.color=r.color,this.backgroundColor=r.backgroundColor,this.padding=r.padding,this.borderWidth=r.borderWidth,this.borderColor=r.borderColor,this.fontFace=r.fontFace,this.fontSize=r.fontSize,this.fontWeight=r.fontWeight,this.strokeWidth=r.strokeWidth,this.strokeColor=r.strokeColor,this}}]),t}(Ci.Sprite);const OA=[{id:"nīl",size:5,type:"noun"},{id:"mēṉi",size:5,type:"noun"},{id:"vāl",size:4,type:"noun"},{id:"iḻai",size:7,type:"noun"},{id:"pākattu",size:1},{id:"oru",size:3,type:"noun"},{id:"iru",size:4,type:"noun"},{id:"tāḷ",size:2,type:"noun"},{id:"niḻal",size:3,type:"noun"},{id:"kīḻ",size:1},{id:"mu",size:1,type:"noun"},{id:"vaku",size:1,type:"verb"},{id:"ulakam",size:1,type:"noun"},{id:"vāḻ",size:47,type:"verb"},{id:"yātaṉ",size:10},{id:"yaviṉi",size:10},{id:"nel",size:9,type:"noun"},{id:"pal",size:20,type:"noun"},{id:"poli",size:2,type:"noun"},{id:"poṉ",size:6,type:"noun"},{id:"peru(m)",size:21,type:"adjective"},{id:"ciṟa",size:8,type:"verb"},{id:"veṉa",size:9},{id:"vēṭṭōḷ",size:10},{id:"yāy",size:11,type:"noun"},{id:"yām",size:18,type:"pronoun"},{id:"naṉai",size:2,type:"noun"},{id:"kāñcic",size:1},{id:"ciṉai",size:4,type:"verb"},{id:"ciṟu(m)",size:6,type:"adjective"},{id:"miṉ",size:5,type:"noun"},{id:"yāṇar",size:9,type:"noun"},{id:"ūr",size:44,type:"noun"},{id:"pāṇ",size:11,type:"noun"},{id:"māri",size:3,type:"noun"},{id:"vāy",size:3,type:"noun"},{id:"vaḷam",size:4,type:"noun"},{id:"naṉi",size:4},{id:"pū(m)",size:18,type:"noun"},{id:"māattup",size:2},{id:"pulavu",size:2,type:"noun"},{id:"taṭpam",size:32,type:"noun"},{id:"tuṟai",size:21,type:"noun"},{id:"yūraṉ",size:20},{id:"tāṉ",size:16,type:"pronoun"},{id:"koḷ",size:13,type:"verb"},{id:"cel",size:11,type:"noun"},{id:"puṉal",size:17,type:"noun"},{id:"aṭu",size:8,type:"verb"},{id:"maka",size:26,type:"noun"},{id:"iṭu",size:1,type:"verb"},{id:"voḷ",size:4},{id:"ḷiḻai",size:1},{id:"maṇal",size:3,type:"noun"},{id:"cimaiyattu",size:1},{id:"erumai",size:6,type:"noun"},{id:"kiḷai",size:1,type:"noun"},{id:"i-",size:23,type:"pronoun"},{id:"narampu",size:1,type:"noun"},{id:"aṉṉai",size:20,type:"noun"},{id:"vēṇṭu",size:12,type:"verb"},{id:"yutuk",size:1},{id:"kaṇ",size:19,type:"noun"},{id:"ēr",size:3,type:"noun"},{id:"koṭip",size:3},{id:"pācu",size:1},{id:"aṭumpu",size:1,type:"noun"},{id:"pari",size:3,type:"noun"},{id:"vūrpu",size:1},{id:"iḻi",size:2,type:"verb"},{id:"neytal",size:4,type:"noun"},{id:"mayakkam",size:1},{id:"varavu",size:17,type:"noun"},{id:"nī",size:39,type:"pronoun"},{id:"pūp",size:3},{id:"pōl",size:8,type:"verb"},{id:"uṇ",size:12},{id:"maruvu",size:1,type:"verb"},{id:"no/nō",size:6,type:"verb"},{id:"maruntu",size:4,type:"noun"},{id:"ākkam",size:27,type:"noun"},{id:"namm",size:2},{id:"niṟap",size:1},{id:"kaṭal",size:5,type:"noun"},{id:"puḷ",size:1,type:"noun"},{id:"°āṉ",size:1,type:"verb"},{id:"tuṉpam",size:1,type:"noun"},{id:"uṟu",size:7,type:"verb"},{id:"tuyara",size:1},{id:"nīkku",size:2,type:"verb"},{id:"viṉpu",size:1},{id:"vicaikkum",size:1},{id:"a-",size:38,type:"pronoun"},{id:"tēr",size:6,type:"noun"},{id:"puṉṉai",size:1,type:"noun"},{id:"ñāḻal",size:1,type:"noun"},{id:"am",size:4,type:"adjective"},{id:"amaintaṉaṉ",size:1},{id:"amai",size:6,type:"noun"},{id:"mā",size:3,type:"adjective"},{id:"ūrp",size:1},{id:"maṭi",size:1,type:"noun"},{id:"poḻutu",size:4,type:"noun"},{id:"nal",size:25,type:"adjective"},{id:"mikac",size:2},{id:"cā",size:4,type:"verb"},{id:"naḷḷeṉ",size:2,type:"verb"},{id:"viyal",size:2,type:"noun"},{id:"tērc",size:1},{id:"celvak",size:1},{id:"koṇkaṉ",size:2,type:"noun"},{id:"muḻakkam",size:2},{id:"tirai",size:2,type:"verb"},{id:"taru",size:1},{id:"muttam",size:1,type:"noun"},{id:"veḷ",size:12,type:"adjective"},{id:"imai",size:1,type:"noun"},{id:"eṉap",size:4},{id:"civantaṉṟu",size:1},{id:"yavar",size:1},{id:"nāṭṭut",size:1},{id:"tutik",size:1},{id:"kāl",size:8,type:"noun"},{id:"aṉṉam",size:1,type:"noun"},{id:"tuṇai",size:8,type:"noun"},{id:"miti",size:1,type:"noun"},{id:"vaḷaiyiṉum",size:1},{id:"ilaṅku",size:1,type:"verb"},{id:"kaliḻ",size:2,type:"verb"},{id:"ākam",size:1,type:"noun"},{id:"yeṉ",size:2},{id:"tōḻaṉ",size:13},{id:"cuṭar",size:5,type:"noun"},{id:"nutal",size:8,type:"noun"},{id:"pacappac",size:2},{id:"cāayp",size:1},{id:"paṭar",size:2,type:"noun"},{id:"mel",size:6,type:"adjective"},{id:"paṭu",size:3,type:"verb"},{id:"kēḷ",size:6,type:"verb"},{id:"tuñcu",size:4,type:"verb"},{id:"kaḻi",size:2},{id:"muṇṭakam",size:1,type:"noun"},{id:"malar",size:15,type:"noun"},{id:"cērppu",size:1,type:"noun"},{id:"em",size:9,type:"pronoun"},{id:"tōḷ",size:6,type:"noun"},{id:"tuṟa",size:2,type:"verb"},{id:"e-",size:13,type:"pronoun"},{id:"kol",size:2,type:"verb"},{id:"maṉai",size:10,type:"noun"},{id:"naṭu",size:2,type:"verb"},{id:"vayalai",size:1,type:"noun"},{id:"vēḻam",size:8,type:"noun"},{id:"cuṟṟam",size:1,type:"noun"},{id:"keḻu",size:4},{id:"koṭu(m)",size:2,type:"adjective"},{id:"nāṇ",size:1,type:"noun"},{id:"nallaṉ",size:1},{id:"yallaṉ",size:1},{id:"taṭa(m)",size:4,type:"adjective"},{id:"karai",size:3,type:"noun"},{id:"cēr",size:2,type:"verb"},{id:"karuppu",size:6,type:"adjective"},{id:"āṟṟuka",size:1},{id:"tōṟka",size:1},{id:"vel",size:5,type:"verb"},{id:"yuṭai",size:1},{id:"poṅku",size:1,type:"verb"},{id:"uḷai",size:1,type:"noun"},{id:"yaṉṉa",size:6},{id:"vaṭai",size:1},{id:"pakar",size:1,type:"verb"},{id:"peṇ",size:7,type:"noun"},{id:"yāmam",size:1,type:"noun"},{id:"pai",size:2},{id:"al",size:12,type:"verb"},{id:"paṇait",size:2},{id:"ai",size:1,type:"noun"},{id:"akal",size:3,type:"noun"},{id:"valkul",size:1},{id:"kaṇṇi",size:1,type:"noun"},{id:"nēr",size:1,type:"noun"},{id:"tīṇṭu",size:1,type:"verb"},{id:"yayala",size:1},{id:"vaṭuk",size:1},{id:"mā(m)",size:4,type:"noun"},{id:"val",size:4,type:"noun"},{id:"taḷir",size:2,type:"noun"},{id:"nuṭaṅku",size:4,type:"verb"},{id:"aṇit",size:1},{id:"mārpu",size:9,type:"noun"},{id:"paṉit",size:1},{id:"tuyil",size:1,type:"noun"},{id:"cey",size:8,type:"noun"},{id:"malir",size:3,type:"verb"},{id:"niṟai",size:5,type:"noun"},{id:"virumpiya",size:1},{id:"taḻaip",size:1},{id:"makaḷirkkup",size:1},{id:"puṇar",size:5,type:"verb"},{id:"yutavum",size:1},{id:"mūtu",size:1},{id:"ōkku",size:2,type:"verb"},{id:"vēḻattut",size:2},{id:"tūmpu",size:2,type:"noun"},{id:"uṭait",size:1},{id:"tiraḷ",size:1,type:"noun"},{id:"toḻumakaḷir",size:1},{id:"añcaṉam",size:1},{id:"pey",size:3,type:"verb"},{id:"pūk",size:5},{id:"kañal",size:4,type:"verb"},{id:"yuḷḷip",size:1},{id:"putal",size:1,type:"noun"},{id:"micai",size:1,type:"noun"},{id:"vicumpu",size:2,type:"noun"},{id:"kuruku",size:4,type:"noun"},{id:"tōṟṟam",size:3,type:"noun"},{id:"putu",size:1,type:"adjective"},{id:"mēvu",size:1,type:"noun"},{id:"vaṟu(m)",size:1,type:"adjective"},{id:"maṭa(m)",size:6,type:"noun"},{id:"iru(m)",size:2,type:"adjective"},{id:"cāy",size:1,type:"noun"},{id:"ceruntiyoṭu",size:1},{id:"alamvaru",size:2,type:"verb"},{id:"kaḻaṉi",size:9,type:"noun"},{id:"poru",size:1,type:"verb"},{id:"ṇaḻap",size:1},{id:"piri",size:4,type:"verb"},{id:"ekkar",size:1,type:"noun"},{id:"putup",size:5},{id:"meym",size:1},{id:"maṇa",size:3,type:"verb"},{id:"kamaḻ",size:1,type:"verb"},{id:"poḻil",size:2,type:"noun"},{id:"ḷuḷai",size:1},{id:"cī",size:2,type:"verb"},{id:"kalakkam",size:2,type:"noun"},{id:"viḷaika",size:1},{id:"vayal",size:3,type:"noun"},{id:"viravalar",size:1},{id:"eṉ",size:15,type:"pronoun"},{id:"litaḻ",size:1},{id:"nikar",size:1,type:"noun"},{id:"vaḻi",size:1,type:"noun"},{id:"vaḻic",size:1},{id:"aṟu",size:6,type:"noun"},{id:"cil",size:3,type:"noun"},{id:"vam",size:3},{id:"ciṟait",size:1},{id:"tumpi",size:1,type:"noun"},{id:"nūṟṟu",size:1},{id:"itaḻt",size:1},{id:"tāmaraip",size:1},{id:"pūc",size:1},{id:"kāmpu",size:1,type:"noun"},{id:"uṭai",size:2,type:"noun"},{id:"naṇṇu",size:2,type:"verb"},{id:"yūraṉai",size:2},{id:"yuḷḷi",size:2},{id:"ṉiṟai",size:1},{id:"yēr",size:1},{id:"el",size:2,type:"noun"},{id:"vaḷai",size:3,type:"noun"},{id:"yeṉṉai",size:2},{id:"tāṉum",size:1},{id:"malaintāṉ",size:1},{id:"taḻai",size:2,type:"noun"},{id:"yāyiṉa",size:1},{id:"vī",size:2,type:"noun"},{id:"maṇi",size:4,type:"noun"},{id:"arumpu",size:1,type:"noun"},{id:"yeṉṉa",size:1},{id:"maram",size:1,type:"noun"},{id:"yaḵtu",size:1},{id:"varaiyara",size:1},{id:"niraiyuṭaṉ",size:1},{id:"kuḻīip",size:1},{id:"peyarvuḻip",size:1},{id:"peyarvuḻit",size:1},{id:"tavir",size:1,type:"verb"},{id:"nōkkam",size:2,type:"noun"},{id:"tīyēṉ",size:1},{id:"muḷḷi",size:3,type:"noun"},{id:"nīṭṭu",size:2,type:"verb"},{id:"mutu",size:1,type:"adjective"},{id:"nīr",size:3,type:"pronoun"},{id:"aṭai",size:1,type:"noun"},{id:"karaip",size:1},{id:"puḷḷik",size:3},{id:"kaḷvaṉ",size:9,type:"noun"},{id:"āmpal",size:6,type:"noun"},{id:"teḷ",size:1,type:"adjective"},{id:"pacappatu",size:2},{id:"aḷḷal",size:1,type:"noun"},{id:"āṭu",size:6,type:"noun"},{id:"vēr",size:2,type:"noun"},{id:"aḷaic",size:1},{id:"col",size:4,type:"noun"},{id:"nīyēṉ",size:1},{id:"amma",size:12},{id:"kātal",size:3,type:"noun"},{id:"pāvai",size:2,type:"noun"},{id:"veṉṉ",size:1},{id:"kaviṉ",size:3,type:"noun"},{id:"tolai",size:1,type:"verb"},{id:"tām",size:2,type:"pronoun"},{id:"malai",size:1,type:"noun"},{id:"nāṭu",size:3,type:"noun"},{id:"vaḻit",size:1},{id:"taṇantu",size:1},{id:"varaitaṟku",size:1},{id:"vēṇṭuvaṉa",size:1},{id:"muṭi",size:1,type:"noun"},{id:"talaimakaṉ",size:1},{id:"kūṟak",size:1},{id:"talaimakaḷ",size:2},{id:"ciṟaippuṟattāṉ",size:1},{id:"āyk",size:1},{id:"kēṭpat",size:1},{id:"aḷaik",size:1},{id:"āṭṭip",size:1},{id:"kuṟṟu",size:2,type:"verb"},{id:"eytu",size:1,type:"verb"},{id:"aṇi",size:8,type:"noun"},{id:"tēṟṟam",size:1},{id:"nap",size:1},{id:"iṉit",size:1},{id:"tākku",size:1,type:"verb"},{id:"aṇaṅku",size:3,type:"noun"},{id:"tāy",size:2,type:"noun"},{id:"cāp",size:1},{id:"piṟa",size:3,type:"noun"},{id:"kaḷvaṉoṭu",size:1},{id:"piḷḷai",size:1,type:"noun"},{id:"tiṉṉum",size:2},{id:"mutalaittu",size:1},{id:"eytiṉaṉ",size:1},{id:"makiḻ",size:23,type:"noun"},{id:"polam",size:2,type:"noun"},{id:"toṭi",size:8,type:"noun"},{id:"teḷir",size:1,type:"verb"},{id:"muyaṅkiyavar",size:1},{id:"tuṟappatu",size:1},{id:"ayal",size:1,type:"noun"},{id:"puṟantā",size:1,type:"verb"},{id:"puṉiṟu",size:2,type:"noun"},{id:"pai(m)",size:2,type:"adjective"},{id:"kāy",size:2,type:"noun"},{id:"vayalaic",size:2},{id:"ce(m)",size:9,type:"adjective"},{id:"koṭi",size:1,type:"noun"},{id:"palarkku",size:1},{id:"nekiḻ",size:2,type:"verb"},{id:"poy",size:5,type:"noun"},{id:"aṟiyāk",size:1},{id:"kaḻaṅku",size:1,type:"noun"},{id:"mey",size:1,type:"noun"},{id:"varaik",size:1},{id:"kaṭci",size:1,type:"noun"},{id:"mayil",size:2,type:"noun"},{id:"ālu",size:2,type:"verb"},{id:"nām",size:8,type:"pronoun"},{id:"vaḷḷi",size:1,type:"noun"},{id:"kāṉ",size:1,type:"noun"},{id:"kiḻamai",size:1,type:"noun"},{id:"āṇ",size:1,type:"noun"},{id:"taku",size:2,type:"verb"},{id:"viṟal",size:1,type:"noun"},{id:"vēṭkai",size:1,type:"noun"},{id:"pūṭṭu",size:1,type:"noun"},{id:"tāṅku",size:1,type:"verb"},{id:"iḷa(m)",size:1,type:"adjective"},{id:"karantai",size:1,type:"noun"},{id:"ceṟu",size:3,type:"verb"},{id:"vaḷḷai",size:1,type:"noun"},{id:"aṟi",size:7,type:"verb"},{id:"iṉṉaṉ",size:1},{id:"katir",size:5,type:"noun"},{id:"ṇakam",size:2},{id:"maṇ",size:2,type:"noun"},{id:"ṇaḷaic",size:1},{id:"nekiḻac",size:2},{id:"allal",size:1,type:"noun"},{id:"uḻa",size:1,type:"verb"},{id:"yaṇaṅku",size:1},{id:"uṟai",size:3,type:"noun"},{id:"cēṟu",size:1,type:"noun"},{id:"vari",size:3,type:"noun"},{id:"oṇmai",size:5,type:"noun"},{id:"kaṭi",size:1,type:"noun"},{id:"koḷak",size:1},{id:"kā",size:1,type:"noun"},{id:"kaṭuka",size:1},{id:"vittu",size:2,type:"noun"},{id:"muḷai",size:1,type:"noun"},{id:"marīit",size:1},{id:"titti",size:2,type:"noun"},{id:"yalkul",size:2},{id:"paca",size:6,type:"verb"},{id:"koḷvatu",size:1},{id:"pāl",size:2,type:"noun"},{id:"vūṟuka",size:1},{id:"pakaṭu",size:1},{id:"vuḻavar",size:1},{id:"peyar",size:2,type:"noun"},{id:"vēppa(m)",size:1,type:"noun"},{id:"neṭu(m)",size:7,type:"adjective"},{id:"ṇaḷai",size:1},{id:"vuṟaikkum",size:1},{id:"iḻa",size:1,type:"verb"},{id:"ñeli",size:1,type:"noun"},{id:"kaḻai",size:2,type:"noun"},{id:"aḻal",size:1,type:"noun"},{id:"vayamā",size:1},{id:"veru",size:2,type:"noun"},{id:"kuṉṟam",size:1,type:"noun"},{id:"yarum",size:1},{id:"curam",size:3,type:"noun"},{id:"ayar",size:1,type:"verb"},{id:"il",size:7,type:"noun"},{id:"poruḷ",size:1,type:"noun"},{id:"tuṇaip",size:1},{id:"kaṭam",size:1,type:"noun"},{id:"mūr",size:3},{id:"muṭam",size:1},{id:"mutir",size:2,type:"verb"},{id:"marutattup",size:2},{id:"yuṭaṉ",size:1},{id:"āyamōṭu",size:2},{id:"pāṇṭil",size:2,type:"noun"},{id:"kalam",size:1,type:"noun"},{id:"nantat",size:1},{id:"alkul",size:1,type:"noun"},{id:"vāṭṭam",size:1,type:"noun"},{id:"viṟantōr",size:1},{id:"maṉ",size:3},{id:"piṟaṅku",size:1,type:"verb"},{id:"malaip",size:1},{id:"pull",size:1},{id:"arai",size:1,type:"noun"},{id:"yōmai",size:1},{id:"puli",size:1,type:"noun"},{id:"vaḻakku",size:1,type:"noun"},{id:"cūḻkam",size:1},{id:"pāḻ",size:1,type:"noun"},{id:"paṭṭup",size:1},{id:"veppa(m)",size:2,type:"noun"},{id:"pālai",size:1,type:"noun"},{id:"vem",size:6},{id:"kāṭṭu",size:1,type:"noun"},{id:"aru(m)",size:2,type:"adjective"},{id:"iṟa",size:1,type:"verb"},{id:"neñcam",size:3,type:"noun"},{id:"nāḷ",size:5,type:"noun"},{id:"mil",size:1},{id:"vantataṟku",size:1},{id:"eḻu",size:2,type:"noun"},{id:"aḻupa",size:1},{id:"veṉpa",size:1},{id:"vavaṉ",size:1},{id:"tī",size:3,type:"noun"},{id:"yuṟu",size:1},{id:"meḻukiṉ",size:1},{id:"muḷiya",size:1},{id:"vēṉal",size:3,type:"noun"},{id:"nīṭik",size:1},{id:"kaṭu(m)",size:1,type:"adjective"},{id:"ñāyiṟu",size:1,type:"noun"},{id:"kal",size:1,type:"noun"},{id:"pakat",size:1},{id:"teṟu",size:1,type:"verb"},{id:"vāyiṉa",size:2},{id:"muṉ",size:6},{id:"yoḷ",size:4},{id:"arivai",size:4,type:"noun"},{id:"yuḷḷu",size:1},{id:"toṟum",size:1},{id:"eri",size:1,type:"noun"},{id:"kavar",size:1,type:"verb"},{id:"veṉṟūḻ",size:1},{id:"nīḷ",size:2,type:"noun"},{id:"iṭaic",size:1},{id:"kaṇpaṭuppiṉum",size:1},{id:"kāṇkuveṉ",size:1},{id:"kaṅkul",size:1,type:"noun"},{id:"naḷi",size:1,type:"noun"},{id:"nakar",size:2,type:"noun"},{id:"vēṅkai",size:1,type:"noun"},{id:"cuṇaṅku",size:2,type:"noun"},{id:"tēm",size:1,type:"noun"},{id:"pāy",size:4,type:"verb"},{id:"maruta(m)",size:3,type:"noun"},{id:"uyar",size:1,type:"verb"},{id:"viri",size:2,type:"verb"},{id:"tuṟaip",size:1},{id:"peṇṭirōṭu",size:1},{id:"tār",size:1,type:"noun"},{id:"talait",size:1},{id:"mūrp",size:2},{id:"poykaip",size:3},{id:"puḻaik",size:1},{id:"tātu",size:6,type:"noun"},{id:"vaṇṇa(m)",size:2,type:"noun"},{id:"vētilāḷarkkup",size:1},{id:"tiṇ",size:3,type:"adjective"},{id:"nilaik",size:1},{id:"kōṅkam",size:1,type:"noun"},{id:"paya",size:2,type:"verb"},{id:"vaṇi",size:1},{id:"miku",size:2,type:"verb"},{id:"koḻu",size:1,type:"verb"},{id:"mukiḻ",size:2,type:"noun"},{id:"poykai",size:7,type:"noun"},{id:"yāmpal",size:3},{id:"nār",size:1,type:"noun"},{id:"uri",size:1,type:"noun"},{id:"niṟam",size:3,type:"noun"},{id:"niḻaṟṟutal",size:1},{id:"yiṉip",size:1},{id:"maṟa",size:2,type:"verb"},{id:"uḷḷu",size:1,type:"verb"},{id:"amaikuva",size:1},{id:"kayal",size:2,type:"noun"},{id:"eṉak",size:3},{id:"karutiya",size:1},{id:"vuṇ",size:2},{id:"olku",size:1,type:"verb"},{id:"naya",size:4,type:"verb"},{id:"paṉi",size:1,type:"noun"},{id:"mal",size:1,type:"noun"},{id:"tēṟṟāṉ",size:1},{id:"uṇarntōr",size:2},{id:"vauvu",size:1,type:"verb"},{id:"mulai",size:3,type:"noun"},{id:"yaṭaiya",size:1},{id:"muyakkam",size:1,type:"noun"},{id:"vayiṉ",size:2,type:"noun"},{id:"tiruttu",size:1,type:"verb"},{id:"ñekiḻap",size:1},{id:"pakai",size:2,type:"noun"},{id:"pul",size:2,type:"noun"},{id:"lārka",size:1},{id:"pār",size:1,type:"noun"},{id:"ōtuka",size:1},{id:"kāytta",size:1},{id:"paḻaṉa(m)",size:5,type:"noun"},{id:"ākaṟka",size:2},{id:"aḻap",size:1},{id:"iṟai",size:1,type:"noun"},{id:"keṇṭai",size:1,type:"noun"},{id:"taru/tā",size:3,type:"verb"},{id:"vaviḻnta",size:1},{id:"vaṇṭu",size:6,type:"noun"},{id:"piṇi",size:4,type:"noun"},{id:"maṟi",size:1,type:"noun"},{id:"yiṭaip",size:1},{id:"piṇa",size:1,type:"noun"},{id:"pōlap",size:3},{id:"putalvaṉ",size:4,type:"noun"},{id:"naṭuvaṇaṉ",size:1},{id:"naṉṟum",size:1},{id:"iṉitumaṉṟa",size:1},{id:"vavar",size:1},{id:"kiṭa",size:1,type:"verb"},{id:"muṉi",size:1,type:"noun"},{id:"niṟa",size:1,type:"verb"},{id:"aka(m)",size:1,type:"noun"},{id:"kavai",size:2,type:"noun"},{id:"vīṉum",size:1},{id:"umparum",size:1},{id:"kātaliyiṉ",size:1},{id:"talai",size:1},{id:"amar",size:2,type:"noun"},{id:"vuḷḷam",size:1},{id:"yakaṉ",size:1},{id:"tantai",size:2,type:"noun"},{id:"muṟuvaliṉ",size:1},{id:"iṉ",size:3,type:"adjective"},{id:"naku",size:1,type:"verb"},{id:"payiṟṟic",size:1},{id:"uruṭṭu",size:1,type:"verb"},{id:"taḷar",size:2,type:"verb"},{id:"vāḷ",size:1,type:"noun"},{id:"yūṭṭat",size:1},{id:"puṟam",size:1,type:"noun"},{id:"naṟu(m)",size:7,type:"adjective"},{id:"puṟavam",size:3},{id:"kuṟu(m)",size:2,type:"adjective"},{id:"poṟu",size:1,type:"verb"},{id:"oṇ",size:1},{id:"maṉaikku",size:1},{id:"viḷakkam",size:1,type:"noun"},{id:"kaṉai",size:1,type:"verb"},{id:"vai",size:1,type:"noun"},{id:"mātar",size:1,type:"noun"},{id:"viḷaiyāṭak",size:1},{id:"kātalit",size:1},{id:"taḻuvu",size:3,type:"verb"},{id:"yiṉitu",size:1},{id:"iruntaṉaṉ",size:1},{id:"piracam",size:1,type:"noun"},{id:"ūtu",size:2,type:"verb"},{id:"pārpput",size:2},{id:"aṉpu",size:1,type:"noun"},{id:"mutalai",size:1,type:"noun"},{id:"poykaittu",size:1},{id:"mayaṅkiṉaḷ",size:1},{id:"māṇ",size:4,type:"noun"},{id:"yarivai",size:1},{id:"kāviri",size:1,type:"noun"},{id:"ampaṇattu",size:1},{id:"yāmai",size:3,type:"noun"},{id:"yēṟic",size:1},{id:"cempiṉ",size:1},{id:"pārppup",size:1},{id:"tīm",size:2,type:"adjective"},{id:"yiḷam",size:1},{id:"mukam",size:1,type:"noun"},{id:"vaḷarnticiṉāaṅku",size:1},{id:"yaiya",size:1},{id:"yaṟintaṉai",size:1},{id:"yoḻukumati",size:1},{id:"kūtir",size:1,type:"noun"},{id:"yāṟu",size:1,type:"noun"},{id:"aṇintaṉa",size:1},{id:"yaṉṟu",size:1},{id:"aḵtu",size:1},{id:"kuṟippiṉai",size:1},{id:"yāki",size:2},{id:"yīṇṭu",size:1},{id:"yaruḷātu",size:1},{id:"muḷ",size:1,type:"noun"},{id:"ḷeyiṟṟup",size:1},{id:"keṭiṟu",size:1,type:"noun"},{id:"cori",size:3,type:"verb"},{id:"vakaṉ",size:1},{id:"vaṭṭi",size:2,type:"noun"},{id:"ari",size:1,type:"noun"},{id:"payaṟu",size:1,type:"noun"},{id:"niṟaikkum",size:2},{id:"yāyam",size:1},{id:"valai",size:1,type:"noun"},{id:"eyiṟu",size:1,type:"noun"},{id:"varāal",size:1,type:"noun"},{id:"yuḷ",size:1},{id:"yāṅkaṇ",size:8,type:"pronoun"},{id:"vēṇṭēm",size:1},{id:"parattaṉ",size:1,type:"noun"},{id:"yāṇṭuc",size:1},{id:"kuṟiyōṭu",size:1},{id:"ōti",size:1,type:"noun"},{id:"yacai",size:1},{id:"naṭaip",size:2},{id:"peṟu",size:5,type:"verb"},{id:"citaiyap",size:1},{id:"paci",size:2,type:"noun"},{id:"yil",size:1},{id:"lākuka",size:3},{id:"cēṇ",size:1,type:"noun"},{id:"mutalaip",size:1},{id:"pōttu",size:2,type:"noun"},{id:"muḻu",size:1,type:"noun"},{id:"kaṭai",size:1,type:"noun"},{id:"niṟka",size:1},{id:"celvam",size:1,type:"noun"},{id:"varuttam",size:1,type:"noun"},{id:"vañci",size:1,type:"noun"},{id:"yōṅkiya",size:1},{id:"tañcam",size:1,type:"noun"},{id:"aruḷ",size:1,type:"noun"},{id:"kōḻi",size:1,type:"noun"},{id:"nīlac",size:1},{id:"cēval",size:1,type:"noun"},{id:"kūr",size:1,type:"noun"},{id:"ukirp",size:1},{id:"pēṭai",size:3,type:"noun"},{id:"vayāam",size:1},{id:"puḷim",size:1},{id:"vēṭkaittu",size:1},{id:"taiic",size:1},{id:"viral",size:1,type:"noun"},{id:"civa",size:3,type:"verb"},{id:"yari",size:1},{id:"maḻaik",size:1},{id:"vāyk",size:1},{id:"vev",size:1},{id:"yevaṉ",size:1},{id:"ciṟai",size:2,type:"noun"},{id:"yaḻi",size:2},{id:"kalaṅkik",size:1},{id:"kaḻaṉit",size:2},{id:"tāmarai",size:3,type:"noun"},{id:"vūra",size:1},{id:"tērt",size:1},{id:"teṉ",size:1,type:"noun"},{id:"nāṭṭu",size:1,type:"verb"},{id:"uḷ",size:1},{id:"oḻukku",size:1,type:"verb"},{id:"tēṉūr",size:3},{id:"vivaḷ",size:6},{id:"teri",size:1,type:"verb"},{id:"vūriṉ",size:1},{id:"pañcāyk",size:1},{id:"kōtai",size:1,type:"noun"},{id:"accam",size:2,type:"noun"},{id:"entiram",size:1},{id:"kaḷiṟu",size:1,type:"noun"},{id:"etir",size:1,type:"noun"},{id:"piḷiṟṟum",size:1},{id:"vaḷ",size:4,type:"noun"},{id:"kō",size:1,type:"noun"},{id:"laṇi",size:1},{id:"tuṟattaliṉ",size:1},{id:"aṟiyap",size:1},{id:"pakal",size:3,type:"noun"},{id:"viḷakkōṭu",size:1},{id:"ira(m)",size:1,type:"noun"},{id:"pōrc",size:1},{id:"cōḻaṉ",size:1,type:"noun"},{id:"āmūr",size:1,type:"noun"},{id:"tēmpa",size:1},{id:"vevaṉ",size:1},{id:"katirt",size:1},{id:"pulampap",size:1},{id:"vaṉai",size:1,type:"verb"},{id:"-uṭai",size:2},{id:"viṇṭu",size:1,type:"noun"},{id:"vaṉṉa",size:1},{id:"pōr",size:2,type:"verb"},{id:"kai",size:2,type:"noun"},{id:"virāaṉ",size:1,type:"noun"},{id:"iruppai",size:1,type:"noun"},{id:"maṉaiyai",size:1},{id:"vāṟṟu",size:1},{id:"maintu",size:1,type:"noun"},{id:"evvam",size:1,type:"noun"},{id:"tīr",size:1,type:"verb"},{id:"yāṉ",size:1,type:"pronoun"},{id:"yivaṭku",size:1},{id:"vēttu",size:1,type:"adjective"},{id:"taṇika",size:1},{id:"nantuka",size:1},{id:"tāmarait",size:1},{id:"varaika",size:1},{id:"entai",size:1,type:"noun"},{id:"koṭukka",size:1},{id:"paḻaṉak",size:1},{id:"kampuḷ",size:2,type:"noun"},{id:"payirp",size:1},{id:"peṭai",size:1,type:"noun"},{id:"yakavum",size:1},{id:"yūra",size:2},{id:"moḻi",size:2,type:"noun"},{id:"vaṭi",size:1,type:"noun"},{id:"viḷai",size:1,type:"noun"},{id:"uku",size:1,type:"verb"},{id:"paḻa(m)",size:1,type:"adjective"},{id:"nīrp",size:2},{id:"poykait",size:2},{id:"tuṭumeṉ",size:1},{id:"viḻūum",size:1},{id:"matti",size:1,type:"noun"},{id:"kaḻāar",size:1,type:"noun"},{id:"vatuvai",size:1,type:"noun"},{id:"yayara",size:1},{id:"intira",size:1},{id:"viḻavu",size:1,type:"noun"},{id:"talaip",size:2},{id:"akavu",size:1,type:"verb"},{id:"iv",size:1},{id:"vūr",size:2},{id:"maṅkaiyart",size:1},{id:"toku",size:1,type:"verb"},{id:"yev",size:1},{id:"nil",size:2,type:"verb"},{id:"paḷḷip",size:1},{id:"nīrnāy",size:1,type:"noun"},{id:"vāḷai",size:1,type:"noun"},{id:"irai",size:1,type:"noun"},{id:"tolaivatu",size:1},{id:"tuṉṉu",size:1,type:"verb"},{id:"piṟart",size:1},{id:"āṭak",size:1},{id:"oruvar",size:1},{id:"ē",size:1,type:"noun"},{id:"pāttiyiṉ",size:1},{id:"kali",size:1,type:"noun"},{id:"vāmpal",size:1},{id:"curumpu",size:1,type:"noun"},{id:"kaḷai",size:1,type:"verb"},{id:"yīṉṟa",size:1},{id:"muyaṅkaṉmō",size:1},{id:"uṭaliṉēṉ",size:1},{id:"urai",size:2,type:"verb"},{id:"yiṉik",size:1},{id:"nikarā",size:1},{id:"veṉṉoṭu",size:1},{id:"nikarip",size:1},{id:"tarukkum",size:1},{id:"malart",size:1},{id:"yōti",size:1},{id:"kaṉṉi",size:1,type:"noun"},{id:"viṭiyal",size:1,type:"noun"},{id:"kaṇaik",size:1},{id:"pēṇāḷ",size:1},{id:"naṭa",size:2,type:"verb"},{id:"kaṇṭaṉem",size:1},{id:"vaṇṭal",size:1,type:"noun"},{id:"uy",size:1,type:"verb"},{id:"vaḻutu",size:1},{id:"yaṟam",size:1},{id:"vallatu",size:1},{id:"keṭu",size:1,type:"verb"},{id:"yuḷaip",size:1},{id:"marutattuk",size:1},{id:"kiḷaik",size:1},{id:"ṉūrk",size:1},{id:"paḻaṉap",size:2},{id:"nārai",size:2,type:"noun"},{id:"ceṉṉic",size:1},{id:"cē",size:2,type:"noun"},{id:"tūyar",size:1},{id:"naṟiyar",size:1},{id:"pēy",size:1,type:"noun"},{id:"(i)yām",size:1},{id:"cūtu",size:1},{id:"toṭic",size:1},{id:"cūr",size:1,type:"noun"},{id:"nuṭakkattu",size:1},{id:"nerunal",size:1},{id:"yāṭiṉai",size:1},{id:"yeṉpa",size:1},{id:"maṟai",size:1,type:"noun"},{id:"ol(lu)",size:3,type:"verb"},{id:"putaittal",size:1},{id:"kayil",size:1},{id:"taḻait",size:1},{id:"tuyal",size:1,type:"verb"},{id:"kūntal",size:3,type:"noun"},{id:"kuvaḷai",size:2,type:"noun"},{id:"yuṇ",size:1},{id:"liyal",size:1},{id:"paṇṇai",size:2,type:"noun"},{id:"kaḷ",size:1,type:"verb"},{id:"nāṟit",size:1},{id:"taṇṇ",size:1},{id:"tōkaic",size:1},{id:"cīr",size:1,type:"noun"},{id:"pacu(m)",size:3,type:"adjective"},{id:"avir",size:1,type:"verb"},{id:"niḻaṟṟak",size:1},{id:"ēṟip",size:1},{id:"pāyvōḷ",size:1},{id:"ovvāy",size:1},{id:"vataṉāl",size:1},{id:"toṭakku",size:1,type:"verb"},{id:"tol",size:1,type:"adjective"},{id:"niṉṉōṭu",size:2},{id:"āṭiṉaḷ",size:1},{id:"paiñcāyk",size:1},{id:"malarc",size:1},{id:"āṭit",size:2},{id:"mēmpaṭṭaṉaḷ",size:1},{id:"antaram",size:1},{id:"makaḷirkkut",size:2},{id:"pēr",size:1,type:"noun"},{id:"alaik",size:1},{id:"vēl",size:1,type:"noun"},{id:"kaṭu",size:1,type:"verb"},{id:"kiḷḷi",size:1,type:"noun"},{id:"matil",size:1,type:"noun"},{id:"yāṉai",size:1,type:"noun"},{id:"kataḻpu",size:1},{id:"neṟi",size:2,type:"noun"},{id:"āṭi",size:1,type:"noun"},{id:"yamartta",size:1},{id:"paṟṟu",size:1,type:"noun"},{id:"makaṉai",size:1},{id:"yaracu",size:1},{id:"muṟai",size:1,type:"noun"},{id:"ceyka",size:1},{id:"kaḷavu",size:1,type:"noun"},{id:"yalaṅku",size:1},{id:"cūḷ",size:1,type:"noun"},{id:"vāyppatu",size:1},{id:"pulakkuvēm",size:1},{id:"nalat",size:1},{id:"yākit",size:1},{id:"tava",size:1},{id:"ḷakaṭṭu",size:1},{id:"yarip",size:1},{id:"paṟai",size:2,type:"noun"},{id:"viṉai",size:1,type:"noun"},{id:"micaik",size:1},{id:"kūṭṭam",size:1,type:"noun"},{id:"nayantaṉeṉ",size:1},{id:"kēṭkiṉ",size:1},{id:"vekuṇṭaṉaḷ",size:1},{id:"aviḻ",size:2,type:"noun"},{id:"iṇar",size:1,type:"noun"},{id:"tārt",size:1},{id:"paṟa",size:1,type:"verb"},{id:"yaruḷāy",size:1},{id:"paipayat",size:1},{id:"taṇa",size:1,type:"verb"},{id:"yuymmō",size:1},{id:"num",size:3,type:"pronoun"},{id:"āy",size:1,type:"verb"},{id:"cevi",size:1,type:"noun"},{id:"liṟantu",size:1},{id:"vekuḷvōḷ",size:1},{id:"yaim",size:1},{id:"taiit",size:1},{id:"kayam",size:1,type:"noun"},{id:"paṭintu",size:1},{id:"arik",size:1},{id:"kural",size:2,type:"noun"},{id:"paḻaṉattuk",size:1},{id:"kiḷaiyōṭu",size:1},{id:"mali",size:2,type:"verb"},{id:"ciṟuvariṉ",size:1},{id:"nakār",size:1},{id:"talaik",size:1},{id:"viḷik",size:1},{id:"yimiḻum",size:1},{id:"mivaṇ",size:1},{id:"alku",size:1,type:"verb"},{id:"pakaṉṟaik",size:1},{id:"kaṇṇip",size:1},{id:"lāṉ",size:1},{id:"kōvalar",size:1,type:"noun"},{id:"kuṇil",size:1,type:"noun"},{id:"ā",size:1},{id:"kaṉi",size:1,type:"noun"},{id:"yutirkkum",size:1},{id:"pula",size:2,type:"verb"},{id:"malarp",size:2},{id:"yevvai",size:1},{id:"yem",size:1},{id:"vevvaikku",size:1},{id:"aḷi",size:1,type:"noun"},{id:"virumpiṉṟu",size:1},{id:"yampal",size:1},{id:"kuṇam",size:2,type:"noun"},{id:"maruppu",size:1,type:"noun"},{id:"virum",size:1},{id:"veṟi",size:1,type:"noun"},{id:"mayakkum",size:2},{id:"vetir",size:1,type:"noun"},{id:"karu(m)",size:3,type:"adjective"},{id:"kōṭṭam",size:4,type:"noun"},{id:"erumaic",size:1},{id:"āk",size:1},{id:"kuḻavikku",size:1},{id:"ūṟṟu",size:1,type:"noun"},{id:"maṭukkum",size:1},{id:"nuntai",size:2,type:"noun"},{id:"maṭantai",size:1,type:"noun"},{id:"niṉṉai",size:1},{id:"lēṟṟu",size:1},{id:"iṉam",size:1,type:"noun"},{id:"mēy",size:2,type:"verb"},{id:"aruttu",size:1,type:"verb"},{id:"mōrōṭamōṭu",size:1},{id:"viṉaiya",size:1},{id:"veṟukkaiya",size:1},{id:"vāki",size:1},{id:"yivaḷ",size:1},{id:"mucci",size:1,type:"noun"},{id:"maḷḷar",size:1,type:"noun"},{id:"vati",size:1,type:"noun"},{id:"ilañcip",size:1},{id:"paḻaṉattatu",size:1},{id:"kayiṟu",size:1,type:"noun"},{id:"acai",size:1,type:"verb"},{id:"muṟṟi",size:1,type:"verb"},{id:"yaru",size:1},{id:"yerumai",size:2},{id:"yāṭiya",size:1},{id:"āmpaloṭu",size:1},{id:"kalikkum",size:1},{id:"vūraṉ",size:1},{id:"pāyal",size:1,type:"noun"},{id:"pakaṉṟai",size:1,type:"noun"},{id:"miṭai",size:1,type:"noun"},{id:"kōṭṭaik",size:1},{id:"erumaik",size:1},{id:"kaṉṟu",size:1,type:"noun"},{id:"yampiyiṉ",size:1},{id:"pākal",size:1,type:"noun"},{id:"muyiṟu",size:1,type:"noun"},{id:"mūcu",size:1,type:"verb"},{id:"kuṭampai",size:1,type:"noun"}],IA=[{id:"a- ūr",source:"a-",target:"ūr",strength:.16165775065637075,citations:["Aink24","Aink41"]},{id:"a- nī",source:"a-",target:"nī",strength:.17841325553979803,citations:["Aink44","Aink51"]},{id:"ūr ūr",source:"ūr",target:"ūr",strength:.20940809846682662,citations:["Aink15"],curvature:.5},{id:"ūr maka",source:"ūr",target:"maka",strength:.21436973173350696,citations:["Aink100","Aink99"]},{id:"vāḻ yūraṉ",source:"vāḻ",target:"yūraṉ",strength:.24165101797076322,citations:["Aink36","Aink39"]},{id:"tuṟai ūr",source:"tuṟai",target:"ūr",strength:.24403566537063812,citations:["Aink11","Aink12"]},{id:"ūr peru(m)",source:"ūr",target:"peru(m)",strength:.24403566537063812,citations:["Aink30","Aink48"]},{id:"makiḻ nī",source:"makiḻ",target:"nī",strength:.24815498107505646,citations:["Aink69","Aink77"]},{id:"makiḻ a-",source:"makiḻ",target:"a-",strength:.25176303586613796,citations:["Aink31","Aink90"]},{id:"nī pal",source:"nī",target:"pal",strength:.26756823624837434,citations:["Aink55","Aink69"]},{id:"puṉal ūr",source:"puṉal",target:"ūr",strength:.2733869843784451,citations:["Aink65","Aink95"]},{id:"pū(m) a-",source:"pū(m)",target:"a-",strength:.2858111089369301,citations:["Aink41","Aink62"]},{id:"ūr eṉ",source:"ūr",target:"eṉ",strength:.2907724327427665,citations:["Aink41","Aink89"]},{id:"ūr nal",source:"ūr",target:"nal",strength:.29261786340811874,citations:["Aink12","Aink22","Aink63"]},{id:"nal nal",source:"nal",target:"nal",strength:.29834096697228707,citations:["Aink204","Aink61"],curvature:.5},{id:"tāṉ a-",source:"tāṉ",target:"a-",strength:.3021714434273284,citations:["Aink103","Aink404"],curvature:.25},{id:"nī maka",source:"nī",target:"maka",strength:.30460037662197414,citations:["Aink101","Aink29","Aink49"]},{id:"eṉ nī",source:"eṉ",target:"nī",strength:.30752793762619374,citations:["Aink81","Aink82"]},{id:"pū(m) taṭpam",source:"pū(m)",target:"taṭpam",strength:.30968150478734185,citations:["Aink103","Aink404"]},{id:"malar a-",source:"malar",target:"a-",strength:.31113599241727524,citations:["Aink18","Aink72"]},{id:"eṉ a-",source:"eṉ",target:"a-",strength:.31113599241727524,citations:["Aink41","Aink89"]},{id:"ākkam peru(m)",source:"ākkam",target:"peru(m)",strength:.3118689877829798,citations:["Aink403","Aink63"]},{id:"vāḻ pāṇ",source:"vāḻ",target:"pāṇ",strength:.3246919520797524,citations:["Aink1","Aink89"]},{id:"ākkam taṭpam",source:"ākkam",target:"taṭpam",strength:.3281636959117378,citations:["Aink28","Aink45","Aink54"]},{id:"kaṇ maka",source:"kaṇ",target:"maka",strength:.33101302865405285,citations:["Aink406","Aink79"]},{id:"cel ūr",source:"cel",target:"ūr",strength:.33385366547393625,citations:["Aink22","Aink27"]},{id:"tuṟai i-",source:"tuṟai",target:"i-",strength:.3341409505804054,citations:["Aink103","Aink28"]},{id:"malar taṭpam",source:"malar",target:"taṭpam",strength:.33500638826768697,citations:["Aink108","Aink69"]},{id:"ūr ākkam",source:"ūr",target:"ākkam",strength:.33794445386181143,citations:["Aink15","Aink19","Aink24"]},{id:"ūr maṉai",source:"ūr",target:"maṉai",strength:.34709246861098425,citations:["Aink3","Aink87"]},{id:"ūr i-",source:"ūr",target:"i-",strength:.36258920701756664,citations:["Aink100","Aink30","Aink8","Aink99"]},{id:"pū(m) peru(m)",source:"pū(m)",target:"peru(m)",strength:.36818902365119743,citations:["Aink19","Aink33"]},{id:"vāḻ nām",source:"vāḻ",target:"nām",strength:.3689259076046729,citations:["Aink34","Aink35"]},{id:"makiḻ tāṉ",source:"makiḻ",target:"tāṉ",strength:.3719131689625868,citations:["Aink38","Aink66"]},{id:"tuṟai varavu",source:"tuṟai",target:"varavu",strength:.3761284587672213,citations:["Aink105","Aink69"]},{id:"ūr toṭi",source:"ūr",target:"toṭi",strength:.3780876209988568,citations:["Aink28","Aink98"]},{id:"ākkam e-",source:"ākkam",target:"e-",strength:.37848279139188573,citations:["Aink108","Aink17"]},{id:"a- tāṉ",source:"a-",target:"tāṉ",strength:.37988671257354756,citations:["Aink343","Aink41","Aink66"],curvature:.25},{id:"em a-",source:"em",target:"a-",strength:.38209084618296724,citations:["Aink82","Aink90"]},{id:"tuṟai tāṉ",source:"tuṟai",target:"tāṉ",strength:.38454935814159574,citations:["Aink10","Aink7"]},{id:"yūraṉ tāṉ",source:"yūraṉ",target:"tāṉ",strength:.39132642413590474,citations:["Aink10","Aink7"]},{id:"nī yāṅkaṇ",source:"nī",target:"yāṅkaṇ",strength:.39484312588228404,citations:["Aink79","Aink87"]},{id:"peṇ ūr",source:"peṇ",target:"ūr",strength:.396635438484893,citations:["Aink13","Aink40"]},{id:"ūr nī",source:"ūr",target:"nī",strength:.4020169965930798,citations:["Aink42","Aink43","Aink49","Aink54","Aink68","Aink85","Aink87"]},{id:"yūraṉ maka",source:"yūraṉ",target:"maka",strength:.4028996295736917,citations:["Aink91","Aink96","Aink97"]},{id:"varavu puṉal",source:"varavu",target:"puṉal",strength:.4054797777750283,citations:["Aink69","Aink72"]},{id:"kaḷvaṉ taṭpam",source:"kaḷvaṉ",target:"taṭpam",strength:.40596124203337897,citations:["Aink27","Aink30"]},{id:"cel nal",source:"cel",target:"nal",strength:.4123770534691488,citations:["Aink22","Aink307"]},{id:"aṟi nī",source:"aṟi",target:"nī",strength:.4133909433683203,citations:["Aink47","Aink79"]},{id:"ūr pāṇ",source:"ūr",target:"pāṇ",strength:.4134597704436027,citations:["Aink1","Aink43","Aink49"]},{id:"ūr vem",source:"ūr",target:"vem",strength:.4180473223766762,citations:["Aink63","Aink86"]},{id:"tōḻaṉ yūraṉ",source:"tōḻaṉ",target:"yūraṉ",strength:.42016800936262916,citations:["Aink36","Aink39"]},{id:"yūraṉ i-",source:"yūraṉ",target:"i-",strength:.42094573111807504,citations:["Aink91","Aink96","Aink97"]},{id:"a- nal",source:"a-",target:"nal",strength:.42104440896785095,citations:["Aink55","Aink56","Aink57","Aink61"]},{id:"varavu eṉ",source:"varavu",target:"eṉ",strength:.4228652261393496,citations:["Aink2","Aink88"]},{id:"peru(m) tuṟai",source:"peru(m)",target:"tuṟai",strength:.42715453432191397,citations:["Aink31","Aink69","Aink75"]},{id:"kaṇ e-",source:"kaṇ",target:"e-",strength:.42729276590009,citations:["Aink84"]},{id:"nī pāṇ",source:"nī",target:"pāṇ",strength:.43121526544220945,citations:["Aink43","Aink47","Aink49"]},{id:"eṉ tāṉ",source:"eṉ",target:"tāṉ",strength:.43128612551372414,citations:["Aink33","Aink41"]},{id:"nī paca",source:"nī",target:"paca",strength:.43480282726010344,citations:["Aink29","Aink45"]},{id:"yaṉṉa nī",source:"yaṉṉa",target:"nī",strength:.43480282726010344,citations:["Aink307","Aink42"]},{id:"kaḻaṉi maka",source:"kaḻaṉi",target:"maka",strength:.43480282726010344,citations:["Aink91","Aink96"]},{id:"peṟu ūr",source:"peṟu",target:"ūr",strength:.4433722058570213,citations:["Aink49","Aink63"]},{id:"nī maṉai",source:"nī",target:"maṉai",strength:.44524417740414574,citations:["Aink66","Aink81","Aink87"]},{id:"nal eṉ",source:"nal",target:"eṉ",strength:.45101715918889707,citations:["Aink204","Aink67"]},{id:"tāṉ koḷ",source:"tāṉ",target:"koḷ",strength:.45116316175050175,citations:["Aink10","Aink7"]},{id:"yāṅkaṇ maka",source:"yāṅkaṇ",target:"maka",strength:.45116316175050175,citations:["Aink79"]},{id:"yaviṉi pal",source:"yaviṉi",target:"pal",strength:.4566110089940693,citations:["Aink1","Aink3"]},{id:"yāy pū(m)",source:"yāy",target:"pū(m)",strength:.45800702375449553,citations:["Aink10","Aink4"]},{id:"taṭpam āṭu",source:"taṭpam",target:"āṭu",strength:.4622812779015967,citations:["Aink77","Aink98"]},{id:"ākkam aṟi",source:"ākkam",target:"aṟi",strength:.4644687608972346,citations:["Aink79","Aink90"]},{id:"makiḻ toṭi",source:"makiḻ",target:"toṭi",strength:.46819290620862397,citations:["Aink24","Aink40"]},{id:"pal veṉa",source:"pal",target:"veṉa",strength:.47124582689154354,citations:["Aink3","Aink6"]},{id:"vāḻ vāḻ",source:"vāḻ",target:"vāḻ",strength:.4713850854539946,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.5},{id:"yām pū(m)",source:"yām",target:"pū(m)",strength:.47253407973057987,citations:["Aink10","Aink4","Aink7"]},{id:"tuñcu ūr",source:"tuñcu",target:"ūr",strength:.47436735824489384,citations:["Aink13","Aink43"]},{id:"ūr māṇ",source:"ūr",target:"māṇ",strength:.47436735824489384,citations:["Aink42","Aink47"]},{id:"miṉ taṭpam",source:"miṉ",target:"taṭpam",strength:.48760616138194185,citations:["Aink10","Aink5"]},{id:"maṭa(m) maka",source:"maṭa(m)",target:"maka",strength:.4911228631283211,citations:["Aink48","Aink98"]},{id:"puṉal em",source:"puṉal",target:"em",strength:.49382007990504156,citations:["Aink77","Aink78"]},{id:"pōl kaṇ",source:"pōl",target:"kaṇ",strength:.49473091791940266,citations:["Aink101","Aink16"]},{id:"poḻutu a-",source:"poḻutu",target:"a-",strength:.49473091791940266,citations:["Aink406","Aink82"]},{id:"nī peṇ",source:"nī",target:"peṇ",strength:.4977439355392991,citations:["Aink68","Aink69","Aink70"]},{id:"toṭi yām",source:"toṭi",target:"yām",strength:.5022409792794161,citations:["Aink38","Aink40"]},{id:"koḷ cel",source:"koḷ",target:"cel",strength:.5032089434716184,citations:["Aink10","Aink7"]},{id:"i- no/nō",source:"i-",target:"no/nō",strength:.5081526075864433,citations:["Aink28","Aink99"]},{id:"taṭpam puṉal",source:"taṭpam",target:"puṉal",strength:.509777734423902,citations:["Aink54","Aink69","Aink76","Aink77","Aink98"]},{id:"vāḻ makiḻ",source:"vāḻ",target:"makiḻ",strength:.5137186259366764,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40","Aink59","Aink77"]},{id:"tōṟṟam ūr",source:"tōṟṟam",target:"ūr",strength:.5143270596227133,citations:["Aink17","Aink98"]},{id:"maka paḻaṉa(m)",source:"maka",target:"paḻaṉa(m)",strength:.5164477466086663,citations:["Aink91","Aink96"]},{id:"tuṟai kēḷ",source:"tuṟai",target:"kēḷ",strength:.5207887967654523,citations:["Aink2","Aink9"]},{id:"nī mārpu",source:"nī",target:"mārpu",strength:.5253423522796198,citations:["Aink42","Aink44","Aink46","Aink51"]},{id:"yāṇar nī",source:"yāṇar",target:"nī",strength:.5253423522796198,citations:["Aink42","Aink43","Aink49","Aink87"]},{id:"yūraṉ kēḷ",source:"yūraṉ",target:"kēḷ",strength:.5275658627597613,citations:["Aink2","Aink9"]},{id:"aṟu yūraṉ",source:"aṟu",target:"yūraṉ",strength:.5275658627597613,citations:["Aink25","Aink29"]},{id:"nī neñcam",source:"nī",target:"neñcam",strength:.5310825645061406,citations:["Aink50"]},{id:"veḷ pū(m)",source:"veḷ",target:"pū(m)",strength:.5322153678885139,citations:["Aink17","Aink19","Aink41"]},{id:"i- paḻaṉa(m)",source:"i-",target:"paḻaṉa(m)",strength:.5334774910667885,citations:["Aink91","Aink96"]},{id:"kaṇ paca",source:"kaṇ",target:"paca",strength:.5346906192972221,citations:["Aink36","Aink37"]},{id:"muṉ yām",source:"muṉ",target:"yām",strength:.5422006806572355,citations:["Aink38","Aink40"]},{id:"veḷ nel",source:"veḷ",target:"nel",strength:.5422006806572355,citations:["Aink48","Aink58"]},{id:"em cel",source:"em",target:"cel",strength:.5542867610005326,citations:["Aink77"]},{id:"pāṇ maka",source:"pāṇ",target:"maka",strength:.5568193656941569,citations:["Aink47","Aink48","Aink49"]},{id:"pōl uṇ",source:"pōl",target:"uṇ",strength:.5585610151476338,citations:["Aink101","Aink16"]},{id:"tāṉ amai",source:"tāṉ",target:"amai",strength:.5585610151476338,citations:["Aink103"]},{id:"keḻu ūr",source:"keḻu",target:"ūr",strength:.5623595014029593,citations:["Aink11","Aink12","Aink85"]},{id:"i- maruntu",source:"i-",target:"maruntu",strength:.5644726434546611,citations:["Aink59","Aink99"]},{id:"peru(m) ciṟa",source:"peru(m)",target:"ciṟa",strength:.5692068833421149,citations:["Aink1","Aink403","Aink9"]},{id:"ūr koṭu(m)",source:"ūr",target:"koṭu(m)",strength:.5706470954909311,citations:["Aink11","Aink12"]},{id:"niṟaikkum ūr",source:"niṟaikkum",target:"ūr",strength:.5706470954909311,citations:["Aink47","Aink48"]},{id:"no/nō ākkam",source:"no/nō",target:"ākkam",strength:.5745599157189679,citations:["Aink101","Aink28","Aink99"]},{id:"taṭpam kaṭal",source:"taṭpam",target:"kaṭal",strength:.5763884133648955,citations:["Aink106","Aink107","Aink108"]},{id:"tuṟai keḻu",source:"tuṟai",target:"keḻu",strength:.5771088326336701,citations:["Aink11","Aink12"]},{id:"kaḷvaṉ kaḻaṉi",source:"kaḷvaṉ",target:"kaḻaṉi",strength:.5821603820350549,citations:["Aink25","Aink29"]},{id:"vēṉal ākkam",source:"vēṉal",target:"ākkam",strength:.5821603820350549,citations:["Aink45","Aink54"]},{id:"maṉai yāṅkaṇ",source:"maṉai",target:"yāṅkaṇ",strength:.583885898627979,citations:["Aink48","Aink87"]},{id:"vivaḷ nal",source:"vivaḷ",target:"nal",strength:.5858879781863173,citations:["Aink55","Aink56","Aink57"]},{id:"yūra nī",source:"yūra",target:"nī",strength:.5874026003743582,citations:["Aink60","Aink81"]},{id:"nī moḻi",source:"nī",target:"moḻi",strength:.5874026003743582,citations:["Aink60","Aink77"]},{id:"a- vivaḷ",source:"a-",target:"vivaḷ",strength:.5916550080085913,citations:["Aink54","Aink55","Aink56","Aink57"]},{id:"vēḻam pū(m)",source:"vēḻam",target:"pū(m)",strength:.5918966560464478,citations:["Aink12","Aink17","Aink19"]},{id:"nal nāṭu",source:"nal",target:"nāṭu",strength:.5928504476179258,citations:["Aink61"]},{id:"pūk ūr",source:"pūk",target:"ūr",strength:.5971448968716753,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"aṉṉai vāḻ",source:"aṉṉai",target:"vāḻ",strength:.5991479387420863,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink201","Aink204"],curvature:.25},{id:"vāḻ aṉṉai",source:"vāḻ",target:"aṉṉai",strength:.5991479387420863,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink201","Aink204"],curvature:.25},{id:"puṉal aṭu",source:"puṉal",target:"aṭu",strength:.6003099268774423,citations:["Aink100","Aink15","Aink72"]},{id:"maṉai neṭu(m)",source:"maṉai",target:"neṭu(m)",strength:.6024337161140152,citations:["Aink324","Aink60"]},{id:"varavu eṉap",source:"varavu",target:"eṉap",strength:.606460151641477,citations:["Aink105","Aink72"]},{id:"taṭpam ṇakam",source:"taṭpam",target:"ṇakam",strength:.6148810510158516,citations:["Aink27","Aink30"]},{id:"taṭpam maṇ",source:"taṭpam",target:"maṇ",strength:.6148810510158516,citations:["Aink27","Aink30"]},{id:"tāṉ col",source:"tāṉ",target:"col",strength:.6148810510158516,citations:["Aink38","Aink41"]},{id:"maka i-",source:"maka",target:"i-",strength:.6155679282046013,citations:["Aink100","Aink52","Aink79","Aink91","Aink96","Aink97","Aink98","Aink99"]},{id:"il veṉa",source:"il",target:"veṉa",strength:.6170685340114894,citations:["Aink8","Aink9"]},{id:"al poy",source:"al",target:"poy",strength:.6238456000057984,citations:["Aink66","Aink80"]},{id:"tēṉūr a-",source:"tēṉūr",target:"a-",strength:.6262829323807777,citations:["Aink54","Aink55","Aink57"]},{id:"yūraṉ mārpu",source:"yūraṉ",target:"mārpu",strength:.6279880926959907,citations:["Aink14","Aink25","Aink29","Aink4"]},{id:"kaṇ ēr",source:"kaṇ",target:"ēr",strength:.6309703565432592,citations:["Aink101","Aink72"]},{id:"kañal ūr",source:"kañal",target:"ūr",strength:.6314421829515726,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"maruntu ākkam",source:"maruntu",target:"ākkam",strength:.6342412038769019,citations:["Aink101","Aink59","Aink99"]},{id:"taṭpam yūraṉ",source:"taṭpam",target:"yūraṉ",strength:.6370612001093251,citations:["Aink10","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"aṟu kaḻaṉi",source:"aṟu",target:"kaḻaṉi",strength:.6384804179032726,citations:["Aink25","Aink29"]},{id:"poykaip pū(m)",source:"poykaip",target:"pū(m)",strength:.6384804179032726,citations:["Aink34","Aink97"]},{id:"āṭu em",source:"āṭu",target:"em",strength:.6384804179032726,citations:["Aink77","Aink78"]},{id:"tōḻaṉ nām",source:"tōḻaṉ",target:"nām",strength:.6397962845595,citations:["Aink34","Aink35","Aink36"]},{id:"puṉal āṭu",source:"puṉal",target:"āṭu",strength:.6426544747078964,citations:["Aink77","Aink78","Aink98"]},{id:"e- taṭa(m)",source:"e-",target:"taṭa(m)",strength:.643722636242576,citations:["Aink11"]},{id:"uṇ kaṇ",source:"uṇ",target:"kaṇ",strength:.6481832193963125,citations:["Aink101","Aink16","Aink21","Aink37","Aink406"]},{id:"nōkkam nal",source:"nōkkam",target:"nal",strength:.6491704834861436,citations:["Aink204"]},{id:"vēḻam veḷ",source:"vēḻam",target:"veḷ",strength:.6515779442043819,citations:["Aink13","Aink17","Aink19"]},{id:"tōḻaṉ makiḻ",source:"tōḻaṉ",target:"makiḻ",strength:.6530025715678441,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40"]},{id:"vēḻam karuppu",source:"vēḻam",target:"karuppu",strength:.6548407523936709,citations:["Aink12","Aink18"]},{id:"mel kāl",source:"mel",target:"kāl",strength:.6548407523936709,citations:["Aink26","Aink35"]},{id:"poṉ cey",source:"poṉ",target:"cey",strength:.6548407523936709,citations:["Aink316","Aink41"]},{id:"kāl āmpal",source:"kāl",target:"āmpal",strength:.6548407523936709,citations:["Aink34","Aink68"]},{id:"toṭi maṭa(m)",source:"toṭi",target:"maṭa(m)",strength:.6548407523936709,citations:["Aink76","Aink98"]},{id:"mūtu ūr",source:"mūtu",target:"ūr",strength:.6669268327369681,citations:["Aink15"]},{id:"tuṟai yūraṉai",source:"tuṟai",target:"yūraṉai",strength:.6733885698797072,citations:["Aink20","Aink88"]},{id:"marutattup peru(m)",source:"marutattup",target:"peru(m)",strength:.6733885698797072,citations:["Aink31","Aink75"]},{id:"marutattup tuṟai",source:"marutattup",target:"tuṟai",strength:.6733885698797072,citations:["Aink31","Aink75"]},{id:"kaḻaṉi mārpu",source:"kaḻaṉi",target:"mārpu",strength:.676585751707356,citations:["Aink25","Aink29","Aink4"]},{id:"ciṟa vēṭṭōḷ",source:"ciṟa",target:"vēṭṭōḷ",strength:.6784142493532836,citations:["Aink1","Aink10","Aink3"]},{id:"aṉṉai namm",source:"aṉṉai",target:"namm",strength:.6801656358740161,citations:["Aink102","Aink104"]},{id:"puṇar tuṇai",source:"puṇar",target:"tuṇai",strength:.6801656358740161,citations:["Aink15","Aink72"]},{id:"aṭu puṇar",source:"aṭu",target:"puṇar",strength:.6801656358740161,citations:["Aink15","Aink72"]},{id:"peṟu nutal",source:"peṟu",target:"nutal",strength:.6801656358740161,citations:["Aink56","Aink94"]},{id:"aruḷ nī",source:"aruḷ",target:"nī",strength:.6836823376203954,citations:["Aink50"]},{id:"yāṇar ūr",source:"yāṇar",target:"ūr",strength:.6864737940318947,citations:["Aink1","Aink100","Aink42","Aink43","Aink49","Aink50","Aink70","Aink87"]},{id:"vuṇ kaṇ",source:"vuṇ",target:"kaṇ",strength:.6872903924114769,citations:["Aink36","Aink69"]},{id:"vāḻ vēṇṭu",source:"vāḻ",target:"vēṇṭu",strength:.6905321574161809,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink201","Aink204"]},{id:"ciṟa veṉa",source:"ciṟa",target:"veṉa",strength:.6939224920348359,citations:["Aink1","Aink10","Aink3"]},{id:"tātu uṇ",source:"tātu",target:"uṇ",strength:.6939224920348359,citations:["Aink67","Aink82","Aink93"]},{id:"pūp uṇ",source:"pūp",target:"uṇ",strength:.6948004537714904,citations:["Aink101","Aink16"]},{id:"ōkku pū(m)",source:"ōkku",target:"pū(m)",strength:.6948004537714904,citations:["Aink16","Aink33"]},{id:"yaḻi puṉal",source:"yaḻi",target:"puṉal",strength:.702739888887514,citations:["Aink53","Aink78"]},{id:"puṉal āṭit",source:"puṉal",target:"āṭit",strength:.702739888887514,citations:["Aink76","Aink80"]},{id:"vāḻ tōḻaṉ",source:"vāḻ",target:"tōḻaṉ",strength:.7052889830525715,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink35","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"curam cel",source:"curam",target:"cel",strength:.7068865341147876,citations:["Aink307","Aink317"]},{id:"naṉi ciṟa",source:"naṉi",target:"ciṟa",strength:.7111607882618887,citations:["Aink10","Aink7"]},{id:"yoḷ nutal",source:"yoḷ",target:"nutal",strength:.7111607882618887,citations:["Aink322","Aink73"]},{id:"tāṉ uṇarntōr",source:"tāṉ",target:"uṇarntōr",strength:.7111607882618887,citations:["Aink38","Aink41"]},{id:"taṭpam tuṟai",source:"taṭpam",target:"tuṟai",strength:.7151304466657624,citations:["Aink10","Aink103","Aink105","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"ciṟu(m) miṉ",source:"ciṟu(m)",target:"miṉ",strength:.7201253372518356,citations:["Aink1","Aink10"]},{id:"oṇmai muṉ",source:"oṇmai",target:"muṉ",strength:.7201253372518356,citations:["Aink40","Aink83"]},{id:"kaḻaṉit malar",source:"kaḻaṉit",target:"malar",strength:.7201253372518356,citations:["Aink53","Aink94"]},{id:"lākuka vēṭṭōḷ",source:"lākuka",target:"vēṭṭōḷ",strength:.7201253372518356,citations:["Aink8","Aink9"]},{id:"vāḻ yātaṉ",source:"vāḻ",target:"yātaṉ",strength:.7231485968426664,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"yātaṉ vāḻ",source:"yātaṉ",target:"vāḻ",strength:.7231485968426664,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"vāḻ yaviṉi",source:"vāḻ",target:"yaviṉi",strength:.7231485968426664,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"vāl iḻai",source:"vāl",target:"iḻai",strength:.729708605747925,citations:["Aink0","Aink73"]},{id:"māṇ iḻai",source:"māṇ",target:"iḻai",strength:.729708605747925,citations:["Aink42","Aink47"]},{id:"puḷḷik kaḷvaṉ",source:"puḷḷik",target:"kaḷvaṉ",strength:.7347601551493097,citations:["Aink21","Aink22"]},{id:"lākuka veṉa",source:"lākuka",target:"veṉa",strength:.7347601551493097,citations:["Aink8","Aink9"]},{id:"kaḻaṉi yūraṉ",source:"kaḻaṉi",target:"yūraṉ",strength:.7361876716725394,citations:["Aink18","Aink25","Aink29","Aink4","Aink91","Aink96"]},{id:"kaḷvaṉ aṟu",source:"kaḷvaṉ",target:"aṟu",strength:.7362670398652899,citations:["Aink21","Aink25","Aink29"]},{id:"tōḻaṉ mūrp",source:"tōḻaṉ",target:"mūrp",strength:.7400023734886132,citations:["Aink34","Aink35"]},{id:"kuṇam koḷ",source:"kuṇam",target:"koḷ",strength:.7400023734886132,citations:["Aink90"]},{id:"tuṟai yūraṉ",source:"tuṟai",target:"yūraṉ",strength:.7432703608170488,citations:["Aink10","Aink13","Aink14","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink9"]},{id:"putup puṉal",source:"putup",target:"puṉal",strength:.7433104735890198,citations:["Aink53","Aink64","Aink78","Aink79"]},{id:"peṟu cuṭar",source:"peṟu",target:"cuṭar",strength:.7454502207321806,citations:["Aink56","Aink94"]},{id:"amma vāḻ",source:"amma",target:"vāḻ",strength:.7475303760733198,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40","Aink77","Aink89"]},{id:"maṇal aṭu",source:"maṇal",target:"aṭu",strength:.7511204896397081,citations:["Aink100","Aink15"]},{id:"pūp pōl",source:"pūp",target:"pōl",strength:.7511204896397081,citations:["Aink101","Aink16"]},{id:"no/nō maruntu",source:"no/nō",target:"maruntu",strength:.7511204896397081,citations:["Aink101","Aink99"]},{id:"vēṇṭu namm",source:"vēṇṭu",target:"namm",strength:.7511204896397081,citations:["Aink102","Aink104"]},{id:"karai vēḻam",source:"karai",target:"vēḻam",strength:.7511204896397081,citations:["Aink12","Aink13"]},{id:"puṟavam aṇi",source:"puṟavam",target:"aṇi",strength:.7511204896397081,citations:["Aink404","Aink405"]},{id:"al urai",source:"al",target:"urai",strength:.7511204896397081,citations:["Aink66","Aink80"]},{id:"taṭa(m) erumai",source:"taṭa(m)",target:"erumai",strength:.7511204896397081,citations:["Aink94","Aink98"]},{id:"toṭi muṉ",source:"toṭi",target:"muṉ",strength:.7536037801927699,citations:["Aink38","Aink40","Aink83"]},{id:"tāmarai malar",source:"tāmarai",target:"malar",strength:.7631033450141916,citations:["Aink53","Aink68","Aink94"]},{id:"poykai yāmpal",source:"poykai",target:"yāmpal",strength:.7696683071257443,citations:["Aink35","Aink91"]},{id:"aṇaṅku uṟu",source:"aṇaṅku",target:"uṟu",strength:.7696683071257443,citations:["Aink53","Aink58"]},{id:"il lākuka",source:"il",target:"lākuka",strength:.7696683071257443,citations:["Aink8","Aink9"]},{id:"maṉai nakar",source:"maṉai",target:"nakar",strength:.7764453731200532,citations:["Aink324","Aink60"]},{id:"val poy",source:"val",target:"poy",strength:.7764453731200532,citations:["Aink37"]},{id:"yaviṉi pakai",source:"yaviṉi",target:"pakai",strength:.7764453731200532,citations:["Aink4","Aink6"]},{id:"vaṭṭi maṉai",source:"vaṭṭi",target:"maṉai",strength:.7764453731200532,citations:["Aink47","Aink48"]},{id:"cuṭar nutal",source:"cuṭar",target:"nutal",strength:.7804400853416715,citations:["Aink107","Aink56","Aink94"]},{id:"vekuḷvōḷ kaṇ",source:"vekuḷvōḷ",target:"kaṇ",strength:.783570129657514,citations:["Aink84"]},{id:"vayalaic ce(m)",source:"vayalaic",target:"ce(m)",strength:.7910801910175275,citations:["Aink25","Aink52"]},{id:"kaḷvaṉ ṇakam",source:"kaḷvaṉ",target:"ṇakam",strength:.7910801910175275,citations:["Aink27","Aink30"]},{id:"amaintaṉaṉ tāṉ",source:"amaintaṉaṉ",target:"tāṉ",strength:.8074405255079259,citations:["Aink103"]},{id:"yoḷ arivai",source:"yoḷ",target:"arivai",strength:.8074405255079259,citations:["Aink322","Aink73"]},{id:"nām mūrp",source:"nām",target:"mūrp",strength:.8074405255079259,citations:["Aink34","Aink35"]},{id:"nām maṟa",source:"nām",target:"maṟa",strength:.8074405255079259,citations:["Aink36"]},{id:"taṭa(m) kōṭṭam",source:"taṭa(m)",target:"kōṭṭam",strength:.8074405255079259,citations:["Aink94","Aink98"]},{id:"mūr oṇmai",source:"mūr",target:"oṇmai",strength:.8164050744978727,citations:["Aink83","Aink92"]},{id:"neṭu(m) nakar",source:"neṭu(m)",target:"nakar",strength:.825988342993962,citations:["Aink324","Aink60"]},{id:"yallaṉ e-",source:"yallaṉ",target:"e-",strength:.8362821107346503,citations:["Aink11"]},{id:"vēṇṭu aṉṉai",source:"vēṇṭu",target:"aṉṉai",strength:.8433829024729342,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink201","Aink204"],curvature:.25},{id:"aṉṉai vēṇṭu",source:"aṉṉai",target:"vēṇṭu",strength:.8433829024729342,citations:["Aink101","Aink102","Aink103","Aink104","Aink105","Aink106","Aink107","Aink108","Aink201","Aink204"],curvature:.25},{id:"paṇait tōḷ",source:"paṇait",target:"tōḷ",strength:.8474002268857452,citations:["Aink135","Aink39"]},{id:"pāvai yaṉṉa",source:"pāvai",target:"yaṉṉa",strength:.8474002268857452,citations:["Aink221","Aink307"]},{id:"maṟa amai",source:"maṟa",target:"amai",strength:.8474002268857452,citations:["Aink36"]},{id:"tēr taḷar",source:"tēr",target:"taḷar",strength:.8474002268857452,citations:["Aink403","Aink66"]},{id:"maṇi niṟam",source:"maṇi",target:"niṟam",strength:.8474002268857452,citations:["Aink45","Aink96"]},{id:"pāy eṉak",source:"pāy",target:"eṉak",strength:.8474002268857452,citations:["Aink53","Aink73"]},{id:"karu(m) kōṭṭam",source:"karu(m)",target:"kōṭṭam",strength:.8474002268857452,citations:["Aink92","Aink95"]},{id:"kōṭṭam erumai",source:"kōṭṭam",target:"erumai",strength:.855629616181158,citations:["Aink94","Aink95","Aink98"]},{id:"kaṭal tirai",source:"kaṭal",target:"tirai",strength:.8727251103660904,citations:["Aink105","Aink107"]},{id:"yaḻi putup",source:"yaḻi",target:"putup",strength:.8727251103660904,citations:["Aink53","Aink78"]},{id:"ciṟai putup",source:"ciṟai",target:"putup",strength:.8727251103660904,citations:["Aink53","Aink78"]},{id:"poy urai",source:"poy",target:"urai",strength:.8727251103660904,citations:["Aink66","Aink80"]},{id:"yāy yām",source:"yāy",target:"yām",strength:.8777972980837893,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"num mūr",source:"num",target:"mūr",strength:.8873599282635646,citations:["Aink83","Aink92"]},{id:"nutal arivai",source:"nutal",target:"arivai",strength:.8934628986267965,citations:["Aink322","Aink404","Aink46","Aink73"]},{id:"vēṭṭōḷ yām",source:"vēṭṭōḷ",target:"yām",strength:.8948478255199299,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"tēṉūr vivaḷ",source:"tēṉūr",target:"vivaḷ",strength:.897974164011612,citations:["Aink54","Aink55","Aink57"]},{id:"keḻu koṭu(m)",source:"keḻu",target:"koṭu(m)",strength:.9037202627539629,citations:["Aink11","Aink12"]},{id:"nekiḻac cā",source:"nekiḻac",target:"cā",strength:.9037202627539629,citations:["Aink27","Aink28"]},{id:"col uṇarntōr",source:"col",target:"uṇarntōr",strength:.9037202627539629,citations:["Aink38","Aink41"]},{id:"kai vaḷ",source:"kai",target:"vaḷ",strength:.9037202627539629,citations:["Aink58","Aink61"]},{id:"māṇ kuṇam",source:"māṇ",target:"kuṇam",strength:.9037202627539629,citations:["Aink90"]},{id:"amma tōḻaṉ",source:"amma",target:"tōḻaṉ",strength:.920447870191333,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"malir niṟai",source:"malir",target:"niṟai",strength:.9248104691605138,citations:["Aink15","Aink42","Aink72"]},{id:"oṇmai toṭi",source:"oṇmai",target:"toṭi",strength:.9251945611708375,citations:["Aink28","Aink40","Aink76","Aink83","Aink92"]},{id:"karai cēr",source:"karai",target:"cēr",strength:.9436799641317823,citations:["Aink12","Aink74"]},{id:"el vaḷai",source:"el",target:"vaḷai",strength:.9436799641317823,citations:["Aink20","Aink27"]},{id:"muḷḷi vēr",source:"muḷḷi",target:"vēr",strength:.9436799641317823,citations:["Aink22","Aink23"]},{id:"kaḻaṉit tāmarai",source:"kaḻaṉit",target:"tāmarai",strength:.9436799641317823,citations:["Aink53","Aink94"]},{id:"veṉa yāy",source:"veṉa",target:"yāy",strength:.964765113131363,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"pūk kañal",source:"pūk",target:"kañal",strength:.9657027139201028,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"veṉa vēṭṭōḷ",source:"veṉa",target:"vēṭṭōḷ",strength:.9815002093799743,citations:["Aink1","Aink10","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"vēṭṭōḷ yāy",source:"vēṭṭōḷ",target:"yāy",strength:.9829494725638592,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"yātaṉ yaviṉi",source:"yātaṉ",target:"yaviṉi",strength:1,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"ṇakam maṇ",source:"ṇakam",target:"maṇ",strength:1,citations:["Aink27","Aink30"]},{id:"titti yalkul",source:"titti",target:"yalkul",strength:1,citations:["Aink29","Aink72"]},{id:"mal val",source:"mal",target:"val",strength:1,citations:["Aink37"]},{id:"ciṟai yaḻi",source:"ciṟai",target:"yaḻi",strength:1,citations:["Aink53","Aink78"]}],Ma={nodes:OA,links:IA},NA=n=>{const t=1+200/Math.hypot(n.x,n.y,n.z),i=n.x||n.y||n.z?{x:n.x*t,y:n.y*t,z:n.z*t}:{x:0,y:0,z:200};Sa.cameraPosition(i,n,1e3)},Sa=_A(),UA=()=>{const n=new Map([["adjective","#66c2a5"],["noun","#fc8d62"],["pronoun","#8da0cb"],["verb","#e78ac3"],["other","#a6d854"]]),e=document.getElementById("panellegend");e.innerHTML=[...n].map(i=>`<div><input type="checkbox" name="${i[0]}" checked autocomplete="off"/><label><span style="color:${i[1]}; font-size: 150%">●</span> ${i[0]}</div>`).join("")+'<div id="solonodes"><input type="checkbox" name="solonodes" checked autocomplete="off"/><label>Show unconnected nodes</label></div>';const t=structuredClone(Ma.links).filter(i=>i.strength>=.45);Sa(document.getElementById("colgraph")).graphData({nodes:Ma.nodes,links:t}).nodeLabel(i=>`${i.size} occurences`).nodeThreeObject(i=>{const r=new DA(i.id);return r.material.depthWrite=!1,r.color=n.get(i.type)||n.get("other"),r.textHeight=i.size/2<8?8:i.size/2,r}).linkWidth(i=>i.strength*5).linkOpacity(.3).linkDirectionalArrowLength(5).linkCurvature(i=>i.curvature||0).linkLabel(i=>`${i.citations.join(", ")} (NPMI: ${i.strength.toPrecision(4)})`).onNodeClick(NA),Sa.d3Force("link").distance(i=>40/i.strength)},FA=n=>{const e=document.getElementById("panel");e.style.display!=="flex"?(e.animate([{marginTop:"-25px"},{marginTop:"0px"}],{duration:200,iterations:1}),e.style.display="flex",n.target.textContent="⇧"):(e.animate([{marginTop:"0px"},{marginTop:"-25px"}],{duration:200,iterations:1}),setTimeout(()=>e.style.display="none",200),n.target.textContent="⇩")},BA=n=>{const e=new Set;for(const t of n)e.add(t.source),e.add(t.target);return e},HA=()=>{const n={};n.nodes=Ma.nodes,n.links=structuredClone(Ma.links);const e=document.getElementById("npmi").value;n.links=n.links.filter(r=>r.strength>=e);const t=document.getElementById("panellegend").querySelectorAll('input:not([name="solonodes"])'),i=new Set([...t].filter(r=>r.checked).map(r=>r.getAttribute("name")));if(i.size!==t.length){n.nodes=n.nodes.filter(a=>i.has(a.type));const r=new Set(n.nodes.map(a=>a.id));n.links=n.links.filter(a=>r.has(a.target)&&r.has(a.source))}if(!document.querySelector('input[name="solonodes"]').checked){const r=BA(n.links);n.nodes=n.nodes.filter(a=>r.has(a.id))}Sa.graphData(n)};document.getElementById("paneltoggle").addEventListener("click",FA);document.getElementById("graphupdate").addEventListener("click",HA);UA();
