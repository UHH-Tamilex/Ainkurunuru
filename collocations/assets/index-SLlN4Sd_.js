...
`),g="".concat(this.fontWeight," ").concat(this.fontSize,"px ").concat(this.fontFace);o.font=g;var v=Math.max.apply(Math,na(m.map(function(P){return o.measureText(P).width}))),p=this.fontSize*m.length;if(a.width=v+c[0]*2+f[0]*2,a.height=p+c[1]*2+f[1]*2,this.borderWidth){if(o.strokeStyle=this.borderColor,c[0]){var d=c[0]/2;o.lineWidth=c[0],o.beginPath(),o.moveTo(d,l[0]),o.lineTo(d,a.height-l[3]),o.moveTo(a.width-d,l[1]),o.lineTo(a.width-d,a.height-l[2]),o.stroke()}if(c[1]){var x=c[1]/2;o.lineWidth=c[1],o.beginPath(),o.moveTo(Math.max(c[0],l[0]),x),o.lineTo(a.width-Math.max(c[0],l[1]),x),o.moveTo(Math.max(c[0],l[3]),a.height-x),o.lineTo(a.width-Math.max(c[0],l[2]),a.height-x),o.stroke()}if(this.borderRadius){var _=Math.max.apply(Math,na(c)),y=_/2;o.lineWidth=_,o.beginPath(),[!!l[0]&&[l[0],y,y,l[0]],!!l[1]&&[a.width-l[1],a.width-y,y,l[1]],!!l[2]&&[a.width-l[2],a.width-y,a.height-y,a.height-l[2]],!!l[3]&&[l[3],y,a.height-y,a.height-l[3]]].filter(function(P){return P}).forEach(function(P){var b=yl(P,4),w=b[0],N=b[1],U=b[2],ee=b[3];o.moveTo(w,U),o.quadraticCurveTo(N,U,N,ee)}),o.stroke()}}this.backgroundColor&&(o.fillStyle=this.backgroundColor,this.borderRadius?(o.beginPath(),o.moveTo(c[0],l[0]),[[c[0],l[0],a.width-l[1],c[1],c[1],c[1]],[a.width-c[0],a.width-c[0],a.width-c[0],c[1],l[1],a.height-l[2]],[a.width-c[0],a.width-l[2],l[3],a.height-c[1],a.height-c[1],a.height-c[1]],[c[0],c[0],c[0],a.height-c[1],a.height-l[3],l[0]]].forEach(function(P){var b=yl(P,6),w=b[0],N=b[1],U=b[2],ee=b[3],k=b[4],R=b[5];o.quadraticCurveTo(w,ee,N,k),o.lineTo(U,R)}),o.closePath(),o.fill()):o.fillRect(c[0],c[1],a.width-c[0]*2,a.height-c[1]*2)),o.translate.apply(o,na(c)),o.translate.apply(o,na(f)),o.font=g,o.fillStyle=this.color,o.textBaseline="bottom";var A=this.strokeWidth>0;A&&(o.lineWidth=this.strokeWidth*this.fontSize/10,o.strokeStyle=this.strokeColor),m.forEach(function(P,b){var w=(v-o.measureText(P).width)/2,N=(b+1)*r.fontSize;A&&o.strokeText(P,w,N),o.fillText(P,w,N)}),this.material.map&&this.material.map.dispose();var M=this.material.map=new ki.Texture(a);M.minFilter=ki.LinearFilter,M.colorSpace=ki.SRGBColorSpace,M.needsUpdate=!0;var E=this.textHeight*m.length+s[1]*2+h[1]*2;this.scale.set(E*a.width/a.height,E,0)}},{key:"clone",value:function(){return new this.constructor(this.text,this.textHeight,this.color).copy(this)}},{key:"copy",value:function(r){return ki.Sprite.prototype.copy.call(this,r),this.color=r.color,this.backgroundColor=r.backgroundColor,this.padding=r.padding,this.borderWidth=r.borderWidth,this.borderColor=r.borderColor,this.fontFace=r.fontFace,this.fontSize=r.fontSize,this.fontWeight=r.fontWeight,this.strokeWidth=r.strokeWidth,this.strokeColor=r.strokeColor,this}}]),t}(ki.Sprite);const OA=[{id:"nīl",size:5,type:"noun"},{id:"mēṉi",size:5,type:"noun"},{id:"vāl",size:4,type:"noun"},{id:"iḻai",size:8,type:"noun"},{id:"pākattu",size:1},{id:"oru",size:3,type:"noun"},{id:"iru",size:4,type:"noun"},{id:"tāḷ",size:2,type:"noun"},{id:"niḻal",size:4,type:"noun"},{id:"kīḻ",size:1},{id:"mu",size:1,type:"noun"},{id:"vaku",size:1,type:"verb"},{id:"ulakam",size:1,type:"noun"},{id:"vāḻ",size:43,type:"verb"},{id:"ātaṉ",size:10,type:"noun"},{id:"aviṉi",size:10},{id:"nel",size:9,type:"noun"},{id:"pal",size:19,type:"noun"},{id:"poli",size:2,type:"noun"},{id:"poṉ",size:6,type:"noun"},{id:"peru(m)",size:21,type:"adjective"},{id:"ciṟa",size:8,type:"verb"},{id:"eṉ",size:34,type:"pronoun"},{id:"vēṭṭōḷ",size:10},{id:"yāy",size:11,type:"noun"},{id:"yām",size:18,type:"pronoun"},{id:"naṉai",size:2,type:"noun"},{id:"kāñci",size:1,type:"noun"},{id:"ciṉai",size:4,type:"verb"},{id:"ciṟu(m)",size:6,type:"adjective"},{id:"miṉ",size:5,type:"noun"},{id:"yāṇar",size:9,type:"noun"},{id:"ūr",size:80,type:"noun"},{id:"pāṇ",size:11,type:"noun"},{id:"māri",size:3,type:"noun"},{id:"vāy",size:4,type:"noun"},{id:"vaḷam",size:4,type:"noun"},{id:"naṉi",size:4},{id:"pū(m)",size:27,type:"noun"},{id:"mā(m)",size:6,type:"noun"},{id:"pulavu",size:2,type:"noun"},{id:"taṭpam",size:30,type:"noun"},{id:"tuṟai",size:22,type:"noun"},{id:"tāṉ",size:16,type:"pronoun"},{id:"koḷ",size:14,type:"verb"},{id:"cel",size:10,type:"noun"},{id:"puṉal",size:17,type:"noun"},{id:"aṭu",size:8,type:"verb"},{id:"maka",size:29,type:"noun"},{id:"iṭu",size:1,type:"verb"},{id:"oṇmai",size:13,type:"noun"},{id:"maṇal",size:3,type:"noun"},{id:"cimaiyattu",size:1},{id:"erumai",size:10,type:"noun"},{id:"kiḷai",size:2,type:"noun"},{id:"i-",size:35,type:"pronoun"},{id:"narampu",size:1,type:"noun"},{id:"aṉṉai",size:12,type:"noun"},{id:"vēṇṭu",size:8,type:"verb"},{id:"u-",size:2,type:"noun"},{id:"kaṇ",size:20,type:"noun"},{id:"ēr",size:4,type:"noun"},{id:"koṭi",size:4,type:"noun"},{id:"pācu",size:1},{id:"aṭumpu",size:1,type:"noun"},{id:"pari",size:3,type:"noun"},{id:"iḻi",size:2,type:"verb"},{id:"neytal",size:4,type:"noun"},{id:"mayakkam",size:1},{id:"varavu",size:16,type:"noun"},{id:"nī",size:39,type:"pronoun"},{id:"pōl",size:11,type:"verb"},{id:"uṇ",size:15},{id:"maruvu",size:2,type:"verb"},{id:"no/nō",size:6,type:"verb"},{id:"maruntu",size:4,type:"noun"},{id:"ākkam",size:36,type:"noun"},{id:"nām",size:9,type:"pronoun"},{id:"niṟa",size:2,type:"verb"},{id:"kaṭal",size:2,type:"noun"},{id:"puḷ",size:1,type:"noun"},{id:"°āṉ",size:1,type:"verb"},{id:"tuṉpam",size:1,type:"noun"},{id:"uṟu",size:8,type:"verb"},{id:"tuyara",size:1},{id:"nīkku",size:2,type:"verb"},{id:"iṉ",size:6,type:"adjective"},{id:"icai",size:1,type:"noun"},{id:"a-",size:50,type:"pronoun"},{id:"tēr",size:7,type:"noun"},{id:"puṉṉai",size:1,type:"noun"},{id:"ñāḻal",size:1,type:"noun"},{id:"am",size:5,type:"adjective"},{id:"amaintaṉaṉ",size:1},{id:"amai",size:6,type:"noun"},{id:"mā",size:3,type:"adjective"},{id:"muḻakkam",size:2},{id:"tirai",size:1,type:"verb"},{id:"taru",size:1},{id:"muttam",size:1,type:"noun"},{id:"veḷ",size:12,type:"adjective"},{id:"imai",size:1,type:"noun"},{id:"civantaṉṟu",size:1},{id:"maṉai",size:10,type:"noun"},{id:"naṭu",size:2,type:"verb"},{id:"vayalai",size:3,type:"noun"},{id:"vēḻam",size:10,type:"noun"},{id:"cuṟṟam",size:1,type:"noun"},{id:"keḻu",size:4},{id:"koṭu(m)",size:2,type:"adjective"},{id:"nāṇ",size:1,type:"noun"},{id:"nallaṉ",size:1},{id:"e-",size:22,type:"pronoun"},{id:"al",size:14,type:"verb"},{id:"taṭa(m)",size:4,type:"adjective"},{id:"karai",size:4,type:"noun"},{id:"cēr",size:2,type:"verb"},{id:"karuppu",size:6,type:"adjective"},{id:"nal",size:24,type:"adjective"},{id:"āṟṟuka",size:1},{id:"tōṟka",size:1},{id:"uṭai",size:4,type:"noun"},{id:"poṅku",size:1,type:"verb"},{id:"uḷai",size:3,type:"noun"},{id:"aṭai",size:3,type:"noun"},{id:"pakar",size:1,type:"verb"},{id:"peṇ",size:7,type:"noun"},{id:"tuñcu",size:3,type:"verb"},{id:"yāmam",size:1,type:"noun"},{id:"pai",size:3},{id:"paṇait",size:1},{id:"tōḷ",size:5,type:"noun"},{id:"ai",size:2,type:"noun"},{id:"akal",size:3,type:"noun"},{id:"valkul",size:1},{id:"kaṇṇi",size:1,type:"noun"},{id:"nēr",size:1,type:"noun"},{id:"tīṇṭu",size:1,type:"verb"},{id:"ayal",size:2,type:"noun"},{id:"vaṭu",size:1,type:"noun"},{id:"val",size:4,type:"noun"},{id:"taḷir",size:2,type:"noun"},{id:"nuṭaṅku",size:4,type:"verb"},{id:"aṇi",size:11,type:"noun"},{id:"mārpu",size:9,type:"noun"},{id:"paṉi",size:2,type:"noun"},{id:"tuyil",size:1,type:"noun"},{id:"cey",size:8,type:"noun"},{id:"malir",size:3,type:"verb"},{id:"niṟai",size:5,type:"noun"},{id:"virumpiya",size:1},{id:"taḻai",size:4,type:"noun"},{id:"puṇar",size:5,type:"verb"},{id:"tuṇai",size:8,type:"noun"},{id:"utavum",size:1},{id:"mūtu",size:1},{id:"ōkku",size:3,type:"verb"},{id:"tūmpu",size:2,type:"noun"},{id:"tiraḷ",size:1,type:"noun"},{id:"kāl",size:7,type:"noun"},{id:"toḻumakaḷir",size:1},{id:"añcaṉam",size:1},{id:"pey",size:3,type:"verb"},{id:"kañal",size:4,type:"verb"},{id:"uḷḷi",size:3,type:"noun"},{id:"putal",size:1,type:"noun"},{id:"micai",size:2,type:"noun"},{id:"vicumpu",size:2,type:"noun"},{id:"kuruku",size:4,type:"noun"},{id:"tōṟṟam",size:3,type:"noun"},{id:"putu",size:6,type:"adjective"},{id:"mēvu",size:1,type:"noun"},{id:"vaṟu(m)",size:1,type:"adjective"},{id:"maṭa(m)",size:6,type:"noun"},{id:"iru(m)",size:3,type:"adjective"},{id:"cāy",size:1,type:"noun"},{id:"ceruntiyoṭu",size:1},{id:"alamvaru",size:2,type:"verb"},{id:"kaḻaṉi",size:11,type:"noun"},{id:"poru",size:2,type:"verb"},{id:"malar",size:18,type:"noun"},{id:"aḻu",size:3,type:"verb"},{id:"piri",size:4,type:"verb"},{id:"ekkar",size:1,type:"noun"},{id:"mey",size:2,type:"noun"},{id:"maṇa",size:3,type:"verb"},{id:"kamaḻ",size:1,type:"verb"},{id:"poḻil",size:2,type:"noun"},{id:"cī",size:2,type:"verb"},{id:"kalakkam",size:3,type:"noun"},{id:"viḷaika",size:1},{id:"vayal",size:3,type:"noun"},{id:"ira",size:1,type:"verb"},{id:"itaḻ",size:2,type:"noun"},{id:"nikar",size:1,type:"noun"},{id:"kēḷ",size:6,type:"verb"},{id:"vaḻi",size:3,type:"noun"},{id:"aṟu",size:6,type:"noun"},{id:"cil",size:3,type:"noun"},{id:"ciṟai",size:3,type:"noun"},{id:"tumpi",size:1,type:"noun"},{id:"nūṟṟu",size:1},{id:"tāmarai",size:5,type:"noun"},{id:"kāmpu",size:1,type:"noun"},{id:"naṇṇu",size:2,type:"verb"},{id:"iṟai",size:2,type:"noun"},{id:"el",size:2,type:"noun"},{id:"vaḷai",size:3,type:"noun"},{id:"tāṉum",size:1},{id:"malaintāṉ",size:1},{id:"em",size:13,type:"pronoun"},{id:"vī",size:2,type:"noun"},{id:"maṇi",size:4,type:"noun"},{id:"arumpu",size:1,type:"noun"},{id:"maram",size:1,type:"noun"},{id:"aḵtu",size:2},{id:"varaiyara",size:1},{id:"niraiyuṭaṉ",size:1},{id:"kuḻuvu",size:1,type:"verb"},{id:"peyarvuḻi",size:2},{id:"tavir",size:1,type:"verb"},{id:"nōkkam",size:2,type:"noun"},{id:"tīyēṉ",size:1},{id:"muḷḷi",size:3,type:"noun"},{id:"nīṭṭu",size:3,type:"verb"},{id:"mutu",size:1,type:"adjective"},{id:"nīr",size:5,type:"pronoun"},{id:"puḷḷi",size:3,type:"noun"},{id:"kaḷvaṉ",size:9,type:"noun"},{id:"āmpal",size:10,type:"noun"},{id:"teḷ",size:1,type:"adjective"},{id:"pacappatu",size:2},{id:"aḷḷal",size:2,type:"noun"},{id:"āṭu",size:9,type:"noun"},{id:"vēr",size:2,type:"noun"},{id:"aḷai",size:4,type:"noun"},{id:"col",size:4,type:"noun"},{id:"nīyēṉ",size:1},{id:"amma",size:12},{id:"tōḻaṉ",size:12},{id:"kātal",size:4,type:"noun"},{id:"pāvai",size:2,type:"noun"},{id:"kaviṉ",size:3,type:"noun"},{id:"tolai",size:1,type:"verb"},{id:"paca",size:7,type:"verb"},{id:"tām",size:2,type:"pronoun"},{id:"malai",size:2,type:"noun"},{id:"nāṭu",size:3,type:"noun"},{id:"taṇantu",size:1},{id:"varaitaṟku",size:1},{id:"vēṇṭuvaṉa",size:1},{id:"muṭi",size:1,type:"noun"},{id:"talaimakaṉ",size:1},{id:"kūṟṟam",size:1,type:"noun"},{id:"talaimakaḷ",size:2},{id:"ciṟaippuṟattāṉ",size:1},{id:"āṭṭi",size:1,type:"noun"},{id:"kuṟṟu",size:2,type:"verb"},{id:"eytu",size:1,type:"verb"},{id:"tēṟṟam",size:1},{id:"na",size:1},{id:"tākku",size:1,type:"verb"},{id:"aṇaṅku",size:4,type:"noun"},{id:"tāy",size:2,type:"noun"},{id:"cā",size:3,type:"verb"},{id:"piṟa",size:4,type:"noun"},{id:"kaḷvaṉoṭu",size:1},{id:"piḷḷai",size:1,type:"noun"},{id:"tiṉṉum",size:2},{id:"mutalaittu",size:1},{id:"eytiṉaṉ",size:1},{id:"makiḻ",size:23,type:"noun"},{id:"polam",size:2,type:"noun"},{id:"toṭi",size:9,type:"noun"},{id:"teḷir",size:1,type:"verb"},{id:"muyaṅkiyavar",size:1},{id:"tuṟappatu",size:1},{id:"puṟantā",size:1,type:"verb"},{id:"puṉiṟu",size:2,type:"noun"},{id:"pai(m)",size:2,type:"adjective"},{id:"kāy",size:2,type:"noun"},{id:"ce(m)",size:9,type:"adjective"},{id:"palarkku",size:1},{id:"nekiḻ",size:4,type:"verb"},{id:"poy",size:5,type:"noun"},{id:"paṭu",size:2,type:"verb"},{id:"aṟi",size:10,type:"verb"},{id:"kaḻaṅku",size:1,type:"noun"},{id:"varai",size:1,type:"noun"},{id:"kaṭci",size:1,type:"noun"},{id:"mayil",size:2,type:"noun"},{id:"ālu",size:2,type:"verb"},{id:"vaḷḷiam",size:1},{id:"kāṉ",size:1,type:"noun"},{id:"kiḻamai",size:1,type:"noun"},{id:"āṇ",size:1,type:"noun"},{id:"taku",size:2,type:"verb"},{id:"viṟal",size:1,type:"noun"},{id:"vēṭkai",size:1,type:"noun"},{id:"pūṭṭu",size:1,type:"noun"},{id:"tāṅku",size:1,type:"verb"},{id:"iḷa(m)",size:2,type:"adjective"},{id:"karantai",size:1,type:"noun"},{id:"ceṟu",size:3,type:"verb"},{id:"tuṟa",size:1,type:"verb"},{id:"vaḷḷai",size:1,type:"noun"},{id:"mel",size:5,type:"adjective"},{id:"iṉṉaṉ",size:1},{id:"katir",size:6,type:"noun"},{id:"aka(m)",size:5,type:"noun"},{id:"maṇ",size:2,type:"noun"},{id:"allal",size:1,type:"noun"},{id:"uḻa",size:1,type:"verb"},{id:"uṟai",size:4,type:"noun"},{id:"cēṟu",size:1,type:"noun"},{id:"vari",size:3,type:"noun"},{id:"kaṭi",size:1,type:"noun"},{id:"kā",size:1,type:"noun"},{id:"kaṭuka",size:1},{id:"vittu",size:2,type:"noun"},{id:"muḷai",size:1,type:"noun"},{id:"titti",size:2,type:"noun"},{id:"alkul",size:3,type:"noun"},{id:"koḷvatu",size:1},{id:"pāl",size:2,type:"noun"},{id:"ūṟuka",size:1},{id:"pakaṭu",size:1},{id:"uḻavaṉ",size:1,type:"noun"},{id:"peyar",size:2,type:"noun"},{id:"vēppa(m)",size:1,type:"noun"},{id:"neṭu(m)",size:7,type:"adjective"},{id:"iḻa",size:1,type:"verb"},{id:"ñeli",size:1,type:"noun"},{id:"kaḻai",size:2,type:"noun"},{id:"aḻal",size:1,type:"noun"},{id:"vayamā",size:1},{id:"veru",size:2,type:"noun"},{id:"kuṉṟam",size:1,type:"noun"},{id:"aru(m)",size:4,type:"adjective"},{id:"curam",size:3,type:"noun"},{id:"ayar",size:2,type:"verb"},{id:"il",size:9,type:"noun"},{id:"koṇkaṉ",size:1,type:"noun"},{id:"poruḷ",size:1,type:"noun"},{id:"kaṭam",size:1,type:"noun"},{id:"muṭam",size:1},{id:"mutir",size:2,type:"verb"},{id:"marutattu",size:3},{id:"-uṭaṉ",size:1},{id:"āyamōṭu",size:2},{id:"pāṇṭil",size:2,type:"noun"},{id:"kalam",size:1,type:"noun"},{id:"nanta",size:1},{id:"vāṭṭam",size:1,type:"noun"},{id:"iṟa",size:3,type:"verb"},{id:"maṉ",size:3},{id:"piṟaṅku",size:1,type:"verb"},{id:"pul",size:3,type:"noun"},{id:"arai",size:1,type:"noun"},{id:"ōmai",size:1,type:"noun"},{id:"puli",size:1,type:"noun"},{id:"vaḻakku",size:1,type:"noun"},{id:"cūḻkam",size:1},{id:"vam",size:1},{id:"pāḻ",size:1,type:"noun"},{id:"paṭṭu",size:1,type:"noun"},{id:"veppa(m)",size:2,type:"noun"},{id:"pālai",size:1,type:"noun"},{id:"vem",size:3},{id:"kāṭṭu",size:1,type:"noun"},{id:"neñcam",size:3,type:"noun"},{id:"nāḷ",size:5,type:"noun"},{id:"vantataṟku",size:1},{id:"eḻu",size:2,type:"noun"},{id:"aḻupa",size:1},{id:"tī",size:3,type:"noun"},{id:"meḻukiṉ",size:1},{id:"muḷiya",size:1},{id:"vēṉal",size:3,type:"noun"},{id:"kaṭu(m)",size:1,type:"adjective"},{id:"ñāyiṟu",size:1,type:"noun"},{id:"kal",size:1,type:"noun"},{id:"pakku",size:1,type:"noun"},{id:"teṟu",size:1,type:"verb"},{id:"muṉ",size:6},{id:"nutal",size:7,type:"noun"},{id:"arivai",size:5,type:"noun"},{id:"uḷḷu",size:2,type:"verb"},{id:"toṟum",size:1},{id:"eri",size:1,type:"noun"},{id:"kavar",size:1,type:"verb"},{id:"veṉṟūḻ",size:1},{id:"nīḷ",size:2,type:"noun"},{id:"iṭaic",size:1},{id:"kaṇpaṭuppiṉum",size:1},{id:"kāṇkuveṉ",size:1},{id:"naḷḷeṉ",size:1,type:"verb"},{id:"kaṅkul",size:1,type:"noun"},{id:"naḷi",size:1,type:"noun"},{id:"nakar",size:2,type:"noun"},{id:"vēṅkai",size:1,type:"noun"},{id:"vel",size:2,type:"verb"},{id:"cuṇaṅku",size:2,type:"noun"},{id:"tēm",size:1,type:"noun"},{id:"pāy",size:4,type:"verb"},{id:"maruta(m)",size:3,type:"noun"},{id:"uyar",size:1,type:"verb"},{id:"viri",size:2,type:"verb"},{id:"peṇṭirōṭu",size:1},{id:"tār",size:2,type:"noun"},{id:"talai",size:5},{id:"poykai",size:12,type:"noun"},{id:"puḻai",size:1,type:"noun"},{id:"tātu",size:6,type:"noun"},{id:"vaṇṇa(m)",size:2,type:"noun"},{id:"ētilāḷarkku",size:1},{id:"tiṇ",size:3,type:"adjective"},{id:"nil",size:3,type:"verb"},{id:"kōṅkam",size:1,type:"noun"},{id:"paya",size:2,type:"verb"},{id:"miku",size:3,type:"verb"},{id:"koḻu",size:1,type:"verb"},{id:"mukiḻ",size:2,type:"noun"},{id:"nār",size:1,type:"noun"},{id:"uri",size:1,type:"noun"},{id:"niṟam",size:3,type:"noun"},{id:"niḻaṟṟutal",size:1},{id:"maṟa",size:2,type:"verb"},{id:"amaikuva",size:1},{id:"kayal",size:2,type:"noun"},{id:"karutiya",size:1},{id:"olku",size:1,type:"verb"},{id:"naya",size:4,type:"verb"},{id:"mal",size:1,type:"noun"},{id:"tēṟṟāṉ",size:1},{id:"uṇarntōr",size:2},{id:"vauvu",size:1,type:"verb"},{id:"mulai",size:3,type:"noun"},{id:"muyakkam",size:1,type:"noun"},{id:"vayiṉ",size:2,type:"noun"},{id:"tiruttu",size:1,type:"verb"},{id:"paṇṇai",size:3,type:"noun"},{id:"ñekiḻ",size:1,type:"verb"},{id:"pakai",size:2,type:"noun"},{id:"ārka",size:1},{id:"pār",size:1,type:"noun"},{id:"ōtuka",size:1},{id:"kāytta",size:1},{id:"paḻaṉa(m)",size:9,type:"noun"},{id:"ākaṟka",size:2},{id:"keṇṭai",size:1,type:"noun"},{id:"taru/tā",size:3,type:"verb"},{id:"aviḻ",size:3,type:"noun"},{id:"vaṇṭu",size:6,type:"noun"},{id:"piṇi",size:4,type:"noun"},{id:"maṟi",size:1,type:"noun"},{id:"iṭai",size:1,type:"noun"},{id:"piṇa",size:1,type:"noun"},{id:"putalvaṉ",size:4,type:"noun"},{id:"naṭuvaṇaṉ",size:1},{id:"naṉṟ",size:1},{id:"kiṭa",size:1,type:"verb"},{id:"muṉi",size:1,type:"noun"},{id:"viyal",size:1,type:"noun"},{id:"kavai",size:2,type:"noun"},{id:"īṟṟu",size:2,type:"noun"},{id:"kātaliyiṉ",size:1},{id:"amar",size:3,type:"noun"},{id:"-uḷ",size:2},{id:"tantai",size:2,type:"noun"},{id:"muṟuvaliṉ",size:1},{id:"naku",size:1,type:"verb"},{id:"payil",size:1,type:"verb"},{id:"uruṭṭu",size:1,type:"verb"},{id:"taḷar",size:2,type:"verb"},{id:"vāḷ",size:1,type:"noun"},{id:"ūṭṭu",size:1,type:"noun"},{id:"puṟam",size:1,type:"noun"},{id:"naṟu(m)",size:8,type:"adjective"},{id:"puṟavam",size:3},{id:"kuṟu(m)",size:2,type:"adjective"},{id:"poṟu",size:1,type:"verb"},{id:"oṇ",size:1},{id:"cuṭar",size:4,type:"noun"},{id:"maṉaikku",size:1},{id:"viḷakkam",size:1,type:"noun"},{id:"kaṉai",size:1,type:"verb"},{id:"vai",size:1,type:"noun"},{id:"mātar",size:1,type:"noun"},{id:"viḷaiyāṭṭu",size:1,type:"noun"},{id:"taḻuvu",size:3,type:"verb"},{id:"iruntaṉaṉ",size:1},{id:"piracam",size:1,type:"noun"},{id:"ūtu",size:2,type:"verb"},{id:"poḻutu",size:3,type:"noun"},{id:"pārppu",size:3,type:"noun"},{id:"aṉpu",size:1,type:"noun"},{id:"mutalai",size:2,type:"noun"},{id:"poykaittu",size:1},{id:"mayaṅkiṉaḷ",size:1},{id:"māṇ",size:4,type:"noun"},{id:"kāviri",size:1,type:"noun"},{id:"ampaṇattu",size:1},{id:"yāmai",size:3,type:"noun"},{id:"ēl",size:3,type:"verb"},{id:"cempiṉ",size:1},{id:"tīm",size:2,type:"adjective"},{id:"mukam",size:1,type:"noun"},{id:"vaḷarnticiṉāaṅku",size:1},{id:"oḻukumati",size:1},{id:"kūtir",size:1,type:"noun"},{id:"kaliḻ",size:1,type:"verb"},{id:"yāṟu",size:1,type:"noun"},{id:"aṇintaṉa",size:1},{id:"kuṟippiṉai",size:1},{id:"aruḷ",size:3,type:"noun"},{id:"muḷ",size:1,type:"noun"},{id:"eyiṟu",size:2,type:"noun"},{id:"keṭiṟu",size:1,type:"noun"},{id:"cori",size:3,type:"verb"},{id:"vaṭṭi",size:2,type:"noun"},{id:"ari",size:4,type:"noun"},{id:"payaṟu",size:1,type:"noun"},{id:"niṟaikkum",size:2},{id:"āy",size:2,type:"verb"},{id:"valai",size:1,type:"noun"},{id:"varāal",size:1,type:"noun"},{id:"yāṅkaṇ",size:8,type:"pronoun"},{id:"kaḻi",size:1},{id:"vēṇṭēm",size:1},{id:"parattaṉ",size:1,type:"noun"},{id:"kuṟiyōṭu",size:1},{id:"ōti",size:2,type:"noun"},{id:"acai",size:2,type:"verb"},{id:"naṭa",size:4,type:"verb"},{id:"peṟu",size:5,type:"verb"},{id:"citai",size:1,type:"verb"},{id:"paci",size:2,type:"noun"},{id:"cēṇ",size:1,type:"noun"},{id:"pōttu",size:2,type:"noun"},{id:"muḻu",size:1,type:"noun"},{id:"kaṭai",size:1,type:"noun"},{id:"niṟka",size:1},{id:"celvam",size:1,type:"noun"},{id:"varuttam",size:1,type:"noun"},{id:"vañci",size:1,type:"noun"},{id:"tañcam",size:1,type:"noun"},{id:"kōḻi",size:1,type:"noun"},{id:"nīla",size:1},{id:"cēval",size:1,type:"noun"},{id:"kūr",size:1,type:"noun"},{id:"ukir",size:1,type:"noun"},{id:"pēṭai",size:3,type:"noun"},{id:"vayāam",size:1},{id:"puḷim",size:1},{id:"vēṭkaittu",size:1},{id:"tai",size:2,type:"noun"},{id:"viral",size:1,type:"noun"},{id:"civa",size:3,type:"verb"},{id:"maḻai",size:1,type:"noun"},{id:"e",size:2},{id:"aḻi",size:2,type:"noun"},{id:"teṉ",size:1,type:"noun"},{id:"nāṭṭu",size:1,type:"verb"},{id:"uḷ",size:1},{id:"oḻukku",size:1,type:"verb"},{id:"tēṉūr",size:3},{id:"teri",size:1,type:"verb"},{id:"pañcāy",size:1,type:"noun"},{id:"kōtai",size:1,type:"noun"},{id:"accam",size:2,type:"noun"},{id:"entiram",size:1},{id:"kaḷiṟu",size:1,type:"noun"},{id:"etir",size:1,type:"noun"},{id:"piḷiṟṟum",size:1},{id:"vaḷ",size:3,type:"noun"},{id:"kō",size:1,type:"noun"},{id:"tuṟattaliṉ",size:1},{id:"pakal",size:3,type:"noun"},{id:"viḷakkōṭu",size:1},{id:"ira(m)",size:1,type:"noun"},{id:"cōḻaṉ",size:1,type:"noun"},{id:"āmūr",size:1,type:"noun"},{id:"tēmpa",size:1},{id:"pulampu",size:1,type:"noun"},{id:"-uṭai",size:2},{id:"viṇṭu",size:1,type:"noun"},{id:"pōr",size:2,type:"verb"},{id:"kai",size:2,type:"noun"},{id:"virāaṉ",size:1,type:"noun"},{id:"iruppai",size:1,type:"noun"},{id:"maṉaiyai",size:1},{id:"āṟṟu",size:1,type:"verb"},{id:"maintu",size:1,type:"noun"},{id:"evvam",size:1,type:"noun"},{id:"tīr",size:1,type:"verb"},{id:"yāṉ",size:1,type:"pronoun"},{id:"vēttu",size:1,type:"adjective"},{id:"taṇika",size:1},{id:"nantuka",size:1},{id:"varaika",size:1},{id:"entai",size:1,type:"noun"},{id:"koṭukka",size:1},{id:"kampuḷ",size:2,type:"noun"},{id:"payir",size:1,type:"noun"},{id:"peṭai",size:1,type:"noun"},{id:"akavu",size:2,type:"verb"},{id:"moḻi",size:2,type:"noun"},{id:"vaṭi",size:1,type:"noun"},{id:"viḷai",size:1,type:"noun"},{id:"uku",size:1,type:"verb"},{id:"paḻa(m)",size:1,type:"adjective"},{id:"tuṭumeṉ",size:1},{id:"viḻūum",size:1},{id:"matti",size:1,type:"noun"},{id:"kaḻāar",size:1,type:"noun"},{id:"vatuvai",size:1,type:"noun"},{id:"intira",size:1},{id:"viḻavu",size:1,type:"noun"},{id:"i",size:1},{id:"maṅkai",size:1,type:"noun"},{id:"toku",size:1,type:"verb"},{id:"paḷḷi",size:1,type:"noun"},{id:"nīrnāy",size:1,type:"noun"},{id:"vāḷai",size:1,type:"noun"},{id:"irai",size:1,type:"noun"},{id:"tolaivatu",size:1},{id:"tuṉṉu",size:1,type:"verb"},{id:"oruvar",size:1},{id:"ē",size:1,type:"noun"},{id:"pāttiyiṉ",size:1},{id:"kali",size:1,type:"noun"},{id:"curumpu",size:1,type:"noun"},{id:"kaḷai",size:1,type:"verb"},{id:"muyaṅkaṉmō",size:1},{id:"uṭaliṉēṉ",size:1},{id:"urai",size:2,type:"verb"},{id:"nikarā",size:1},{id:"nikari",size:1},{id:"tarukkum",size:1},{id:"kaṉṉi",size:1,type:"noun"},{id:"viṭiyal",size:1,type:"noun"},{id:"kaṇai",size:1,type:"noun"},{id:"pēṇāḷ",size:1},{id:"kaṇṭaṉem",size:1},{id:"vaṇṭal",size:1,type:"noun"},{id:"uy",size:1,type:"verb"},{id:"aṟam",size:1,type:"noun"},{id:"keṭu",size:1,type:"verb"},{id:"nārai",size:2,type:"noun"},{id:"ceṉṉi",size:1,type:"noun"},{id:"cē",size:2,type:"noun"},{id:"tūyar",size:1},{id:"naṟiyar",size:1},{id:"pēy",size:1,type:"noun"},{id:"iyām",size:1},{id:"cūtu",size:1},{id:"cūr",size:1,type:"noun"},{id:"nuṭakkattu",size:1},{id:"nerunal",size:1},{id:"maṟai",size:1,type:"noun"},{id:"ol(lu)",size:3,type:"verb"},{id:"putaittal",size:1},{id:"kayil",size:1},{id:"tuyal",size:1,type:"verb"},{id:"kūntal",size:3,type:"noun"},{id:"kuvaḷai",size:2,type:"noun"},{id:"iyal",size:1,type:"noun"},{id:"kaḷ",size:1,type:"verb"},{id:"tōkai",size:1,type:"noun"},{id:"cīr",size:1,type:"noun"},{id:"pacu(m)",size:3,type:"adjective"},{id:"avir",size:1,type:"verb"},{id:"pāyvōḷ",size:1},{id:"ovvāy",size:1},{id:"toṭakku",size:1,type:"verb"},{id:"tol",size:1,type:"adjective"},{id:"niṉṉōṭu",size:2},{id:"āṭiṉaḷ",size:1},{id:"paiñcāy",size:1,type:"noun"},{id:"āṭi",size:3,type:"noun"},{id:"mēmpaṭṭaṉaḷ",size:1},{id:"antaram",size:1},{id:"pēr",size:1,type:"noun"},{id:"alai",size:1,type:"noun"},{id:"vēl",size:1,type:"noun"},{id:"kaṭu",size:1,type:"verb"},{id:"kiḷḷi",size:1,type:"noun"},{id:"matil",size:1,type:"noun"},{id:"kol",size:1,type:"verb"},{id:"yāṉai",size:1,type:"noun"},{id:"kataḻpu",size:1},{id:"neṟi",size:2,type:"noun"},{id:"paṟṟu",size:1,type:"noun"},{id:"makaṉai",size:1},{id:"aracaṉ",size:1,type:"noun"},{id:"muṟai",size:1,type:"noun"},{id:"ceyka",size:1},{id:"kaḷavu",size:1,type:"noun"},{id:"alaṅku",size:1,type:"verb"},{id:"cūḷ",size:1,type:"noun"},{id:"vāyppatu",size:1},{id:"pulakkuvēm",size:1},{id:"nala",size:1},{id:"tava",size:1},{id:"akaṭṭu",size:1},{id:"paṟai",size:2,type:"noun"},{id:"viṉai",size:1,type:"noun"},{id:"kūṭṭam",size:1,type:"noun"},{id:"nayantaṉeṉ",size:1},{id:"kēṭkiṉ",size:1},{id:"vekuṇṭaṉaḷ",size:1},{id:"iṇar",size:1,type:"noun"},{id:"paṟa",size:1,type:"verb"},{id:"taṇa",size:1,type:"verb"},{id:"uymmō",size:1},{id:"num",size:3,type:"pronoun"},{id:"cevi",size:1,type:"noun"},{id:"vekuḷvōḷ",size:1},{id:"ai(m)",size:1,type:"noun"},{id:"kayam",size:1,type:"noun"},{id:"paṭintu",size:1},{id:"kural",size:2,type:"noun"},{id:"kiḷaiyōṭu",size:1},{id:"mali",size:2,type:"verb"},{id:"ciṟuvariṉ",size:1},{id:"nakār",size:1},{id:"viḷi",size:1,type:"noun"},{id:"imiḻum",size:1},{id:"alku",size:1,type:"verb"},{id:"pakaṉṟai",size:2,type:"noun"},{id:"ā",size:3},{id:"kōvalar",size:1,type:"noun"},{id:"kuṇil",size:1,type:"noun"},{id:"kaṉi",size:1,type:"noun"},{id:"utirkkum",size:1},{id:"pula",size:2,type:"verb"},{id:"evvai",size:1},{id:"evvaikku",size:1},{id:"aḷi",size:1,type:"noun"},{id:"virumpiṉṟu",size:1},{id:"ampal",size:1,type:"noun"},{id:"kuṇam",size:2,type:"noun"},{id:"maruppu",size:1,type:"noun"},{id:"veṟi",size:1,type:"noun"},{id:"mayakkum",size:2},{id:"vetir",size:1,type:"noun"},{id:"karu(m)",size:3,type:"adjective"},{id:"kōṭṭam",size:4,type:"noun"},{id:"kuḻavikku",size:1},{id:"ūṟṟu",size:1,type:"noun"},{id:"maṭukkum",size:1},{id:"nuntai",size:2,type:"noun"},{id:"maṭantai",size:1,type:"noun"},{id:"niṉṉai",size:1},{id:"iṉam",size:1,type:"noun"},{id:"mēy",size:2,type:"verb"},{id:"aruttu",size:1,type:"verb"},{id:"mōrōṭamōṭu",size:1},{id:"viṉaiya",size:1},{id:"veṟukkaiya",size:1},{id:"mucci",size:1,type:"noun"},{id:"maḷḷar",size:1,type:"noun"},{id:"vati",size:1,type:"noun"},{id:"ilañci",size:1,type:"noun"},{id:"paḻaṉattatu",size:1},{id:"kayiṟu",size:1,type:"noun"},{id:"muṟṟi",size:1,type:"verb"},{id:"paṭar",size:1,type:"noun"},{id:"āmpaloṭu",size:1},{id:"kalikkum",size:1},{id:"pāyal",size:1,type:"noun"},{id:"miṭai",size:1,type:"noun"},{id:"kōṭṭai",size:1},{id:"kaṉṟu",size:1,type:"noun"},{id:"ampi",size:1,type:"noun"},{id:"pākal",size:1,type:"noun"},{id:"muyiṟu",size:1,type:"noun"},{id:"mūcu",size:1,type:"verb"},{id:"kuṭampai",size:1,type:"noun"}],IA=[{id:"a- ūr",source:"a-",target:"ūr",strength:.03633262628102516,citations:["Aink24","Aink41"]},{id:"vāḻ ūr",source:"vāḻ",target:"ūr",strength:.05737319476923728,citations:["Aink36","Aink39"]},{id:"i- ūr",source:"i-",target:"ūr",strength:.08609061460215275,citations:["Aink62","Aink96"],curvature:.25},{id:"ūr eṉ",source:"ūr",target:"eṉ",strength:.09013452501893073,citations:["Aink41","Aink89"]},{id:"ūr ūr",source:"ūr",target:"ūr",strength:.11304179525044912,citations:["Aink15","Aink54","Aink7"],curvature:.5},{id:"ūr pū(m)",source:"ūr",target:"pū(m)",strength:.1222937605017615,citations:["Aink16","Aink34"],curvature:.25},{id:"nī a-",source:"nī",target:"a-",strength:.13656218576268014,citations:["Aink46","Aink48"],curvature:.25},{id:"ūr e-",source:"ūr",target:"e-",strength:.15086363390005364,citations:["Aink20","Aink81"]},{id:"ūr peru(m)",source:"ūr",target:"peru(m)",strength:.1573534152373636,citations:["Aink30","Aink48"]},{id:"ūr malar",source:"ūr",target:"malar",strength:.17885822755144687,citations:["Aink18","Aink75"],curvature:.25},{id:"malar ūr",source:"malar",target:"ūr",strength:.17885822755144687,citations:["Aink53","Aink68"],curvature:.25},{id:"ākkam nī",source:"ākkam",target:"nī",strength:.18239019192238748,citations:["Aink46","Aink79"]},{id:"nī i-",source:"nī",target:"i-",strength:.18632017408380777,citations:["Aink67","Aink85"]},{id:"pū(m) a-",source:"pū(m)",target:"a-",strength:.1878616830382941,citations:["Aink41","Aink62"]},{id:"eṉ nī",source:"eṉ",target:"nī",strength:.19036408450058576,citations:["Aink81","Aink82"]},{id:"tāṉ ūr",source:"tāṉ",target:"ūr",strength:.19528956654010313,citations:["Aink40","Aink7"],curvature:.25},{id:"ūr ākkam",source:"ūr",target:"ākkam",strength:.19800481719449076,citations:["Aink15","Aink19","Aink24"]},{id:"ākkam eṉ",source:"ākkam",target:"eṉ",strength:.20153045371517067,citations:["Aink8","Aink9"]},{id:"i- eṉ",source:"i-",target:"eṉ",strength:.20546043587659096,citations:["Aink22","Aink79"]},{id:"ūr nal",source:"ūr",target:"nal",strength:.20699831596271656,citations:["Aink12","Aink22","Aink63"]},{id:"a- ākkam",source:"a-",target:"ākkam",strength:.2165415811593237,citations:["Aink221","Aink90"]},{id:"eṉ a-",source:"eṉ",target:"a-",strength:.2249935551413321,citations:["Aink32","Aink41","Aink89"]},{id:"a- kaṇ",source:"a-",target:"kaṇ",strength:.22972781650245394,citations:["Aink18","Aink30"]},{id:"ūr poykai",source:"ūr",target:"poykai",strength:.23542269460113216,citations:["Aink34","Aink35"],curvature:.25},{id:"malar a-",source:"malar",target:"a-",strength:.24442615008797944,citations:["Aink18","Aink72"]},{id:"makiḻ nī",source:"makiḻ",target:"nī",strength:.24489194397958347,citations:["Aink69","Aink77"]},{id:"nī e-",source:"nī",target:"e-",strength:.2510931933817086,citations:["Aink60","Aink81"]},{id:"puṉal ūr",source:"puṉal",target:"ūr",strength:.2579896332907664,citations:["Aink23","Aink65","Aink95"]},{id:"a- nī",source:"a-",target:"nī",strength:.25823000095077164,citations:["Aink307","Aink42","Aink44","Aink51"],curvature:.25},{id:"cel ūr",source:"cel",target:"ūr",strength:.2608574890766357,citations:["Aink22","Aink27"]},{id:"ūr maṉai",source:"ūr",target:"maṉai",strength:.2608574890766357,citations:["Aink3","Aink87"]},{id:"tāṉ a-",source:"tāṉ",target:"a-",strength:.26085748907663575,citations:["Aink103","Aink404"],curvature:.25},{id:"e- ākkam",source:"e-",target:"ākkam",strength:.2622595625962935,citations:["Aink221","Aink84"]},{id:"tuṟai i-",source:"tuṟai",target:"i-",strength:.2661895447577138,citations:["Aink103","Aink28"]},{id:"ūr tāṉ",source:"ūr",target:"tāṉ",strength:.2669541529797905,citations:["Aink10","Aink3","Aink7"],curvature:.25},{id:"ākkam peru(m)",source:"ākkam",target:"peru(m)",strength:.2687493439336035,citations:["Aink403","Aink63"]},{id:"nī pal",source:"nī",target:"pal",strength:.27154513170998407,citations:["Aink55","Aink69"]},{id:"ūr maka",source:"ūr",target:"maka",strength:.275349281681856,citations:["Aink100","Aink91","Aink96","Aink97","Aink99"]},{id:"nel ūr",source:"nel",target:"ūr",strength:.2755558226621612,citations:["Aink4","Aink48"]},{id:"paḻaṉa(m) ūr",source:"paḻaṉa(m)",target:"ūr",strength:.2755558226621612,citations:["Aink53","Aink96"]},{id:"peru(m) eṉ",source:"peru(m)",target:"eṉ",strength:.2767232365118018,citations:["Aink1","Aink89"],curvature:.25},{id:"eṉ peru(m)",source:"eṉ",target:"peru(m)",strength:.2767232365118018,citations:["Aink67","Aink73"],curvature:.25},{id:"makiḻ a-",source:"makiḻ",target:"a-",strength:.28279067807614255,citations:["Aink31","Aink75","Aink90"]},{id:"nī maka",source:"nī",target:"maka",strength:.28525414275029504,citations:["Aink101","Aink29","Aink49"]},{id:"ūr koḷ",source:"ūr",target:"koḷ",strength:.2866993449895628,citations:["Aink10","Aink40","Aink7"]},{id:"pū(m) ūr",source:"pū(m)",target:"ūr",strength:.2867792341119562,citations:["Aink16","Aink3","Aink30","Aink8","Aink99"],curvature:.25},{id:"a- e-",source:"a-",target:"e-",strength:.2893637285767237,citations:["Aink18","Aink221","Aink31"]},{id:"em a-",source:"em",target:"a-",strength:.28982424792307987,citations:["Aink82","Aink90"]},{id:"pal eṉ",source:"pal",target:"eṉ",strength:.2906853935027673,citations:["Aink3","Aink6"]},{id:"ākkam taṭpam",source:"ākkam",target:"taṭpam",strength:.2920770026547995,citations:["Aink28","Aink45","Aink54"]},{id:"pū(m) tuṟai",source:"pū(m)",target:"tuṟai",strength:.3023926906573226,citations:["Aink12","Aink33"]},{id:"kaṇ maka",source:"kaṇ",target:"maka",strength:.30572005788199813,citations:["Aink406","Aink79"]},{id:"eṉ puṉal",source:"eṉ",target:"puṉal",strength:.3062019414040833,citations:["Aink71","Aink72"]},{id:"nal nal",source:"nal",target:"nal",strength:.306685495236343,citations:["Aink204","Aink61"],curvature:.5},{id:"pū(m) peru(m)",source:"pū(m)",target:"peru(m)",strength:.30888247199463253,citations:["Aink19","Aink33"]},{id:"poykai ūr",source:"poykai",target:"ūr",strength:.30949349632583195,citations:["Aink70","Aink81","Aink97"],curvature:.25},{id:"i- tāṉ",source:"i-",target:"tāṉ",strength:.31061547739776335,citations:["Aink103","Aink67"]},{id:"ūr peṇ",source:"ūr",target:"peṇ",strength:.31061547739776335,citations:["Aink13","Aink89"],curvature:.25},{id:"peṇ ūr",source:"peṇ",target:"ūr",strength:.31061547739776335,citations:["Aink13","Aink40"],curvature:.25},{id:"eṉ tāṉ",source:"eṉ",target:"tāṉ",strength:.3146593878145413,citations:["Aink33","Aink41"]},{id:"ūr pāṇ",source:"ūr",target:"pāṇ",strength:.32235980672615805,citations:["Aink1","Aink43","Aink49"]},{id:"aṇi ūr",source:"aṇi",target:"ūr",strength:.32235980672615805,citations:["Aink14","Aink23","Aink45"]},{id:"eṉ uṇ",source:"eṉ",target:"uṇ",strength:.3236628433013886,citations:["Aink36","Aink69"]},{id:"ākkam i-",source:"ākkam",target:"i-",strength:.3256762484155726,citations:["Aink322","Aink46","Aink59","Aink93"]},{id:"puṉal maka",source:"puṉal",target:"maka",strength:.32839228404572196,citations:["Aink100","Aink15"]},{id:"i- nal",source:"i-",target:"nal",strength:.32923868833560427,citations:["Aink55","Aink56","Aink57"]},{id:"ūr kēḷ",source:"ūr",target:"kēḷ",strength:.33212028971184654,citations:["Aink2","Aink9"]},{id:"nal eṉ",source:"nal",target:"eṉ",strength:.3335250547862422,citations:["Aink204","Aink67"]},{id:"vāḻ pāṇ",source:"vāḻ",target:"pāṇ",strength:.3341697200355127,citations:["Aink1","Aink89"]},{id:"pū(m) taṭpam",source:"pū(m)",target:"taṭpam",strength:.334616346000841,citations:["Aink103","Aink13","Aink404"]},{id:"a- tāṉ",source:"a-",target:"tāṉ",strength:.3364532551934715,citations:["Aink343","Aink41","Aink66"],curvature:.25},{id:"kaṇ e-",source:"kaṇ",target:"e-",strength:.34425882412148245,citations:["Aink84"]},{id:"ūr i-",source:"ūr",target:"i-",strength:.3464965760622056,citations:["Aink100","Aink30","Aink8","Aink86","Aink91","Aink96","Aink97","Aink99"],curvature:.25},{id:"aṇi nī",source:"aṇi",target:"nī",strength:.347790788492423,citations:["Aink45","Aink55"]},{id:"ūr toṭi",source:"ūr",target:"toṭi",strength:.35203283967187343,citations:["Aink28","Aink83","Aink98"]},{id:"ūr oṇmai",source:"ūr",target:"oṇmai",strength:.35531170819433366,citations:["Aink28","Aink83","Aink92","Aink98"]},{id:"pū(m) uṇ",source:"pū(m)",target:"uṇ",strength:.3558220787842194,citations:["Aink101","Aink16"]},{id:"peṟu ūr",source:"peṟu",target:"ūr",strength:.35755508418735005,citations:["Aink49","Aink63"]},{id:"a- tuṇai",source:"a-",target:"tuṇai",strength:.3575550841873501,citations:["Aink307","Aink94"]},{id:"e- yām",source:"e-",target:"yām",strength:.3589571577070079,citations:["Aink11","Aink53"],curvature:.25},{id:"yām e-",source:"yām",target:"e-",strength:.3589571577070079,citations:["Aink11","Aink12"],curvature:.25},{id:"a- i-",source:"a-",target:"i-",strength:.36011212640013646,citations:["Aink103","Aink54","Aink55","Aink56","Aink57","Aink58"]},{id:"aṟi nī",source:"aṟi",target:"nī",strength:.3610870485582907,citations:["Aink47","Aink79"]},{id:"vāḻ nām",source:"vāḻ",target:"nām",strength:.36216431368690594,citations:["Aink34","Aink35"]},{id:"tōḻaṉ ūr",source:"tōḻaṉ",target:"ūr",strength:.36767342576991513,citations:["Aink34","Aink35","Aink36","Aink39"]},{id:"makiḻ tāṉ",source:"makiḻ",target:"tāṉ",strength:.369187247293539,citations:["Aink38","Aink66"]},{id:"ākkam aṟi",source:"ākkam",target:"aṟi",strength:.37225341777287557,citations:["Aink79","Aink90"]},{id:"ākkam vēṭṭōḷ",source:"ākkam",target:"vēṭṭōḷ",strength:.37225341777287557,citations:["Aink8","Aink9"]},{id:"tuṟai tāṉ",source:"tuṟai",target:"tāṉ",strength:.37538849669566415,citations:["Aink10","Aink7"]},{id:"tuṟai varavu",source:"tuṟai",target:"varavu",strength:.37538849669566415,citations:["Aink105","Aink69"]},{id:"poykai pū(m)",source:"poykai",target:"pū(m)",strength:.38695175135840115,citations:["Aink34","Aink97"]},{id:"aḷai ūr",source:"aḷai",target:"ūr",strength:.3886847567615319,citations:["Aink22","Aink27"]},{id:"ūr māṇ",source:"ūr",target:"māṇ",strength:.3886847567615319,citations:["Aink42","Aink47"]},{id:"nekiḻ ūr",source:"nekiḻ",target:"ūr",strength:.3886847567615319,citations:["Aink54"]},{id:"maka pōl",source:"maka",target:"pōl",strength:.3891213929268448,citations:["Aink101","Aink401"]},{id:"kaḻaṉi maka",source:"kaḻaṉi",target:"maka",strength:.3891213929268448,citations:["Aink91","Aink96"]},{id:"i- paḻaṉa(m)",source:"i-",target:"paḻaṉa(m)",strength:.3908817335198214,citations:["Aink91","Aink96"]},{id:"nī yāṅkaṇ",source:"nī",target:"yāṅkaṇ",strength:.3922167211324726,citations:["Aink79","Aink87"]},{id:"al e-",source:"al",target:"e-",strength:.39401681244261,citations:["Aink11"]},{id:"malar taṭpam",source:"malar",target:"taṭpam",strength:.39457218301791486,citations:["Aink69","Aink76","Aink88"]},{id:"āṭu eṉ",source:"āṭu",target:"eṉ",strength:.3949256439365994,citations:["Aink33","Aink71"]},{id:"il eṉ",source:"il",target:"eṉ",strength:.3949256439365994,citations:["Aink8","Aink9"]},{id:"yāy pū(m)",source:"yāy",target:"pū(m)",strength:.39909028576803696,citations:["Aink10","Aink4"]},{id:"pū(m) pōl",source:"pū(m)",target:"pōl",strength:.39909028576803696,citations:["Aink101","Aink16"]},{id:"ūr em",source:"ūr",target:"em",strength:.40368562330178487,citations:["Aink26","Aink5","Aink63","Aink86","Aink88"]},{id:"ūr nī",source:"ūr",target:"nī",strength:.4051744221081325,citations:["Aink42","Aink43","Aink49","Aink53","Aink54","Aink60","Aink68","Aink81","Aink85","Aink87"]},{id:"yām pū(m)",source:"yām",target:"pū(m)",strength:.41015176749631677,citations:["Aink10","Aink4","Aink7"]},{id:"nī paca",source:"nī",target:"paca",strength:.4108450368794183,citations:["Aink29","Aink45"]},{id:"varavu puṉal",source:"varavu",target:"puṉal",strength:.4113569829252557,citations:["Aink69","Aink72"]},{id:"aṟu ūr",source:"aṟu",target:"ūr",strength:.41198867668894734,citations:["Aink25","Aink26","Aink29"]},{id:"nām ūr",source:"nām",target:"ūr",strength:.4121027639890999,citations:["Aink102","Aink31","Aink34","Aink35"]},{id:"ūr mārpu",source:"ūr",target:"mārpu",strength:.4121027639890999,citations:["Aink14","Aink25","Aink29","Aink4"]},{id:"pū(m) vēḻam",source:"pū(m)",target:"vēḻam",strength:.41238654583390466,citations:["Aink14","Aink16"],curvature:.25},{id:"kaḷvaṉ taṭpam",source:"kaḷvaṉ",target:"taṭpam",strength:.41238654583390466,citations:["Aink27","Aink30"]},{id:"taṭpam āṭu",source:"taṭpam",target:"āṭu",strength:.41238654583390466,citations:["Aink77","Aink98"]},{id:"aṉṉai e-",source:"aṉṉai",target:"e-",strength:.4155216247566932,citations:["Aink201","Aink204"]},{id:"maka paḻaṉa(m)",source:"maka",target:"paḻaṉa(m)",strength:.417115986578238,citations:["Aink91","Aink96"]},{id:"a- nal",source:"a-",target:"nal",strength:.4222736081716498,citations:["Aink55","Aink56","Aink57","Aink61"]},{id:"nel pū(m)",source:"nel",target:"pū(m)",strength:.42708487941943024,citations:["Aink3","Aink30"]},{id:"taṭpam ūr",source:"taṭpam",target:"ūr",strength:.428279739449997,citations:["Aink10","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"nī pāṇ",source:"nī",target:"pāṇ",strength:.4285987133403883,citations:["Aink43","Aink47","Aink49"]},{id:"tuñcu ūr",source:"tuñcu",target:"ūr",strength:.42881788482256095,citations:["Aink13","Aink43"]},{id:"ūr uḷḷi",source:"ūr",target:"uḷḷi",strength:.42881788482256095,citations:["Aink16","Aink20"]},{id:"tōṟṟam ūr",source:"tōṟṟam",target:"ūr",strength:.42881788482256095,citations:["Aink17","Aink98"]},{id:"cel nal",source:"cel",target:"nal",strength:.42881788482256095,citations:["Aink22","Aink307"]},{id:"naṟu(m) taṭpam",source:"naṟu(m)",target:"taṭpam",strength:.42881788482256095,citations:["Aink404","Aink73"]},{id:"num ūr",source:"num",target:"ūr",strength:.42881788482256095,citations:["Aink83","Aink92"]},{id:"aṭu maka",source:"aṭu",target:"maka",strength:.4335473255668943,citations:["Aink100","Aink15"]},{id:"yāṅkaṇ maka",source:"yāṅkaṇ",target:"maka",strength:.4335473255668943,citations:["Aink79"]},{id:"tāṉ koḷ",source:"tāṉ",target:"koḷ",strength:.4384427450826595,citations:["Aink10","Aink7"]},{id:"puṉal em",source:"puṉal",target:"em",strength:.4403237417716998,citations:["Aink77","Aink78"]},{id:"pōl kaṇ",source:"pōl",target:"kaṇ",strength:.44095641923219675,citations:["Aink101","Aink16"]},{id:"vēḻam tuṟai",source:"vēḻam",target:"tuṟai",strength:.44095641923219675,citations:["Aink11","Aink20"]},{id:"nī maṉai",source:"nī",target:"maṉai",strength:.4426921618077018,citations:["Aink66","Aink81","Aink87"]},{id:"i- no/nō",source:"i-",target:"no/nō",strength:.4474462005695068,citations:["Aink28","Aink99"]},{id:"maṭa(m) i-",source:"maṭa(m)",target:"i-",strength:.4474462005695068,citations:["Aink67","Aink98"]},{id:"makiḻ toṭi",source:"makiḻ",target:"toṭi",strength:.44945350341559714,citations:["Aink24","Aink40"]},{id:"varavu eṉ",source:"varavu",target:"eṉ",strength:.4553923256472169,citations:["Aink105","Aink2","Aink72","Aink88"]},{id:"kaḻaṉi malar",source:"kaḻaṉi",target:"malar",strength:.45565475281772233,citations:["Aink53","Aink94"]},{id:"aviṉi pal",source:"aviṉi",target:"pal",strength:.46140835756047227,citations:["Aink1","Aink3"]},{id:"malar āmpal",source:"malar",target:"āmpal",strength:.46895101288359,citations:["Aink72","Aink91"]},{id:"il ākkam",source:"il",target:"ākkam",strength:.4701076045133907,citations:["Aink5","Aink8","Aink9"]},{id:"keḻu ūr",source:"keḻu",target:"ūr",strength:.47194451370602125,citations:["Aink11","Aink12","Aink85"]},{id:"maṭa(m) maka",source:"maṭa(m)",target:"maka",strength:.4736804536279233,citations:["Aink48","Aink98"]},{id:"peru(m) tuṟai",source:"peru(m)",target:"tuṟai",strength:.4806252459350545,citations:["Aink31","Aink33","Aink69","Aink75"]},{id:"pōl uṇ",source:"pōl",target:"uṇ",strength:.4810895472932258,citations:["Aink101","Aink16"]},{id:"toṭi yām",source:"toṭi",target:"yām",strength:.4836493464691155,citations:["Aink38","Aink40"]},{id:"ūr koṭu(m)",source:"ūr",target:"koṭu(m)",strength:.48538235187224626,citations:["Aink11","Aink12"]},{id:"naṇṇu ūr",source:"naṇṇu",target:"ūr",strength:.48538235187224626,citations:["Aink20","Aink86"]},{id:"niṟaikkum ūr",source:"niṟaikkum",target:"ūr",strength:.48538235187224626,citations:["Aink47","Aink48"]},{id:"akavu ūr",source:"akavu",target:"ūr",strength:.48538235187224626,citations:["Aink60","Aink62"]},{id:"miṉ taṭpam",source:"miṉ",target:"taṭpam",strength:.49438580735909354,citations:["Aink10","Aink5"]},{id:"taṭpam aka(m)",source:"taṭpam",target:"aka(m)",strength:.49438580735909354,citations:["Aink27","Aink30"]},{id:"poḻutu a-",source:"poḻutu",target:"a-",strength:.49438580735909354,citations:["Aink406","Aink82"]},{id:"nī peṇ",source:"nī",target:"peṇ",strength:.4954334319669084,citations:["Aink68","Aink69","Aink70"]},{id:"ciṟa eṉ",source:"ciṟa",target:"eṉ",strength:.4959760721664315,citations:["Aink1","Aink10","Aink3"]},{id:"vāḻ vāḻ",source:"vāḻ",target:"vāḻ",strength:.5009359615014229,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.5},{id:"koḷ cel",source:"koḷ",target:"cel",strength:.5040106676191921,citations:["Aink10","Aink7"]},{id:"i- aṇaṅku",source:"i-",target:"aṇaṅku",strength:.5040106676191921,citations:["Aink23","Aink58"]},{id:"kaṇ paca",source:"kaṇ",target:"paca",strength:.5040106676191921,citations:["Aink36","Aink37"]},{id:"pāy eṉ",source:"pāy",target:"eṉ",strength:.5080545780359701,citations:["Aink53","Aink73"]},{id:"kaḻaṉi ūr",source:"kaḻaṉi",target:"ūr",strength:.5117682390855409,citations:["Aink18","Aink25","Aink29","Aink4","Aink60","Aink91","Aink96"]},{id:"tuṟai kēḷ",source:"tuṟai",target:"kēḷ",strength:.5122192198674076,citations:["Aink2","Aink9"]},{id:"em cel",source:"em",target:"cel",strength:.5143491107186905,citations:["Aink77"]},{id:"taṭpam puṉal",source:"taṭpam",target:"puṉal",strength:.5176613464947993,citations:["Aink54","Aink69","Aink76","Aink77","Aink98"]},{id:"maka tuṇai",source:"maka",target:"tuṇai",strength:.5194968553748452,citations:["Aink15","Aink80","Aink94"]},{id:"maka i-",source:"maka",target:"i-",strength:.5219978403739541,citations:["Aink100","Aink52","Aink79","Aink91","Aink96","Aink97","Aink98","Aink99"]},{id:"nī mārpu",source:"nī",target:"mārpu",strength:.5230617949173302,citations:["Aink42","Aink44","Aink46","Aink51"]},{id:"yāṇar nī",source:"yāṇar",target:"nī",strength:.5230617949173302,citations:["Aink42","Aink43","Aink49","Aink87"]},{id:"poykai āmpal",source:"poykai",target:"āmpal",strength:.5255154799332753,citations:["Aink35","Aink91"]},{id:"vāḻ makiḻ",source:"vāḻ",target:"makiḻ",strength:.5264859080876062,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40","Aink59","Aink77"]},{id:"aruḷ nī",source:"aruḷ",target:"nī",strength:.5290474443042159,citations:["Aink50"]},{id:"nī neñcam",source:"nī",target:"neñcam",strength:.5290474443042159,citations:["Aink50"]},{id:"āṭu em",source:"āṭu",target:"em",strength:.5290474443042159,citations:["Aink77","Aink78"]},{id:"no/nō ākkam",source:"no/nō",target:"ākkam",strength:.5300634415304646,citations:["Aink101","Aink28","Aink99"]},{id:"malar poykai",source:"malar",target:"poykai",strength:.5300634415304646,citations:["Aink6","Aink88","Aink91"]},{id:"veḷ pū(m)",source:"veḷ",target:"pū(m)",strength:.5354235124929116,citations:["Aink13","Aink17","Aink19","Aink41"]},{id:"kañal ūr",source:"kañal",target:"ūr",strength:.5373420343453394,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"pāṇ maka",source:"pāṇ",target:"maka",strength:.5378254119638973,citations:["Aink47","Aink48","Aink49"]},{id:"pū(m) ciṉai",source:"pū(m)",target:"ciṉai",strength:.5402138135188008,citations:["Aink19","Aink20"]},{id:"nām poykai",source:"nām",target:"poykai",strength:.5402138135188008,citations:["Aink34","Aink35"]},{id:"muṉ yām",source:"muṉ",target:"yām",strength:.5402138135188008,citations:["Aink38","Aink40"]},{id:"vēṉal ākkam",source:"vēṉal",target:"ākkam",strength:.5402138135188008,citations:["Aink45","Aink54"]},{id:"veḷ nel",source:"veḷ",target:"nel",strength:.5402138135188008,citations:["Aink48","Aink58"]},{id:"uṇ paca",source:"uṇ",target:"paca",strength:.5441437956802212,citations:["Aink36","Aink37"]},{id:"aka(m) peru(m)",source:"aka(m)",target:"peru(m)",strength:.5441437956802212,citations:["Aink403","Aink47"]},{id:"pāvai a-",source:"pāvai",target:"a-",strength:.5509502744087789,citations:["Aink221","Aink307"]},{id:"kaḷvaṉ kaḻaṉi",source:"kaḷvaṉ",target:"kaḻaṉi",strength:.5523523479284367,citations:["Aink25","Aink29"]},{id:"tāṉ amai",source:"tāṉ",target:"amai",strength:.556645152507457,citations:["Aink103"]},{id:"aṉṉai vāḻ",source:"aṉṉai",target:"vāḻ",strength:.5613227263667411,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"vāḻ aṉṉai",source:"vāḻ",target:"aṉṉai",strength:.5613227263667411,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"vēḻam pū(m)",source:"vēḻam",target:"pū(m)",strength:.5635810756055892,citations:["Aink12","Aink13","Aink17","Aink19"],curvature:.25},{id:"oṇmai nutal",source:"oṇmai",target:"nutal",strength:.564107099039818,citations:["Aink322","Aink73"]},{id:"peru(m) ciṟa",source:"peru(m)",target:"ciṟa",strength:.5672251272112693,citations:["Aink1","Aink403","Aink9"]},{id:"tuṟai keḻu",source:"tuṟai",target:"keḻu",strength:.5687836869170929,citations:["Aink11","Aink12"]},{id:"tuṟai aṇaṅku",source:"tuṟai",target:"aṇaṅku",strength:.5687836869170929,citations:["Aink28","Aink53"]},{id:"tuṟai ūr",source:"tuṟai",target:"ūr",strength:.5796945870914383,citations:["Aink10","Aink11","Aink12","Aink13","Aink14","Aink2","Aink20","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"ōkku pū(m)",source:"ōkku",target:"pū(m)",strength:.5803469415798299,citations:["Aink16","Aink33"]},{id:"pey pū(m)",source:"pey",target:"pū(m)",strength:.5803469415798299,citations:["Aink16","Aink405"]},{id:"yāṇar ūr",source:"yāṇar",target:"ūr",strength:.5813888129582642,citations:["Aink1","Aink100","Aink42","Aink43","Aink49","Aink50","Aink70","Aink87"]},{id:"kaṇ ēr",source:"kaṇ",target:"ēr",strength:.5820799469829607,citations:["Aink101","Aink72"]},{id:"mūtu ūr",source:"mūtu",target:"ūr",strength:.5820799469829607,citations:["Aink15"]},{id:"maṉai yāṅkaṇ",source:"maṉai",target:"yāṅkaṇ",strength:.5820799469829607,citations:["Aink48","Aink87"]},{id:"tēṉūr a-",source:"tēṉūr",target:"a-",strength:.5839829592657437,citations:["Aink54","Aink55","Aink57"]},{id:"nī moḻi",source:"nī",target:"moḻi",strength:.5856119113539013,citations:["Aink60","Aink77"]},{id:"oṇmai maṭa(m)",source:"oṇmai",target:"maṭa(m)",strength:.5856119113539013,citations:["Aink76","Aink98"]},{id:"maruntu ākkam",source:"maruntu",target:"ākkam",strength:.5900192785475386,citations:["Aink101","Aink59","Aink99"]},{id:"i- maruntu",source:"i-",target:"maruntu",strength:.5941848860789088,citations:["Aink59","Aink99"]},{id:"ākkam vī",source:"ākkam",target:"vī",strength:.5967782805684863,citations:["Aink201","Aink84"]},{id:"nal nāṭu",source:"nal",target:"nāṭu",strength:.5967782805684863,citations:["Aink61"]},{id:"puṉal aṭu",source:"puṉal",target:"aṭu",strength:.5984712525295469,citations:["Aink100","Aink15","Aink72"]},{id:"maṉai neṭu(m)",source:"maṉai",target:"neṭu(m)",strength:.6007082627299065,citations:["Aink324","Aink60"]},{id:"kāl āmpal",source:"kāl",target:"āmpal",strength:.6007082627299065,citations:["Aink34","Aink68"]},{id:"i- e",source:"i-",target:"e",strength:.6007082627299065,citations:["Aink52","Aink62"]},{id:"al poy",source:"al",target:"poy",strength:.6007082627299065,citations:["Aink66","Aink80"]},{id:"aṟu kaḻaṉi",source:"aṟu",target:"kaḻaṉi",strength:.6089168149781219,citations:["Aink25","Aink29"]},{id:"marutattu tuṟai",source:"marutattu",target:"tuṟai",strength:.6089168149781219,citations:["Aink31","Aink75"]},{id:"oṇmai arivai",source:"oṇmai",target:"arivai",strength:.6110467058294049,citations:["Aink322","Aink73"]},{id:"tāṉ col",source:"tāṉ",target:"col",strength:.6132096195571424,citations:["Aink38","Aink41"]},{id:"marutattu peru(m)",source:"marutattu",target:"peru(m)",strength:.615406596315432,citations:["Aink31","Aink75"]},{id:"vēḻam veḷ",source:"vēḻam",target:"veḷ",strength:.6169790374151781,citations:["Aink13","Aink17","Aink19"]},{id:"vēḻam karuppu",source:"vēḻam",target:"karuppu",strength:.6222130750439896,citations:["Aink12","Aink18"]},{id:"kaṇ aḻu",source:"kaṇ",target:"aḻu",strength:.6222130750439896,citations:["Aink18","Aink69"]},{id:"nīr poykai",source:"nīr",target:"poykai",strength:.6222130750439896,citations:["Aink61","Aink70"]},{id:"kaṇ ā",source:"kaṇ",target:"ā",strength:.6222130750439896,citations:["Aink87","Aink92"]},{id:"taṭpam maṇ",source:"taṭpam",target:"maṇ",strength:.6222130750439898,citations:["Aink27","Aink30"]},{id:"eyiṟu maka",source:"eyiṟu",target:"maka",strength:.6269425157883232,citations:["Aink47","Aink48"]},{id:"vāḻ vēṇṭu",source:"vāḻ",target:"vēṇṭu",strength:.6281255286528961,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"]},{id:"tōḻaṉ nām",source:"tōḻaṉ",target:"nām",strength:.63255862189358,citations:["Aink34","Aink35","Aink36"]},{id:"kaḻaṉi tāmarai",source:"kaḻaṉi",target:"tāmarai",strength:.6343516094536256,citations:["Aink53","Aink94"]},{id:"tēṉūr i-",source:"tēṉūr",target:"i-",strength:.6367242294249504,citations:["Aink54","Aink55","Aink57"]},{id:"putu āṭu",source:"putu",target:"āṭu",strength:.6369114086295152,citations:["Aink64","Aink78"]},{id:"toṭi maṭa(m)",source:"toṭi",target:"maṭa(m)",strength:.6369114086295152,citations:["Aink76","Aink98"]},{id:"oṇmai taḻai",source:"oṇmai",target:"taḻai",strength:.6421763784035867,citations:["Aink15","Aink73"]},{id:"kaḻaṉi mārpu",source:"kaḻaṉi",target:"mārpu",strength:.6454249322939062,citations:["Aink25","Aink29","Aink4"]},{id:"puṉal āṭu",source:"puṉal",target:"āṭu",strength:.6512999754828911,citations:["Aink64","Aink77","Aink78","Aink98"]},{id:"nōkkam nal",source:"nōkkam",target:"nal",strength:.6533427476181716,citations:["Aink204"]},{id:"poṉ cey",source:"poṉ",target:"cey",strength:.6533427476181716,citations:["Aink316","Aink41"]},{id:"tāmarai malar",source:"tāmarai",target:"malar",strength:.6595183807612196,citations:["Aink53","Aink68","Aink94"]},{id:"tātu uṇ",source:"tātu",target:"uṇ",strength:.6595183807612196,citations:["Aink67","Aink82","Aink93"]},{id:"kaḷvaṉ aka(m)",source:"kaḷvaṉ",target:"aka(m)",strength:.6623462031050188,citations:["Aink27","Aink30"]},{id:"e- taṭa(m)",source:"e-",target:"taṭa(m)",strength:.6628414259649384,citations:["Aink11","Aink12"]},{id:"tōḻaṉ makiḻ",source:"tōḻaṉ",target:"makiḻ",strength:.6644115166852712,citations:["Aink31","Aink32","Aink33","Aink37","Aink38","Aink40"]},{id:"ciṟa vēṭṭōḷ",source:"ciṟa",target:"vēṭṭōḷ",strength:.676934874432252,citations:["Aink1","Aink10","Aink3"]},{id:"karai vēḻam",source:"karai",target:"vēḻam",strength:.678777542093675,citations:["Aink12","Aink13"]},{id:"puṇar tuṇai",source:"puṇar",target:"tuṇai",strength:.678777542093675,citations:["Aink15","Aink72"]},{id:"aṭu puṇar",source:"aṭu",target:"puṇar",strength:.678777542093675,citations:["Aink15","Aink72"]},{id:"aḷai cel",source:"aḷai",target:"cel",strength:.678777542093675,citations:["Aink22","Aink27"]},{id:"taṭa(m) erumai",source:"taṭa(m)",target:"erumai",strength:.678777542093675,citations:["Aink94","Aink98"]},{id:"oṇmai muṉ",source:"oṇmai",target:"muṉ",strength:.6806786006833669,citations:["Aink38","Aink40","Aink83"]},{id:"ce(m) koṭi",source:"ce(m)",target:"koṭi",strength:.6934758756792005,citations:["Aink25","Aink52"]},{id:"mel kāl",source:"mel",target:"kāl",strength:.6974058578406208,citations:["Aink26","Aink35"]},{id:"peṟu nutal",source:"peṟu",target:"nutal",strength:.6974058578406208,citations:["Aink56","Aink94"]},{id:"yāṉ i-",source:"yāṉ",target:"i-",strength:.6974058578406208,citations:["Aink59"]},{id:"aḻi puṉal",source:"aḻi",target:"puṉal",strength:.7014497682573988,citations:["Aink53","Aink78"]},{id:"pū(m) kañal",source:"pū(m)",target:"kañal",strength:.705092121068336,citations:["Aink16","Aink3","Aink8","Aink99"]},{id:"puṟavam aṇi",source:"puṟavam",target:"aṇi",strength:.7056144100888363,citations:["Aink404","Aink405"]},{id:"vāl iḻai",source:"vāl",target:"iḻai",strength:.7099072146678568,citations:["Aink0","Aink73"]},{id:"naṉi ciṟa",source:"naṉi",target:"ciṟa",strength:.7099072146678568,citations:["Aink10","Aink7"]},{id:"tāṉ uṇarntōr",source:"tāṉ",target:"uṇarntōr",strength:.7099072146678568,citations:["Aink38","Aink41"]},{id:"māṇ iḻai",source:"māṇ",target:"iḻai",strength:.7099072146678568,citations:["Aink42","Aink47"]},{id:"aṇaṅku uṟu",source:"aṇaṅku",target:"uṟu",strength:.7099072146678568,citations:["Aink53","Aink58"]},{id:"putu puṉal",source:"putu",target:"puṉal",strength:.7139196106610107,citations:["Aink53","Aink64","Aink78","Aink79"]},{id:"taṭpam tuṟai",source:"taṭpam",target:"tuṟai",strength:.7168334604332807,citations:["Aink10","Aink103","Aink105","Aink13","Aink2","Aink21","Aink5","Aink6","Aink7","Aink83","Aink88","Aink9"]},{id:"ciṟu(m) miṉ",source:"ciṟu(m)",target:"miṉ",strength:.718910670154704,citations:["Aink1","Aink10"]},{id:"curam cel",source:"curam",target:"cel",strength:.718910670154704,citations:["Aink307","Aink317"]},{id:"cuṭar nutal",source:"cuṭar",target:"nutal",strength:.7285355304148027,citations:["Aink56","Aink94"]},{id:"al urai",source:"al",target:"urai",strength:.7285355304148027,citations:["Aink66","Aink80"]},{id:"kuṇam koḷ",source:"kuṇam",target:"koḷ",strength:.7285355304148027,citations:["Aink90"]},{id:"uṇ kaṇ",source:"uṇ",target:"kaṇ",strength:.7328042125512144,citations:["Aink101","Aink16","Aink21","Aink36","Aink37","Aink406","Aink69","Aink72"]},{id:"puḷḷi kaḷvaṉ",source:"puḷḷi",target:"kaḷvaṉ",strength:.7336090037402296,citations:["Aink21","Aink22"]},{id:"vayalai ce(m)",source:"vayalai",target:"ce(m)",strength:.7336090037402296,citations:["Aink25","Aink52"]},{id:"vāḻ tōḻaṉ",source:"vāḻ",target:"tōḻaṉ",strength:.7345418841692791,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink35","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"kaḷvaṉ aṟu",source:"kaḷvaṉ",target:"aṟu",strength:.7350538022566954,citations:["Aink21","Aink25","Aink29"]},{id:"toṭi muṉ",source:"toṭi",target:"muṉ",strength:.7350538022566954,citations:["Aink38","Aink40","Aink83"]},{id:"vāḻ ātaṉ",source:"vāḻ",target:"ātaṉ",strength:.7376004922079576,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"ātaṉ vāḻ",source:"ātaṉ",target:"vāḻ",strength:.7376004922079576,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"],curvature:.25},{id:"vāḻ aviṉi",source:"vāḻ",target:"aviṉi",strength:.7376004922079576,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"puṉal āṭi",source:"puṉal",target:"āṭi",strength:.7435057762387037,citations:["Aink76","Aink79","Aink80"]},{id:"maṇal aṭu",source:"maṇal",target:"aṭu",strength:.750040342728886,citations:["Aink100","Aink15"]},{id:"no/nō maruntu",source:"no/nō",target:"maruntu",strength:.750040342728886,citations:["Aink101","Aink99"]},{id:"vaḻi ciṟa",source:"vaḻi",target:"ciṟa",strength:.750040342728886,citations:["Aink2"]},{id:"amma vāḻ",source:"amma",target:"vāḻ",strength:.7626134359865309,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40","Aink77","Aink89"]},{id:"eṉ yāy",source:"eṉ",target:"yāy",strength:.7627013229760436,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"aka(m) aḷai",source:"aka(m)",target:"aḷai",strength:.7754751372043894,citations:["Aink27","Aink30"]},{id:"maṉai nakar",source:"maṉai",target:"nakar",strength:.7754751372043894,citations:["Aink324","Aink60"]},{id:"val poy",source:"val",target:"poy",strength:.7754751372043894,citations:["Aink37"]},{id:"aviṉi pakai",source:"aviṉi",target:"pakai",strength:.7754751372043894,citations:["Aink4","Aink6"]},{id:"vaṭṭi maṉai",source:"vaṭṭi",target:"maṉai",strength:.7754751372043894,citations:["Aink47","Aink48"]},{id:"peṟu cuṭar",source:"peṟu",target:"cuṭar",strength:.7754751372043894,citations:["Aink56","Aink94"]},{id:"vekuḷvōḷ kaṇ",source:"vekuḷvōḷ",target:"kaṇ",strength:.7754751372043894,citations:["Aink84"]},{id:"eṉ vēṭṭōḷ",source:"eṉ",target:"vēṭṭōḷ",strength:.7798472757319258,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"kēḷ vaḻi",source:"kēḷ",target:"vaḻi",strength:.790173470789915,citations:["Aink2"]},{id:"nām maṟa",source:"nām",target:"maṟa",strength:.790173470789915,citations:["Aink36"]},{id:"ciṟai putu",source:"ciṟai",target:"putu",strength:.790173470789915,citations:["Aink53","Aink78"]},{id:"amaintaṉaṉ tāṉ",source:"amaintaṉaṉ",target:"tāṉ",strength:.8066048097785712,citations:["Aink103"]},{id:"taṭa(m) kōṭṭam",source:"taṭa(m)",target:"kōṭṭam",strength:.8066048097785712,citations:["Aink94","Aink98"]},{id:"karu(m) erumai",source:"karu(m)",target:"erumai",strength:.8219693981414088,citations:["Aink92","Aink95","Aink97"]},{id:"neṭu(m) nakar",source:"neṭu(m)",target:"nakar",strength:.825233125525517,citations:["Aink324","Aink60"]},{id:"tēr taḷar",source:"tēr",target:"taḷar",strength:.825233125525517,citations:["Aink403","Aink66"]},{id:"vēṇṭu aṉṉai",source:"vēṇṭu",target:"aṉṉai",strength:.8384025126819536,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"aṉṉai vēṇṭu",source:"aṉṉai",target:"vēṇṭu",strength:.8384025126819536,citations:["Aink101","Aink102","Aink103","Aink105","Aink201","Aink204"],curvature:.25},{id:"aṭai karai",source:"aṭai",target:"karai",strength:.8467379378396003,citations:["Aink13","Aink21"]},{id:"aḻu piri",source:"aḻu",target:"piri",strength:.8467379378396003,citations:["Aink18","Aink40"]},{id:"muḷḷi aḷai",source:"muḷḷi",target:"aḷai",strength:.8467379378396003,citations:["Aink22","Aink23"]},{id:"vayalai koṭi",source:"vayalai",target:"koṭi",strength:.8467379378396003,citations:["Aink25","Aink52"]},{id:"vaḷai nekiḻ",source:"vaḷai",target:"nekiḻ",strength:.8467379378396003,citations:["Aink27","Aink54"]},{id:"nekiḻ cā",source:"nekiḻ",target:"cā",strength:.8467379378396003,citations:["Aink27","Aink28"]},{id:"aru(m) curam",source:"aru(m)",target:"curam",strength:.8467379378396003,citations:["Aink307","Aink317"]},{id:"maṟa amai",source:"maṟa",target:"amai",strength:.8467379378396003,citations:["Aink36"]},{id:"kātal taḻuvu",source:"kātal",target:"taḻuvu",strength:.8467379378396003,citations:["Aink406","Aink71"]},{id:"maṇi niṟam",source:"maṇi",target:"niṟam",strength:.8467379378396003,citations:["Aink45","Aink96"]},{id:"aḻi putu",source:"aḻi",target:"putu",strength:.8467379378396003,citations:["Aink53","Aink78"]},{id:"karu(m) kōṭṭam",source:"karu(m)",target:"kōṭṭam",strength:.8467379378396003,citations:["Aink92","Aink95"]},{id:"oṇmai toṭi",source:"oṇmai",target:"toṭi",strength:.8528672650295062,citations:["Aink28","Aink38","Aink40","Aink76","Aink83","Aink92","Aink98"]},{id:"kōṭṭam erumai",source:"kōṭṭam",target:"erumai",strength:.8584889545372533,citations:["Aink92","Aink94","Aink95","Aink98"]},{id:"nīl niṟa",source:"nīl",target:"niṟa",strength:.8721727323151038,citations:["Aink102","Aink401"]},{id:"aka(m) maṇ",source:"aka(m)",target:"maṇ",strength:.8721727323151038,citations:["Aink27","Aink30"]},{id:"poy urai",source:"poy",target:"urai",strength:.8721727323151038,citations:["Aink66","Aink80"]},{id:"yāy yām",source:"yāy",target:"yām",strength:.8771133760205393,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"nutal arivai",source:"nutal",target:"arivai",strength:.8791114123610304,citations:["Aink322","Aink404","Aink46","Aink73"]},{id:"vēṭṭōḷ yām",source:"vēṭṭōḷ",target:"yām",strength:.8942593287764214,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"keḻu koṭu(m)",source:"keḻu",target:"koṭu(m)",strength:.9033024048892856,citations:["Aink11","Aink12"]},{id:"karai cēr",source:"karai",target:"cēr",strength:.9033024048892856,citations:["Aink12","Aink74"]},{id:"tūmpu uṭai",source:"tūmpu",target:"uṭai",strength:.9033024048892856,citations:["Aink16","Aink20"]},{id:"vēr aḷai",source:"vēr",target:"aḷai",strength:.9033024048892856,citations:["Aink22","Aink23"]},{id:"maṇ aḷai",source:"maṇ",target:"aḷai",strength:.9033024048892856,citations:["Aink27","Aink30"]},{id:"col uṇarntōr",source:"col",target:"uṇarntōr",strength:.9033024048892856,citations:["Aink38","Aink41"]},{id:"māṇ kuṇam",source:"māṇ",target:"kuṇam",strength:.9033024048892856,citations:["Aink90"]},{id:"malir niṟai",source:"malir",target:"niṟai",strength:.9244645785045242,citations:["Aink15","Aink42","Aink72"]},{id:"amma tōḻaṉ",source:"amma",target:"tōḻaṉ",strength:.9344020375245126,citations:["Aink221","Aink31","Aink32","Aink33","Aink34","Aink36","Aink37","Aink38","Aink39","Aink40"]},{id:"el vaḷai",source:"el",target:"vaḷai",strength:.9434355329503147,citations:["Aink20","Aink27"]},{id:"muḷḷi vēr",source:"muḷḷi",target:"vēr",strength:.9434355329503147,citations:["Aink22","Aink23"]},{id:"titti alkul",source:"titti",target:"alkul",strength:.9434355329503147,citations:["Aink29","Aink72"]},{id:"ciṟai aḻi",source:"ciṟai",target:"aḻi",strength:.9434355329503147,citations:["Aink53","Aink78"]},{id:"kai vaḷ",source:"kai",target:"vaḷ",strength:.9434355329503147,citations:["Aink58","Aink61"]},{id:"vēṭṭōḷ yāy",source:"vēṭṭōḷ",target:"yāy",strength:.9828540472441178,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"ātaṉ aviṉi",source:"ātaṉ",target:"aviṉi",strength:1,citations:["Aink1","Aink10","Aink2","Aink3","Aink4","Aink5","Aink6","Aink7","Aink8","Aink9"]},{id:"tām malai",source:"tām",target:"malai",strength:1,citations:["Aink221","Aink316"]},{id:"mal val",source:"mal",target:"val",strength:1,citations:["Aink37"]},{id:"kuḻuvu peyarvuḻi",source:"kuḻuvu",target:"peyarvuḻi",strength:1.0966975951107143,citations:["Aink204"]},{id:"peyarvuḻi tavir",source:"peyarvuḻi",target:"tavir",strength:1.0966975951107143,citations:["Aink204"]}],Ma={nodes:OA,links:IA},NA=n=>{const t=1+200/Math.hypot(n.x,n.y,n.z),i=n.x||n.y||n.z?{x:n.x*t,y:n.y*t,z:n.z*t}:{x:0,y:0,z:200};Sa.cameraPosition(i,n,1e3)},Sa=_A(),UA=()=>{const n=new Map([["adjective","#66c2a5"],["noun","#fc8d62"],["pronoun","#8da0cb"],["verb","#e78ac3"],["other","#a6d854"]]),e=document.getElementById("panellegend");e.innerHTML=[...n].map(i=>`<div><input type="checkbox" name="${i[0]}" checked autocomplete="off"/><label><span style="color:${i[1]}; font-size: 150%">●</span> ${i[0]}</div>`).join("")+'<div id="solonodes"><input type="checkbox" name="solonodes" checked autocomplete="off"/><label>Show unconnected nodes</label></div>';const t=structuredClone(Ma.links).filter(i=>i.strength>=.45);Sa(document.getElementById("colgraph")).graphData({nodes:Ma.nodes,links:t}).nodeLabel(i=>`${i.size} occurences`).nodeThreeObject(i=>{const r=new zA(i.id);return r.material.depthWrite=!1,r.color=n.get(i.type)||n.get("other"),r.textHeight=i.size/2<8?8:i.size/2,r}).linkWidth(i=>i.strength*5).linkOpacity(.3).linkDirectionalArrowLength(5).linkCurvature(i=>i.curvature||0).linkLabel(i=>`${i.citations.join(", ")} (NPMI: ${i.strength.toPrecision(4)})`).onNodeClick(NA),Sa.d3Force("link").distance(i=>40/i.strength)},FA=n=>{const e=document.getElementById("panel");e.style.display!=="flex"?(e.animate([{marginTop:"-25px"},{marginTop:"0px"}],{duration:200,iterations:1}),e.style.display="flex",n.target.textContent="⇧"):(e.animate([{marginTop:"0px"},{marginTop:"-25px"}],{duration:200,iterations:1}),setTimeout(()=>e.style.display="none",200),n.target.textContent="⇩")},BA=n=>{const e=new Set;for(const t of n)e.add(t.source),e.add(t.target);return e},HA=()=>{const n={};n.nodes=Ma.nodes,n.links=structuredClone(Ma.links);const e=document.getElementById("npmi").value;n.links=n.links.filter(r=>r.strength>=e);const t=document.getElementById("panellegend").querySelectorAll('input:not([name="solonodes"])'),i=new Set([...t].filter(r=>r.checked).map(r=>r.getAttribute("name")));if(i.size!==t.length){n.nodes=n.nodes.filter(a=>i.has(a.type));const r=new Set(n.nodes.map(a=>a.id));n.links=n.links.filter(a=>r.has(a.target)&&r.has(a.source))}if(!document.querySelector('input[name="solonodes"]').checked){const r=BA(n.links);n.nodes=n.nodes.filter(a=>r.has(a.id))}Sa.graphData(n)};document.getElementById("paneltoggle").addEventListener("click",FA);document.getElementById("graphupdate").addEventListener("click",HA);UA();
